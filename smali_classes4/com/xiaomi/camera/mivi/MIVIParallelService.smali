...
.method public static bridge synthetic b(Lcom/xiaomi/camera/mivi/MIVIParallelService;)Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;
    .locals 0
...
.method private registerCallback()V
    ...
    invoke-static {}, Lbr/b;->g()Lbr/b;

    move-result-object v3

    iput-object v3, p0, Lcom/xiaomi/camera/mivi/MIVIParallelService;->mService:Lbr/b;
    ...
    iget-object v3, p0, Lcom/xiaomi/camera/mivi/MIVIParallelService;->mService:Lbr/b;
    ...
    invoke-interface {v3, v4, v5}, Lbr/b;->k(ILbr/c;)I
    ...
    iget-object p0, p0, Lcom/xiaomi/camera/mivi/MIVIParallelService;->mService:Lbr/b;

    new-instance v1, Lcom/xiaomi/camera/mivi/b;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    invoke-interface {p0, v1}, Lbr/b;->i(Landroid/os/IHwBinder$DeathRecipient;)Z
...
.method public static setCapabilities(Ljava/lang/String;)V
    ...
    invoke-interface {v0, p0}, Lbr/b;->h(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/util/NoSuchElementException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public onDestroy()V
    ...
    iget-object v1, p0, Lcom/xiaomi/camera/mivi/MIVIParallelService;->mService:Lbr/b;
    ...
    invoke-interface {v1, v4, v5}, Lbr/b;->k(ILbr/c;)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

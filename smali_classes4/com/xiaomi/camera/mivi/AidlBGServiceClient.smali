...
.method private bindServiceLocked()V
    ...
    invoke-static {v0}, LZh/d;->a(Ljava/lang/String;)Landroid/os/IBinder;
...
.method private static lambda$handleFailedCase$3(Ljava/lang/String;)V
    ...
    const-string v6, "handleFailedCase: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v6, v4, Li2/b;->d:Ljava/lang/String;
    ...
    invoke-static {v4}, Lcom/xiaomi/camera/mivi/qcom/MIVICaptureManagerQcomImpl;->truncateFileToRealSizeAndMarkTaskFinish(Li2/b;)V
    ...
    iget-object v6, v4, Li2/b;->j:Ljava/lang/String;

    invoke-direct {v5, v6}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    const-string v6, "{\"smallPicture\":\"true\",\"type\":\"mivi\",\"reason\":\"big picture does still not back to app\",\"imageName\":\"%s\"}"

    invoke-static {v5, v6}, Lt6/A;->G(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v5, v4}, Lm2/a;->c(Landroid/content/Context;Li2/b;)V
    :try_end_0
...
.method private registerCallback()V
    ...
    invoke-interface {v3, v2, v5}, Lvendor/xiaomi/hardware/aidlbgservice/a;->s0(ILvendor/xiaomi/hardware/aidlbgservice/b;)I
...
.method public setCapabilities(Ljava/lang/String;)V
    ...
    invoke-interface {p0, p1}, Lvendor/xiaomi/hardware/aidlbgservice/a;->h(Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setCurrentPhotoTimestamp(J)V
    ...
    invoke-interface {p0, v0, p1, p2}, Lvendor/xiaomi/hardware/aidlbgservice/a;->z(IJ)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public setPhotoSaveCompleted(J)V
    ...
    invoke-interface {p0, p1, p2}, Lvendor/xiaomi/hardware/aidlbgservice/a;->k(J)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

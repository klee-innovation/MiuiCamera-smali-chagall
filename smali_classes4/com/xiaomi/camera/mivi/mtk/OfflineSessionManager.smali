...
.method private checkTimeoutTask(Landroid/hardware/camera2/CameraOfflineSession;)V
    ...
    :try_start_0
    invoke-static {p1}, LS/U;->b(Landroid/hardware/camera2/CameraOfflineSession;)V
    :try_end_0
...
.method private synthetic lambda$switchToOffline$0(Landroid/hardware/camera2/CameraCaptureSession;Ljava/util/List;Ljava/util/concurrent/Executor;JLio/reactivex/i;)V
    ...
    invoke-static {p1, p2, p3, v2}, LJ5/Z;->b(Landroid/hardware/camera2/CameraCaptureSession;Ljava/util/List;Ljava/util/concurrent/Executor;Landroid/hardware/camera2/CameraOfflineSession$CameraOfflineSessionCallback;)Landroid/hardware/camera2/CameraOfflineSession;
...
.method private preProcessOfflineEvent(Lcom/xiaomi/camera/mivi/mtk/OfflineSessionManager$OfflineSessionEvent;)V
    ...
    invoke-static {v0}, LS/U;->b(Landroid/hardware/camera2/CameraOfflineSession;)V
...
.method public switchToOffline(Landroid/hardware/camera2/CameraCaptureSession;Ljava/util/List;Ljava/util/concurrent/Executor;J)Lio/reactivex/h;
    ...
    new-instance v7, Lcom/xiaomi/camera/mivi/mtk/f;
    ...
    invoke-direct/range {v0 .. v6}, Lcom/xiaomi/camera/mivi/mtk/f;-><init>(Lcom/xiaomi/camera/mivi/mtk/OfflineSessionManager;Landroid/hardware/camera2/CameraCaptureSession;Ljava/util/List;Ljava/util/concurrent/Executor;J)V

    sget-object p1, Lio/reactivex/a;->b:Lio/reactivex/a;

    sget p2, Lio/reactivex/h;->a:I

    new-instance p2, Lio/reactivex/internal/operators/flowable/b;

    invoke-direct {p2, v7, p1}, Lio/reactivex/internal/operators/flowable/b;-><init>(Lio/reactivex/j;Lio/reactivex/a;)V

    new-instance p1, Lcom/xiaomi/camera/mivi/mtk/g;

    invoke-direct {p1, p0}, Lcom/xiaomi/camera/mivi/mtk/g;-><init>(Lcom/xiaomi/camera/mivi/mtk/OfflineSessionManager;)V

    new-instance p0, Lio/reactivex/internal/operators/flowable/f;

    invoke-direct {p0, p2, p1}, Lio/reactivex/internal/operators/flowable/f;-><init>(Lio/reactivex/h;Lio/reactivex/functions/d;)V

    new-instance p1, Lcom/xiaomi/camera/mivi/mtk/h;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    new-instance p2, Lio/reactivex/internal/operators/flowable/k;

    invoke-direct {p2, p0, p1}, Lio/reactivex/internal/operators/flowable/k;-><init>(Lio/reactivex/h;Lio/reactivex/functions/e;)V
...
.method public tryCloseOfflineSession(J)V
    ...
    invoke-static {v0}, LS/V;->a(Ljava/lang/Object;)Landroid/hardware/camera2/CameraOfflineSession;

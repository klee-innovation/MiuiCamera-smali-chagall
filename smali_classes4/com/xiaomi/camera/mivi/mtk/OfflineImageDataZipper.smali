...
.method public static synthetic a(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lag/m;)V
    .locals 0

    invoke-static {p0, p1, p2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lag/m;)V
...
.method private doJpeg(Lag/m;Landroid/media/Image;I)V
    .locals 9
    ...
    invoke-static {v1, v2, p3}, LD0/s;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-direct/range {v3 .. v8}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->generateReprocessData(Lag/m;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
...
.method private generateReprocessData(Lag/m;Landroid/media/Image;Ljava/lang/String;IZ)Lcom/xiaomi/camera/imagecodec/ReprocessData;
    .locals 18
    ...
    iget-object v2, v1, Lag/m;->f:Lag/f;

    iget-object v2, v2, Lag/f;->b:Landroid/hardware/camera2/TotalCaptureResult;

    iget-object v13, v1, Lag/m;->g:Lag/n;

    iget-boolean v5, v13, Lag/n;->p:Z
    ...
    invoke-static {v2, v4}, Lzf/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;

    move-result-object v7

    iget-object v10, v1, Lag/m;->b:Lag/a;

    iget-boolean v8, v10, Lag/a;->d:Z
    ...
    iget v2, v3, Lag/t;->j:I

    iget-object v14, v0, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->mJpegEncoderListener:Lcom/xiaomi/camera/imagecodec/ReprocessData$OnDataAvailableListener;
    ...
    invoke-virtual {v0, v12}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setReprocessFunctionType(I)V

    iget-object v2, v1, Lag/m;->d:Lag/d;

    iget v2, v2, Lag/d;->g:I

    invoke-virtual {v0, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setJpegQuality(I)V

    move/from16 v2, p5

    invoke-virtual {v0, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setImageFromPool(Z)V
    ...
    iget-object v4, v13, Lag/n;->i:Landroid/media/Image;
    ...
    iget-object v2, v13, Lag/n;->i:Landroid/media/Image;

    invoke-virtual {v0, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setTuningImage(Landroid/media/Image;)Ljava/util/ArrayList;

    invoke-virtual {v0, v3}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setKeepTuningImage(Z)V

    invoke-virtual {v0, v3}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setTuningImageFromPool(Z)V
    ...
    iget-boolean v2, v2, Lag/a;->c:Z

    if-eqz v2, :cond_1

    invoke-virtual {v0, v3}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setRotateOrientationToZero(Z)V

    :cond_1
    iget-boolean v2, v13, Lag/n;->u:Z
    ...
    invoke-virtual {v0, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setOrientation(I)V

    :cond_2
    iget-byte v2, v13, Lag/n;->v:B

    invoke-virtual {v0, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setSiqeType(B)V

    iget-object v2, v13, Lag/n;->s:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, v13, Lag/n;->s:Landroid/util/Size;

    invoke-virtual {v3}, Landroid/util/Size;->getHeight()I

    move-result v3

    invoke-virtual {v0, v2, v3}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setYuvInputSize(II)V

    iget-object v2, v1, Lag/m;->h:Lag/o;

    iget v3, v2, Lag/o;->b:I

    iget v2, v2, Lag/o;->c:I

    invoke-virtual {v0, v3, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setRawInputSize(II)V

    move-object/from16 v2, p0

    iget-object v2, v2, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->mRawDataStatusCallback:Lcom/xiaomi/camera/imagecodec/ReprocessData$DataStatusCallback;

    invoke-virtual {v0, v2}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setDataStatusCallback(Lcom/xiaomi/camera/imagecodec/ReprocessData$DataStatusCallback;)V

    iget-object v1, v1, Lag/m;->k:Lag/u;

    iget-object v1, v1, Lag/u;->b:Ljava/lang/String;

    invoke-virtual {v0, v1}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->setImageName(Ljava/lang/String;)V
...
.method private handTimeoutTask(J)V
    ...
    invoke-static {p1, p2, v1, v2}, LI/g;->g(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method private handleDataBeanIfReady(Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;Z)V
    ...
    invoke-virtual {p2, v0}, LT5/n;->g(Ljava/lang/String;)J

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageData;->getTimestamp()J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->getParallelTaskData(J)Lag/m;
    ...
    :cond_1
    iget-wide v0, v0, Lag/s;->b:J

    iget-object v2, p2, Lag/m;->k:Lag/u;

    iget-object v2, v2, Lag/u;->b:Ljava/lang/String;

    iget-object v3, p2, Lag/m;->a:Lag/t;
    ...
    invoke-static {v0}, Lzf/e;->h(Landroid/media/Image;)[B
    ...
    invoke-virtual {p2, v1, v0}, Lag/m;->a(I[B)V
    ...
    invoke-static {v1, v2, v3}, LD0/s;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    iget-object v1, p2, Lag/m;->g:Lag/n;

    iput-object v0, v1, Lag/n;->i:Landroid/media/Image;
    ...
    iget-object v2, p2, Lag/m;->l:Lag/w;
    ...
    invoke-direct {p0, v2, p2, v1}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->postCvWaterMark(Landroid/media/Image;Lag/m;I)V
    ...
    invoke-direct {p0, p2, v1, v2}, Lcom/xiaomi/camera/mivi/mtk/OfflineImageDataZipper;->doJpeg(Lag/m;Landroid/media/Image;I)V
...
.method private handleRawImageData([BLjava/lang/String;)V
    ...
    invoke-virtual {p0, p2, p1}, Lag/m;->a(I[B)V
    ...
    invoke-static {p0, p1}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->notifyFinish(Lag/m;Ljava/lang/String;)V
...
.method private static synthetic lambda$getParallelTaskSize$0(Ljava/util/concurrent/atomic/AtomicInteger;Ljava/lang/Long;Lag/m;)V
    .locals 0

    invoke-virtual {p2}, Lag/m;->c()I
...
.method private postCvWaterMark(Landroid/media/Image;Lag/m;I)V
    .locals 4
    ...
    invoke-static {p1, v2}, Lzf/e;->g(Landroid/media/Image;Z)[B

    move-result-object v2

    const-string v3, ""

    invoke-static {p3, v3}, LA/e;->g(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v1, v3, p1}, LD0/p;->g(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {p1, p2, p3}, LD0/s;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public getParallelTaskData(J)Lag/m;
    .locals 3
...
.method public putParallelTaskData(JLag/m;)V
    .locals 5
    ...
    iget-object p1, p3, Lag/m;->a:Lag/t;

...
.method private static dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lag/m;Ljava/lang/String;)V
    .locals 2
    ...
    iget-object p1, p1, Lag/u;->b:Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2}, Lzf/e;->d(Landroid/media/Image;Ljava/lang/String;Ljava/lang/String;)Z

    :cond_0
    return-void
.end method

.method private getParallelTaskData(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;ZLjava/lang/String;)Lag/m;
    .locals 11
    ...
    invoke-static {v0, v1, v2, p2}, Lcom/xiaomi/camera/mivi/MIVICaptureManager;->getParallelTaskData(Ljava/lang/String;JZ)Lag/m;
    ...
    invoke-virtual {v0, v1, v3}, Lcom/xiaomi/camera/mivi/qcom/ParallelTaskDataConverter;->readParallelTaskDataFromSmallJpeg(Landroid/content/Context;Ljava/lang/String;)Lag/m;
    ...
    invoke-static {p0}, Lt6/A;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/mm/cinemaster/view/c;->c(Landroid/hardware/camera2/TotalCaptureResult;)Ljava/lang/String;
    ...
    invoke-direct/range {v5 .. v10}, Lag/m;-><init>(IILjava/lang/String;J)V

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getCaptureResult()Landroid/hardware/camera2/TotalCaptureResult;

    move-result-object p0

    iget-object p2, v0, Lag/m;->f:Lag/f;

    iput-object p0, p2, Lag/f;->b:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getPictureName()Ljava/lang/String;

    move-result-object p0

    iget-object p2, v0, Lag/m;->k:Lag/u;

    iput-object p0, p2, Lag/u;->b:Ljava/lang/String;

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getFrameNumber()J

    move-result-wide v5

    iget-object p0, v0, Lag/m;->j:Lag/s;

    iput-wide v5, p0, Lag/s;->b:J
    ...
    invoke-virtual {v3, p2}, Lcom/xiaomi/camera/core/ExifData;->setPictureInfo(LFf/f;)V

    invoke-virtual {p1}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getOutputSize()Landroid/util/Size;

    move-result-object p1

    invoke-virtual {v0, p1}, Lag/m;->B(Landroid/util/Size;)V

    iput-boolean v1, p0, Lag/s;->k:Z
...
.method private initReprocessProxy(Lag/m;ZLjava/lang/String;)V
    .locals 2
    ...
    invoke-static {p3, p0}, LI/b;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/xiaomi/camera/mivi/MIVISDKConfig;->isSupportMIVI3OutputJpeg()Z
    ...
    invoke-static {p3, p1}, LI/b;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method private lambda$startReprocessLoop$1()V
    ...
    invoke-static {v6, v7}, Lk2/a;->H(ILjava/lang/String;)V
    ...
    :goto_2
    invoke-direct {p0, v3, v5, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->getParallelTaskData(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;ZLjava/lang/String;)Lag/m;
    ...
    iget-object v8, v5, Lag/m;->j:Lag/s;

    iput v7, v8, Lag/s;->o:I

    invoke-virtual {v3, v5}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->setParallelTaskData(Lag/m;)V
    ...
    sget-boolean v7, Lzf/e;->d:Z

    if-eqz v7, :cond_8

    const-string v7, "algo_done"

    invoke-static {v3, v5, v7}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->dumpImage(Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;Lag/m;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v5, v6, v4}, Lcom/xiaomi/camera/mivi/qcom/ImageReceiverExecutor;->initReprocessProxy(Lag/m;ZLjava/lang/String;)V

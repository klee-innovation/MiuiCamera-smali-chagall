...
.method private execute(Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/xiaomi/camera/mivi/qcom/bean/ResultImageData;->getParallelTaskData()Lag/m;
    ...
    invoke-static {v8, v9, v7}, LD0/s;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v8, v10}, Lzf/a;->a(Landroid/hardware/camera2/CaptureResult;Ljava/lang/String;)Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v9, v2, Lag/m;->b:Lag/a;

    iget-boolean v9, v9, Lag/a;->c:Z

    if-eqz v9, :cond_4

    const-string v9, "process[2]: setRotateOrientationToZero true"

    invoke-static {v1, v9}, LI/b;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v10, v2, Lag/m;->g:Lag/n;

    iget-boolean v10, v10, Lag/n;->u:Z

    if-eqz v10, :cond_6

    const-string v10, "process[3]: setOrientation "

    invoke-static {v1, v10}, LA/e;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v10

    iget-object v12, v2, Lag/m;->a:Lag/t;

    iget v13, v12, Lag/t;->d:I
    ...
    iget-object v10, v2, Lag/m;->d:Lag/d;

    iget v10, v10, Lag/d;->g:I

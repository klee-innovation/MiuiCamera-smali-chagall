...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget p2, LNg/b;->ocr_content_highlight_color:I
    ...
    sget v2, LNg/c;->ocr_selector_width:I
    ...
    sget v3, LNg/c;->ocr_selector_height:I
    ...
    invoke-direct {v3, p2, v2}, LPg/a;-><init>(FF)V

    iput-object v3, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->b:LPg/a;

    new-instance v4, LSg/a;

    invoke-direct {v4, p0, v3}, LSg/a;-><init>(Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;LPg/a;)V

    iput-object v4, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->c:LSg/a;

    new-instance v3, LSg/b;

    invoke-direct {v3, p0, p0}, LSg/b;-><init>(Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;)V

    iput-object v3, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d:LSg/b;
    ...
    sget v3, LNg/d;->ic_ocr_selector_start:I

    sget-object v5, LI/h;->a:Ljava/lang/ThreadLocal;

    invoke-static {p1, v3, v1}, LI/h$a;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    sget v5, LNg/d;->ic_ocr_selector_end:I

    invoke-static {v3, v5, v1}, LI/h$a;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    sget-object v3, LPg/a$c;->a:LPg/a$c;

    iput-object v3, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d0:LPg/a$c;
...
.method public final a()V
    ...
    iget-object v0, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->b:LPg/a;

    invoke-virtual {v0}, LPg/a;->d()Z
    ...
    :cond_0
    iget-object v1, v0, LPg/a;->c:LPg/a$b;

    const/4 v2, -0x1

    iput v2, v1, LPg/a$b;->a:I

    iput v2, v1, LPg/a$b;->b:I

    iget-object v1, v0, LPg/a;->d:LPg/a$b;

    iput v2, v1, LPg/a$b;->a:I

    iput v2, v1, LPg/a$b;->b:I

    invoke-virtual {v0}, LPg/a;->j()V
    ...
    invoke-interface {v0, v1}, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView$a;->c0(Ljava/lang/String;)V

    :cond_1
    iget-object v0, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d:LSg/b;

    iget-object v0, v0, LSg/b;->i:Landroid/view/ActionMode;
...
.method public final b(Landroid/graphics/Canvas;Z)V
    ...
    iget-object p2, v0, LPg/a;->j:LPg/a$e;
    ...
    :cond_0
    iget-object p2, v0, LPg/a;->k:LPg/a$e;
...
.method public final c()V
    ...
    :cond_0
    iget-object v1, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d:LSg/b;

    iget-object v1, v1, LSg/b;->i:Landroid/view/ActionMode;
    ...
    invoke-static {p0}, LSg/d;->a(Ljava/lang/String;)V
...
.method public final d()V
    ...
    iget-object v1, v0, LSg/b;->i:Landroid/view/ActionMode;
    ...
    invoke-virtual {p0}, LPg/a;->c()Z

    move-result v1

    if-eqz v1, :cond_2

    invoke-virtual {p0}, LPg/a;->d()Z
    ...
    :cond_1
    iget-object v1, p0, LPg/a;->a:Ljava/util/ArrayList;

    iget-object v4, p0, LPg/a;->c:LPg/a$b;

    iget v4, v4, LPg/a$b;->a:I

    invoke-virtual {v1, v4}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, LPg/a$d;

    iget-object v1, v1, LPg/a$d;->b:[F
    ...
    invoke-static {v1}, LR1/g;->o([F)Landroid/graphics/Rect;

    move-result-object v1

    iput-object v1, v0, LSg/b;->j:Landroid/graphics/Rect;

    invoke-virtual {p0}, LPg/a;->e()Z
    ...
    iget-object v1, v0, LSg/b;->j:Landroid/graphics/Rect;
    ...
    :cond_4
    iput-boolean p0, v0, LSg/b;->k:Z

    iget-object p0, v0, LSg/b;->b:Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;

    iget-object v1, v0, LSg/b;->a:LSg/b$a;

    invoke-virtual {p0, v1, v4}, Landroid/view/View;->startActionMode(Landroid/view/ActionMode$Callback;I)Landroid/view/ActionMode;

    move-result-object p0

    iput-object p0, v0, LSg/b;->i:Landroid/view/ActionMode;
...
.method public final dispatchHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->c:LSg/a;
...
.method public final dispatchTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    sget-object v3, LPg/a$c;->c:LPg/a$c;

    sget-object v4, LPg/a$c;->b:LPg/a$c;

    sget-object v5, LPg/a$c;->a:LPg/a$c;
    ...
    iget-object v9, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->b:LPg/a;
    ...
    invoke-static {v6, p1, v12, v2}, LD1/a;->c(Ljava/lang/String;FLjava/lang/String;F)Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d0:LPg/a$c;
    ...
    :cond_4
    iget-object v5, v9, LPg/a;->a:Ljava/util/ArrayList;

    const/4 v6, -0x1

    iget-object v10, v9, LPg/a;->d:LPg/a$b;

    iget-object v12, v9, LPg/a;->c:LPg/a$b;
    ...
    check-cast v3, LPg/a$d;

    iget-object v4, v3, LPg/a$d;->b:[F

    invoke-static {v0, v1, v4}, LR1/g;->q(FF[F)Z
    ...
    :goto_1
    iget-object v11, v3, LPg/a$d;->a:Ljava/util/ArrayList;
    ...
    check-cast v11, LPg/a$a;

    iget-object v11, v11, LPg/a$a;->a:[F

    invoke-static {v0, v1, v11}, LR1/g;->q(FF[F)Z
    ...
    invoke-direct {v0, p1, v4}, LPg/a$b;-><init>(II)V
    ...
    :goto_3
    iget p1, v0, LPg/a$b;->a:I

    if-eq p1, v6, :cond_14

    iget p1, v0, LPg/a$b;->b:I
    ...
    iget-object v1, v9, LPg/a;->e:LPg/a$b;
    ...
    iget v3, v0, LPg/a$b;->b:I

    iput p1, v12, LPg/a$b;->a:I

    iput v3, v12, LPg/a$b;->b:I
    ...
    iput p1, v10, LPg/a$b;->a:I

    iput v3, v10, LPg/a$b;->b:I

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget p1, v0, LPg/a$b;->a:I

    iget v0, v0, LPg/a$b;->b:I

    iput p1, v1, LPg/a$b;->a:I

    iput v0, v1, LPg/a$b;->b:I

    goto/16 :goto_5

    :cond_9
    invoke-virtual {v0, v1}, LPg/a$b;->e(LPg/a$b;)I
    ...
    iput v0, v12, LPg/a$b;->b:I

    invoke-virtual {v10}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget p1, v1, LPg/a$b;->a:I

    iget v0, v1, LPg/a$b;->b:I

    iput p1, v10, LPg/a$b;->a:I

    iput v0, v10, LPg/a$b;->b:I
    ...
    iget v1, v1, LPg/a$b;->b:I

    iput p1, v12, LPg/a$b;->a:I

    iput v1, v12, LPg/a$b;->b:I
    ...
    :cond_c
    iget p1, v10, LPg/a$b;->a:I

    invoke-virtual {v9, p1, v0, v1}, LPg/a;->a(IFF)I
    ...
    invoke-virtual {v3, v2, v0, v1}, LPg/a$d;->b(LPg/a$c;FF)I

    move-result v0

    invoke-virtual {v10, p1, v0}, LPg/a$b;->a(II)Z
    ...
    :cond_d
    iget v1, v12, LPg/a$b;->a:I

    if-lt p1, v1, :cond_f

    if-ne p1, v1, :cond_e

    iget v1, v12, LPg/a$b;->b:I
    ...
    :cond_f
    :goto_4
    invoke-virtual {v9, v12, v6}, LPg/a;->g(LPg/a$b;I)LPg/a$b;

    move-result-object v1

    iget v2, v1, LPg/a$b;->a:I

    iget v1, v1, LPg/a$b;->b:I

    iput v2, v10, LPg/a$b;->a:I

    iput v1, v10, LPg/a$b;->b:I
    ...
    check-cast v4, LPg/a$d;

    invoke-virtual {v4, v2, v0, v1}, LPg/a$d;->b(LPg/a$c;FF)I

    move-result v0

    invoke-virtual {v12, p1, v0}, LPg/a$b;->a(II)Z
    ...
    :cond_11
    iget v1, v10, LPg/a$b;->a:I

    if-gt p1, v1, :cond_13

    if-ne p1, v1, :cond_12

    iget v1, v10, LPg/a$b;->b:I
    ...
    :cond_13
    :goto_6
    invoke-virtual {v9, v10, v8}, LPg/a;->g(LPg/a$b;I)LPg/a$b;
    ...
    :goto_7
    invoke-virtual {v9}, LPg/a;->j()V

    move-object v2, v3

    :cond_14
    :goto_8
    iput-object v2, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d0:LPg/a$c;
    ...
    iput-object v5, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d0:LPg/a$c;
    ...
    invoke-virtual {v9, p1, v0}, LPg/a;->i(FF)LPg/a$f;

    move-result-object p1

    iget v0, p1, LPg/a$f;->a:I
    ...
    :cond_18
    iget-boolean p1, p1, LPg/a$f;->b:Z
    ...
    :cond_19
    iget-object p1, v9, LPg/a;->a:Ljava/util/ArrayList;

    invoke-virtual {p1, v0}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, LPg/a$d;

    iget-object v1, v9, LPg/a;->c:LPg/a$b;

    iput v0, v1, LPg/a$b;->a:I

    iput v7, v1, LPg/a$b;->b:I

    iget-object p1, p1, LPg/a$d;->a:Ljava/util/ArrayList;
    ...
    iget-object v1, v9, LPg/a;->d:LPg/a$b;

    iput v0, v1, LPg/a$b;->a:I

    iput p1, v1, LPg/a$b;->b:I
    ...
    invoke-interface {v0, p1}, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView$a;->c0(Ljava/lang/String;)V
    ...
    iget-object p1, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d:LSg/b;

    iget-object p1, p1, LSg/b;->i:Landroid/view/ActionMode;
    ...
    iget-object p1, v9, LPg/a;->j:LPg/a$e;

    if-eqz p1, :cond_25

    iget-object p1, v9, LPg/a;->k:LPg/a$e;
    ...
    iget-object v0, v9, LPg/a;->j:LPg/a$e;

    iget-object v0, v0, LPg/a$e;->a:[F
    ...
    invoke-static {v1, v2, v11, v0}, LR1/g;->k(FFFF)Landroid/graphics/PointF;

    move-result-object v0

    invoke-static {v0, p1}, LR1/g;->j(Landroid/graphics/PointF;Landroid/graphics/PointF;)F

    move-result v0

    iget v1, v9, LPg/a;->i:F
    ...
    :cond_24
    iget-object v0, v9, LPg/a;->k:LPg/a$e;
    ...
    invoke-static {v2, v4, v6, v0}, LR1/g;->k(FFFF)Landroid/graphics/PointF;
    ...
    iget-object p0, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d0:LPg/a$c;
...
.method public final e(Landroid/graphics/RectF;)V
    ...
    iget-object v2, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->b:LPg/a;

    iget-object v2, v2, LPg/a;->f:Landroid/graphics/Matrix;

    invoke-virtual {v2, v0}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    iget-object p0, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->c:LSg/a;

    iget-object p0, p0, LSg/a;->q:Landroid/graphics/Rect;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v1, v0, LPg/a;->b:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Lcom/xiaomi/camera/features/ocr/ui/widgets/OCRContentView;->d0:LPg/a$c;

    sget-object v1, LPg/a$c;->b:LPg/a$c;
    ...
    sget-object v1, LPg/a$c;->c:LPg/a$c;
...
.method public setOCRResult(Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;)V
    ...
    iput-object p1, p0, LPg/a;->l:Lcom/xiaomi/ocr/sdk_ocr/OCRData$OCRResult;

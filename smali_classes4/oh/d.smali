...
.method public constructor <init>(Landroid/content/Context;Landroid/net/Uri;)V
    ...
    .line 8
    iput-object v0, p0, Loh/d;->g:Landroid/os/ParcelFileDescriptor;
    ...
    iput-object p1, p0, Loh/d;->g:Landroid/os/ParcelFileDescriptor;
    ...
    iput-object v1, p0, Loh/d;->a:Landroid/media/MediaMuxer;
    :try_end_0
    ...
    .line 12
    :goto_0
    iput v0, p0, Loh/d;->b:I

    .line 13
    iput v0, p0, Loh/d;->c:I
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, Loh/d;->a:Landroid/media/MediaMuxer;

    .line 4
    iput v1, p0, Loh/d;->b:I

    .line 5
    iput v1, p0, Loh/d;->c:I

    .line 6
    iput-boolean v1, p0, Loh/d;->d:Z
...
.method public final a()V
    ...
    iget-object v1, p0, Loh/d;->f:Loh/b;

    const/4 v2, 0x0

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Loh/c;->e()V

    iput-object v2, p0, Loh/d;->f:Loh/b;

    :cond_0
    iget-object v1, p0, Loh/d;->e:Loh/e;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Loh/c;->e()V

    iput-object v2, p0, Loh/d;->e:Loh/e;
...
.method public final b(JZ)Z
    ...
    iget-object v0, p0, Loh/d;->e:Loh/e;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p1, p2, p3}, Loh/e;->h(JZ)Z

    :cond_0
    iget-object p0, p0, Loh/d;->f:Loh/b;

    if-eqz p0, :cond_1

    invoke-virtual {p0, p1, p2, p3}, Loh/b;->h(JZ)Z
...
.method public final declared-synchronized c()Z
    ...
    iget v3, p0, Loh/d;->b:I

    if-lez v3, :cond_0

    if-gtz v0, :cond_0

    iget-object v0, p0, Loh/d;->a:Landroid/media/MediaMuxer;
...
.method public final d()V
    ...
    invoke-virtual {v1}, Loh/c;->i()V

    :cond_0
    iget-object p0, p0, Loh/d;->e:Loh/e;

    if-eqz p0, :cond_1

    invoke-virtual {p0}, Loh/c;->i()V

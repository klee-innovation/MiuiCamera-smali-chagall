...
.method static constructor <clinit>()V
    ...
    sput-object v0, Loh/e;->e0:[I

    return-void
.end method

.method public constructor <init>(Lph/c;Ljava/lang/String;Loh/d;Loh/c$a;II)V
    .locals 1

    invoke-direct {p0, p3, p4}, Loh/c;-><init>(Loh/d;Loh/c$a;)V

    const-string p3, "video/avc"

    iput-object p3, p0, Loh/e;->r:Ljava/lang/String;
    ...
    invoke-static {p5, p6, p4, v0}, LKb/v1;->f(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, Loh/e;->d0:Lph/c;

    iput p5, p0, Loh/e;->s:I

    iput p6, p0, Loh/e;->t:I
    ...
    iput-object p2, p0, Loh/e;->r:Ljava/lang/String;

    :cond_0
    iget-object p1, p0, Loh/c;->a:Ljava/lang/String;

    invoke-static {p5, p6, p1}, Lph/d;->a(IILjava/lang/String;)Lph/d;

    move-result-object p1

    iput-object p1, p0, Loh/e;->Y:Lph/d;
...
.method public final f()V
    ...
    iget-object v1, p0, Loh/e;->Y:Lph/d;

    const/4 v3, 0x0

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lph/d;->e()V

    iput-object v3, p0, Loh/e;->d0:Lph/c;

    iput-object v3, p0, Loh/e;->Y:Lph/d;

    :cond_0
    iget-object v1, p0, Loh/e;->Z:Landroid/view/Surface;

    if-eqz v1, :cond_1

    invoke-virtual {v1}, Landroid/view/Surface;->release()V

    iput-object v3, p0, Loh/e;->Z:Landroid/view/Surface;
...
.method public final j(LM2/e;)V
    .locals 9

    invoke-virtual {p0}, Loh/c;->c()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Loh/c;->f:Z

    if-nez v0, :cond_0

    iget-object v0, p0, Loh/e;->Y:Lph/d;
    ...
    iget-object v3, p1, LM2/e;->d:LC8/f;

    iget-object v4, p1, LM2/e;->c:[F

    new-instance v5, Landroid/graphics/Rect;

    iget v6, v0, Lph/d;->g:I

    const/4 v7, 0x0

    iget v8, v0, Lph/d;->f:I

    invoke-direct {v5, v7, v7, v8, v6}, Landroid/graphics/Rect;-><init>(IIII)V

    invoke-virtual {v2, v3, v4, v5}, LM2/e;->a(LC8/f;[FLandroid/graphics/Rect;)V

    iget-object v3, p1, LM2/e;->f:LTl/a;

    iput-object v3, v2, LM2/e;->f:LTl/a;

    iget-object p1, p1, LM2/e;->g:LTl/a;

    iput-object p1, v2, LM2/e;->g:LTl/a;

    invoke-virtual {v1, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v0, v1}, Lph/d;->b(Ljava/util/ArrayList;)V

    iget-object p0, p0, Loh/e;->Y:Lph/d;

    invoke-virtual {p0}, Lph/d;->g()V
...
.method public final k()V
    ...
    iget-object v3, p0, Loh/e;->r:Ljava/lang/String;
    ...
    iget v2, p0, Loh/e;->s:I

    iget v5, p0, Loh/e;->t:I
    ...
    iget-object v2, p0, Loh/e;->d0:Lph/c;

    iget-object v5, v2, Lph/c;->b:LTl/a;

    sget-object v8, LTl/a;->b:LTl/a$c;

    if-ne v5, v8, :cond_8

    sget-object v5, LTl/a;->a:LTl/a$a;

    iget-object v2, v2, Lph/c;->c:LTl/a;
    ...
    iput-object v1, p0, Loh/e;->Z:Landroid/view/Surface;

    iget-object v2, p0, Loh/e;->Y:Lph/d;

    iget-object v3, p0, Loh/e;->d0:Lph/c;

    iput-object v3, v2, Lph/d;->m:Lph/c;

    iget-object v3, v3, Lph/c;->a:Landroid/opengl/EGLContext;

    invoke-virtual {v2, v3, v1}, Lph/d;->f(Landroid/opengl/EGLContext;Landroid/view/Surface;)V

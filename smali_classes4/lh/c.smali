...
.field public final h:Llh/h$c;

.field public final h0:Z

.field public final i:Landroid/os/Handler;

.field public i0:Llh/c$e;
...
.field public m0:LX2/b;

.field public final n:I

.field public n0:Llh/b;
...
# direct methods
.method public constructor <init>(IIZIIIILandroid/os/Handler;Llh/h$c;)V
    .locals 23
    ...
    iput-object v9, v0, Llh/c;->e0:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, Llh/c;->f0:Ljava/util/ArrayList;

    new-instance v9, Ljava/util/ArrayList;

    invoke-direct {v9}, Ljava/util/ArrayList;-><init>()V

    iput-object v9, v0, Llh/c;->g0:Ljava/util/ArrayList;

    const/16 v9, 0x10

    new-array v9, v9, [F

    iput-object v9, v0, Llh/c;->p0:[F
    ...
    iput-object v9, v0, Llh/c;->q0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v7, v0, Llh/c;->a:Ljava/lang/String;

    const/16 v9, 0x200

    iput v9, v0, Llh/c;->b:I

    iput v9, v0, Llh/c;->c:I

    const/16 v11, 0x20

    iput v11, v0, Llh/c;->d:I

    const-wide/high16 v11, 0x3fd0000000000000L    # 0.25

    iput-wide v11, v0, Llh/c;->e:D
    ...
    iget-object v9, v0, Llh/c;->a:Ljava/lang/String;
    ...
    iput-object v7, v0, Llh/c;->f:Landroid/media/MediaCodec;
    ...
    :cond_1
    iget-object v7, v0, Llh/c;->f:Landroid/media/MediaCodec;

    invoke-virtual {v7}, Landroid/media/MediaCodec;->release()V

    iput-object v14, v0, Llh/c;->f:Landroid/media/MediaCodec;
    ...
    :catch_0
    sget-object v7, Llh/e;->r0:Landroid/media/MediaCodecList;
    ...
    iget v8, v0, Llh/c;->b:I

    if-gt v1, v8, :cond_8

    iget v8, v0, Llh/c;->c:I
    ...
    :cond_9
    sget-object v7, Llh/a;->r0:Landroid/media/MediaCodecList;
    ...
    iput-object v9, v0, Llh/c;->h:Llh/h$c;
    ...
    iput-object v9, v0, Llh/c;->i:Landroid/os/Handler;
    ...
    :goto_10
    iput-boolean v4, v0, Llh/c;->h0:Z

    iput v1, v0, Llh/c;->k:I

    iput v2, v0, Llh/c;->l:I

    iput-boolean v8, v0, Llh/c;->r:Z

    if-eqz v8, :cond_19

    iget v9, v0, Llh/c;->b:I

    iget v3, v0, Llh/c;->c:I
    ...
    iput v1, v0, Llh/c;->m:I

    iput v2, v0, Llh/c;->n:I

    const/4 v3, 0x1

    iput v3, v0, Llh/c;->o:I

    iput v3, v0, Llh/c;->p:I

    goto :goto_13

    :cond_1e
    iput v9, v0, Llh/c;->m:I

    iput v3, v0, Llh/c;->n:I

    iput v11, v0, Llh/c;->o:I

    iput v7, v0, Llh/c;->p:I

    :goto_13
    iget v3, v0, Llh/c;->o:I

    iget v5, v0, Llh/c;->p:I

    mul-int/2addr v3, v5

    iput v3, v0, Llh/c;->q:I
    ...
    :goto_17
    iput-object v12, v0, Llh/c;->g:Landroid/media/MediaFormat;

    new-instance v1, Landroid/graphics/Rect;

    iget v2, v0, Llh/c;->m:I

    iget v3, v0, Llh/c;->n:I

    const/4 v4, 0x0

    invoke-direct {v1, v4, v4, v2, v3}, Landroid/graphics/Rect;-><init>(IIII)V

    iput-object v1, v0, Llh/c;->Z:Landroid/graphics/Rect;

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, v0, Llh/c;->Y:Landroid/graphics/Rect;
...
.method public final a(Landroid/graphics/Bitmap;)V
    ...
    iget v0, p0, Llh/c;->j:I

    const/4 v1, 0x2

    if-ne v0, v1, :cond_2

    iget-object v0, p0, Llh/c;->i0:Llh/c$e;

    iget v1, p0, Llh/c;->s:I

    invoke-virtual {p0, v1}, Llh/c;->g(I)J
    ...
    iget v3, p0, Llh/c;->s:I

    iget v4, p0, Llh/c;->q:I

    add-int/2addr v3, v4

    add-int/lit8 v3, v3, -0x1

    invoke-virtual {p0, v3}, Llh/c;->g(I)J

    move-result-wide v3

    invoke-virtual {v0, v1, v2, v3, v4}, Llh/c$e;->b(JJ)Z
    ...
    :try_start_0
    iget-object v0, p0, Llh/c;->m0:LX2/b;
    ...
    iget-object v0, p0, Llh/c;->n0:Llh/b;

    iget v1, p0, Llh/c;->o0:I

    iget-object v0, v0, Llh/b;->e:Llh/g;

    iget v0, v0, Llh/g;->f:I
    ...
    invoke-virtual {p0}, Llh/c;->h()V

    iget-object p1, p0, Llh/c;->m0:LX2/b;

    invoke-virtual {p1}, LX2/b;->c()V
...
.method public final close()V
    ...
    iget-object v0, p0, Llh/c;->e0:Ljava/util/ArrayList;
    ...
    :try_start_0
    iput-boolean v1, p0, Llh/c;->t:Z

    iget-object v1, p0, Llh/c;->e0:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Llh/c;->i:Landroid/os/Handler;

    new-instance v1, Llh/c$b;

    invoke-direct {v1, p0}, Llh/c$b;-><init>(Llh/c;)V
...
.method public final d([B)V
    ...
    iget-object p1, p0, Llh/c;->f0:Ljava/util/ArrayList;

    monitor-enter p1

    :try_start_3
    iget-object v0, p0, Llh/c;->f0:Ljava/util/ArrayList;
    ...
    iget-object p1, p0, Llh/c;->i:Landroid/os/Handler;
...
.method public final h()V
    ...
    iget v1, p0, Llh/c;->m:I

    iget v2, p0, Llh/c;->n:I
    ...
    iget-object v9, p0, Llh/c;->Y:Landroid/graphics/Rect;

    invoke-virtual {v9, v5, v6, v7, v8}, Landroid/graphics/Rect;->set(IIII)V

    :try_start_0
    iget-object v5, p0, Llh/c;->n0:Llh/b;

    iget v6, p0, Llh/c;->o0:I

    sget-object v7, Llh/g;->h:[F

    invoke-virtual {v5, v6, v7, v9}, Llh/b;->a(I[FLandroid/graphics/Rect;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    iget-object v5, p0, Llh/c;->m0:LX2/b;

    iget v6, p0, Llh/c;->s:I

    add-int/lit8 v7, v6, 0x1

    iput v7, p0, Llh/c;->s:I

    invoke-virtual {p0, v6}, Llh/c;->g(I)J
    ...
    iget-object v8, v5, LX2/b;->a:Ljava/lang/Object;

    check-cast v8, Landroid/opengl/EGLDisplay;

    iget-object v5, v5, LX2/b;->c:Ljava/lang/Object;
    ...
    iget-object v6, v5, LX2/b;->a:Ljava/lang/Object;
    ...
    iget-object p0, p0, Llh/c;->q0:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final j()V
    ...
    :cond_0
    :goto_0
    iget-boolean v1, v0, Llh/c;->t:Z

    const/4 v3, 0x0

    if-nez v1, :cond_2

    iget-object v1, v0, Llh/c;->d0:Ljava/nio/ByteBuffer;

    if-nez v1, :cond_2

    iget-object v1, v0, Llh/c;->f0:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_0
    iget-object v4, v0, Llh/c;->f0:Ljava/util/ArrayList;
    ...
    :goto_1
    iput-object v4, v0, Llh/c;->d0:Ljava/nio/ByteBuffer;
    ...
    iget-object v4, v0, Llh/c;->g0:Ljava/util/ArrayList;
    ...
    iget v4, v0, Llh/c;->s:I

    iget v5, v0, Llh/c;->q:I
    ...
    iget-object v8, v0, Llh/c;->f:Landroid/media/MediaCodec;

    invoke-virtual {v8, v6}, Landroid/media/MediaCodec;->getInputImage(I)Landroid/media/Image;

    move-result-object v8

    iget v9, v0, Llh/c;->m:I

    iget v10, v0, Llh/c;->s:I

    iget v11, v0, Llh/c;->p:I

    rem-int v12, v10, v11

    mul-int/2addr v12, v9

    iget v13, v0, Llh/c;->n:I

    div-int/2addr v10, v11

    iget v11, v0, Llh/c;->o:I

    rem-int/2addr v10, v11

    mul-int/2addr v10, v13

    iget-object v11, v0, Llh/c;->Y:Landroid/graphics/Rect;
    ...
    iget v9, v0, Llh/c;->k:I

    iget v10, v0, Llh/c;->l:I

    iget-object v11, v0, Llh/c;->Y:Landroid/graphics/Rect;

    iget-object v12, v0, Llh/c;->Z:Landroid/graphics/Rect;
    ...
    iget-object v5, v0, Llh/c;->f:Landroid/media/MediaCodec;
    ...
    :goto_b
    iget v2, v0, Llh/c;->s:I

    add-int/lit8 v3, v2, 0x1

    iput v3, v0, Llh/c;->s:I

    invoke-virtual {v0, v2}, Llh/c;->g(I)J
    ...
    iget v1, v0, Llh/c;->s:I

    iget v2, v0, Llh/c;->q:I
    ...
    :cond_10
    iget-object v1, v0, Llh/c;->e0:Ljava/util/ArrayList;

    monitor-enter v1

    :try_start_1
    iget-boolean v2, v0, Llh/c;->t:Z

    or-int/2addr v2, v4

    iput-boolean v2, v0, Llh/c;->t:Z

    iget-object v2, v0, Llh/c;->e0:Ljava/util/ArrayList;

    iget-object v3, v0, Llh/c;->d0:Ljava/nio/ByteBuffer;
    ...
    iput-object v1, v0, Llh/c;->d0:Ljava/nio/ByteBuffer;
...
.method public final m()V
    ...
    iget-object v1, p0, Llh/c;->q0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :try_start_0
    iget-object v3, p0, Llh/c;->f:Landroid/media/MediaCodec;
    ...
    :cond_0
    :goto_0
    iput-object v1, p0, Llh/c;->f:Landroid/media/MediaCodec;
    ...
    :try_start_2
    iput-boolean v2, p0, Llh/c;->t:Z

    iget-object v2, p0, Llh/c;->e0:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Llh/b;->e:Llh/g;

    if-eqz v2, :cond_1

    iput-object v1, v0, Llh/b;->e:Llh/g;
    :try_end_3
    ...
    :cond_1
    :try_start_4
    iput-object v1, p0, Llh/c;->n0:Llh/b;
    ...
    :goto_4
    :try_start_6
    iput-object v1, p0, Llh/c;->m0:LX2/b;
    ...
    :goto_6
    :try_start_7
    iget-object v0, p0, Llh/c;->j0:Landroid/graphics/SurfaceTexture;
    ...
    :goto_7
    :try_start_8
    iput-object v1, p0, Llh/c;->j0:Landroid/graphics/SurfaceTexture;
...
.method public final onFrameAvailable(Landroid/graphics/SurfaceTexture;)V
    ...
    iget-object v2, p0, Llh/c;->i0:Llh/c$e;
    ...
    invoke-virtual {v2, v0, v1, v3, v4}, Llh/c$e;->b(JJ)Z

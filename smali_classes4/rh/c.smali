...
.method public constructor <init>(Landroid/media/MediaFormat;JJLjava/util/concurrent/LinkedBlockingQueue;)V
    ...
    iput-object v0, p0, Lrh/c;->a:Ljava/lang/String;

    const/4 v1, 0x0

    iput-boolean v1, p0, Lrh/c;->o:Z

    const-wide/16 v2, -0x1

    iput-wide v2, p0, Lrh/c;->u:J

    iput-wide v2, p0, Lrh/c;->v:J

    const-wide/16 v2, 0x0

    iput-wide v2, p0, Lrh/c;->w:J
    ...
    :goto_0
    const-string v6, "The desired MediaFormat must not be null"

    invoke-static {v6, v5}, Lqh/g;->a(Ljava/lang/String;Z)V
    ...
    :goto_1
    const-string v6, "The preCaptureDurationUs must not be greater than captureDurationUs"
    ...
    invoke-static {v3, v2}, Lqh/g;->a(Ljava/lang/String;Z)V
    ...
    invoke-static {v3, v4}, Lqh/g;->a(Ljava/lang/String;Z)V

    invoke-static {p1, v2}, Lqh/q;->a(Landroid/media/MediaFormat;Ljava/lang/String;)Z
    ...
    :cond_5
    iput-object p6, p0, Lrh/c;->q:Ljava/util/concurrent/LinkedBlockingQueue;

    iput-object p1, p0, Lrh/c;->b:Landroid/media/MediaFormat;

    iput-wide p2, p0, Lrh/c;->d:J

    sub-long p4, p2, p4

    iput-wide p4, p0, Lrh/c;->e:J

    const-wide/16 p4, 0x2

    mul-long/2addr p2, p4

    iput-wide p2, p0, Lrh/c;->c:J
    ...
    new-instance p4, Lrh/i;

    invoke-direct {p4, p1, p2, p3}, Lrh/i;-><init>(Landroid/media/MediaFormat;J)V

    iput-object p4, p0, Lrh/c;->m:Lrh/i;

    new-instance p1, Landroid/media/MediaCodec$BufferInfo;

    invoke-direct {p1}, Landroid/media/MediaCodec$BufferInfo;-><init>()V

    iput-object p1, p0, Lrh/c;->g:Landroid/media/MediaCodec$BufferInfo;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lrh/c;->f:Ljava/util/ArrayList;
    ...
    iput-object p2, p0, Lrh/c;->a:Ljava/lang/String;
    ...
    invoke-direct {p2, p1}, Luh/b;-><init>(Ljava/lang/String;)V

    iput-object p2, p0, Lrh/c;->h:Luh/b;

    new-instance p1, Lrh/c$a;

    invoke-virtual {p2}, Luh/b;->a()V

    iget-object p2, p2, Luh/b;->d:Landroid/os/Looper;

    invoke-direct {p1, p0, p2}, Lrh/c$a;-><init>(Lrh/c;Landroid/os/Looper;)V

    iput-object p1, p0, Lrh/c;->j:Lrh/c$a;

    new-instance p1, Luh/c;

    invoke-direct {p1}, Luh/c;-><init>()V

    iput-object p1, p0, Lrh/c;->i:Luh/c;
    ...
    iput-object p1, p0, Lrh/c;->s:Landroid/os/HandlerThread;
    ...
    invoke-direct {p2, p0, p1}, Lrh/c$b;-><init>(Lrh/c;Landroid/os/Looper;)V

    iput-object p2, p0, Lrh/c;->t:Lrh/c$b;
...
.method public final a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object v0, p0, Lrh/c;->a:Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {p0}, Lrh/c;->n()Lqh/e;

    move-result-object v8

    iget-object v3, p0, Lrh/c;->m:Lrh/i;
    ...
    invoke-virtual/range {v3 .. v8}, Lrh/i;->a(Ljava/nio/ByteBuffer;IJLqh/e;)V

    iget-wide v0, p2, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iput-wide v0, p0, Lrh/c;->p:J

    iget-object p1, p0, Lrh/c;->a:Ljava/lang/String;
    ...
    :cond_1
    iget-object p1, p0, Lrh/c;->s:Landroid/os/HandlerThread;
    ...
    iget-object p0, p0, Lrh/c;->t:Lrh/c$b;
...
.method public final b(J)V
    ...
    invoke-virtual {p0, v1, v9}, Lrh/c;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
...
.method public abstract n()Lqh/e;
.end method
...
.method public final o()V
    ...
    iget-object v1, p0, Lrh/c;->f:Ljava/util/ArrayList;
    ...
    const-string v3, "putEosAll E "

    invoke-direct {v2, v3}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v0, v2}, LFa/s;->h(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public onOutputBufferAvailable(Landroid/media/MediaCodec;ILandroid/media/MediaCodec$BufferInfo;)V
    ...
    invoke-virtual {p0, v2, v3}, Lrh/c;->h(J)J

    move-result-wide v2

    iput-wide v2, p3, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    invoke-virtual {p0, v1, p3}, Lrh/c;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
...
.method public onOutputFormatChanged(Landroid/media/MediaCodec;Landroid/media/MediaFormat;)V
    ...
    :try_start_0
    iget-object p1, p0, Lrh/c;->k:Landroid/media/MediaCodec;
    ...
    :try_start_1
    iget-object p2, p0, Lrh/c;->a:Ljava/lang/String;
    ...
    :try_start_2
    iget-object p2, p0, Lrh/c;->f:Ljava/util/ArrayList;
...
.method public final p()V
    ...
    iput-object v1, p0, Lrh/c;->k:Landroid/media/MediaCodec;

    :cond_0
    const-string p0, "releaseCodec X"
...
.method public final q(ILjava/util/ArrayList;)V
    ...
    iget-object v0, p0, Lrh/c;->t:Lrh/c$b;
    ...
    const-string v0, "sendMessagePutAllEos "
...
.method public r(IJZZZ)Lrh/l;
    ...
    iget-boolean v1, v0, Lrh/c;->n:Z

    const/4 v2, 0x0

    if-nez v1, :cond_0

    iget-object v0, v0, Lrh/c;->a:Ljava/lang/String;
    ...
    :goto_1
    iget-wide v5, v0, Lrh/c;->e:J

    add-long v10, v12, v5

    iget-wide v5, v0, Lrh/c;->d:J
    ...
    iget-wide v14, v0, Lrh/c;->d:J

    iget-object v5, v0, Lrh/c;->l:Landroid/media/MediaFormat;

    invoke-virtual/range {p0 .. p0}, Lrh/c;->k()Z
    ...
    invoke-direct/range {v7 .. v20}, Lrh/l;-><init>(JJJJILandroid/media/MediaFormat;ZZZ)V

    move/from16 v5, p6

    iput-boolean v5, v1, Lrh/l;->u:Z
    ...
    iget-object v7, v0, Lrh/c;->m:Lrh/i;

    iget v8, v7, Lrh/i;->k:I

    iget v9, v7, Lrh/i;->j:I
    ...
    invoke-static {v3, v4, v7, v6}, LKk/a;->c(JLjava/lang/String;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, v0, Lrh/c;->f:Ljava/util/ArrayList;
...
.method public t(Z)V
    ...
    iget-object p1, p0, Lrh/c;->i:Luh/c;
    ...
    invoke-virtual {p1, v0}, Luh/c;->b(Landroid/os/Message;)V

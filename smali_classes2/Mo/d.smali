...
# static fields
.field public static final g:LMo/d$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LMo/d;->g:LMo/d$a;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, LMo/d;->a:Z

    iput-boolean v0, p0, LMo/d;->c:Z

    iput v0, p0, LMo/d;->e:I
...
.method public static d(LMo/d;Landroid/view/View;)Landroid/graphics/Rect;
    .locals 1
...
.method public static f(LMo/d;Landroid/view/View;ILmiuix/appcompat/app/m$d;LMo/d$b;)V
    .locals 4
    ...
    new-instance v2, LMo/d$g;

    invoke-direct {v2, p0, p3, p4, p1}, LMo/d$g;-><init>(LMo/d;Lmiuix/appcompat/app/m$d;LMo/d$b;Landroid/view/View;)V
    ...
    iget-object p1, p0, LMo/d;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p1, p0, LMo/d;->b:Lmiuix/animation/IFolme;

    :cond_0
    iget-object p0, p0, LMo/d;->b:Lmiuix/animation/IFolme;
    ...
    sget-object p2, LMo/d;->g:LMo/d$a;
...
# virtual methods
.method public final a(Landroid/view/View;Landroid/view/View;Lmiuix/appcompat/app/l;)V
    .locals 7
    ...
    iput-object v5, v4, LMo/d$f;->a:Ljava/lang/ref/WeakReference;

    new-instance p3, Ljava/lang/ref/WeakReference;

    invoke-direct {p3, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object p3, v4, LMo/d$f;->b:Ljava/lang/ref/WeakReference;

    sget-object p3, LPo/j;->b:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {p3}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    move-result p3

    iput p3, v4, LMo/d$f;->c:I
    ...
    new-instance p3, LMo/d$h;

    invoke-direct {p3, p0, p1}, LMo/d$h;-><init>(LMo/d;Landroid/view/View;)V
    ...
    iget-object p3, p0, LMo/d;->b:Lmiuix/animation/IFolme;
    ...
    iput-object p3, p0, LMo/d;->b:Lmiuix/animation/IFolme;
    ...
    sget-object v1, LMo/d;->g:LMo/d$a;
    ...
    invoke-static {p1}, LS/b0;->a(Landroid/view/View;)Landroid/view/WindowInsetsController;
    ...
    invoke-direct {v0, p0, p1, v3, v2}, LMo/h;-><init>(LMo/d;Landroid/view/View;ILmiuix/animation/base/AnimConfig;)V

    invoke-static {p3, v0}, LMo/c;->b(Landroid/view/WindowInsetsController;LMo/h;)V
    ...
    :cond_3
    :goto_0
    invoke-static {p2}, Ljd/b;->h(Landroid/view/View;)V
...
.method public final c(Landroid/view/View;Landroid/view/View;ZLmiuix/appcompat/app/m$d;)V
    .locals 9
    ...
    invoke-direct {v1, p0, p1, p2, v0}, LMo/d$b;-><init>(LMo/d;Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-direct/range {v3 .. v8}, LMo/d$c;-><init>(LMo/d;Landroid/view/View;ZLmiuix/appcompat/app/m$d;LMo/d$b;)V
    ...
    :cond_3
    new-instance v0, LMo/d$d;

    invoke-direct {v0, p0, p3, p4, v8}, LMo/d$d;-><init>(LMo/d;ZLmiuix/appcompat/app/m$d;LMo/d$b;)V

    invoke-virtual {p1, v0}, Landroid/view/View;->addOnLayoutChangeListener(Landroid/view/View$OnLayoutChangeListener;)V

    :goto_2
    invoke-static {p2}, Ljd/b;->t(Landroid/view/View;)V

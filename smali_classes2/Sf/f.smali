...
# direct methods
.method public constructor <init>(Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/MiviInfo4EntityJsonAdapter;LQf/a;)V
    .locals 1
    ...
    iput-object p1, p0, LSf/f;->a:Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/MiviInfo4EntityJsonAdapter;

    iput-object p2, p0, LSf/f;->b:LQf/a;
...
.method public final fromJson(LWe/q;)Ljava/lang/Object;
    ...
    invoke-virtual {p1}, LWe/q;->O()Ljava/lang/Object;
    ...
    :cond_1
    iget-object p0, p0, LSf/f;->a:Lcom/xiaomi/camera/cloudconfig/mivi/data/entity/MiviInfo4EntityJsonAdapter;

    invoke-virtual {p0, p1}, LWe/l;->fromJsonValue(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Lim/k;->R([Ljava/lang/Object;)Ljava/util/Set;

    move-result-object p0

    invoke-static {p1, p0}, Lim/D;->l(Ljava/util/Map;Ljava/util/Set;)Ljava/util/Map;
...
.method public final toJson(LWe/v;Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lim/D;->r(Ljava/util/Map;)Ljava/util/LinkedHashMap;
    ...
    :cond_4
    iget-object p0, p0, LSf/f;->b:LQf/a;

    invoke-virtual {p0, p1, v0}, LQf/a;->toJson(LWe/v;Ljava/lang/Object;)V

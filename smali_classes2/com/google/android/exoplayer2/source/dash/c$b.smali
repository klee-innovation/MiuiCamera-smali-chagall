...
# direct methods
.method public constructor <init>(Lcom/google/android/exoplayer2/source/dash/c;Lkb/m;)V
    .locals 1
    ...
    invoke-direct {p1, p2, v0, v0}, LNa/I;-><init>(Lkb/m;Lcom/google/android/exoplayer2/drm/d;Lcom/google/android/exoplayer2/drm/c$a;)V

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/dash/c$b;->a:LNa/I;

    new-instance p1, LO9/b;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lcom/google/android/exoplayer2/source/dash/c$b;->b:LO9/b;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/source/dash/c$b;->c:LGa/b;
...
.method public final a(JIIILta/v$a;)V
    ...
    iget-object v0, p0, Lcom/google/android/exoplayer2/source/dash/c$b;->a:LNa/I;
    ...
    invoke-virtual/range {v0 .. v6}, LNa/I;->a(JIIILta/v$a;)V

    :cond_0
    :goto_0
    iget-object p1, p0, Lcom/google/android/exoplayer2/source/dash/c$b;->a:LNa/I;

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, LNa/I;->u(Z)Z

    move-result p1

    if-eqz p1, :cond_6

    iget-object p1, p0, Lcom/google/android/exoplayer2/source/dash/c$b;->c:LGa/b;

    invoke-virtual {p1}, Lra/g;->l()V

    iget-object p3, p0, Lcom/google/android/exoplayer2/source/dash/c$b;->a:LNa/I;

    iget-object p4, p0, Lcom/google/android/exoplayer2/source/dash/c$b;->b:LO9/b;

    invoke-virtual {p3, p4, p1, p2, p2}, LNa/I;->z(LO9/b;Lra/g;IZ)I
    ...
    :cond_2
    iget-wide p3, p1, Lra/g;->e:J

    iget-object p5, p0, Lcom/google/android/exoplayer2/source/dash/c$b;->e:Lcom/google/android/exoplayer2/source/dash/c;

    iget-object p5, p5, Lcom/google/android/exoplayer2/source/dash/c;->c:LIa/a;

    invoke-virtual {p5, p1}, LAc/c;->c(LGa/b;)Lcom/google/android/exoplayer2/metadata/Metadata;
    ...
    invoke-static {p1}, Llb/G;->o([B)Ljava/lang/String;

    move-result-object p1

    invoke-static {p1}, Llb/G;->L(Ljava/lang/String;)J
    ...
    :cond_7
    :try_start_2
    invoke-virtual {p0, p2}, LNa/I;->g(I)J
    ...
    :goto_3
    invoke-virtual {p1, p2, p3}, LNa/H;->b(J)V
...
.method public final d(Loa/G;)V
    ...
    invoke-virtual {p0, p1}, LNa/I;->d(Loa/G;)V

...
.field public final j0:Lcom/google/android/material/timepicker/b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v2, LQb/b;->materialClockStyle:I
    ...
    iput-object v3, p0, Lcom/google/android/material/timepicker/ClockFaceView;->f0:Landroid/graphics/Rect;

    new-instance v3, Landroid/graphics/RectF;

    invoke-direct {v3}, Landroid/graphics/RectF;-><init>()V

    iput-object v3, p0, Lcom/google/android/material/timepicker/ClockFaceView;->g0:Landroid/graphics/RectF;

    new-instance v3, Landroid/graphics/Rect;

    invoke-direct {v3}, Landroid/graphics/Rect;-><init>()V

    iput-object v3, p0, Lcom/google/android/material/timepicker/ClockFaceView;->h0:Landroid/graphics/Rect;

    new-instance v3, Landroid/util/SparseArray;

    invoke-direct {v3}, Landroid/util/SparseArray;-><init>()V

    iput-object v3, p0, Lcom/google/android/material/timepicker/ClockFaceView;->i0:Landroid/util/SparseArray;
    ...
    iput-object v4, p0, Lcom/google/android/material/timepicker/ClockFaceView;->l0:[F

    sget-object v4, LQb/l;->ClockFaceView:[I

    sget v5, LQb/k;->Widget_MaterialComponents_TimePicker_Clock:I
    ...
    sget v4, LQb/l;->ClockFaceView_clockNumberTextColor:I
    ...
    iput-object v4, p0, Lcom/google/android/material/timepicker/ClockFaceView;->s0:Landroid/content/res/ColorStateList;

    invoke-static {p1}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v5

    sget v6, LQb/h;->material_clockface_view:I

    invoke-virtual {v5, v6, p0, v1}, Landroid/view/LayoutInflater;->inflate(ILandroid/view/ViewGroup;Z)Landroid/view/View;

    sget v5, LQb/f;->material_clock_hand:I
    ...
    iput-object v5, p0, Lcom/google/android/material/timepicker/ClockFaceView;->e0:Lcom/google/android/material/timepicker/ClockHandView;

    sget v6, LQb/d;->material_clock_hand_padding:I

    invoke-virtual {v2, v6}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v6

    iput v6, p0, Lcom/google/android/material/timepicker/ClockFaceView;->m0:I
    ...
    iput-object v4, p0, Lcom/google/android/material/timepicker/ClockFaceView;->k0:[I

    iget-object v4, v5, Lcom/google/android/material/timepicker/ClockHandView;->c:Ljava/util/ArrayList;

    invoke-virtual {v4, p0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    sget v4, LQb/c;->material_timepicker_clockface:I
    ...
    sget v5, LQb/l;->ClockFaceView_clockFaceBackgroundColor:I

    invoke-static {p1, p2, v5}, Ljc/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    iput-object p1, p0, Lcom/google/android/material/timepicker/ClockFaceView;->j0:Lcom/google/android/material/timepicker/b;
    ...
    iget-object v8, p0, Lcom/google/android/material/timepicker/ClockFaceView;->q0:[Ljava/lang/String;
    ...
    sget v7, LQb/h;->material_clockface_textview:I
    ...
    sget v8, LQb/f;->material_value_index:I
    ...
    sget v9, LQb/f;->material_clock_level:I
    ...
    :cond_3
    iget-object v8, p0, Lcom/google/android/material/timepicker/ClockFaceView;->j0:Lcom/google/android/material/timepicker/b;

    invoke-static {v7, v8}, LS/H;->j(Landroid/view/View;LS/a;)V

    iget-object v8, p0, Lcom/google/android/material/timepicker/ClockFaceView;->s0:Landroid/content/res/ColorStateList;
    ...
    sget p1, LQb/d;->material_time_picker_minimum_screen_height:I
    ...
    sget p1, LQb/d;->material_time_picker_minimum_screen_width:I
    ...
    sget p1, LQb/d;->material_clock_size:I
...
.method public final b(F)V
    ...
    iget v0, p0, Lcom/google/android/material/timepicker/ClockFaceView;->r0:F
    ...
    iput p1, p0, Lcom/google/android/material/timepicker/ClockFaceView;->r0:F
...
.method public final v()V
    ...
    invoke-super {p0}, Lcom/google/android/material/timepicker/c;->v()V
    ...
    :goto_0
    iget-object v2, p0, Lcom/google/android/material/timepicker/ClockFaceView;->i0:Landroid/util/SparseArray;
...
.method public final w()V
    ...
    iget-object v9, v0, Lcom/google/android/material/timepicker/ClockFaceView;->g0:Landroid/graphics/RectF;

    iget-object v10, v0, Lcom/google/android/material/timepicker/ClockFaceView;->f0:Landroid/graphics/Rect;
    ...
    iget-object v11, v0, Lcom/google/android/material/timepicker/ClockFaceView;->l0:[F

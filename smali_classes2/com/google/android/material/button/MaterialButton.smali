...
.method static constructor <clinit>()V
    ...
    sget v0, LQb/k;->Widget_MaterialComponents_Button:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v6, LQb/b;->materialButtonStyle:I
    ...
    sget-object v2, LQb/l;->MaterialButton:[I
    ...
    sget v1, LQb/l;->MaterialButton_iconPadding:I
    ...
    sget v1, LQb/l;->MaterialButton_iconTintMode:I
    ...
    invoke-static {v1, v3}, Lfc/n;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    sget v4, LQb/l;->MaterialButton_iconTint:I

    invoke-static {v1, v0, v4}, Ljc/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    sget v4, LQb/l;->MaterialButton_icon:I

    invoke-static {v1, v0, v4}, Ljc/c;->c(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->i:Landroid/graphics/drawable/Drawable;

    sget v1, LQb/l;->MaterialButton_iconGravity:I
    ...
    sget v1, LQb/l;->MaterialButton_iconSize:I
    ...
    invoke-static {v8, p2, v6, v7}, Lnc/k;->b(Landroid/content/Context;Landroid/util/AttributeSet;II)Lnc/k$a;
    ...
    invoke-direct {v1, p0, p2}, LWb/a;-><init>(Lcom/google/android/material/button/MaterialButton;Lnc/k;)V

    iput-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:LWb/a;

    sget p2, LQb/l;->MaterialButton_android_insetLeft:I

    invoke-virtual {v0, p2, p1}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result p2

    iput p2, v1, LWb/a;->c:I

    sget p2, LQb/l;->MaterialButton_android_insetRight:I

    invoke-virtual {v0, p2, p1}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result p2

    iput p2, v1, LWb/a;->d:I

    sget p2, LQb/l;->MaterialButton_android_insetTop:I

    invoke-virtual {v0, p2, p1}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result p2

    iput p2, v1, LWb/a;->e:I

    sget p2, LQb/l;->MaterialButton_android_insetBottom:I

    invoke-virtual {v0, p2, p1}, Landroid/content/res/TypedArray;->getDimensionPixelOffset(II)I

    move-result p2

    iput p2, v1, LWb/a;->f:I

    sget p2, LQb/l;->MaterialButton_cornerRadius:I
    ...
    iput p2, v1, LWb/a;->g:I

    iget-object v5, v1, LWb/a;->b:Lnc/k;
    ...
    invoke-virtual {v5, p2}, Lnc/k$a;->c(F)V

    invoke-virtual {v5}, Lnc/k$a;->a()Lnc/k;

    move-result-object p2

    invoke-virtual {v1, p2}, LWb/a;->c(Lnc/k;)V

    iput-boolean v4, v1, LWb/a;->p:Z

    :cond_0
    sget p2, LQb/l;->MaterialButton_strokeWidth:I

    invoke-virtual {v0, p2, p1}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p2

    iput p2, v1, LWb/a;->h:I

    sget p2, LQb/l;->MaterialButton_backgroundTintMode:I

    invoke-virtual {v0, p2, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p2

    invoke-static {p2, v3}, Lfc/n;->e(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    iput-object p2, v1, LWb/a;->i:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p2

    sget v2, LQb/l;->MaterialButton_backgroundTint:I

    invoke-static {p2, v0, v2}, Ljc/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v1, LWb/a;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p2

    sget v2, LQb/l;->MaterialButton_strokeColor:I

    invoke-static {p2, v0, v2}, Ljc/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v1, LWb/a;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object p2

    sget v2, LQb/l;->MaterialButton_rippleColor:I

    invoke-static {p2, v0, v2}, Ljc/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object p2

    iput-object p2, v1, LWb/a;->l:Landroid/content/res/ColorStateList;

    sget p2, LQb/l;->MaterialButton_android_checkable:I

    invoke-virtual {v0, p2, p1}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p2

    iput-boolean p2, v1, LWb/a;->q:Z

    sget p2, LQb/l;->MaterialButton_elevation:I

    invoke-virtual {v0, p2, p1}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p2

    iput p2, v1, LWb/a;->t:I

    sget p2, LQb/l;->MaterialButton_toggleCheckedStateOnClick:I

    invoke-virtual {v0, p2, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p2

    iput-boolean p2, v1, LWb/a;->r:Z
    ...
    sget v6, LQb/l;->MaterialButton_android_background:I
    ...
    iput-boolean v4, v1, LWb/a;->o:Z

    iget-object v6, v1, LWb/a;->j:Landroid/content/res/ColorStateList;
    ...
    iget-object v6, v1, LWb/a;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_1
    invoke-virtual {v1}, LWb/a;->e()V

    :goto_0
    iget v6, v1, LWb/a;->c:I

    add-int/2addr p2, v6

    iget v6, v1, LWb/a;->e:I

    add-int/2addr v2, v6

    iget v6, v1, LWb/a;->d:I

    add-int/2addr v3, v6

    iget v1, v1, LWb/a;->f:I
...
.method public final a()Z
    ...
    iget-object p0, p0, Lcom/google/android/material/button/MaterialButton;->d:LWb/a;

    if-eqz p0, :cond_0

    iget-boolean p0, p0, LWb/a;->q:Z
...
.method public final d(Z)V
    ...
    invoke-static {v0, v2}, LK/a$a;->h(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {v2, v0}, LK/a$a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public getRippleColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, LWb/a;->l:Landroid/content/res/ColorStateList;
...
.method public getShapeAppearanceModel()Lnc/k;
    ...
    iget-object p0, p0, LWb/a;->b:Lnc/k;
...
.method public getStrokeColor()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, LWb/a;->k:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object p0, p0, LWb/a;->j:Landroid/content/res/ColorStateList;
...
.method public getSupportBackgroundTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p0, p0, LWb/a;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public onAttachedToWindow()V
    ...
    iget-object v1, p0, Lcom/google/android/material/button/MaterialButton;->d:LWb/a;

    invoke-virtual {v1, v0}, LWb/a;->b(Z)Lnc/g;
...
.method public final performClick()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:LWb/a;

    iget-boolean v0, v0, LWb/a;->r:Z
...
.method public setBackgroundColor(I)V
    ...
    invoke-virtual {p0, p1}, Lnc/g;->setTint(I)V
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v0, v1, LWb/a;->o:Z

    iget-object v0, v1, LWb/a;->j:Landroid/content/res/ColorStateList;

    iget-object v2, v1, LWb/a;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    iget-object v0, v1, LWb/a;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public setCornerRadius(I)V
    ...
    iget-boolean v0, p0, LWb/a;->p:Z

    if-eqz v0, :cond_0

    iget v0, p0, LWb/a;->g:I

    if-eq v0, p1, :cond_1

    :cond_0
    iput p1, p0, LWb/a;->g:I

    const/4 v0, 0x1

    iput-boolean v0, p0, LWb/a;->p:Z

    iget-object v0, p0, LWb/a;->b:Lnc/k;
    ...
    invoke-virtual {p0, p1}, LWb/a;->c(Lnc/k;)V
...
.method public setInsetBottom(I)V
    ...
    iget v0, p0, LWb/a;->e:I

    invoke-virtual {p0, v0, p1}, LWb/a;->d(II)V
...
.method public setInsetTop(I)V
    ...
    iget v0, p0, LWb/a;->f:I

    invoke-virtual {p0, p1, v0}, LWb/a;->d(II)V
...
.method public setRippleColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, LWb/a;->l:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, LWb/a;->l:Landroid/content/res/ColorStateList;
...
.method public setShouldDrawSurfaceColorStroke(Z)V
    ...
    iput-boolean p1, p0, LWb/a;->n:Z

    invoke-virtual {p0}, LWb/a;->f()V
...
.method public setStrokeColor(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, LWb/a;->k:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_0

    iput-object p1, p0, LWb/a;->k:Landroid/content/res/ColorStateList;
...
.method public setStrokeWidth(I)V
    ...
    iget v0, p0, LWb/a;->h:I

    if-eq v0, p1, :cond_0

    iput p1, p0, LWb/a;->h:I
...
.method public setSupportBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, LWb/a;->j:Landroid/content/res/ColorStateList;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, LWb/a;->j:Landroid/content/res/ColorStateList;

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, LWb/a;->b(Z)Lnc/g;
...
.method public setSupportBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v0, p0, LWb/a;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v0, p1, :cond_1

    iput-object p1, p0, LWb/a;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {p1, p0}, LK/a$a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V

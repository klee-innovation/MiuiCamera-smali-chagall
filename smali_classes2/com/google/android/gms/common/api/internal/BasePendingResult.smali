...
.field public d:Lub/i;

.field public e:Z

.field private resultGuardian:Lvb/U;
    .annotation build Lcom/google/android/gms/common/annotation/KeepName;
    .end annotation
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, LHb/h;-><init>(Landroid/os/Looper;)V
...
.method public static f(Lub/i;)V
    .locals 3
    ...
    invoke-interface {v0}, Lub/g;->release()V
    :try_end_0
...
# virtual methods
.method public abstract a()Lub/i;
.end method
...
.method public final b(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->a()Lub/i;

    move-result-object v0

    invoke-virtual {p0, v0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d(Lub/i;)V
...
.method public final d(Lub/i;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->e(Lub/i;)V
    ...
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f(Lub/i;)V
...
.method public final e(Lub/i;)V
    .locals 3

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d:Lub/i;

    invoke-interface {p1}, Lub/i;->getStatus()Lcom/google/android/gms/common/api/Status;
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d:Lub/i;

    instance-of p1, p1, Lub/g;

    if-eqz p1, :cond_0

    new-instance p1, Lvb/U;

    invoke-direct {p1, p0}, Lvb/U;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->resultGuardian:Lvb/U;
    ...
    check-cast v2, Lub/f$a;

    invoke-interface {v2}, Lub/f$a;->onComplete()V

...
.method public constructor <init>(LPb/a;)V
    ...
    iput-object v0, p0, Lpe/i;->a:Ljava/util/HashMap;
    ...
    iput-object v2, v1, Lqe/a;->a:Lqe/b;

    iput-object v1, p0, Lpe/i;->b:Lqe/a;

    iput-object p1, p0, Lpe/i;->c:LPb/a;

    new-instance p0, Lpe/l;
    ...
    const-class p1, Lpe/a;

    invoke-virtual {v0, p1, p0}, Ljava/util/HashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    new-instance p0, Lpe/j;

    invoke-direct {p0}, Lpe/j;-><init>()V

    const-class p1, Lpe/j;
...
.method public final a(Ljava/lang/Class;[B)V
    ...
    :try_start_0
    iget-object v0, p0, Lpe/i;->a:Ljava/util/HashMap;
    ...
    :goto_0
    iget-object p0, p0, Lpe/i;->c:LPb/a;
    ...
    :cond_1
    invoke-virtual {p0, v3}, LPb/a;->a(I)V
    ...
    :cond_2
    :goto_1
    invoke-virtual {v0, p2}, Lpe/b;->h([B)V
    :try_end_0

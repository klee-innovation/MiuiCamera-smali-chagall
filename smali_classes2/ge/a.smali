...
.method static constructor <clinit>()V
    ...
    sget-object v0, Lge/a$b;->a:Lge/a$b;

    invoke-static {v0}, Lag/v;->t(Lwm/a;)Lhm/m;

    move-result-object v0

    sput-object v0, Lge/a;->a:Lhm/m;
    ...
    sput-object v0, Lge/a;->c:Lhm/m;

    return-void
.end method

.method public static final a(Landroid/view/View;)Lhe/c;
    .locals 9
    ...
    sput-object v0, Lge/a;->b:Landroid/content/Context;
    ...
    iget-object v3, v0, Lhe/e;->a:Landroid/util/ArrayMap;
    ...
    iget-object v6, v6, Landroidx/fragment/app/FragmentManager;->c:Landroidx/fragment/app/D;

    invoke-virtual {v6}, Landroidx/fragment/app/D;->f()Ljava/util/List;

    move-result-object v6

    invoke-static {v6, v3}, Lhe/e;->a(Ljava/util/List;Landroid/util/ArrayMap;)V
    ...
    iget-object v6, v0, Lhe/e;->b:Landroid/util/ArrayMap;
    ...
    invoke-virtual {v6, v7, v5, v3, v8}, Landroidx/fragment/app/a;->g(ILandroidx/fragment/app/Fragment;Ljava/lang/String;I)V

    invoke-virtual {v6, v8}, Landroidx/fragment/app/a;->o(Z)I

    iget-object v0, v0, Lhe/e;->c:Landroid/os/Handler;
    ...
    :cond_2
    iget-object v0, v5, Lhe/f;->a:Lhe/c;
    ...
    invoke-direct {v1, v3}, LL8/b;-><init>(I)V

    invoke-virtual {v5}, Landroidx/fragment/app/Fragment;->getLifecycle()Landroidx/lifecycle/m;

    move-result-object v3

    new-instance v6, Lie/b;

    invoke-direct {v6, v1, v5}, Lie/b;-><init>(Lie/c;Lhe/f;)V

    invoke-virtual {v3, v6}, Landroidx/lifecycle/m;->a(Landroidx/lifecycle/v;)V
    ...
    invoke-direct {v0, v2, v1, v3}, Lhe/c;-><init>(Landroid/content/Context;LL8/b;Lje/b;)V

    iput-object v0, v5, Lhe/f;->a:Lhe/c;
    ...
    sget v0, Lge/b;->dynamic_string_view_request_manager:I
    ...
    invoke-direct {v3, p0}, Lie/e;-><init>(Landroid/view/View;)V
    ...
    invoke-direct {v1, v2, v3, v4}, Lhe/c;-><init>(Landroid/content/Context;LL8/b;Lje/b;)V

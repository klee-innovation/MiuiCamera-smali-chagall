...
.field public static final l:LC8/n$a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, LC8/n;->k:Ljava/util/HashMap;

    new-instance v0, LC8/n$a;

    invoke-direct {v0}, LC8/n$a;-><init>()V

    sput-object v0, LC8/n;->l:LC8/n$a;
...
.method public constructor <init>()V
    ...
    iput-boolean v1, p0, LC8/n;->g:Z

    iput-boolean v1, p0, LC8/n;->h:Z

    iput-boolean v0, p0, LC8/n;->i:Z
...
.method public static k(ZLandroid/graphics/Bitmap$Config;I)Landroid/graphics/Bitmap;
    ...
    sget-object v0, LC8/n;->l:LC8/n$a;

    iput-boolean p0, v0, LC8/n$a;->a:Z

    iput-object p1, v0, LC8/n$a;->b:Landroid/graphics/Bitmap$Config;

    iput p2, v0, LC8/n$a;->c:I

    sget-object v1, LC8/n;->k:Ljava/util/HashMap;
    ...
    :goto_1
    invoke-virtual {v0}, LC8/n$a;->b()LC8/n$a;
...
.method public final b()I
    ...
    invoke-virtual {p0}, LC8/n;->j()Landroid/graphics/Bitmap;
...
.method public final g(LC8/g;)Z
    ...
    invoke-virtual/range {p0 .. p0}, LC8/b;->f()Z
    ...
    invoke-virtual/range {p0 .. p0}, LC8/n;->j()Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {p0 .. p0}, LC8/n;->e()I

    move-result v11

    invoke-virtual/range {p0 .. p0}, LC8/n;->b()I
    ...
    invoke-static {v3, v15, v14}, LC8/n;->k(ZLandroid/graphics/Bitmap$Config;I)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v5, v2}, LC8/n;->k(ZLandroid/graphics/Bitmap$Config;I)Landroid/graphics/Bitmap;
    ...
    :goto_2
    invoke-virtual/range {p0 .. p0}, LC8/n;->i()V

    move-object/from16 v0, p1

    iput-object v0, v1, LC8/b;->e:LC8/g;

    iput v7, v1, LC8/b;->a:I

    iput v3, v1, LC8/b;->b:I

    iput-boolean v3, v1, LC8/n;->g:Z
...
.method public final h()V
    ...
    invoke-super {p0}, LC8/b;->h()V

    iget-object v0, p0, LC8/n;->j:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_0

    invoke-virtual {p0}, LC8/n;->i()V
...
.method public final i()V
    ...
    :goto_0
    sget-object v2, LC8/o;->a:[J

    if-eqz v1, :cond_1

    invoke-virtual {p0, v0}, LC8/n;->l(Landroid/graphics/Bitmap;)V

    const/4 v0, 0x0

    iput-object v0, p0, LC8/n;->j:Landroid/graphics/Bitmap;
...
.method public final j()Landroid/graphics/Bitmap;
    ...
    invoke-virtual {p0}, LC8/n;->m()Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, LC8/n;->j:Landroid/graphics/Bitmap;
    ...
    iput v1, p0, LC8/b;->d:I

    :cond_0
    iget-object p0, p0, LC8/n;->j:Landroid/graphics/Bitmap;

...
# static fields
.field public static final L0:Lmiuix/animation/property/IntValueProperty;

.field public static final M0:Lmiuix/animation/property/IntValueProperty;

.field public static final N0:Lmiuix/animation/property/IntValueProperty;
...
.field public final K0:Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$g;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->L0:Lmiuix/animation/property/IntValueProperty;
    ...
    sput-object v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->M0:Lmiuix/animation/property/IntValueProperty;
    ...
    sput-object v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->N0:Lmiuix/animation/property/IntValueProperty;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Lkp/a;->miuixProgressSeekBarStyle:I
    ...
    iput v2, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->y0:F

    iput v4, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->J0:I
    ...
    iput-object v5, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->K0:Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$g;

    sget-object v6, Lkp/j;->HyperProgressSeekBar:[I

    sget v7, Lkp/i;->Widget_HyperProgressSeekBar_DayNight:I
    ...
    sget v1, Lkp/j;->HyperProgressSeekBar_progressBarMode:I
    ...
    sget v8, Lkp/b;->miuix_appcompat_hyper_progress_seekbar_shadow_default_color:I
    ...
    sget v9, Lkp/c;->miuix_appcompat_hyper_progress_seekbar_shadow_radius:I

    invoke-virtual {v8, v9}, Landroid/content/res/Resources;->getDimension(I)F

    move-result v8

    sget v9, Lkp/j;->HyperProgressSeekBar_shadowDx:I

    invoke-virtual {p2, v9, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v9

    iput v9, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->z0:F

    sget v9, Lkp/j;->HyperProgressSeekBar_shadowDy:I

    invoke-virtual {p2, v9, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v9

    iput v9, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->A0:F

    sget v9, Lkp/j;->HyperProgressSeekBar_shadowHorizontalExtend:I
    ...
    iput v9, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->E0:F

    sget v9, Lkp/j;->HyperProgressSeekBar_shadowVerticalExtend:I

    invoke-virtual {p2, v9, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v9

    iput v9, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->D0:F

    sget v9, Lkp/j;->HyperProgressSeekBar_shadowRadius:I

    invoke-virtual {p2, v9, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v3

    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->C0:F

    sget v3, Lkp/j;->HyperProgressSeekBar_shadowColor:I

    invoke-virtual {p2, v3, v7}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v3

    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->B0:I
    ...
    sget v7, Lkp/c;->miuix_appcompat_hyper_progress_seekbar_shadow_clip_radius:I

    invoke-virtual {v3, v7}, Landroid/content/res/Resources;->getDimension(I)F

    move-result v3

    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->I0:F

    new-instance v3, Landroid/graphics/RectF;

    invoke-direct {v3}, Landroid/graphics/RectF;-><init>()V

    iput-object v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->F0:Landroid/graphics/RectF;

    new-instance v3, Landroid/graphics/RectF;

    invoke-direct {v3}, Landroid/graphics/RectF;-><init>()V

    iput-object v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->G0:Landroid/graphics/RectF;

    new-instance v3, Landroid/graphics/Path;

    invoke-direct {v3}, Landroid/graphics/Path;-><init>()V

    iput-object v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->H0:Landroid/graphics/Path;

    new-instance v3, Landroid/graphics/Paint;

    invoke-direct {v3}, Landroid/graphics/Paint;-><init>()V

    iput-object v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->b:Landroid/graphics/Paint;
    ...
    iput-object v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->l:Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$j;
    ...
    sget v8, Lkp/c;->miuix_appcompat_hyper_progress_seekbar_min_height:I

    invoke-virtual {v3, v8}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->u0:I

    invoke-virtual {p0}, Landroid/view/View;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    sget v8, Lkp/c;->miuix_appcompat_hyper_progress_seekbar_height:I

    invoke-virtual {v3, v8}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->v0:I

    sget v3, Lkp/j;->HyperProgressSeekBar_progressSeekBarMinHeight:I

    iget v8, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->u0:I

    invoke-virtual {p2, v3, v8}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v3

    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->x0:I

    sget v3, Lkp/j;->HyperProgressSeekBar_progressSeekBarMaxHeight:I

    iget v8, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->v0:I

    invoke-virtual {p2, v3, v8}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v3

    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->w0:I
    ...
    :cond_0
    iget v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->x0:I
    ...
    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->s:I

    invoke-virtual {p0, v3}, Landroid/widget/ProgressBar;->setMinHeight(I)V

    iget v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->s:I

    invoke-virtual {p0, v3}, Landroid/widget/ProgressBar;->setMaxHeight(I)V

    iget-object v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->l:Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$j;

    iget-object v3, v3, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$j;->a:Lmiuix/animation/Folme$ObjectFolmeImpl;

    sget-object v8, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->L0:Lmiuix/animation/property/IntValueProperty;

    iget v9, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->s:I
    ...
    sget v8, Lkp/c;->miuix_appcompat_hyper_progress_seekbar_padding_offset:I

    invoke-virtual {v3, v8}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v3

    sget v8, Lkp/j;->HyperProgressSeekBar_paddingOffset:I

    invoke-virtual {p2, v8, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v3

    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->t0:I
    ...
    invoke-static {}, LSo/a;->b()I

    move-result v1

    iput v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->J0:I
    ...
    :cond_4
    :goto_0
    iget v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->J0:I
    ...
    sget v3, Lkp/g;->music_player_tracker:I
    ...
    invoke-static {v1}, LQh/c;->b(Ljava/lang/String;)Landroid/graphics/RuntimeShader;
    ...
    sget v3, Lkp/g;->music_player_tracker_middle:I
    ...
    sget v3, Lkp/b;->miuix_appcompat_hyper_progress_seekbar_foreground_normal_color_light:I
    ...
    sget v4, Lkp/b;->miuix_appcompat_hyper_progress_seekbar_background_disabled_color_light:I

    invoke-virtual {v3, v4}, Landroid/content/res/Resources;->getColor(I)I

    move-result v3

    iput v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->d0:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v4

    sget v5, Lkp/b;->miuix_appcompat_hyper_progress_seekbar_background_normal_color_light:I

    invoke-virtual {v4, v5}, Landroid/content/res/Resources;->getColor(I)I

    move-result v4

    iput v4, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->e0:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget v5, Lkp/b;->miuix_appcompat_hyper_progress_seekbar_background_disabled_color_dark:I

    invoke-virtual {p1, v5}, Landroid/content/res/Resources;->getColor(I)I

    move-result p1

    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->f0:I

    sget v5, Lkp/j;->HyperProgressSeekBar_foregroundPrimaryColor:I
    ...
    sget v1, Lkp/j;->HyperProgressSeekBar_foregroundPrimaryDisableColor:I

    invoke-virtual {p2, v1, v3}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v1

    iput v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->h0:I

    sget v1, Lkp/j;->HyperProgressSeekBar_backgroundPrimaryColor:I

    invoke-virtual {p2, v1, v4}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result v1

    iput v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->i0:I

    sget v1, Lkp/j;->HyperProgressSeekBar_backgroundPrimaryDisableColor:I

    invoke-virtual {p2, v1, p1}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result p1

    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->j0:I

    sget p1, Lkp/j;->HyperProgressSeekBar_progressAlpha:I
    ...
    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->m0:I

    sget v3, Lkp/j;->HyperProgressSeekBar_progressPressedAlpha:I

    invoke-virtual {p2, v3, v1}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v1

    iput v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->n0:I
    ...
    sget-object v3, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->N0:Lmiuix/animation/property/IntValueProperty;
    ...
    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->o0:I
    ...
    :cond_a
    iget p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->J0:I
    ...
    sget-object p1, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->M0:Lmiuix/animation/property/IntValueProperty;
...
.method public final b(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v0, v1}, Lj8/b0;->a(Landroid/graphics/RuntimeShader;[F)V
    ...
    invoke-static {v0, v1}, Lj8/c0;->a(Landroid/graphics/RuntimeShader;F)V
...
.method public final c(Landroid/graphics/Canvas;)V
    ...
    iget v3, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->t0:I
    ...
    sget-object v9, LS/H;->a:Ljava/util/WeakHashMap;
    ...
    :goto_1
    iget v8, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->C0:F
    ...
    iget v8, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->J0:I

    if-nez v8, :cond_2

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/Canvas;->save()I

    iget-object v8, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->G0:Landroid/graphics/RectF;
    ...
    iget-object v12, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->H0:Landroid/graphics/Path;

    invoke-virtual {v12}, Landroid/graphics/Path;->reset()V

    iget v13, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->I0:F
    ...
    iget v12, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->z0:F

    iget v13, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->A0:F

    iget v14, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->B0:I
    ...
    sget v12, Lkp/b;->miuix_color_transparent:I
    ...
    iget v12, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->w0:I

    sub-int/2addr v8, v12

    div-int/lit8 v8, v8, 0x2

    iget-object v12, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->F0:Landroid/graphics/RectF;

    int-to-float v13, v3

    iget v14, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->E0:F

    sub-float/2addr v13, v14

    int-to-float v14, v8

    iget v15, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->D0:F
    ...
    iget v11, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->E0:F
    ...
    iget v11, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->D0:F
    ...
    :cond_2
    iget-object v2, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->q0:Landroid/graphics/drawable/Drawable;
    ...
    :cond_3
    iget-object v2, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->r0:Landroid/graphics/drawable/Drawable;
    ...
    iget v3, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->o0:I

    invoke-virtual {v2, v3}, Landroid/graphics/drawable/Drawable;->setAlpha(I)V

    iget-object v0, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->r0:Landroid/graphics/drawable/Drawable;
...
.method public final d()V
    ...
    iput-object v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->q0:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->r0:Landroid/graphics/drawable/Drawable;
...
.method public final e()V
    ...
    sget v1, Lkp/d;->miuix_hyper_progressbar_light_head:I
    ...
    invoke-static {v0, v1}, Lcom/android/camera/module/k0;->b(Landroid/graphics/RuntimeShader;Landroid/graphics/BitmapShader;)V

    iget-object v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->c:Landroid/graphics/RuntimeShader;

    invoke-static {v0, v2}, Lcom/android/camera/module/l0;->b(Landroid/graphics/RuntimeShader;[F)V

    iget-object v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->c:Landroid/graphics/RuntimeShader;

    iget v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->h:F

    invoke-static {v0, v1}, Llp/b;->a(Landroid/graphics/RuntimeShader;F)V
    ...
    invoke-static {v0, v2}, LPo/k;->c(Landroid/content/Context;F)I
    ...
    iget v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->t0:I
    ...
    invoke-static {v0, v5}, LPo/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v0, v1}, Llp/c;->a(Landroid/graphics/RuntimeShader;[F)V

    iget-object p0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->c:Landroid/graphics/RuntimeShader;

    invoke-static {p0, v2}, Lj8/b0;->a(Landroid/graphics/RuntimeShader;[F)V
...
.method public final g()V
    ...
    iget-object v5, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->k0:Landroid/content/res/ColorStateList;

    if-nez v5, :cond_0

    if-eqz v4, :cond_0

    iput-object v4, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->k0:Landroid/content/res/ColorStateList;

    :cond_0
    iget-object v4, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->k0:Landroid/content/res/ColorStateList;
    ...
    iget v5, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->h0:I
    ...
    iget v5, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->g0:I
    ...
    iget v4, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->h0:I
    ...
    iput-object v6, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->k0:Landroid/content/res/ColorStateList;
    ...
    iput-object v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->k0:Landroid/content/res/ColorStateList;

    :cond_3
    iget-object v1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->k0:Landroid/content/res/ColorStateList;
    ...
    iget v5, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->f0:I
    ...
    iget v5, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->e0:I
    ...
    iput-object v3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->k0:Landroid/content/res/ColorStateList;
...
.method public final onLayout(ZIIII)V
    ...
    invoke-static {p1, p2}, Lj8/b0;->a(Landroid/graphics/RuntimeShader;[F)V
    ...
    :goto_0
    invoke-static {p1, p3}, Llp/a;->a(Landroid/graphics/RuntimeShader;I)V
...
.method public final onSizeChanged(IIII)V
    ...
    iget p3, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->J0:I
    ...
    invoke-static {p1, p3}, Li/o;->b(Landroid/graphics/RuntimeShader;[F)V

    iget-object p0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->c:Landroid/graphics/RuntimeShader;

    invoke-static {p0, p3}, Lj8/a0;->a(Landroid/graphics/RuntimeShader;[F)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v1, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->w0:I
    ...
    iget v3, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->x0:I

    iget v4, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->t0:I

    iget v5, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->J0:I
    ...
    sget-object v9, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->L0:Lmiuix/animation/property/IntValueProperty;

    sget-object v10, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->N0:Lmiuix/animation/property/IntValueProperty;
    ...
    sget-object v12, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->M0:Lmiuix/animation/property/IntValueProperty;
    ...
    iget-object v1, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->K0:Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$g;
    ...
    :cond_2
    iput-boolean v8, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->l0:Z

    :goto_0
    return v6

    :cond_3
    iget-boolean v2, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->l0:Z

    if-nez v2, :cond_4

    invoke-virtual {v1, v0}, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$g;->onStartTrackingTouch(Landroid/widget/SeekBar;)V

    iput-boolean v6, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->l0:Z
    ...
    iget v2, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->y0:F
    ...
    iget v5, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->m0:I
    ...
    iput v2, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->y0:F

    iput-boolean v8, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->p:Z
    ...
    iget-object v14, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->f:[F
    ...
    iget v5, v0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->n0:I
...
.method public setBackgroundPrimaryColor(I)V
    ...
    :cond_0
    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->i0:I
...
.method public setDistanceScale(F)V
    ...
    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->y0:F
...
.method public setForegroundPrimaryColor(I)V
    ...
    :cond_0
    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->g0:I
...
.method public setForegroundPrimaryDisableColor(I)V
    ...
    :cond_0
    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->h0:I
...
.method public setOnSeekBarChangeListener(Landroid/widget/SeekBar$OnSeekBarChangeListener;)V
    ...
    iget-object v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->K0:Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar$g;
...
.method public setProgress(I)V
    ...
    iput-boolean v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->s0:Z
...
.method public setShadowColor(I)V
    ...
    iget v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->B0:I

    if-eq v0, p1, :cond_0

    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->B0:I
...
.method public setShadowHorizontalExtend(F)V
    ...
    iget v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->E0:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->E0:F
...
.method public setShadowRadius(F)V
    ...
    iget v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->C0:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->C0:F
...
.method public setShadowVerticalExtend(F)V
    ...
    iget v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->D0:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->D0:F
...
.method public setShadowX(F)V
    ...
    iget v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->z0:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->z0:F
...
.method public setShadowY(F)V
    ...
    iget v0, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->A0:F

    cmpl-float v0, v0, p1

    if-eqz v0, :cond_0

    iput p1, p0, Lmiuix/miuixbasewidget/widget/HyperProgressSeekBar;->A0:F

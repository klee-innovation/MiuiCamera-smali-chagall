...
.method public final a(Landroid/content/Context;Landroid/view/Display;Landroid/content/res/Configuration;)V
    ...
    invoke-static {v11}, LCn/X;->s(Ljava/lang/String;)V
    ...
    invoke-static {v8}, LCn/X;->s(Ljava/lang/String;)V
    ...
    invoke-static {v8, v9, v5}, LF1/h;->e(ILjava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v9}, LCn/X;->s(Ljava/lang/String;)V
    ...
    invoke-static {v12}, LCn/X;->s(Ljava/lang/String;)V
    ...
    sget-boolean v8, Lop/a;->g:Z

    if-eqz v8, :cond_d

    invoke-static/range {p1 .. p1}, Lop/b;->c(Landroid/content/Context;)Z
    ...
    :goto_f
    sget-boolean v7, Lop/a;->f:Z

    sget v9, Lmiuix/autodensity/k;->b:F

    if-nez v7, :cond_31

    sget-boolean v7, Lop/a;->h:Z

    if-eqz v7, :cond_32

    :cond_31
    invoke-static/range {p1 .. p1}, LPo/a;->b(Landroid/content/Context;)Landroid/graphics/Point;

...
.method private constructor <init>(Landroid/app/Application;)V
    ...
    iget-object v2, v0, Lvo/c;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, Lvo/c;->c:Lvo/c$b;

    if-nez v3, :cond_0

    new-instance v3, Lvo/c$b;
    ...
    iput-object v4, v3, Lvo/c$b;->a:Ljava/util/ArrayList;

    iput-object v3, v0, Lvo/c;->c:Lvo/c$b;
    ...
    iget-object v3, v3, Lvo/c$b;->a:Ljava/util/ArrayList;
    ...
    iget-object p0, v0, Lvo/c;->b:Ljava/lang/Object;

    monitor-enter p0

    :try_start_1
    iget-object p1, v0, Lvo/c;->d:Lvo/c$a;
    ...
    iput-object p1, v0, Lvo/c;->d:Lvo/c$a;
    ...
    iget-object v0, p1, Lvo/c$a;->a:Ljava/util/ArrayList;
    ...
    iput-object v0, p1, Lvo/c$a;->a:Ljava/util/ArrayList;

    :cond_2
    iget-object p1, p1, Lvo/c$a;->a:Ljava/util/ArrayList;
...
.method private changeCurrentConfig(Landroid/app/Activity;)V
    ...
    invoke-static {v0, v1, p1}, LIp/a;->c(Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static createAutoDensityContextWrapper(Landroid/content/Context;II)Landroid/content/Context;
    ...
    .line 9
    invoke-static {p0, v4}, Lop/b;->b(Landroid/content/Context;Landroid/view/Display;)Z

    move-result v5

    if-nez v5, :cond_1

    invoke-static {p0}, Lop/b;->e(Landroid/content/Context;)Z
...
.method public static forceUpdateDensity(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lmiuix/autodensity/g;->j(Landroid/content/Context;)V
...
.method private removeCurrentConfig(Landroid/app/Activity;)V
    ...
    invoke-static {p1, p0, v0, v1}, LIp/a;->h(Ljava/lang/Object;Ljava/lang/Class;Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static setForceDeviceScale(F)V
    ...
    invoke-static {v0}, LCn/X;->s(Ljava/lang/String;)V
...
.method public static setUpdateSystemRes(Z)V
    ...
    :goto_1
    invoke-static {v0}, Lmiuix/autodensity/g;->h(Lmiuix/autodensity/d;)V
    ...
    :cond_4
    invoke-static {p0}, Lmiuix/autodensity/g;->h(Lmiuix/autodensity/d;)V
...
.method public static updateDensity(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lmiuix/autodensity/g;->g(Landroid/content/Context;)Z
...
.method public onRegisterDensityCallback(Ljava/lang/Object;)V
    ...
    invoke-static {p0}, LCn/X;->s(Ljava/lang/String;)V
...
.method public prepareInApplication(Landroid/app/Application;)V
    ...
    invoke-static {v1, v2, v3, v4, v5}, LIp/a;->f(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;[Ljava/lang/Object;)Ljava/lang/Object;
    ...
    sput-object v1, LCn/X;->b:Ljava/lang/String;
    ...
    invoke-static {p1, v0}, Lop/b;->b(Landroid/content/Context;Landroid/view/Display;)Z
    ...
    invoke-static {p1}, Lmiuix/autodensity/g;->j(Landroid/content/Context;)V
...
.method public processBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;)V
    ...
    invoke-static {p1, v0, v4, v2}, LPo/a;->k(Landroid/content/Context;LPo/n;Landroid/content/res/Configuration;Z)V

    invoke-virtual {p0, p1, p2, v0}, Lmiuix/autodensity/f;->onDensityChangedBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;LPo/n;)V
    ...
    invoke-static {p1}, Lmiuix/autodensity/g;->g(Landroid/content/Context;)Z
    ...
    invoke-static {p1, v1, v4, v2}, LPo/a;->k(Landroid/content/Context;LPo/n;Landroid/content/res/Configuration;Z)V

    invoke-virtual {p0, p1, p2, v1}, Lmiuix/autodensity/f;->onDensityChangedBeforeActivityConfigChanged(Landroid/app/Activity;Landroid/content/res/Configuration;LPo/n;)V
...
.method public processOnActivityCreated(Landroid/app/Activity;)V
    ...
    :try_start_0
    invoke-static {p1}, LMo/g;->b(Landroid/app/Activity;)Landroid/view/Display;
...
.method public processOnActivityDisplayChanged(ILandroid/app/Activity;)V
    ...
    invoke-static {p2}, Lmiuix/autodensity/g;->j(Landroid/content/Context;)V
    ...
    invoke-static {p2}, Lmiuix/autodensity/g;->g(Landroid/content/Context;)Z

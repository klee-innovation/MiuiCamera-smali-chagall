...
.method public constructor <init>(Lmiuix/appcompat/internal/view/menu/action/d;Landroid/content/Context;Lmiuix/appcompat/internal/view/menu/d;Landroid/view/View;Landroid/view/View;)V
    ...
    sget p3, Lwo/a$c;->overflowMenuMaxHeight:I

    invoke-static {p2, p3}, Lgp/d;->j(Landroid/content/Context;I)Landroid/util/TypedValue;
    ...
    :cond_2
    iget-object p1, p1, Lmiuix/appcompat/internal/view/menu/action/a;->d0:Lmiuix/appcompat/internal/view/menu/action/a$f;

    iput-object p1, p0, Lmiuix/appcompat/internal/view/menu/b;->g:Lmiuix/appcompat/internal/view/menu/h$a;

    invoke-static {p4}, Lgp/h;->c(Landroid/view/View;)Z
...
.method public final f(Z)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LLo/e;

    new-instance v0, LHo/b;

    const/4 v1, 0x0

    invoke-direct {v0, p0, v1}, LHo/b;-><init>(Ljava/lang/Object;I)V

    iput-object v0, p1, LAp/l;->Y:Landroid/widget/PopupWindow$OnDismissListener;

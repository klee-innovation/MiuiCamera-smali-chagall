...
# instance fields
.field public f0:Lmiuix/appcompat/internal/view/menu/f;
...
.method public final f(Landroid/content/Context;)Landroid/view/View;
    ...
    sget v10, Lwo/a$h;->more:I

    sget v2, Lwo/a$k;->more:I
    ...
    sget v2, Lwo/a$c;->endActionMoreButtonIcon:I
    ...
    invoke-direct {p1, p0}, LIo/c;-><init>(Lmiuix/appcompat/internal/view/menu/action/c;)V
    ...
    invoke-virtual {p0, v11, v1, v0}, Lmiuix/appcompat/internal/view/menu/action/a;->h(Lmiuix/appcompat/internal/view/menu/f;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;

    move-result-object p1

    invoke-virtual {p1, v10}, Landroid/view/View;->setId(I)V

    iput-object v11, p0, Lmiuix/appcompat/internal/view/menu/action/c;->f0:Lmiuix/appcompat/internal/view/menu/f;

    new-instance p0, LHo/f;

    invoke-direct {p0}, LS/a;-><init>()V

    invoke-static {p1, p0}, LS/H;->j(Landroid/view/View;LS/a;)V

    sget p0, Lwo/a$h;->action_menu_item_child_icon:I
...
.method public final g()I
    ...
    sget v0, Lwo/a$i;->action_bar_end_menu_max_item_count:I
...
.method public final j(Lmiuix/appcompat/internal/view/menu/j;)Z
    ...
    iget-object v5, p0, Lmiuix/appcompat/internal/view/menu/action/a;->Z:Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;
    ...
    invoke-virtual {v6}, Lmiuix/appcompat/internal/view/menu/g;->g()Z
...
.method public final m(Landroid/view/View;)V
    ...
    invoke-static {p1}, Lgp/h;->c(Landroid/view/View;)Z

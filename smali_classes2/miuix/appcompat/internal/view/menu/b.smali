...
.method public final b(Lmiuix/appcompat/internal/view/menu/d;Z)V
    ...
    invoke-virtual {p0, v0}, Lmiuix/appcompat/internal/view/menu/b;->f(Z)V
...
.method public final c()V
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LKo/e;
...
.method public final g()Z
    ...
    invoke-direct {v0, v2, v1}, LLo/e;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LLo/e;

    const v1, 0x800055

    invoke-virtual {v0, v1}, LAp/l;->j(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LLo/e;

    iput-object p0, v0, LAp/l;->Y:Landroid/widget/PopupWindow$OnDismissListener;

    iput-object p0, v0, LLo/e;->z0:LLo/e$c;

    const/4 v1, 0x0

    iput-boolean v1, v0, LAp/l;->m0:Z

    new-instance v0, LKo/e;

    const/4 v3, 0x1

    invoke-direct {v0, v2, v3}, LKo/e;-><init>(Landroid/content/Context;Z)V

    iput-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LKo/e;
    ...
    iget-object v4, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LKo/e;

    invoke-virtual {v4, v0}, LKo/e;->e(Ljava/util/HashMap;)V

    :cond_1
    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LKo/e;

    invoke-virtual {v0, v2}, LKo/e;->f(Lmiuix/appcompat/internal/view/menu/d;)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LLo/e;

    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->f:LKo/e;

    iget-object v0, v0, LLo/e;->s0:LLo/e$d;

    iput-object v2, v0, LLo/e$d;->b:Landroid/widget/ListAdapter;

    iget-object v0, v2, LKo/e;->e:Ljava/util/HashMap;
    ...
    iget-object v2, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LLo/e;

    iput-boolean v0, v2, LLo/e;->B0:Z

    invoke-virtual {v2, v1}, LAp/l;->e(I)V

    iget-object v0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LLo/e;

    invoke-virtual {v0, v1}, LAp/l;->a(I)V

    iget v0, p0, Lmiuix/appcompat/internal/view/menu/b;->h:I

    if-lez v0, :cond_2

    iget-object v1, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LLo/e;

    iput v0, v1, LAp/l;->l:I
    ...
    invoke-virtual {v0, v1}, LLo/e;->L(Landroid/view/View;)V
...
.method public final isShowing()Z
    ...
    iget-object p0, p0, Lmiuix/appcompat/internal/view/menu/b;->b:LLo/e;

    iget-boolean p0, p0, LAp/l;->n0:Z
...
.method public final k()V
    ...
    iget-object v0, v0, LKo/e;->g:Ljava/util/HashMap;
    ...
    iget-object v0, v0, LKo/e;->i:Ljava/util/HashMap;
...
.method public final onKey(Landroid/view/View;ILandroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, p3}, Lmiuix/appcompat/internal/view/menu/b;->f(Z)V

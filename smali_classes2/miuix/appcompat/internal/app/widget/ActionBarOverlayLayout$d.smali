...
.method public final b(Lmiuix/appcompat/internal/view/menu/d;Z)V
    ...
    :cond_1
    iget-object p1, v2, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->r0:Lmiuix/appcompat/internal/view/menu/e;

    const/4 p2, 0x0

    if-eqz p1, :cond_3

    iget-object v0, p1, Lmiuix/appcompat/internal/view/menu/e;->b:Lmiuix/appcompat/app/m;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lmiuix/appcompat/app/m;->dismiss()V

    iput-object p2, p1, Lmiuix/appcompat/internal/view/menu/e;->b:Lmiuix/appcompat/app/m;

    :cond_2
    iput-object p2, v2, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->r0:Lmiuix/appcompat/internal/view/menu/e;

    iput-object p2, v2, Lmiuix/appcompat/internal/app/widget/ActionBarOverlayLayout;->q0:LJo/a;
...
.method public final c(Lmiuix/appcompat/internal/view/menu/j;)Z
    ...
    invoke-virtual {v0, p0}, Lmiuix/appcompat/internal/view/menu/e;->a(Landroid/os/IBinder;)V

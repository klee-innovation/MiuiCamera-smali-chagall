...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lmiuix/appcompat/internal/app/widget/r$a;
    }
.end annotation
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget v0, Lwo/a$m;->SecondarySegmentTabBar_segmentTabBarLayoutConfig:I

    invoke-virtual {p1, v0, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/internal/app/widget/r;->l0:I
    ...
    iput p1, p0, Lmiuix/appcompat/internal/app/widget/r;->m0:I
...
.method public final a(I)V
    ...
    iget v1, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->i0:I
    ...
    :cond_1
    iget p1, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->i0:I

    add-int/lit8 p1, p1, -0x1

    iput p1, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->i0:I

    :goto_0
    return-void
.end method

.method public final c(Li/a$d;IZ)V
    .locals 4

    new-instance v0, Lmiuix/appcompat/internal/app/widget/r$a;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    sget v2, Lwo/a$c;->segmentTabViewStyle:I
    ...
    iput-object p1, v0, Lmiuix/appcompat/internal/app/widget/r$a;->n:Li/a$d;

    invoke-virtual {p1}, Li/a$d;->b()Ljava/lang/CharSequence;
    ...
    iget-object v1, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->j0:Lmiuix/miuixbasewidget/widget/FilterSortView$a;
    ...
    iget-object v1, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->k0:Lmiuix/miuixbasewidget/widget/FilterSortView$b;
    ...
    iput-boolean v1, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->h0:Z
    ...
    :goto_1
    iget p2, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->i0:I

    add-int/lit8 p2, p2, 0x1

    iput p2, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->i0:I

    iget-object p2, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->s:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p2}, Lmiuix/miuixbasewidget/widget/FilterSortView;->v(Landroidx/constraintlayout/widget/c;)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/internal/app/widget/r;->n0:La3/i;
    ...
    iput-object p1, p0, Lmiuix/appcompat/internal/app/widget/r;->n0:La3/i;
...
.method public final k()V
    ...
    iput v0, p0, Lmiuix/miuixbasewidget/widget/FilterSortView;->i0:I
...
.method public final onMeasure(II)V
    ...
    iget v4, p0, Lmiuix/appcompat/internal/app/widget/r;->m0:I

    const/4 v5, 0x2

    const/high16 v6, 0x3f800000    # 1.0f

    iget v7, p0, Lmiuix/appcompat/internal/app/widget/r;->l0:I
    ...
    invoke-static {v8}, LPo/a;->e(Landroid/content/Context;)Landroid/graphics/Point;
...
.method public final p(Li/a$d;Z)V
    .locals 1

    const/4 v0, -0x1

    invoke-virtual {p0, p1, v0, p2}, Lmiuix/appcompat/internal/app/widget/r;->c(Li/a$d;IZ)V

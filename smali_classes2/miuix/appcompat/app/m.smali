...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lmiuix/appcompat/app/m$b;,
        Lmiuix/appcompat/app/m$e;,
        Lmiuix/appcompat/app/m$c;,
        Lmiuix/appcompat/app/m$d;,
...
.field public final g:Lmiuix/appcompat/app/m$b;

.field public final h:Ljava/lang/String;

.field public final i:Lmiuix/appcompat/app/l;
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-static {p1, p2}, Lmiuix/appcompat/app/m;->p(Landroid/content/Context;I)I

    move-result p2

    invoke-direct {p0, p1, p2}, Li/s;-><init>(Landroid/content/Context;I)V

    new-instance p2, Lmiuix/appcompat/app/l;

    invoke-direct {p2, p0}, Lmiuix/appcompat/app/l;-><init>(Lmiuix/appcompat/app/m;)V

    iput-object p2, p0, Lmiuix/appcompat/app/m;->i:Lmiuix/appcompat/app/l;
    ...
    invoke-static {p1}, LPo/a;->j(Landroid/content/Context;)V
    ...
    invoke-direct {v0, p2, p0, v1}, Lmiuix/appcompat/app/AlertController;-><init>(Landroid/content/Context;Lmiuix/appcompat/app/m;Landroid/view/Window;)V

    iput-object v0, p0, Lmiuix/appcompat/app/m;->f:Lmiuix/appcompat/app/AlertController;

    new-instance p2, Lmiuix/appcompat/app/m$b;

    invoke-direct {p2}, Ljava/lang/Object;-><init>()V

    iput-object p2, p0, Lmiuix/appcompat/app/m;->g:Lmiuix/appcompat/app/m$b;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object p1

    sget p2, Lwo/a$k;->miuix_appcompat_show_dialog_description:I

    invoke-virtual {p1, p2}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lmiuix/appcompat/app/m;->h:Ljava/lang/String;

    return-void
.end method

.method public static f(Lmiuix/appcompat/app/m;)V
    .locals 1
    ...
    invoke-super {p0}, Li/s;->dismiss()V
...
.method public static p(Landroid/content/Context;I)I
    ...
    sget v0, Lwo/a$c;->miuiAlertDialogTheme:I
...
.method public dismiss()V
    ...
    iget-object v0, p0, Lmiuix/appcompat/app/m;->f:Lmiuix/appcompat/app/AlertController;
    ...
    invoke-static {v2}, LPo/a;->j(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v1}, Lmiuix/appcompat/app/m;->g(Landroid/view/View;)V

    goto :goto_2

    :cond_7
    invoke-virtual {p0, v1}, Lmiuix/appcompat/app/m;->i(Landroid/view/View;)V
...
.method public dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    :cond_0
    invoke-super {p0, p1}, Li/s;->dispatchKeyEvent(Landroid/view/KeyEvent;)Z
...
.method public h(Landroid/view/View;)V
    ...
    iget-object p1, p0, Lmiuix/appcompat/app/m;->i:Lmiuix/appcompat/app/l;

    iget-object p0, p0, Lmiuix/appcompat/app/m;->f:Lmiuix/appcompat/app/AlertController;

    invoke-virtual {p0, p1}, Lmiuix/appcompat/app/AlertController;->e(Lmiuix/appcompat/app/l;)V
...
.method public final i(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Lmiuix/appcompat/app/m;->h(Landroid/view/View;)V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1}, Lmiuix/appcompat/app/m;->g(Landroid/view/View;)V
...
.method public onAttachedToWindow()V
    ...
    iget-object v1, p0, Lmiuix/appcompat/app/m;->f:Lmiuix/appcompat/app/AlertController;
    ...
    sget v3, Lwo/a$d;->treat_as_land:I
    ...
    invoke-static {v5, v3}, Lmiuix/appcompat/app/i;->b(Landroid/view/View;Landroid/view/WindowInsetsAnimation$Callback;)V
    ...
    :cond_3
    iget-object p0, p0, Lmiuix/appcompat/app/m;->h:Ljava/lang/String;

    invoke-static {v0, p0}, LS/H;->k(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-super {p0, p1}, Li/s;->onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, LPo/k;->h(Landroid/content/Context;)Z
    ...
    iget-object v3, v0, Lmiuix/appcompat/app/AlertController;->d:Lmiuix/appcompat/app/m;

    invoke-virtual {v3, v1}, Li/s;->setContentView(I)V

    sget v1, Lwo/a$h;->dialog_root_view:I
    ...
    sget v1, Lwo/a$h;->dialog_dim_bg:I
    ...
    sget v5, Lwo/a$e;->miuix_appcompat_transparent:I
    ...
    sget v5, Lwo/a$l;->Animation_Dialog_NoAnimation:I
    ...
    invoke-virtual {v3}, Lmiuix/appcompat/app/m;->j()Landroid/app/Activity;
    ...
    invoke-static {v5}, Lmiuix/appcompat/app/g;->b(Landroid/view/WindowManager$LayoutParams;)V
    ...
    invoke-static {v8, v9, v10, v5, v2}, LD2/e;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/StringBuilder;
    ...
    invoke-static {v3}, Lmiuix/appcompat/app/h;->a(Landroid/widget/TextView;)I
...
.method public onStart()V
    ...
    sget v2, Lwo/a$d;->treat_as_land:I
    ...
    iget-object v2, p0, Lmiuix/appcompat/app/AlertController;->g0:LLo/b;

    iput-boolean v0, v2, LLo/b;->b:Z
    ...
    iget-object v7, p0, Lmiuix/appcompat/app/AlertController;->L0:Lmiuix/appcompat/app/m$d;

    invoke-virtual/range {v2 .. v7}, LLo/b;->b(Landroid/view/View;Landroid/view/View;ZZLmiuix/appcompat/app/m$d;)V

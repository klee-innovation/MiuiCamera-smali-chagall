...
.method public static a(Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher;)V
    ...
    iget-object v2, v2, Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher$ActivitySpec;->g:Lmiuix/appcompat/app/o;
    ...
    invoke-direct {v3, v2, v4}, LAo/a;-><init>(Ljava/lang/Object;I)V
...
.method public static f(Lmiuix/appcompat/app/o;Landroid/content/Intent;Landroid/os/Bundle;)V
    .locals 11
    ...
    sget v6, Lwo/a$b;->multi_floating_package_allow_list:I
    ...
    invoke-static {p0}, LCp/a;->j(Lmiuix/appcompat/app/o;)I
    ...
    iget-object v6, p0, Lmiuix/appcompat/app/o;->h0:Lmiuix/appcompat/app/p;

    iget-object v7, v6, Lmiuix/appcompat/app/p;->p0:Ljava/lang/String;
    ...
    iget-object v6, v6, Lmiuix/appcompat/app/p;->p0:Ljava/lang/String;
    ...
    :cond_8
    iput-object p0, p2, Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher$ActivitySpec;->g:Lmiuix/appcompat/app/o;
    ...
    sget v0, Lwo/a$h;->miuix_appcompat_floating_window_index:I
    ...
    iget-object v0, v0, Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher$ActivitySpec;->g:Lmiuix/appcompat/app/o;

    if-eqz v0, :cond_c

    if-eqz p2, :cond_c

    iget-object p2, v0, Lmiuix/appcompat/app/o;->h0:Lmiuix/appcompat/app/p;

    iget-object p2, p2, Lmiuix/appcompat/app/p;->n0:Lzo/a;

    if-eqz p2, :cond_c

    invoke-virtual {p2}, Lzo/a;->e()V
    ...
    invoke-direct {p2, v2, p0}, Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher$d;-><init>(Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher;Lmiuix/appcompat/app/o;)V
    ...
    new-instance p1, Lmiuix/appcompat/app/floatingactivity/multiapp/d;

    invoke-direct {p1, p0}, Lyo/c;-><init>(Lmiuix/appcompat/app/o;)V

    iget-object p2, p0, LG/f;->a:Landroidx/lifecycle/x;

    invoke-virtual {p2, p1}, Landroidx/lifecycle/x;->a(Landroidx/lifecycle/v;)V

    iget-boolean p1, v2, Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher;->c:Z

    iget-object p2, p0, Lmiuix/appcompat/app/o;->h0:Lmiuix/appcompat/app/p;

    iget-object p2, p2, Lmiuix/appcompat/app/p;->n0:Lzo/a;

    if-eqz p2, :cond_10

    invoke-virtual {p2, p1}, Lzo/a;->k(Z)V

    :cond_10
    new-instance p1, Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher$b;

    invoke-direct {p1, v2, p0}, Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher$b;-><init>(Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher;Lmiuix/appcompat/app/o;)V
    ...
    invoke-virtual {p0, p1}, Lzo/a;->m(Lyo/g;)V
    ...
    :cond_12
    invoke-static {p0, p2}, Lmiuix/appcompat/app/floatingactivity/FloatingActivitySwitcher;->e(Lmiuix/appcompat/app/o;Landroid/os/Bundle;)V
...
.method public final b(ILjava/lang/String;)V
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher$ActivitySpec;->g:Lmiuix/appcompat/app/o;
...
.method public final g(Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher$ActivitySpec;)V
    ...
    invoke-interface {v2, v3, v4}, Lmiuix/appcompat/app/floatingactivity/multiapp/a;->p0(Lmiuix/appcompat/app/floatingactivity/multiapp/b;Ljava/lang/String;)I
    ...
    :try_start_1
    invoke-interface {p0, v2, v0}, Lmiuix/appcompat/app/floatingactivity/multiapp/a;->C(ILjava/lang/String;)V
    :try_end_1
...
.method public final i(ILandroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Lmiuix/appcompat/app/floatingactivity/multiapp/a;->B0(ILandroid/os/Bundle;)Landroid/os/Bundle;
...
.method public final j(Landroid/graphics/Bitmap;Ljava/lang/String;I)V
    ...
    :try_start_3
    invoke-interface {p0, p1, v5}, Lmiuix/appcompat/app/floatingactivity/multiapp/a;->B0(ILandroid/os/Bundle;)Landroid/os/Bundle;
    :try_end_3
...
.method public final k(ILjava/lang/String;)V
    ...
    invoke-interface {p0, p1, p2}, Lmiuix/appcompat/app/floatingactivity/multiapp/a;->M(Lmiuix/appcompat/app/floatingactivity/multiapp/MultiAppFloatingActivitySwitcher$d;Ljava/lang/String;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0

...
# instance fields
.field public final A:Lmiuix/appcompat/app/t;

.field public final A0:Landroid/graphics/Point;

.field public final B:Lmiuix/appcompat/app/w;
...
.field public K0:Lmiuix/appcompat/app/m$d;

.field public L:Landroid/os/Message;

.field public final L0:Lmiuix/appcompat/app/m$d;
...
.field public final d:Lmiuix/appcompat/app/m;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lmiuix/appcompat/app/m;Landroid/view/Window;)V
    .locals 7
    ...
    iput v2, v3, Lmiuix/appcompat/app/t;->d:I

    iput-object v3, p0, Lmiuix/appcompat/app/AlertController;->A:Lmiuix/appcompat/app/t;

    new-instance v3, Lmiuix/appcompat/app/w;

    invoke-direct {v3}, Ljava/lang/Object;-><init>()V

    iput-object v3, p0, Lmiuix/appcompat/app/AlertController;->B:Lmiuix/appcompat/app/w;
    ...
    invoke-direct {v2}, LLo/b;-><init>()V

    iput-object v2, p0, Lmiuix/appcompat/app/AlertController;->g0:LLo/b;
    ...
    iput-object v5, p0, Lmiuix/appcompat/app/AlertController;->L0:Lmiuix/appcompat/app/m$d;
    ...
    new-instance v5, LBo/d;

    invoke-direct {v5}, Ljava/lang/Object;-><init>()V

    iput-object v5, v3, Lmiuix/appcompat/app/w;->b:LBo/d;

    new-instance v5, LBo/c;

    invoke-direct {v5}, Ljava/lang/Object;-><init>()V

    iput-object v5, v3, Lmiuix/appcompat/app/w;->a:LBo/c;
    ...
    iput-object p2, p0, Lmiuix/appcompat/app/AlertController;->d:Lmiuix/appcompat/app/m;
    ...
    sget v3, Lwo/a$i;->dialog_enter_duration:I
    ...
    sget-boolean p3, Lop/a;->g:Z

    if-eqz p3, :cond_0

    invoke-static {p1}, Lop/b;->c(Landroid/content/Context;)Z
    ...
    invoke-static {p1, v4}, Lop/b;->b(Landroid/content/Context;Landroid/view/Display;)Z
    ...
    invoke-static {p1}, Lop/b;->e(Landroid/content/Context;)Z
    ...
    sget-object p3, Lwo/a$m;->AlertDialog:[I
    ...
    sget v3, Lwo/a$m;->AlertDialog_layout:I
    ...
    sget v3, Lwo/a$m;->AlertDialog_listLayout:I
    ...
    sget v3, Lwo/a$m;->AlertDialog_multiChoiceItemLayout:I
    ...
    sget v3, Lwo/a$m;->AlertDialog_singleChoiceItemLayout:I
    ...
    sget v3, Lwo/a$m;->AlertDialog_listItemLayout:I
    ...
    sget v1, Lwo/a$m;->AlertDialog_showTitle:I
    ...
    invoke-virtual {p2}, Li/s;->d()Li/g;

    move-result-object p2

    invoke-virtual {p2, v2}, Li/g;->n(I)Z
    ...
    sget p2, Lwo/a$d;->treat_as_land:I
    ...
    invoke-static {p1, v0, p0}, LB2/m;->i(Ljava/lang/StringBuilder;Ljava/lang/String;I)V
...
.method public static a(Lmiuix/appcompat/app/AlertController;Landroid/view/ViewGroup;Landroid/view/ViewGroup;)V
    ...
    invoke-static {v2, v1}, LPo/p;->b(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    invoke-static {p0, p1}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/ViewGroup;Landroid/view/View;)V

    goto :goto_5

    :cond_7
    invoke-static {p2, p1}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/ViewGroup;Landroid/view/View;)V
...
.method public static v(Landroid/view/ViewGroup;Landroid/view/View;)V
    .locals 1
...
.method public final A()V
    ...
    invoke-static {v3, v5}, LPo/k;->c(Landroid/content/Context;F)I
    ...
    invoke-static {v0, v6, v5}, LB2/m;->i(Ljava/lang/StringBuilder;Ljava/lang/String;I)V
    ...
    iget-object v10, p0, Lmiuix/appcompat/app/AlertController;->A:Lmiuix/appcompat/app/t;

    if-eqz v0, :cond_4

    iget v0, v10, Lmiuix/appcompat/app/t;->f:I

    goto :goto_2

    :cond_4
    iget v0, v10, Lmiuix/appcompat/app/t;->d:I

    :goto_2
    invoke-static {v3}, LPo/k;->m(Landroid/content/Context;)Z

    move-result v12

    invoke-static {v3}, LPo/k;->j(Landroid/content/Context;)Z
    ...
    invoke-static {v3}, Lop/b;->d(Landroid/content/Context;)Z
    ...
    iget v10, v10, Lmiuix/appcompat/app/t;->i:I
    ...
    invoke-static {v3}, Lgp/h;->d(Landroid/content/Context;)Z
    ...
    sget v0, Lwo/a$e;->miuix_appcompat_transparent:I
    ...
    sget p0, Lwo/a$l;->Animation_Dialog_Center:I
...
.method public final B(FZ)V
    ...
    iget-object v2, v0, Lmiuix/appcompat/app/AlertController;->i0:Landroid/view/View;

    new-instance v9, Lcom/android/camera/features/mode/aiwatermark/a;

    invoke-direct {v9, v0, v4}, Lcom/android/camera/features/mode/aiwatermark/a;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-virtual {v0, v2}, Lmiuix/appcompat/app/AlertController;->F(Landroid/graphics/Point;)V
    ...
    invoke-static {v5, v2}, LPo/k;->c(Landroid/content/Context;F)I
    ...
    new-instance v9, Lcom/android/camera2/compat/theme/custom/mm/filter/d;

    invoke-direct {v9, v0, v1}, Lcom/android/camera2/compat/theme/custom/mm/filter/d;-><init>(Ljava/lang/Object;I)V
    ...
    iget-boolean v2, v0, Lmiuix/appcompat/app/AlertController;->O0:Z
    ...
    sget v10, Lwo/a$h;->contentPanel:I
    ...
    sget v11, Lwo/a$h;->buttonPanel:I
    ...
    iget-object v11, v0, Lmiuix/appcompat/app/AlertController;->A:Lmiuix/appcompat/app/t;
    ...
    sget-object v16, LS/H;->a:Ljava/util/WeakHashMap;

    invoke-static {v12, v1}, LS/H$d;->t(Landroid/view/View;Z)V
    ...
    invoke-virtual {v0, v1}, Lmiuix/appcompat/app/AlertController;->y(Landroid/view/ViewGroup;)V
    ...
    invoke-static {v1}, Lmiuix/appcompat/app/AlertController;->w(Landroid/view/View;)V

    iget-object v1, v0, Lmiuix/appcompat/app/AlertController;->n:Landroid/widget/ListView;

    sget v3, Lwo/a$c;->dialogListPreferredItemHeight:I

    invoke-static {v5, v3}, Lgp/d;->f(Landroid/content/Context;I)I
    ...
    invoke-static {v1, v3}, LS/H$d;->t(Landroid/view/View;Z)V
    ...
    iget v3, v11, Lmiuix/appcompat/app/t;->c:I
    ...
    invoke-static {v3, v4}, LS/H$d;->t(Landroid/view/View;Z)V
    ...
    iget-object v4, v0, Lmiuix/appcompat/app/AlertController;->T0:Landroid/view/View$OnClickListener;

    invoke-virtual {v3, v4}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v3, v0, Lmiuix/appcompat/app/AlertController;->D:Landroid/widget/Button;

    iget-object v6, v0, Lmiuix/appcompat/app/AlertController;->C:Landroid/text/TextWatcher;
    ...
    iget-object v9, v0, Lmiuix/appcompat/app/AlertController;->E:Ljava/lang/CharSequence;
    ...
    iput-object v9, v0, Lmiuix/appcompat/app/AlertController;->G:Landroid/widget/Button;

    invoke-virtual {v9, v4}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v9, v0, Lmiuix/appcompat/app/AlertController;->G:Landroid/widget/Button;
    ...
    iget-object v9, v0, Lmiuix/appcompat/app/AlertController;->H:Ljava/lang/CharSequence;
    ...
    iput-object v9, v0, Lmiuix/appcompat/app/AlertController;->J:Landroid/widget/Button;
    ...
    invoke-static {v9}, Lmiuix/appcompat/app/AlertController$ButtonInfo;->access$1700(Lmiuix/appcompat/app/AlertController$ButtonInfo;)I
    ...
    invoke-static {v9}, Lmiuix/appcompat/app/AlertController$ButtonInfo;->access$1800(Lmiuix/appcompat/app/AlertController$ButtonInfo;)Landroid/content/DialogInterface$OnClickListener;
    ...
    :cond_1d
    instance-of v4, v10, Lmiuix/appcompat/internal/widget/DialogButtonPanel;
    ...
    invoke-static {v7}, Lmiuix/appcompat/app/AlertController$ButtonInfo;->access$600(Lmiuix/appcompat/app/AlertController$ButtonInfo;)Lmiuix/internal/widget/GroupButton;
    ...
    invoke-static {v7}, Lmiuix/appcompat/app/AlertController$ButtonInfo;->access$1700(Lmiuix/appcompat/app/AlertController$ButtonInfo;)I
    ...
    sget v12, Lwo/a$c;->buttonBarPrimaryButtonStyle:I
    ...
    sget v12, Lwo/a$c;->buttonBarButtonStyle:I
    ...
    iget-object v9, v1, Lmiuix/appcompat/internal/widget/DialogButtonPanel;->o:Ljava/util/ArrayList;
    ...
    iget-object v9, v1, Lmiuix/appcompat/internal/widget/DialogButtonPanel;->n:Ljava/util/ArrayList;
    ...
    iget-object v9, v1, Lmiuix/appcompat/internal/widget/DialogButtonPanel;->m:Ljava/util/ArrayList;
    ...
    :cond_2a
    invoke-static {v5}, LPo/p;->e(Landroid/content/Context;)Z
    ...
    :goto_13
    invoke-static {v5}, LPo/k;->e(Landroid/content/Context;)I
    ...
    :goto_14
    iget-boolean v7, v0, Lmiuix/appcompat/app/AlertController;->P0:Z

    if-nez v7, :cond_2e

    iget-boolean v7, v0, Lmiuix/appcompat/app/AlertController;->k0:Z
    ...
    invoke-static {v5, v4}, LPo/p;->b(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    sget v6, Lwo/a$h;->contentPanel:I
    ...
    invoke-static {v1, v10}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/ViewGroup;Landroid/view/View;)V

    goto :goto_1a

    :cond_31
    invoke-static {v5, v10}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/ViewGroup;Landroid/view/View;)V

    check-cast v5, Lmiuix/appcompat/internal/widget/NestedScrollViewExpander;

    const/4 v1, 0x0

    invoke-virtual {v5, v1}, Lmiuix/appcompat/internal/widget/NestedScrollViewExpander;->setExpandView(Landroid/view/View;)V
    ...
    invoke-virtual {v2, v6, v14, v5}, Landroid/view/ViewGroup;->addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V

    sget v5, Lwo/a$h;->alertTitle:I
    ...
    invoke-virtual {v4, v5, v6, v7, v9}, Landroid/widget/TextView;->setPadding(IIII)V
    ...
    iget v5, v11, Lmiuix/appcompat/app/t;->j:I

    iput v5, v4, Landroid/view/ViewGroup$LayoutParams;->width:I

    iget v5, v11, Lmiuix/appcompat/app/t;->k:I
    ...
    :cond_3c
    :goto_1f
    sget v1, Lwo/a$h;->titleDividerNoCustom:I
    ...
    sget v2, Lwo/a$h;->checkbox_stub:I
    ...
    iget-object v1, v0, Lmiuix/appcompat/app/AlertController;->d:Lmiuix/appcompat/app/m;
...
.method public final C()Z
    ...
    iget-object v3, p0, Lmiuix/appcompat/app/AlertController;->A:Lmiuix/appcompat/app/t;

    iget v3, v3, Lmiuix/appcompat/app/t;->b:I
...
.method public final D(I)V
    ...
    invoke-static {p1, v0, v1}, LGe/b;->h(ILjava/lang/String;Ljava/lang/String;)V
...
.method public final E(Landroid/view/WindowInsets;)V
    ...
    invoke-static {v0}, LPo/k;->j(Landroid/content/Context;)Z
    ...
    :goto_1
    sget-boolean v4, Lop/a;->b:Z

    if-eqz v1, :cond_2

    invoke-static {v0}, LPo/a;->f(Landroid/content/Context;)Z

    move-result v6

    if-nez v6, :cond_2

    invoke-static {v0}, Lop/b;->d(Landroid/content/Context;)Z
    ...
    invoke-static {p1, v1}, LS/g0;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {p1, v2}, LS/g0;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {v2, v5, v1}, LB2/m;->i(Ljava/lang/StringBuilder;Ljava/lang/String;I)V
    ...
    invoke-static {v3, p1, v5}, LGe/b;->h(ILjava/lang/String;Ljava/lang/String;)V
...
.method public final F(Landroid/graphics/Point;)V
    ...
    invoke-static {v3, v2}, LPo/p;->b(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    iget-object v9, p0, Lmiuix/appcompat/app/AlertController;->B:Lmiuix/appcompat/app/w;

    iget-object v10, v9, Lmiuix/appcompat/app/w;->b:LBo/d;
    ...
    :cond_c
    iget-object v2, p0, Lmiuix/appcompat/app/AlertController;->A:Lmiuix/appcompat/app/t;
    ...
    :cond_e
    iget-object v1, v9, Lmiuix/appcompat/app/w;->b:LBo/d;

    if-nez v1, :cond_f

    iget v1, v2, Lmiuix/appcompat/app/t;->f:I
    ...
    iget v1, v2, Lmiuix/appcompat/app/t;->g:I

    :goto_6
    iput-boolean v0, p0, Lmiuix/appcompat/app/AlertController;->f:Z

    new-instance v5, Lmiuix/appcompat/app/v;
    ...
    iput-boolean v6, v5, Lmiuix/appcompat/app/v;->a:Z

    iput-boolean v0, v5, Lmiuix/appcompat/app/v;->b:Z

    iput-boolean v7, v5, Lmiuix/appcompat/app/v;->c:Z

    iput-boolean v8, v5, Lmiuix/appcompat/app/v;->d:Z

    iput p1, v5, Lmiuix/appcompat/app/v;->e:I

    iput v10, v5, Lmiuix/appcompat/app/v;->f:I

    iput-boolean v12, v5, Lmiuix/appcompat/app/v;->g:Z

    invoke-virtual {v9, v5, v2}, Lmiuix/appcompat/app/w;->a(Lmiuix/appcompat/app/v;Lmiuix/appcompat/app/t;)I
    ...
    sget p1, Lwo/a$j;->miuix_appcompat_alert_dialog_content:I
    ...
    sget p1, Lwo/a$j;->miuix_appcompat_alert_dialog_content_land:I
    ...
    iget-object p1, p1, Lgp/c;->a:Ljava/util/HashMap;
...
.method public final H(Landroid/content/res/Resources;)V
    ...
    sget v0, Lwo/a$f;->miuix_appcompat_dialog_max_width:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iget-object p0, p0, Lmiuix/appcompat/app/AlertController;->A:Lmiuix/appcompat/app/t;

    iput v0, p0, Lmiuix/appcompat/app/t;->a:I

    sget v0, Lwo/a$f;->miuix_appcompat_dialog_max_width_land:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/app/t;->b:I

    sget v0, Lwo/a$f;->miuix_appcompat_dialog_list_view_margin_bottom:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/app/t;->c:I

    sget v0, Lwo/a$f;->miuix_appcompat_dialog_ime_margin:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/app/t;->d:I

    sget v0, Lwo/a$f;->fake_landscape_screen_minor_size:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/app/t;->e:I

    sget v0, Lwo/a$f;->miuix_appcompat_dialog_width_small_margin:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/app/t;->f:I

    sget v0, Lwo/a$f;->miuix_appcompat_dialog_width_margin:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/app/t;->g:I

    sget v0, Lwo/a$f;->miuix_appcompat_dialog_freeform_bottom_height_tablet_t:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/app/t;->h:I

    sget v0, Lwo/a$f;->miuix_appcompat_dialog_freeform_bottom_height_phone_t:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/app/t;->i:I

    sget v0, Lwo/a$f;->miuix_appcompat_dialog_icon_drawable_width_small:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lmiuix/appcompat/app/t;->j:I

    sget v0, Lwo/a$f;->miuix_appcompat_dialog_icon_drawable_height_small:I

    invoke-virtual {p1, v0}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result p1

    iput p1, p0, Lmiuix/appcompat/app/t;->k:I
...
.method public final J(Landroid/view/WindowInsets;)V
    ...
    invoke-static {}, LT/c;->a()I

    move-result v2

    invoke-static {v1, v2}, LS/g0;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {v1, v2}, LS/f0;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {v1, v4}, LS/g0;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    invoke-static {v13}, LPo/a;->e(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {v13, v12}, LPo/p;->b(Landroid/content/Context;Landroid/graphics/Point;)V
    ...
    invoke-static {v7, v13}, LPo/k;->p(FF)I

    move-result v13

    int-to-float v3, v3

    invoke-static {v7, v3}, LPo/k;->p(FF)I

    move-result v3

    invoke-virtual {v11, v13, v3}, Landroid/graphics/Point;->set(II)V

    iget-object v3, v0, Lmiuix/appcompat/app/AlertController;->B:Lmiuix/appcompat/app/w;

    iget-object v7, v3, Lmiuix/appcompat/app/w;->b:LBo/d;
    ...
    :goto_5
    new-instance v2, Lmiuix/appcompat/app/v;
    ...
    iput-boolean v5, v2, Lmiuix/appcompat/app/v;->a:Z

    iput-boolean v1, v2, Lmiuix/appcompat/app/v;->b:Z

    iput-boolean v7, v2, Lmiuix/appcompat/app/v;->c:Z

    iput-boolean v9, v2, Lmiuix/appcompat/app/v;->d:Z

    iput v13, v2, Lmiuix/appcompat/app/v;->e:I

    iput v10, v2, Lmiuix/appcompat/app/v;->f:I

    iput-boolean v11, v2, Lmiuix/appcompat/app/v;->g:Z

    iget-object v1, v0, Lmiuix/appcompat/app/AlertController;->A:Lmiuix/appcompat/app/t;

    invoke-virtual {v3, v2, v1}, Lmiuix/appcompat/app/w;->a(Lmiuix/appcompat/app/v;Lmiuix/appcompat/app/t;)I

    move-result v2

    new-instance v5, Lmiuix/appcompat/app/u;
    ...
    iput-object v7, v5, Lmiuix/appcompat/app/u;->j:Landroid/graphics/Rect;
    ...
    iput v9, v5, Lmiuix/appcompat/app/u;->a:I

    iput v10, v5, Lmiuix/appcompat/app/u;->b:I

    iput v6, v5, Lmiuix/appcompat/app/u;->c:I

    iput v2, v5, Lmiuix/appcompat/app/u;->d:I

    iput v13, v5, Lmiuix/appcompat/app/u;->e:I

    move/from16 v6, v20

    iput v6, v5, Lmiuix/appcompat/app/u;->f:I

    iput v8, v5, Lmiuix/appcompat/app/u;->g:I

    iput-boolean v11, v5, Lmiuix/appcompat/app/u;->h:Z

    iput-boolean v12, v5, Lmiuix/appcompat/app/u;->i:Z

    new-instance v6, Landroid/graphics/Rect;

    invoke-direct {v6}, Landroid/graphics/Rect;-><init>()V

    iget-object v3, v3, Lmiuix/appcompat/app/w;->b:LBo/d;
    ...
    :cond_14
    iget v3, v5, Lmiuix/appcompat/app/u;->g:I

    iget v9, v5, Lmiuix/appcompat/app/u;->c:I

    invoke-static {v3, v9}, Ljava/lang/Math;->max(II)I

    move-result v3

    iget v9, v5, Lmiuix/appcompat/app/u;->a:I

    iget v10, v5, Lmiuix/appcompat/app/u;->b:I
    ...
    :goto_8
    iget v10, v5, Lmiuix/appcompat/app/u;->d:I

    iget v11, v5, Lmiuix/appcompat/app/u;->e:I

    const/16 v12, 0x168

    if-ge v11, v12, :cond_16

    iget v11, v1, Lmiuix/appcompat/app/t;->f:I
    ...
    iget v11, v1, Lmiuix/appcompat/app/t;->g:I
    ...
    iget v8, v5, Lmiuix/appcompat/app/u;->f:I
    ...
    :cond_18
    iget-boolean v8, v5, Lmiuix/appcompat/app/u;->h:Z

    if-eqz v8, :cond_19

    iget v8, v1, Lmiuix/appcompat/app/t;->f:I

    goto :goto_a

    :cond_19
    iget v8, v1, Lmiuix/appcompat/app/t;->d:I
    ...
    :goto_c
    iget-boolean v15, v5, Lmiuix/appcompat/app/u;->i:Z
    ...
    iget v15, v1, Lmiuix/appcompat/app/t;->f:I

    invoke-static {v4, v14, v15}, LB2/m;->i(Ljava/lang/StringBuilder;Ljava/lang/String;I)V
    ...
    :goto_e
    iget-boolean v9, v5, Lmiuix/appcompat/app/u;->i:Z
    ...
    iget v3, v5, Lmiuix/appcompat/app/u;->f:I
    ...
    :goto_11
    iget-boolean v5, v5, Lmiuix/appcompat/app/u;->i:Z
    ...
    invoke-static/range {v19 .. v19}, LPo/k;->j(Landroid/content/Context;)Z
    ...
    invoke-static/range {v19 .. v19}, Lop/b;->d(Landroid/content/Context;)Z
    ...
    iget v1, v1, Lmiuix/appcompat/app/t;->i:I
    ...
    invoke-static {v4, v3}, LS/g0;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
...
.method public final K()V
    ...
    invoke-static {v2, v1}, LPo/a;->d(Landroid/content/Context;Landroid/content/res/Configuration;)LPo/n;
    ...
    iget-object v2, v0, LPo/n;->d:Landroid/graphics/Point;
    ...
    iget-object v0, v0, LPo/n;->c:Landroid/graphics/Point;
...
.method public final L()V
    ...
    iget-object v1, p0, Lmiuix/appcompat/app/AlertController;->d:Lmiuix/appcompat/app/m;

    invoke-virtual {v1}, Lmiuix/appcompat/app/m;->j()Landroid/app/Activity;
...
.method public final b(Lmiuix/appcompat/internal/widget/DialogButtonPanel;I)Z
    ...
    invoke-static {v5}, LPo/a;->e(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    :goto_1
    new-instance v9, Lmiuix/appcompat/app/s;

    invoke-direct {v9}, Ljava/lang/Object;-><init>()V

    iput v3, v9, Lmiuix/appcompat/app/s;->a:I

    iput v3, v9, Lmiuix/appcompat/app/s;->b:I

    iput v3, v9, Lmiuix/appcompat/app/s;->c:I

    iput v3, v9, Lmiuix/appcompat/app/s;->d:I
    ...
    :goto_2
    iput v1, v9, Lmiuix/appcompat/app/s;->a:I

    iput v10, v9, Lmiuix/appcompat/app/s;->b:I

    iput v6, v9, Lmiuix/appcompat/app/s;->c:I

    iput v4, v9, Lmiuix/appcompat/app/s;->d:I

    iput-boolean v11, v9, Lmiuix/appcompat/app/s;->e:Z

    iput v12, v9, Lmiuix/appcompat/app/s;->f:I

    move/from16 v1, p2

    iput v1, v9, Lmiuix/appcompat/app/s;->g:I

    iput v13, v9, Lmiuix/appcompat/app/s;->h:I

    iput-boolean v5, v9, Lmiuix/appcompat/app/s;->i:Z

    iput-boolean v14, v9, Lmiuix/appcompat/app/s;->j:Z
    ...
    invoke-static {v2, v10, v12, v13, v14}, LB2/m;->h(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v12, v11, v13, v5, v14}, LA1/v;->i(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    :cond_8
    :goto_4
    iget-object v0, v0, Lmiuix/appcompat/app/AlertController;->B:Lmiuix/appcompat/app/w;

    iget-object v0, v0, Lmiuix/appcompat/app/w;->a:LBo/c;
    ...
    :cond_9
    iget v0, v9, Lmiuix/appcompat/app/s;->a:I
    ...
    :cond_a
    iget v0, v9, Lmiuix/appcompat/app/s;->c:I

    invoke-static {v0, v8}, Ljava/lang/Math;->max(II)I

    move-result v0

    iget v1, v9, Lmiuix/appcompat/app/s;->b:I

    iget v2, v9, Lmiuix/appcompat/app/s;->a:I
    ...
    iget v4, v9, Lmiuix/appcompat/app/s;->d:I
    ...
    iget-boolean v0, v9, Lmiuix/appcompat/app/s;->e:Z

    if-eqz v0, :cond_b

    iget v2, v9, Lmiuix/appcompat/app/s;->f:I
    ...
    :goto_5
    iget-boolean v5, v9, Lmiuix/appcompat/app/s;->j:Z

    if-nez v5, :cond_d

    if-nez v0, :cond_c

    iget v0, v9, Lmiuix/appcompat/app/s;->h:I
    ...
    :cond_c
    iget v0, v9, Lmiuix/appcompat/app/s;->g:I
    ...
    :goto_6
    iget-boolean v5, v9, Lmiuix/appcompat/app/s;->i:Z
...
.method public final e(Lmiuix/appcompat/app/l;)V
    .locals 5
    ...
    invoke-static {v0}, LJ5/Z;->f(Landroid/view/View;)V
    ...
    invoke-virtual {p1}, Lmiuix/appcompat/app/l;->end()V
    ...
    invoke-static {v0, v2}, LPo/a;->d(Landroid/content/Context;Landroid/content/res/Configuration;)LPo/n;
    ...
    iget-object p0, p0, Lmiuix/appcompat/app/AlertController;->g0:LLo/b;

    invoke-virtual {p0, v0, v1, v2, p1}, LLo/b;->a(Landroid/view/View;ZLandroid/view/View;Lmiuix/appcompat/app/l;)V
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/m;->o()V
    :try_end_0
...
.method public final f(I)Landroid/graphics/Insets;
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/m;->j()Landroid/app/Activity;
...
.method public final h()Landroid/graphics/Point;
    ...
    invoke-static {v4, v8}, LS/f0;->a(Landroid/view/WindowInsets;I)Landroid/graphics/Insets;
    ...
    sget-object v8, LPo/a;->f:Ljava/lang/Object;
    ...
    invoke-static {v8}, LS/i0;->b(Landroid/content/Context;)Landroid/view/Display;
...
.method public final i()I
    ...
    iget v2, v2, Lmiuix/appcompat/app/t;->d:I
    ...
    invoke-static {v2, v7}, LS/h0;->c(Landroid/view/WindowInsets;I)Z
...
.method public final j()V
    ...
    invoke-static {v1}, LS/i0;->b(Landroid/content/Context;)Landroid/view/Display;
    ...
    invoke-static {v2, v3, v4}, LIp/a;->d(Ljava/lang/Class;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
...
.method public final l(Landroid/graphics/Rect;)I
    ...
    iget v2, v3, Lmiuix/appcompat/app/t;->f:I

    goto :goto_0

    :cond_0
    iget v2, v3, Lmiuix/appcompat/app/t;->d:I
    ...
    invoke-static {v9, v7, v10, v1, v11}, LA1/v;->i(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    iget v4, v3, Lmiuix/appcompat/app/t;->h:I
    ...
    :cond_c
    iget v4, v3, Lmiuix/appcompat/app/t;->i:I

    iget v5, v3, Lmiuix/appcompat/app/t;->d:I
    ...
    iget p1, v3, Lmiuix/appcompat/app/t;->h:I

    goto :goto_a

    :cond_e
    iget p1, v3, Lmiuix/appcompat/app/t;->i:I

    iget v3, v3, Lmiuix/appcompat/app/t;->d:I
    ...
    invoke-static {v0}, LPo/a;->c(Landroid/content/Context;)I
...
.method public final r()Z
    ...
    sget v0, Lwo/a$c;->dialogListPreferredItemHeight:I

    iget-object v1, p0, Lmiuix/appcompat/app/AlertController;->c:Landroid/content/Context;

    invoke-static {v1, v0}, Lgp/d;->f(Landroid/content/Context;I)I
    ...
    :goto_0
    invoke-static {v1}, LPo/p;->e(Landroid/content/Context;)Z
    ...
    :goto_2
    invoke-static {v1}, LPo/a;->b(Landroid/content/Context;)Landroid/graphics/Point;
    ...
    invoke-static {v1, v9}, LPo/k;->q(Landroid/content/Context;F)I
    ...
    invoke-static {v2, v0, v4, v8, v9}, LB2/m;->h(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final t(Landroid/graphics/Rect;)V
    ...
    invoke-static {p0, v0}, LPo/k;->p(FF)I
...
.method public final u()V
    ...
    sget v2, Lwo/a$c;->dialogListPreferredItemHeight:I

    invoke-static {v1, v2}, Lgp/d;->f(Landroid/content/Context;I)I
...
.method public final z(Landroid/widget/FrameLayout;)Z
    ...
    sget p0, Lwo/a$l;->Animation_Dialog_ExistIme:I
    ...
    invoke-static {p1, v1}, Lmiuix/appcompat/app/AlertController;->v(Landroid/view/ViewGroup;Landroid/view/View;)V

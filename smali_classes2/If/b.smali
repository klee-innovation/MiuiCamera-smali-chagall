...
.field public r:LIf/f;

.field public final s:Ljava/lang/StringBuilder;

.field public t:Z

.field public final u:LB4/c;
...
.method public constructor <init>(Ljava/lang/String;)V
    ...
    iput-object v0, p0, LIf/b;->q:Landroid/os/Handler;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    iput-object v0, p0, LIf/b;->s:Ljava/lang/StringBuilder;
    ...
    iput-object v0, p0, LIf/b;->u:LB4/c;
    ...
    iput-object p1, p0, LIf/b;->n:Ljava/lang/String;

    const/4 p1, 0x0

    iput-boolean p1, p0, LIf/b;->t:Z
...
.method public final a(Ltv/danmaku/ijk/media/player/IjkMediaPlayer;)V
    ...
    invoke-super {p0, p1}, LIf/h;->a(Ltv/danmaku/ijk/media/player/IjkMediaPlayer;)V

    iget-object p1, p0, LIf/h;->f:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
...
.method public final onError(Ltv/danmaku/ijk/media/player/IMediaPlayer;II)Z
    ...
    iget-object v3, p0, LIf/b;->n:Ljava/lang/String;

    invoke-static {v3, p1, v2}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    invoke-virtual {p0}, LIf/b;->i()V

    iget-object p1, p0, LIf/h;->j:Landroid/widget/RelativeLayout;

    if-eqz p1, :cond_0

    iget-boolean p1, p0, LIf/b;->t:Z
...
.method public final onPrepared(Ltv/danmaku/ijk/media/player/IMediaPlayer;)V
    ...
    iget-object p1, p0, LIf/b;->q:Landroid/os/Handler;
...
.method public final onRpcResult(Ltv/danmaku/ijk/media/player/IMediaPlayer;Ljava/lang/String;)V
    ...
    invoke-static {p2}, Lei/h;->a(Ljava/lang/String;)I
    ...
    invoke-direct {p1, p0, p2}, LAp/m;-><init>(Ljava/lang/Object;I)V
...
.method public final onRtpHdrExtAvailable(Ltv/danmaku/ijk/media/player/IMediaPlayer;Ljava/nio/ByteBuffer;I)V
    ...
    iget-object p1, p0, LIf/b;->r:LIf/f;

    if-nez p1, :cond_2

    new-instance p1, LIf/f;

    invoke-direct {p1}, LIf/f;-><init>()V

    iput-object p1, p0, LIf/b;->r:LIf/f;
    ...
    iput-byte p3, p1, LIf/f;->b:B

    invoke-virtual {p2}, Ljava/nio/ByteBuffer;->get()B

    move-result p3

    iput-byte p3, p1, LIf/f;->c:B
...
.method public final onVideoSizeChanged(Ltv/danmaku/ijk/media/player/IMediaPlayer;IIII)V
    ...
    invoke-direct {p4, p0, p2, p3}, LIf/a;-><init>(LIf/b;II)V

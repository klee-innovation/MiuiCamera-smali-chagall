...
.field public c:Lgf/h;

.field public d:Lgf/g;

.field public e:Lgf/b;

.field public f:Lpf/a;

.field public g:Ljava/util/HashMap;

.field public h:Lgf/e;

.field public i:Lgf/l;
...
.field public m:Lgf/i;

.field public n:Lmf/E4;

.field public o:Lgf/k;


# virtual methods
.method public final a(Ljava/lang/Class;)Lff/b;
    .locals 0
    ...
    iget-object p0, p0, Lgf/f;->g:Ljava/util/HashMap;
...
.method public final b(IZ)V
    ...
    iget-object v0, v1, Lgf/f;->f:Lpf/a;
    ...
    iget-object v0, v1, Lgf/f;->o:Lgf/k;

    invoke-virtual {v0, v4}, Lgf/k;->b(Z)V
    ...
    iput v0, v5, Lbf/a;->a:I

    iput-object v1, v5, Ldf/a;->l:Lgf/f;

    const-string v0, "DAA-TOKEN-V1"

    iput-object v0, v5, Ldf/a;->m:Ljava/lang/String;

    new-instance v0, Ljq/x;

    invoke-direct {v0}, Ljq/x;-><init>()V

    iput-object v0, v5, Ldf/a;->n:Ljq/x;

    iget-object v0, v1, Lgf/f;->l:Landroid/content/Context;
    ...
    invoke-static {v7, v0}, Lrf/a;->d(Ljava/lang/String;Ljava/lang/String;)V

    :goto_0
    const-string v0, "MD5"

    invoke-static {v0, v9}, Lgj/c;->f(Ljava/lang/String;[B)Ljava/lang/String;

    move-result-object v0

    iput-object v0, v5, Ldf/a;->e:Ljava/lang/String;
    ...
    iput-object v0, v5, Ldf/a;->f:Ljava/lang/String;

    iget-object v0, v1, Lgf/f;->n:Lmf/E4;

    iget-object v0, v0, Lmf/E4;->a:Lqj/a;
    ...
    iput-object v0, v5, Ldf/a;->g:Ljava/lang/String;

    iget-object v0, v1, Lgf/f;->b:Lel/a;

    const-string v7, "aivs.env"

    const/4 v8, -0x1

    invoke-virtual {v0, v7, v8}, Lel/a;->b(Ljava/lang/String;I)I
    ...
    invoke-virtual {v0, v8}, Lel/a;->c(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    iput-object v8, v5, Ldf/a;->h:Ljava/lang/String;
    ...
    iput-object v8, v5, Ldf/a;->i:Ljava/lang/String;
    ...
    iput-object v8, v5, Ldf/a;->j:Ljava/lang/String;
    ...
    iget v6, v5, Lbf/a;->a:I

    iget-object v8, v1, Lgf/f;->l:Landroid/content/Context;
    ...
    iput-object v0, v5, Ldf/a;->k:Ljava/lang/String;
    ...
    invoke-virtual {v0, v6}, Lel/a;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v6, v1, Lgf/f;->n:Lmf/E4;

    iget-object v8, v1, Lgf/f;->e:Lgf/b;

    invoke-direct {v0, v2, v6, v5, v8}, Lpf/a;-><init>(Lel/a;Lmf/E4;Ldf/a;LCn/l;)V

    new-instance v6, Ljq/x$a;

    invoke-direct {v6}, Ljq/x$a;-><init>()V

    new-instance v8, Ljq/x;

    invoke-direct {v8, v6}, Ljq/x;-><init>(Ljq/x$a;)V

    iput-object v8, v0, Lpf/d;->k:Ljq/x;
    ...
    invoke-virtual {v6, v8, v10}, Lel/a;->a(Ljava/lang/String;Z)Z
    ...
    :cond_5
    iget-object v6, v0, Lpf/a;->c:LCn/l;

    const-string v12, "wss_expire_at"

    invoke-virtual {v6, v12}, LCn/l;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-boolean v10, v0, Lpf/d;->j:Z

    const-string v6, "checkWssMode:not in wss mode"

    :goto_3
    invoke-static {v8, v6}, Lrf/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v6, v12}, LCn/l;->h(Ljava/lang/String;)V
    ...
    iget-object v14, v2, Lel/a;->a:Ljava/util/HashMap;
    ...
    invoke-virtual {v2, v10}, Lel/a;->c(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_8
    invoke-virtual {v2, v7, v4}, Lel/a;->b(Ljava/lang/String;I)I
    ...
    :cond_b
    invoke-virtual {v2, v13, v4}, Lel/a;->a(Ljava/lang/String;Z)Z
    ...
    :goto_5
    invoke-direct {v6, v0, v2}, Ltf/d;-><init>(Lpf/a;Ljava/lang/String;)V

    :goto_6
    iput-object v6, v0, Lpf/a;->f:Ltf/d;
    ...
    iget-object v7, v1, Lgf/f;->e:Lgf/b;

    invoke-direct {v0, v2, v6, v5, v7}, Lpf/a;-><init>(Lel/a;Lmf/E4;Ldf/a;LCn/l;)V
    ...
    :goto_8
    iput-object v0, v5, Lbf/a;->b:Lpf/a;

    iput-object v0, v1, Lgf/f;->f:Lpf/a;
    ...
    iget-object v2, v1, Lgf/f;->o:Lgf/k;

    iget-object v5, v2, Lgf/k;->c:Lgf/f;

    iget-object v5, v5, Lgf/f;->b:Lel/a;

    invoke-virtual {v5, v3, v4}, Lel/a;->a(Ljava/lang/String;Z)Z

    move-result v3

    if-eqz v3, :cond_14

    iget-object v2, v2, Lgf/k;->b:Landroid/os/Handler;
    ...
    iget-object v1, v1, Lgf/k;->d:Ljf/a;

    iput-object v1, v0, Lpf/a;->h:Ljf/a;
    ...
    invoke-static {v6, v0}, Lrf/a;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final c()I
    ...
    invoke-virtual {v2, v0, v3}, Lel/a;->b(Ljava/lang/String;I)I
    ...
    invoke-virtual {v2, v4, v5}, Lel/a;->b(Ljava/lang/String;I)I
    ...
    :cond_0
    iget-object v4, v1, Lgf/f;->l:Landroid/content/Context;

    const-string v5, "aivs_cloud_control"

    const-string v9, "link_mode"

    invoke-static {v4, v5, v9}, Lkf/b;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v4, v1, Lgf/f;->e:Lgf/b;

    invoke-virtual {v4, v9}, Lgf/b;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v5}, Lrf/a;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v6, v8}, Lel/a;->e(Ljava/lang/String;Z)V
    ...
    invoke-virtual {v2, v6, v3}, Lel/a;->e(Ljava/lang/String;Z)V
    ...
    :cond_5
    iget-object v0, v1, Lgf/f;->e:Lgf/b;

    const-string v5, "xmd_ws_expire_at"

    invoke-virtual {v0, v5}, Lgf/b;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v0}, Lrf/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5}, Lgf/b;->h(Ljava/lang/String;)V
...
.method public final d()V
    ...
    iget-object v0, p0, Lgf/f;->n:Lmf/E4;

    if-eqz v0, :cond_0

    iget-object v0, v0, Lmf/E4;->f:Lqj/a;
    ...
    iget-object p0, p0, Lgf/f;->n:Lmf/E4;

    iget-object p0, p0, Lmf/E4;->f:Lqj/a;
    ...
    invoke-static {v0, p0}, Lrf/a;->c(Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method public final e(Lff/b;)V
    .locals 1

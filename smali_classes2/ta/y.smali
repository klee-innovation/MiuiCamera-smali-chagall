...
.method public static b(Ljava/util/List;)Lcom/google/android/exoplayer2/metadata/Metadata;
    ...
    invoke-static {v8, v5, v4}, Llb/m;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
...
.method public static c(Llb/w;ZZ)Lta/y$a;
    .locals 5
    ...
    invoke-static {p1, p0, v0}, Lta/y;->d(ILlb/w;Z)Z

    :cond_0
    invoke-virtual {p0}, Llb/w;->i()J
    ...
    invoke-virtual {p0, p1, v1}, Llb/w;->p(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3, v4}, Llb/w;->p(ILjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    :cond_3
    :goto_1
    new-instance p0, Lta/y$a;

    invoke-direct {p0, p1}, Lta/y$a;-><init>([Ljava/lang/String;)V

    return-object p0
.end method

.method public static d(ILlb/w;Z)Z
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Loa/S;
    ...
    invoke-static {v2, p0}, Loa/S;->a(Ljava/lang/Exception;Ljava/lang/String;)Loa/S;

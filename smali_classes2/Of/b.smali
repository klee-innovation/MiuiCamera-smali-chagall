...
.method public final onRequestResult(LKd/h;)V
    ...
    sget-object p0, LOf/d;->a:Ljava/util/Map;

    if-nez p0, :cond_5

    const-class p0, LOf/d;
    ...
    invoke-static {v0, v1, v2}, LKd/b;->d(Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/Object;
    ...
    invoke-virtual {v1, v0}, LWe/l;->fromJson(Ljava/lang/String;)Ljava/lang/Object;
    ...
    sput-object p1, LOf/d;->a:Ljava/util/Map;
    ...
    :cond_5
    :goto_7
    sget-object p1, LNf/b;->b:Ljava/util/LinkedHashMap;

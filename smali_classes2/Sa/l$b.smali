...
.method public constructor <init>(Lkb/m;Lcom/google/android/exoplayer2/drm/d;Lcom/google/android/exoplayer2/drm/c$a;Ljava/util/Map;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1, p2, p3}, LNa/I;-><init>(Lkb/m;Lcom/google/android/exoplayer2/drm/d;Lcom/google/android/exoplayer2/drm/c$a;)V

    .line 2
    iput-object p4, p0, LSa/l$b;->H:Ljava/util/Map;
...
# virtual methods
.method public final m(Loa/G;)Loa/G;
    .locals 10

    iget-object v0, p0, LSa/l$b;->I:Lcom/google/android/exoplayer2/drm/DrmInitData;
    ...
    :cond_0
    iget-object v0, p1, Loa/G;->o:Lcom/google/android/exoplayer2/drm/DrmInitData;

    :goto_0
    if-eqz v0, :cond_1

    iget-object v1, p0, LSa/l$b;->H:Ljava/util/Map;
    ...
    :cond_1
    iget-object v1, p1, Loa/G;->j:Lcom/google/android/exoplayer2/metadata/Metadata;
    ...
    iput-object v0, p1, Loa/G$a;->n:Lcom/google/android/exoplayer2/drm/DrmInitData;

    iput-object v1, p1, Loa/G$a;->i:Lcom/google/android/exoplayer2/metadata/Metadata;

    new-instance v0, Loa/G;

    invoke-direct {v0, p1}, Loa/G;-><init>(Loa/G$a;)V

    move-object p1, v0

    :cond_b
    invoke-super {p0, p1}, LNa/I;->m(Loa/G;)Loa/G;

...
.field public final synthetic q:LLo/e$d;


# direct methods
.method public constructor <init>(LLo/e$d;Landroid/graphics/Rect;Landroid/view/View;IIIIIIIIIIIIII)V
    .locals 2
    ...
    iput-object v1, v0, LLo/m;->q:LLo/e$d;

    move-object v1, p2

    iput-object v1, v0, LLo/m;->a:Landroid/graphics/Rect;

    move-object v1, p3

    iput-object v1, v0, LLo/m;->b:Landroid/view/View;

    move v1, p4

    iput v1, v0, LLo/m;->c:I

    move v1, p5

    iput v1, v0, LLo/m;->d:I

    move v1, p6

    iput v1, v0, LLo/m;->e:I

    move v1, p7

    iput v1, v0, LLo/m;->f:I

    move v1, p8

    iput v1, v0, LLo/m;->g:I

    move v1, p9

    iput v1, v0, LLo/m;->h:I

    move v1, p10

    iput v1, v0, LLo/m;->i:I

    move v1, p11

    iput v1, v0, LLo/m;->j:I

    move v1, p12

    iput v1, v0, LLo/m;->k:I

    move v1, p13

    iput v1, v0, LLo/m;->l:I

    move/from16 v1, p14

    iput v1, v0, LLo/m;->m:I

    move/from16 v1, p15

    iput v1, v0, LLo/m;->n:I

    move/from16 v1, p16

    iput v1, v0, LLo/m;->o:I

    move/from16 v1, p17

    iput v1, v0, LLo/m;->p:I
...
.method public final onPreDraw()Z
    ...
    iget-object v2, p0, LLo/m;->q:LLo/e$d;

    iget-object v3, v2, LLo/e$d;->a:Lmiuix/smooth/SmoothFrameLayout2;

    sget v4, Lwo/a$h;->tag_secondary_popup_menu_item_head:I
    ...
    :cond_0
    iget-object v4, v2, LLo/e$d;->a:Lmiuix/smooth/SmoothFrameLayout2;
    ...
    iget-object v4, p0, LLo/m;->a:Landroid/graphics/Rect;

    invoke-virtual {v4}, Landroid/graphics/Rect;->height()I

    move-result v4

    iput v4, v2, LLo/e$d;->l:I

    iget-object v4, p0, LLo/m;->b:Landroid/view/View;

    invoke-virtual {v4}, Landroid/view/View;->getPaddingTop()I

    move-result v5

    iput v5, v2, LLo/e$d;->m:I

    invoke-virtual {v4}, Landroid/view/View;->getPaddingBottom()I

    move-result v4

    iput v4, v2, LLo/e$d;->n:I

    invoke-virtual {v3}, Landroid/view/View;->getHeight()I

    move-result v4

    iput v4, v2, LLo/e$d;->o:I

    invoke-virtual {v3}, Landroid/view/View;->getPaddingTop()I

    move-result v4

    iput v4, v2, LLo/e$d;->p:I

    invoke-virtual {v3}, Landroid/view/View;->getPaddingBottom()I

    move-result v10

    iput v10, v2, LLo/e$d;->q:I

    iget v11, v2, LLo/e$d;->l:I

    iget v12, v2, LLo/e$d;->o:I

    iget v7, v2, LLo/e$d;->m:I

    iget v8, v2, LLo/e$d;->p:I

    iget v9, v2, LLo/e$d;->n:I

    iput-object v3, v2, LLo/e$d;->k:Landroid/view/View;

    new-instance v3, Lmiuix/animation/base/AnimConfig;

    invoke-direct {v3}, Lmiuix/animation/base/AnimConfig;-><init>()V

    new-instance v4, LLo/m$a;

    move-object v5, v4

    move-object v6, p0

    invoke-direct/range {v5 .. v12}, LLo/m$a;-><init>(LLo/m;IIIIII)V
    ...
    sget-object v3, LLo/e$f;->g:LLo/e$f$a;
    ...
    iget-object v4, v2, LLo/e$d;->i:LLo/e$f;

    invoke-static {v4}, Lmiuix/animation/Folme;->use(Lmiuix/animation/FolmeObject;)Lmiuix/animation/Folme$ObjectFolmeImpl;

    iget-object v4, v2, LLo/e$d;->i:LLo/e$f;

    iget v4, v4, LLo/e$f;->d:F

    iget-object v5, v2, LLo/e$d;->s:LLo/e;

    iget v5, v5, LLo/e;->y0:F

    iget-object v6, v2, LLo/e$d;->a:Lmiuix/smooth/SmoothFrameLayout2;
    ...
    sget-object v7, LLo/e$f;->h:LLo/e$f$b;
    ...
    iget-object v3, v2, LLo/e$d;->i:LLo/e$f;

    iget-object v3, v3, LLo/e$f;->f:Lmiuix/animation/Folme$ObjectFolmeImpl;
    ...
    iget-object v2, v2, LLo/e$d;->i:LLo/e$f;

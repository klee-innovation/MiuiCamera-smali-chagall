...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lag/k;->e(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
.end annotation
...
# direct methods
.method public constructor <init>(Lag/k;Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    .locals 0
    ...
    iput-object p1, p0, Lag/k$b;->c:Lag/k;

    iput-object p2, p0, Lag/k$b;->a:Lcom/xiaomi/protocol/ICustomCaptureResult;

    iput-boolean p3, p0, Lag/k$b;->b:Z
...
.method public final run()V
    ...
    iget-object v1, v0, Lag/k$b;->a:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    sget-object v6, LFf/d;->b:LFf/d;

    iget-object v7, v0, Lag/k$b;->c:Lag/k;

    iget-object v8, v7, Lag/k;->d:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    invoke-direct {v12, v5, v13}, Lag/l;-><init>(Ljava/lang/Object;I)V

    invoke-interface {v11, v12}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object v11

    new-instance v12, LH5/m0;

    const/4 v13, 0x7

    invoke-direct {v12, v13}, LH5/m0;-><init>(I)V
    ...
    check-cast v11, LFf/b;

    if-nez v11, :cond_0

    invoke-static {v7, v2, v3}, Lag/k;->a(Lag/k;J)J
    ...
    invoke-static {v11, v12, v8}, LF9/d;->d(JLjava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    iget v6, v8, LFf/b;->b:I

    iget-boolean v11, v8, LFf/b;->l:Z

    iget-object v12, v8, LFf/b;->o:LFf/d;

    iget-boolean v13, v8, LFf/b;->m:Z

    iget-wide v14, v8, LFf/b;->d:J

    const/4 v8, 0x1

    :goto_1
    iget-object v10, v7, Lag/k;->c:Landroid/util/LongSparseArray;
    ...
    invoke-direct/range {v16 .. v21}, LFf/b$a;-><init>(IZLFf/d;ZZ)V

    iput-object v5, v10, LFf/b$a;->p:Ljava/lang/String;

    iget-object v5, v7, Lag/k;->c:Landroid/util/LongSparseArray;
    ...
    invoke-static {v6, v5}, LV1/Y;->a(ILjava/lang/String;)Ljava/lang/String;
    ...
    :goto_2
    iget-boolean v1, v10, LFf/b$a;->f:Z

    if-eq v1, v11, :cond_5

    iput-boolean v11, v10, LFf/b$a;->f:Z

    :cond_5
    iget-object v1, v10, LFf/b$a;->h:LFf/d;

    if-eq v1, v12, :cond_6

    iput-object v12, v10, LFf/b$a;->h:LFf/d;

    :cond_6
    iget-boolean v1, v10, LFf/b$a;->i:Z

    if-eq v1, v13, :cond_7

    iput-boolean v13, v10, LFf/b$a;->i:Z

    :cond_7
    :goto_3
    iput-wide v14, v10, LFf/b$a;->n:J

    const-string v1, "setResult: timestamp = "

    const-string v5, ", firstTimestamp = "

    invoke-static {v2, v3, v1, v5}, LI/g;->g(JLjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-boolean v0, v0, Lag/k$b;->b:Z
    ...
    iget-boolean v1, v10, LFf/b$a;->m:Z

    if-nez v1, :cond_8

    iput-boolean v8, v10, LFf/b$a;->m:Z

    :cond_8
    move-object/from16 v1, v17

    invoke-virtual {v10, v1, v0}, LFf/b$a;->d(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    move-object/from16 v0, v16

    invoke-virtual {v0, v10}, Lag/k;->c(LFf/b$a;)V

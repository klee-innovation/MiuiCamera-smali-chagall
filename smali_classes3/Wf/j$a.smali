...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = LWf/j;->g(Landroid/content/Context;I)V
.end annotation
...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    iput-object p1, p0, LWf/j$a;->a:Landroid/content/Context;

    iput p2, p0, LWf/j$a;->b:I
...
.method public final a(Ljava/io/Serializable;)V
    ...
    iget-object v1, p0, LWf/j$a;->a:Landroid/content/Context;
    ...
    invoke-static {v1, p0, v0}, LWf/j;->d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    :try_start_0
    sget-object p0, LWf/j;->h:Ljava/lang/Boolean;
    ...
    :goto_0
    sget-object p1, Luf/F;->k:Ljava/nio/file/Path;

    invoke-interface {p1}, Ljava/nio/file/Path;->toFile()Ljava/io/File;

    move-result-object p1

    invoke-static {p0, p1}, LWf/j;->a(Ljava/io/File;Ljava/io/File;)V

    invoke-static {p0}, LWf/j;->b(Ljava/io/File;)V
    :try_end_1
    ...
    invoke-direct {v0, p1, v1}, LD4/e;-><init>(Ljava/lang/Object;I)V
    ...
    iget p0, p0, LWf/j$a;->b:I

    if-ge p0, p1, :cond_3

    add-int/2addr p0, v2

    invoke-static {v1, p0}, LWf/j;->g(Landroid/content/Context;I)V

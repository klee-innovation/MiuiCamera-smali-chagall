...
.field public static volatile z:LYf/f;
...
.method static constructor <clinit>()V
    ...
    sput-object v4, LYf/f;->x:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    sput-object v4, LYf/f;->y:Ljava/util/concurrent/atomic/AtomicBoolean;

    const-class v4, LYf/f;
    ...
    sput-object v6, LYf/f;->a:Ljava/lang/Class;

    sget-object v6, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    sput-object v6, LYf/f;->b:Ljava/lang/Boolean;

    sget-object v6, LYf/h;->a:Ljava/lang/Boolean;
    ...
    sget-object v6, LYf/g;->a:Ljava/lang/Boolean;
    ...
    :cond_0
    :goto_0
    sget-object v6, LYf/f;->a:Ljava/lang/Class;
    ...
    sput-object v6, LYf/f;->e:Ljava/lang/reflect/Method;
    :try_end_0
    ...
    invoke-static {v7, v6}, LB/c;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    sput-object v0, LYf/f;->e:Ljava/lang/reflect/Method;
    :try_end_1
    ...
    sput-object v0, LYf/f;->i:Ljava/lang/Class;
    :try_end_2
    ...
    sput-object v0, LYf/f;->o:Ljava/lang/Class;
    :try_end_4
...
.method public static a(II)V
    ...
    sget-object v0, LYf/f;->p:Ljava/lang/reflect/Method;
    ...
    invoke-direct {v2, v0, p0, p1}, LYf/a;-><init>(Ljava/lang/reflect/Method;II)V
    ...
    :cond_0
    sget-object v0, LYf/f;->i:Ljava/lang/Class;
    ...
    sput-object v0, LYf/f;->p:Ljava/lang/reflect/Method;

    sget-object v1, Lcom/xiaomi/camera/rx/CameraSchedulers;->sCameraWorkScheduler:Lio/reactivex/v;

    new-instance v3, LYf/a;

    invoke-direct {v3, v0, p0, p1}, LYf/a;-><init>(Ljava/lang/reflect/Method;II)V
...
.method public static b(I)V
    ...
    :cond_5
    sget-object p0, LYf/f;->n:Ljava/lang/reflect/Method;
    ...
    :cond_6
    sget-object p0, LYf/f;->i:Ljava/lang/Class;
    ...
    sput-object p0, LYf/f;->n:Ljava/lang/reflect/Method;
...
.method public static c()LYf/f;
    .locals 2

    sget-object v0, LYf/f;->z:LYf/f;
...
.method public static d()Ljava/lang/String;
    ...
    sget-object v0, LYf/f;->b:Ljava/lang/Boolean;
    ...
    sget-object v0, LYf/f;->d:Ljava/lang/reflect/Method;
    ...
    const-string v2, "getSystemStatusJson invoke error:"
    ...
    :cond_0
    sget-object v0, LYf/f;->a:Ljava/lang/Class;

    if-eqz v0, :cond_2

    :try_start_1
    const-string v4, "getSystemStatusJson"
    ...
    sput-object v0, LYf/f;->d:Ljava/lang/reflect/Method;
    ...
    const-string v2, "Failed to getSystemStatusJson "
    ...
    const-string v2, "sSupportCameraOpt not support or flag is illegal"
...
.method public static e()I
    ...
    sget-object v0, LYf/f;->q:Ljava/lang/reflect/Method;
    ...
    :cond_0
    sget-object v0, LYf/f;->o:Ljava/lang/Class;
    ...
    sput-object v0, LYf/f;->q:Ljava/lang/reflect/Method;
...
.method public static f(ILjava/lang/String;)V
    ...
    sget-object v2, LYf/f;->e:Ljava/lang/reflect/Method;
...
.method public static g()Z
    ...
    sget-object v1, LYf/f;->x:Ljava/util/concurrent/atomic/AtomicInteger;

    sget-boolean v2, Lg9/b;->X:Z
    ...
    :cond_2
    sget-object v4, LYf/f;->w:Ljava/lang/reflect/Method;

    const/4 v6, 0x0

    if-nez v4, :cond_3

    sget-object v4, LYf/f;->i:Ljava/lang/Class;
    ...
    sput-object v4, LYf/f;->w:Ljava/lang/reflect/Method;
...
.method public static h()V
    ...
    sget-object v0, LYf/f;->m:Ljava/lang/reflect/Method;
    ...
    sput-object v0, LYf/f;->m:Ljava/lang/reflect/Method;
...
.method public static i(J)V
    ...
    sget-object v0, LYf/f;->k:Ljava/lang/reflect/Method;
    ...
    sput-object v0, LYf/f;->k:Ljava/lang/reflect/Method;
...
.method public static j(Landroid/view/Surface;)V
    .locals 7
    ...
    invoke-direct {v6, p0}, LYf/e;-><init>(Landroid/view/Surface;)V
    ...
    invoke-static {p0, v2}, LF1/h;->d(Ljava/lang/Exception;Ljava/lang/String;)Ljava/lang/String;
...
.method public static varargs k(I[Ljava/lang/Object;)V
    .locals 2
    ...
    :pswitch_0
    sget-object v0, LYf/g;->a:Ljava/lang/Boolean;
    ...
    invoke-direct {v1, p0, p1}, LYf/d;-><init>(I[Ljava/lang/Object;)V
    ...
    :pswitch_1
    sget-object v0, LYf/h;->a:Ljava/lang/Boolean;
    ...
    invoke-direct {v1, p0, p1}, LYf/c;-><init>(I[Ljava/lang/Object;)V
    ...
    invoke-direct {v1, p0, p1}, LYf/b;-><init>(I[Ljava/lang/Object;)V
...
.method public static varargs l(I[Ljava/lang/Object;)V
    ...
    invoke-static/range {p0 .. p0}, Lf0/a;->a(I)I
    ...
    invoke-static {v5, v0}, LYf/f;->f(ILjava/lang/String;)V
    :try_end_1
    ...
    :pswitch_34
    const-string v0, "CAMERA_APP_TRACE"

    goto/16 :goto_3

    :pswitch_35
    const-string v0, "CAMERA_STICKER_CAPTURE_START"
    ...
    :pswitch_49
    const-string v0, "ZOOM_TOGGLE_PANEL_DOWN"
...
.method public static m(I)I
    ...
    sget-object v0, LYf/f;->g:Ljava/lang/reflect/Method;
    ...
    sput-object v0, LYf/f;->g:Ljava/lang/reflect/Method;
...
.method public static n()Z
    ...
    sget-object v0, LYf/f;->c:Ljava/lang/Boolean;
    ...
    :cond_0
    const-string v0, "isPerfLockEnabled is "

    sget-object v1, LYf/f;->b:Ljava/lang/Boolean;
    ...
    sput-object v1, LYf/f;->a:Ljava/lang/Class;

    sget-object v1, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    sput-object v1, LYf/f;->b:Ljava/lang/Boolean;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    sget-object v1, LYf/f;->h:Ljava/lang/reflect/Method;

    if-nez v1, :cond_3

    :try_start_1
    sget-object v1, LYf/f;->a:Ljava/lang/Class;

    const-string v5, "isPerfLockEnabled"
    ...
    sput-object v1, LYf/f;->h:Ljava/lang/reflect/Method;
    ...
    const-string v1, "isPerfLockEnabled is not support "
    ...
    sput-object v0, LYf/f;->b:Ljava/lang/Boolean;
    ...
    sput-object v0, LYf/f;->c:Ljava/lang/Boolean;
    ...
    :cond_4
    sget-object v0, LYf/f;->f:Ljava/lang/reflect/Method;
    ...
    sput-object v0, LYf/f;->f:Ljava/lang/reflect/Method;
    ...
    sput-object v1, LYf/f;->c:Ljava/lang/Boolean;
...
.method public static o(Ljava/lang/String;)Z
    ...
    sget-object v1, LYf/f;->i:Ljava/lang/Class;
    ...
    :try_start_0
    sget-object v7, LYf/f;->s:Ljava/lang/reflect/Method;
    ...
    sput-object v7, LYf/f;->s:Ljava/lang/reflect/Method;
    ...
    :cond_1
    :goto_0
    sget-object v7, LYf/f;->y:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :goto_2
    :try_start_1
    sget-object v3, LYf/f;->u:Ljava/lang/reflect/Method;
    ...
    sput-object v1, LYf/f;->u:Ljava/lang/reflect/Method;
    ...
    :cond_3
    :goto_3
    sget-object v1, LYf/f;->u:Ljava/lang/reflect/Method;
...
.method public static p(Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_0
    sget-object v1, LYf/f;->v:Ljava/lang/reflect/Method;
    ...
    sput-object v1, LYf/f;->v:Ljava/lang/reflect/Method;

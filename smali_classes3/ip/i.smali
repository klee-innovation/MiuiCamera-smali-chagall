...
# instance fields
.field public final j:Lmiuix/internal/widget/a;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v3, Lip/a;->a:Lip/a;

    invoke-direct {v1, p1, p0, v2, v3}, Lmiuix/internal/widget/a;-><init>(Landroid/content/Context;Lmiuix/appcompat/app/m;Landroid/view/Window;Lip/a;)V

    iput-object v1, p0, Lip/i;->j:Lmiuix/internal/widget/a;

    new-instance v2, Lip/h;

    invoke-direct {v2, p0}, Lip/h;-><init>(Lip/i;)V

    iput-object v2, v1, Lmiuix/internal/widget/a;->s:Lip/c;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Lwo/a$f;->miuix_appcompat_dialog_width_small_margin:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    iput v1, p0, Lip/i;->k:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Lwo/a$f;->miuix_appcompat_dialog_width_margin:I
    ...
    sget v2, Lwo/a$f;->miuix_appcompat_action_sheet_content_alert_max_fixed_width:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    iput v1, p0, Lip/i;->m:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Lwo/a$f;->miuix_appcompat_dialog_freeform_bottom_height_phone_t:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    iput v1, p0, Lip/i;->n:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Lwo/a$f;->miuix_appcompat_dialog_freeform_bottom_height_tablet_t:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v1

    iput v1, p0, Lip/i;->o:I

    sget-boolean v1, Lop/a;->g:Z
...
.method public final dismiss()V
    ...
    :goto_0
    iget-object v2, p0, Lip/i;->j:Lmiuix/internal/widget/a;

    iget-boolean v3, v2, Lmiuix/internal/widget/a;->J:Z

    if-eqz v3, :cond_1

    iget-boolean v3, v2, Lmiuix/internal/widget/a;->I:Z
    ...
    invoke-static {v1}, LPo/a;->j(Landroid/content/Context;)V
    ...
    invoke-virtual {p0, v0}, Lmiuix/appcompat/app/m;->g(Landroid/view/View;)V

    goto :goto_2

    :cond_5
    invoke-virtual {p0, v0}, Lmiuix/appcompat/app/m;->i(Landroid/view/View;)V
...
.method public final dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, Lip/i;->j:Lmiuix/internal/widget/a;
    ...
    :cond_0
    invoke-virtual {p0, p1}, Lmiuix/appcompat/app/m;->n(Landroid/view/KeyEvent;)Z
...
.method public final h(Landroid/view/View;)V
    ...
    invoke-virtual {p0, p1}, Lmiuix/internal/widget/a;->b(Lmiuix/appcompat/app/l;)V
...
.method public final onAttachedToWindow()V
    ...
    invoke-virtual {p0}, Lmiuix/appcompat/app/m;->r()V
    ...
    :goto_0
    iget-object v1, p0, Lip/i;->j:Lmiuix/internal/widget/a;
    ...
    invoke-direct {v3, v1}, Lip/e;-><init>(Lmiuix/internal/widget/a;)V

    invoke-virtual {v2}, Landroid/view/Window;->getDecorView()Landroid/view/View;

    move-result-object v4

    invoke-static {v4, v3}, LG3/k;->c(Landroid/view/View;Lip/e;)V

    new-instance v3, Lip/f;

    invoke-direct {v3, v1}, Lip/f;-><init>(Lmiuix/internal/widget/a;)V
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-static {p1}, LPo/a;->f(Landroid/content/Context;)Z
    ...
    iget-object v3, p0, Lmiuix/internal/widget/a;->b:Lmiuix/appcompat/app/m;

    invoke-virtual {v3, v2}, Li/s;->setContentView(I)V

    sget v2, Lwo/a$h;->action_sheet_root_view:I
    ...
    invoke-virtual {v2, v5}, Lmiuix/internal/widget/ActionSheetRootView;->setContentController(Lip/c;)V

    sget v2, Lwo/a$h;->action_sheet_dim_bg:I
    ...
    sget p1, Lwo/a$e;->miuix_color_transparent:I
    ...
    sget p1, Lwo/a$l;->Animation_Dialog_NoAnimation:I
    ...
    iget-object v5, p0, Lmiuix/internal/widget/a;->t:Lip/a;
    ...
    invoke-static {p1}, Lmiuix/appcompat/app/g;->b(Landroid/view/WindowManager$LayoutParams;)V
...
.method public final onStart()V
    ...
    sget-object v0, Lip/a;->b:Lip/a;

    iget-object v2, p0, Lmiuix/internal/widget/a;->t:Lip/a;
    ...
    iget-object v2, p0, Lmiuix/internal/widget/a;->H:LLo/b;

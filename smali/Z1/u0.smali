...
.method public constructor <init>(LZ1/D0;)V
    ...
    iput-object p1, p0, LZ1/u0;->f:[F

    new-instance p1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {p1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object p1, p0, LZ1/u0;->h:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, LZ1/u0;->i:Landroid/util/SparseArray;

    new-instance p1, Landroid/util/SparseArray;

    invoke-direct {p1}, Landroid/util/SparseArray;-><init>()V

    iput-object p1, p0, LZ1/u0;->j:Landroid/util/SparseArray;
...
.method public static j(I)F
    ...
    invoke-static {p0}, Lj8/d;->p(Lj8/c;)F
...
.method public final g(IIFFZ)V
    ...
    iget-object v0, p0, LZ1/u0;->h:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput v2, p5, Lcom/android/camera/data/data/d;->x:I

    iput-object p3, p5, Lcom/android/camera/data/data/d;->n:Ljava/lang/String;
    ...
    :cond_1
    iget-object p5, p0, LZ1/u0;->e:[F

    const v1, 0x3dcccccd    # 0.1f

    if-eqz p5, :cond_3

    iget-object v4, p0, LZ1/u0;->d:[F
    ...
    iget-object v4, p0, LZ1/u0;->e:[F

    aget v4, v4, p5

    iget-object v5, p0, LZ1/u0;->f:[F
...
.method public final getComponentValueJudgeSelect(ILjava/lang/String;)Landroid/util/Pair;
    ...
    iget-object v9, p0, LZ1/u0;->d:[F

    invoke-static {p1}, Ljava/lang/Float;->parseFloat(Ljava/lang/String;)F

    move-result v10

    invoke-static {v9, v10, v4}, LZ1/B0;->j([FFZ)F
    ...
    invoke-static {v9, v10, v6}, LZ1/B0;->j([FFZ)F
    ...
    :pswitch_5
    invoke-virtual {p0, p1}, LZ1/u0;->getDefaultValue(I)Ljava/lang/String;
...
.method public final getDefaultValue(I)Ljava/lang/String;
    ...
    invoke-virtual {v2, v1, v4}, Leg/a;->q(Ljava/lang/String;Ljava/lang/String;)Leg/a;
    ...
    :cond_5
    invoke-virtual {p0}, LZ1/u0;->isEmpty()Z

    move-result v1

    if-nez v1, :cond_6

    invoke-virtual {p0, v0}, LZ1/u0;->l(Ljava/lang/String;)F
...
.method public final getItems()Ljava/util/List;
    ...
    iget-object v0, p0, LZ1/u0;->i:Landroid/util/SparseArray;
    ...
    invoke-static {v2, v4, v3}, LA1/v;->d(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method public final h(F)Ljava/lang/String;
    ...
    invoke-virtual {p0}, LZ1/u0;->getItems()Ljava/util/List;
...
.method public final i(Ljava/lang/Object;)V
    ...
    check-cast v0, LZ1/H0$a;

    iget v1, v0, Lcom/android/camera/data/data/y;->a:I

    iput v1, v6, Lcom/android/camera/data/data/c;->mCurrentMode:I

    iget v2, v0, Lcom/android/camera/data/data/y;->b:I

    iput v2, v6, LZ1/u0;->a:I

    iget-object v0, v0, Lcom/android/camera/data/data/y;->c:Lj8/c;

    iput-object v0, v6, Lcom/android/camera/data/data/c;->mCapabilities:Lj8/c;

    iget v0, v0, Lj8/c;->e:I

    iput v0, v6, LZ1/u0;->b:I

    const/4 v0, 0x0

    iput-object v0, v6, LZ1/u0;->d:[F

    iput-object v0, v6, LZ1/u0;->e:[F

    invoke-virtual {v6, v1}, LZ1/u0;->isSupportMode(I)Z

    move-result v0

    if-eqz v0, :cond_17

    iget v0, v6, LZ1/u0;->a:I

    if-nez v0, :cond_17

    iget-object v9, v6, LZ1/u0;->i:Landroid/util/SparseArray;
    ...
    invoke-virtual {v6, v0}, LZ1/u0;->r(I)V
    ...
    iget-object v11, v6, LZ1/u0;->f:[F

    aput v1, v11, v7

    const/4 v1, 0x3

    invoke-static {v0}, LZ1/u0;->j(I)F
    ...
    invoke-virtual {v0}, L捙捕捗挔捗捓挔捞损捌捓捙损挔捙捕捗捗捕捔挔捹捕捗捗捕捔;->w0()Ljava/util/Map;
    ...
    :cond_c
    iget-object v13, v6, LZ1/u0;->h:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    invoke-static {v8}, Lcom/android/camera/data/data/i;->Y0(I)Z
    ...
    invoke-virtual {v8, v1}, LZ1/i0;->q(F)F
    ...
    invoke-virtual/range {v0 .. v5}, LZ1/u0;->g(IIFFZ)V
    ...
    iget-object v0, v6, LZ1/u0;->j:Landroid/util/SparseArray;
...
.method public final isSupportMode(I)Z
    ...
    invoke-virtual {v3, p1}, LEd/c;->v1(I)Z
    ...
    iget-boolean p1, p0, LZ1/u0;->g:Z

    if-nez p1, :cond_7

    iget p0, p0, LZ1/u0;->a:I
...
.method public final k(FIZ)I
    ...
    iget-object v0, p0, LZ1/u0;->j:Landroid/util/SparseArray;
...
.method public final n(IZ)V
    ...
    iget-object v4, p0, LZ1/u0;->l:[I

    aget v5, v0, v3

    invoke-static {v2, p2, v5, p1}, Lcom/android/camera/data/data/i;->G(ZZFI)I
    ...
    const-string v3, "mOpticalLineZoomToggleIndexes: "

    invoke-direct {p2, v3}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-object v3, p0, LZ1/u0;->l:[I

    invoke-static {v3, p2}, LA1/v;->f([ILjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object p1, p0, LZ1/u0;->m:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, LZ1/u0;->m:Ljava/util/ArrayList;
    ...
    const-string p2, "initOpticalZoom: mOpticalZoomRatios: "
    ...
    iget-object p0, p0, LZ1/u0;->m:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, LZ1/u0;->m:Ljava/util/ArrayList;
...
.method public final q()Z
    ...
    iget v1, p0, LZ1/u0;->b:I

    iget-object v0, v0, LM5/f;->a:LM5/b;

    invoke-interface {v0, v1}, LM5/a;->m(I)Z
...
.method public final r(I)V
    ...
    iget-object p1, p1, LZ1/l0;->f:[F

    iput-object p1, p0, LZ1/u0;->e:[F

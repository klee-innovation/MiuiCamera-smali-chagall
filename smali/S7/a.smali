...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Z)V
    ...
    :cond_1
    invoke-static {p1, v1, v4}, LKb/v1;->h(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v5, v6, p3}, LS7/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Z)V
    ...
    invoke-static {p2, p1}, LFa/q;->a(Ljava/io/File;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public static c(Ljava/io/File;)V
    ...
    invoke-static {v2}, LS7/a;->b(Ljava/io/File;)V

    goto :goto_1

    :cond_0
    invoke-static {v2}, LS7/a;->c(Ljava/io/File;)V
...
.method public static d(Landroid/content/Context;Ljava/io/File;Z)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {p1, v4}, LFa/q;->a(Ljava/io/File;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {p0, v6, p1, p2}, LS7/a;->a(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Z)V
...
.method public static declared-synchronized g(Landroid/content/Context;Ljava/io/File;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    const-string/jumbo p1, "tryCopyAssets: content is null"
    ...
    invoke-static {p0, p1, v4}, LS7/a;->d(Landroid/content/Context;Ljava/io/File;Z)V
    ...
    invoke-static {p0, v0}, LS7/a;->f(Landroid/content/Context;Ljava/lang/String;)I
    ...
    invoke-static {v2, v0}, LS7/a;->h(Ljava/io/File;I)Z
    ...
    const-string p1, "assets_copied exists and version check pass"
    ...
    :cond_5
    :try_start_2
    invoke-static {p0, p1, v6}, LS7/a;->d(Landroid/content/Context;Ljava/io/File;Z)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
    ...
    const-string/jumbo p1, "tryCopyAssets: targetDir is null"

...
.method static constructor <clinit>()V
    ...
    sput-object v0, LE2/d;->m:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/camera/a;)V
    ...
    iput-boolean v0, p0, LE2/d;->j:Z

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, LE2/d;->c:Ljava/util/HashMap;

    new-instance v0, LF2/b;

    invoke-direct {v0, p1}, LF2/b;-><init>(Lcom/android/camera/a;)V

    iput-object v0, p0, LE2/d;->l:LF2/b;

    new-instance v0, Lei/a;

    new-instance v1, LE2/d$a;

    invoke-direct {v1, p0}, LE2/d$a;-><init>(LE2/d;)V

    invoke-direct {v0, p1, v1}, Lei/a;-><init>(Landroid/content/ContextWrapper;Lei/a$b$a;)V

    iput-object v0, p0, LE2/d;->e:Lei/a;
    ...
    iput-object v0, p0, LE2/d;->f:Landroid/net/ConnectivityManager;

    new-instance v0, LE2/d$b;

    invoke-direct {v0}, Landroid/net/ConnectivityManager$NetworkCallback;-><init>()V

    iput-object v0, p0, LE2/d;->g:LE2/d$b;

    const/4 v0, 0x2

    invoke-static {p1, v0}, Lhi/c;->t(Landroid/content/ContextWrapper;I)Lhi/c;

    move-result-object p1

    iput-object p1, p0, LE2/d;->d:Lhi/c;
...
# virtual methods
.method public final declared-synchronized F(Ljava/util/HashSet;)I
    .locals 6
    ...
    iget-object v0, p0, LE2/d;->c:Ljava/util/HashMap;
    ...
    iget v4, v3, LE2/c;->h:I

    const/4 v5, 0x1

    if-ne v4, v5, :cond_0

    sget-object v4, LE2/d;->m:Ljava/lang/String;
...
.method public final declared-synchronized H(LE2/c;Z)V
    .locals 1

    monitor-enter p0

    :try_start_0
    iget-boolean v0, p0, LE2/d;->j:Z

    if-eq v0, p2, :cond_0

    iput-boolean p2, p0, LE2/d;->j:Z

    if-nez p2, :cond_0

    if-eqz p1, :cond_0

    iget-object p2, p0, LE2/d;->b:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz p2, :cond_0

    invoke-interface {p2, p1}, LE2/b;->onConnectivityStateChanged(LE2/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized J()V
    ...
    :try_start_0
    iget-object v0, p0, LE2/d;->d:Lhi/c;
...
.method public final declared-synchronized N(Ljava/lang/String;Landroid/view/Surface;)V
    .locals 11
    ...
    sget-object v1, LH2/E0;->e:Landroid/util/Size;
    ...
    sget-object v1, LE2/d;->m:Ljava/lang/String;
    ...
    iput-object v0, p0, LE2/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iget-object v0, p0, LE2/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    iget-object p2, p0, LE2/d;->h:Ltv/danmaku/ijk/media/player/IjkMediaPlayer;
    ...
    :try_start_3
    sget-object p2, LE2/d;->m:Ljava/lang/String;

    const-string/jumbo v0, "startStreaming failed: "

    invoke-static {v2, p2, v0, p1}, Lki/b;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    :try_end_3
...
.method public final declared-synchronized c0()V
    ...
    invoke-static {v2, v1, v3, v0}, Lki/b;->e(ILjava/lang/String;Ljava/lang/String;Ljava/lang/Exception;)V
    :try_end_2
    .catchall {:try_start_2 .. :try_end_2} :catchall_0
...
.method public final declared-synchronized o(I)V
    ...
    :try_start_0
    invoke-virtual {p0, p1}, LE2/d;->v(I)LE2/c;
    ...
    iput v2, v1, LE2/c;->i:I

    iget-object v2, p0, LE2/d;->b:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz v2, :cond_0

    invoke-interface {v2, v1}, LE2/b;->onConnectivityStateChanged(LE2/c;)V
    ...
    :cond_0
    :goto_0
    iget-object v1, p0, LE2/d;->d:Lhi/c;
    ...
    invoke-virtual {v0, v1, p1}, Lfj/e;->j(II)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onConnectionResult(IILjava/lang/String;I)V
    ...
    invoke-static {p3}, LE2/c;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_0
    iget-object p2, p0, LE2/d;->c:Ljava/util/HashMap;
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, p2}, LE2/d;->v(I)LE2/c;
    ...
    sget-object p3, LE2/c;->j:Ljava/lang/String;

    invoke-static {v1, p3, p2}, Landroid/util/Log;->println(ILjava/lang/String;Ljava/lang/String;)I

    :goto_2
    iput-object v4, p1, LE2/c;->e:Ljava/lang/String;

    iput v3, p1, LE2/c;->f:I
...
.method public final declared-synchronized onDisconnection(II)V
    ...
    iput-object p2, p1, LE2/c;->e:Ljava/lang/String;

    const/4 p2, -0x1

    iput p2, p1, LE2/c;->f:I
...
.method public final declared-synchronized onEndpointFound(IILjava/lang/String;[B)V
    ...
    :cond_0
    iget-object p4, p0, LE2/d;->c:Ljava/util/HashMap;
    ...
    new-instance p4, LE2/c;

    invoke-direct {p4, p2, p3}, LE2/c;-><init>(ILjava/lang/String;)V
    ...
    :cond_1
    invoke-static {p3}, LE2/c;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p1

    iput-object p1, p4, LE2/c;->d:Ljava/lang/String;
    ...
    iput-wide p1, p4, LE2/c;->g:J

    const/4 p1, 0x1

    iput p1, p4, LE2/c;->h:I

    iget-object p1, p0, LE2/d;->a:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz p1, :cond_2

    invoke-interface {p1, p4}, LE2/a;->onAvailabilityStateChanged(LE2/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onEndpointLost(IILjava/lang/String;)V
    ...
    invoke-direct {v0, p2, p3}, LE2/c;-><init>(ILjava/lang/String;)V
    ...
    iput-wide p1, v0, LE2/c;->g:J

    const/4 p1, 0x2

    iput p1, v0, LE2/c;->h:I

    iget-object p1, p0, LE2/d;->a:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz p1, :cond_2

    invoke-interface {p1, v0}, LE2/a;->onAvailabilityStateChanged(LE2/c;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized onPayloadReceived(II[B)V
    ...
    sget-object v2, LE2/c;->j:Ljava/lang/String;
...
.method public final declared-synchronized q(I)V
    ...
    iget-object v1, p0, LE2/d;->b:Lcom/xiaomi/microfilm/dualcam/mode/DualVideoModuleBase;

    if-eqz v1, :cond_0

    invoke-interface {v1, v0}, LE2/b;->onConnectivityStateChanged(LE2/c;)V
...
.method public final registerProtocol()V
    ...
    iget-object v0, p0, LE2/d;->e:Lei/a;

    invoke-virtual {v0}, Lei/a;->a()V

    iget-object v0, p0, LE2/d;->f:Landroid/net/ConnectivityManager;
    ...
    iget-object v2, p0, LE2/d;->g:LE2/d$b;
    ...
    invoke-virtual {v0, p0}, Lhi/c;->r(Lhi/b;)V

    iget-object v0, p0, LE2/d;->d:Lhi/c;

    invoke-virtual {v0}, Lhi/c;->m()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final unRegisterProtocol()V
    ...
    iget-object v1, v0, Lei/a;->c:Lei/a$a;

    if-eqz v1, :cond_0

    iget-object v2, v0, Lei/a;->a:Landroid/content/Context;

    invoke-virtual {v2, v1}, Landroid/content/Context;->unregisterReceiver(Landroid/content/BroadcastReceiver;)V

    const/4 v1, 0x0

    iput-object v1, v0, Lei/a;->c:Lei/a$a;
    ...
    iget-object v1, p0, LE2/d;->g:LE2/d$b;
    ...
    iget-object v1, v0, Lhi/c;->l:Ljava/util/LinkedList;
...
.method public final declared-synchronized v(I)LE2/c;
    .locals 3

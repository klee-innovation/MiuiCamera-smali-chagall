...
.method public constructor <init>(Landroid/widget/AbsSeekBar;)V
    ...
    iput-object p1, p0, Lp/n;->a:Landroid/widget/AbsSeekBar;
...
.method public a(Landroid/util/AttributeSet;I)V
    ...
    iget-object v0, p0, Lp/n;->a:Landroid/widget/AbsSeekBar;

    invoke-virtual {v0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v1

    sget-object v2, Lp/n;->c:[I

    invoke-static {v1, p1, v2, p2}, Lp/P;->e(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lp/P;

    move-result-object p1

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Lp/P;->c(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, v7, v2}, Lp/n;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    :cond_2
    invoke-virtual {p1, v2}, Lp/P;->c(I)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_3

    invoke-virtual {p0, v1, p2}, Lp/n;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method public final b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    invoke-interface {v0, p0}, LK/d;->a(Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_2
    invoke-virtual {p0, v5, v4}, Lp/n;->b(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Lp/n;->b:Landroid/graphics/Bitmap;

    if-nez v2, :cond_6

    iput-object v1, p0, Lp/n;->b:Landroid/graphics/Bitmap;

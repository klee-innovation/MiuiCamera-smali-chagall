...
.method public constructor <init>(Landroid/widget/CompoundButton;)V
    ...
    iput-object v0, p0, Lp/f;->b:Landroid/content/res/ColorStateList;

    iput-object v0, p0, Lp/f;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object p1, p0, Lp/f;->a:Landroid/widget/CompoundButton;
...
.method public final a()V
    ...
    iget-object v0, p0, Lp/f;->a:Landroid/widget/CompoundButton;

    invoke-static {v0}, LY/c;->a(Landroid/widget/CompoundButton;)Landroid/graphics/drawable/Drawable;

    move-result-object v1

    if-eqz v1, :cond_4

    iget-boolean v2, p0, Lp/f;->d:Z

    if-nez v2, :cond_0

    iget-boolean v2, p0, Lp/f;->e:Z
    ...
    iget-object v2, p0, Lp/f;->b:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v1, p0}, LK/a$a;->i(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public final b(Landroid/util/AttributeSet;I)V
    ...
    iget-object p0, p0, Lp/f;->a:Landroid/widget/CompoundButton;

    invoke-virtual {p0}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v0

    sget-object v2, Lh/j;->CompoundButton:[I

    invoke-static {v0, p1, v2, p2}, Lp/P;->e(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lp/P;

    move-result-object v7

    iget-object v8, v7, Lp/P;->b:Landroid/content/res/TypedArray;
    ...
    invoke-static {p0, p1}, LY/b;->d(Landroid/widget/CompoundButton;Landroid/graphics/PorterDuff$Mode;)V
    :try_end_2

...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LF1/g;->a:Landroid/util/SparseArray;

    new-instance v0, Landroid/util/SparseArray;

    invoke-direct {v0}, Landroid/util/SparseArray;-><init>()V

    iput-object v0, p0, LF1/g;->b:Landroid/util/SparseArray;
    ...
    iput-object v0, p0, LF1/g;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v0, p0, LF1/g;->d:Ljava/util/concurrent/atomic/AtomicBoolean;

    const/4 v0, -0x1

    iput v0, p0, LF1/g;->h:I

    new-instance v0, LR1/j;

    invoke-direct {v0}, LR1/j;-><init>()V

    iput-object v0, p0, LF1/g;->k:LR1/j;
    ...
    invoke-virtual {v3, v0, v2}, Lio/reactivex/h;->a(Lio/reactivex/v;I)Lio/reactivex/internal/operators/flowable/l;

    move-result-object v0

    new-instance v2, LC5/L;

    invoke-direct {v2, p0, v1}, LC5/L;-><init>(Ljava/lang/Object;I)V
...
.method public final a(I)V
    ...
    :goto_0
    iget v3, p0, LF1/g;->h:I

    if-ne v3, p1, :cond_1

    iget-object v3, p0, LF1/g;->d:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :goto_3
    iput p1, p0, LF1/g;->h:I

    iget v5, p0, LF1/g;->i:I
    ...
    :cond_6
    iget-object v5, p0, LF1/g;->g:Landroid/animation/ValueAnimator;

    invoke-static {v5}, Lhj/f;->b(Landroid/animation/Animator;)Z
    ...
    iput p1, p0, LF1/g;->j:I

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iget-object v5, p0, LF1/g;->a:Landroid/util/SparseArray;
    ...
    iget v0, p0, LF1/g;->j:I

    iput v0, p0, LF1/g;->i:I
    ...
    :cond_d
    iget-object v4, p0, LF1/g;->g:Landroid/animation/ValueAnimator;
    ...
    iget v4, p0, LF1/g;->i:I

    iget v8, p0, LF1/g;->j:I
    ...
    invoke-static {v8, v5}, Lgj/c;->i([Ljava/lang/Object;Lgj/v;)V
    ...
    :goto_8
    iget-object v3, p0, LF1/g;->g:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, LF1/g;->g:Landroid/animation/ValueAnimator;

    new-instance v1, LF1/b;

    invoke-direct {v1, p0, p1}, LF1/b;-><init>(LF1/g;Ljava/util/ArrayList;)V

    invoke-virtual {v0, v1}, Landroid/animation/ValueAnimator;->addUpdateListener(Landroid/animation/ValueAnimator$AnimatorUpdateListener;)V

    iget-object v0, p0, LF1/g;->g:Landroid/animation/ValueAnimator;

    new-instance v1, LF1/f;

    invoke-direct {v1, p0, v2, p1}, LF1/f;-><init>(LF1/g;ILjava/util/ArrayList;)V

    invoke-virtual {v0, v1}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-object p1, p0, LF1/g;->g:Landroid/animation/ValueAnimator;
    ...
    iget-object p0, p0, LF1/g;->g:Landroid/animation/ValueAnimator;
...
.method public final b()Z
    ...
    iget-object v0, p0, LF1/g;->e:Lio/reactivex/i;

    if-eqz v0, :cond_0

    iget-object p0, p0, LF1/g;->e:Lio/reactivex/i;
...
.method public final d(ILcom/xiaomi/camera/base/ui/fragments/a;)V
    .locals 3

    iget-object v0, p0, LF1/g;->a:Landroid/util/SparseArray;
    ...
    iget-object p0, p0, LF1/g;->b:Landroid/util/SparseArray;

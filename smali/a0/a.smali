...
.field public static final l:La0/a$a;

.field public static final m:La0/a$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, La0/a;->k:Landroid/graphics/Rect;

    new-instance v0, La0/a$a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, La0/a;->l:La0/a$a;

    new-instance v0, La0/a$b;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, La0/a;->m:La0/a$b;
...
.method public constructor <init>(Landroid/view/View;)V
    ...
    iput-object v0, p0, La0/a;->a:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, La0/a;->d:[I

    const/high16 v0, -0x80000000

    iput v0, p0, La0/a;->h:I
    ...
    iput-object p1, p0, La0/a;->f:Landroid/view/View;
    ...
    iput-object v0, p0, La0/a;->e:Landroid/view/accessibility/AccessibilityManager;
...
.method public final a(I)Z
    ...
    invoke-virtual {p0, p1, v1}, La0/a;->o(IZ)V

    const/16 v0, 0x8

    invoke-virtual {p0, p1, v0}, La0/a;->q(II)V
...
.method public final b(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    iget-object v1, p0, La0/a;->f:Landroid/view/View;
    ...
    invoke-virtual {p0, p1}, La0/a;->j(I)LT/h;
    ...
    invoke-virtual {v0}, LT/h;->g()Ljava/lang/CharSequence;

    move-result-object v3

    invoke-interface {v2, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    iget-object v0, v0, LT/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-virtual {p0, p2}, La0/a;->l(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public final c(I)LT/h;
    ...
    invoke-direct {v1, v0}, LT/h;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-virtual {v1, v3}, LT/h;->l(Ljava/lang/CharSequence;)V

    sget-object v3, La0/a;->k:Landroid/graphics/Rect;

    invoke-virtual {v1, v3}, LT/h;->i(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v3}, Landroid/view/accessibility/AccessibilityNodeInfo;->setBoundsInScreen(Landroid/graphics/Rect;)V

    iget-object v4, p0, La0/a;->f:Landroid/view/View;

    invoke-virtual {v0, v4}, Landroid/view/accessibility/AccessibilityNodeInfo;->setParent(Landroid/view/View;)V

    invoke-virtual {p0, p1, v1}, La0/a;->n(ILT/h;)V

    invoke-virtual {v1}, LT/h;->g()Ljava/lang/CharSequence;
    ...
    :cond_1
    :goto_0
    iget-object v5, p0, La0/a;->b:Landroid/graphics/Rect;

    invoke-virtual {v1, v5}, LT/h;->f(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v1, v6}, LT/h;->a(I)V
    ...
    invoke-virtual {v1, v5}, LT/h;->a(I)V

    :goto_1
    iget v5, p0, La0/a;->i:I
    ...
    invoke-virtual {v1, v2}, LT/h;->a(I)V

    :cond_5
    :goto_3
    invoke-virtual {v0, p1}, Landroid/view/accessibility/AccessibilityNodeInfo;->setFocused(Z)V

    iget-object p1, p0, La0/a;->d:[I

    invoke-virtual {v4, p1}, Landroid/view/View;->getLocationOnScreen([I)V

    iget-object v5, p0, La0/a;->a:Landroid/graphics/Rect;
    ...
    iget-object p0, v1, LT/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public final d(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, La0/a;->e:Landroid/view/accessibility/AccessibilityManager;
    ...
    :cond_2
    iput v5, p0, La0/a;->j:I

    invoke-virtual {p0, p1, v1}, La0/a;->q(II)V
    ...
    invoke-virtual {p0, v0, p1}, La0/a;->f(FF)I
    ...
    invoke-virtual {p0, p1, v3}, La0/a;->q(II)V

    invoke-virtual {p0, v0, v1}, La0/a;->q(II)V
...
.method public final e(Landroid/view/KeyEvent;)Z
    ...
    invoke-virtual {p0, v3, v4}, La0/a;->i(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, p1, v0, v4}, La0/a;->k(IILandroid/os/Bundle;)Z
    ...
    invoke-virtual {p0, p1, v4}, La0/a;->i(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {p0, v2, v4}, La0/a;->i(ILandroid/graphics/Rect;)Z
...
.method public final getAccessibilityNodeProvider(Landroid/view/View;)LT/i;
    ...
    :cond_0
    iget-object p0, p0, La0/a;->g:La0/a$c;
...
.method public final h(II)V
    ...
    iget-object v0, p0, La0/a;->f:Landroid/view/View;
    ...
    invoke-virtual {p0, p1, v2}, La0/a;->b(II)Landroid/view/accessibility/AccessibilityEvent;
...
.method public final i(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v4}, La0/a;->g(Ljava/util/ArrayList;)V

    new-instance v5, Lv/h;

    invoke-direct {v5}, Lv/h;-><init>()V
    ...
    invoke-virtual {v0, v8}, La0/a;->c(I)LT/h;
    ...
    invoke-virtual {v5, v9, v8}, Lv/h;->f(ILjava/lang/Object;)V
    ...
    :cond_1
    invoke-virtual {v5, v4, v8}, Lv/h;->c(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_1
    sget-object v9, La0/a;->l:La0/a$a;

    sget-object v10, La0/a;->m:La0/a$b;

    iget-object v11, v0, La0/a;->f:Landroid/view/View;
    ...
    iget v6, v0, La0/a;->i:I

    const-string v13, "direction must be one of {FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, FOCUS_RIGHT}."

    if-eq v6, v7, :cond_4

    invoke-virtual {v0, v6}, La0/a;->j(I)LT/h;

    move-result-object v2

    invoke-virtual {v2, v3}, LT/h;->f(Landroid/graphics/Rect;)V
    ...
    iget-object v10, v5, Lv/h;->b:[Ljava/lang/Object;
    ...
    invoke-virtual {v10, v8}, LT/h;->f(Landroid/graphics/Rect;)V

    invoke-static {v3, v8, v1}, La0/b;->c(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    :cond_f
    invoke-static {v3, v2, v1}, La0/b;->c(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    :cond_10
    invoke-static {v1, v3, v8, v2}, La0/b;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_11
    invoke-static {v1, v3, v2, v8}, La0/b;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_12
    invoke-static {v3, v8, v1}, La0/b;->d(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I

    move-result v12

    invoke-static {v3, v8, v1}, La0/b;->e(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I
    ...
    invoke-static {v3, v2, v1}, La0/b;->d(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I

    move-result v12

    invoke-static {v3, v2, v1}, La0/b;->e(Landroid/graphics/Rect;Landroid/graphics/Rect;I)I
    ...
    iget-object v8, v5, Lv/h;->b:[Ljava/lang/Object;
    ...
    invoke-direct {v3, v2, v9}, La0/b$a;-><init>(ZLa0/a$a;)V
    ...
    iget-object v2, v5, Lv/h;->b:[Ljava/lang/Object;
    ...
    :goto_12
    iget-object v1, v5, Lv/h;->a:[I

    aget v7, v1, v13

    :goto_13
    invoke-virtual {v0, v7}, La0/a;->p(I)Z
...
.method public final j(I)LT/h;
    ...
    iget-object p1, p0, La0/a;->f:Landroid/view/View;
    ...
    invoke-virtual {p0, v2}, La0/a;->g(Ljava/util/ArrayList;)V
    ...
    iget-object v4, v1, LT/h;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_3
    invoke-virtual {p0, p1}, La0/a;->c(I)LT/h;
...
.method public m(LT/h;)V
    .locals 0

    return-void
.end method

.method public abstract n(ILT/h;)V
.end method
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/View;LT/h;)V
    ...
    invoke-virtual {p0, p2}, La0/a;->m(LT/h;)V
...
.method public final p(I)Z
    ...
    invoke-virtual {p0, p1, v0}, La0/a;->o(IZ)V
...
.method public final q(II)V
    ...
    :cond_1
    invoke-virtual {p0, p1, p2}, La0/a;->b(II)Landroid/view/accessibility/AccessibilityEvent;

...
.method public static g()Ljava/util/ArrayList;
    ...
    sget v4, LZf/c;->ic_video_cclock_menu:I

    iput v4, v1, Lcom/android/camera/data/data/d;->c:I

    sget v5, LZf/f;->cclock_format:I
...
.method public final getItems()Ljava/util/List;
    ...
    :cond_0
    invoke-static {}, LV1/i;->g()Ljava/util/ArrayList;
...
.method public final h()I
    ...
    invoke-static {v2}, Lcom/android/camera/data/data/B;->m(I)Ljava/lang/String;

    move-result-object v2

    iget v3, p0, LV1/i;->f:I

    invoke-virtual {v1, v3}, LZ1/Z;->isSwitchOn(I)Z
...
.method public final i(Ljava/lang/Object;)V
    ...
    :goto_0
    iput-boolean v2, p0, LV1/i;->b:Z

    iget-object v2, p1, Lj8/c;->x6:Ljava/util/ArrayList;

    if-nez v2, :cond_2

    sget-object v2, LA8/J;->v2:LA8/Q;

    invoke-virtual {p1, v2}, Lj8/c;->L0(LA8/Q;)Ljava/util/ArrayList;

    move-result-object v2

    iput-object v2, p1, Lj8/c;->x6:Ljava/util/ArrayList;

    :cond_2
    iget-object v2, p1, Lj8/c;->x6:Ljava/util/ArrayList;

    iput-object v2, p0, LV1/i;->g:Ljava/util/ArrayList;

    iput-boolean v1, p0, LV1/i;->h:Z

    iget-boolean v2, p0, LV1/i;->b:Z

    if-eqz v2, :cond_5

    iget v2, p0, LV1/i;->f:I

    invoke-virtual {p0, v2}, LV1/i;->isSupportMode(I)Z

    move-result v2

    if-eqz v2, :cond_5

    invoke-static {v0}, LV1/i;->j(I)Z
    ...
    iget-boolean v1, p0, LV1/i;->d:Z

    invoke-static {v1}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object v1

    iget-boolean v2, p0, LV1/i;->e:Z
...
.method public final isSwitchOn(I)Z
    ...
    iget-boolean v0, p0, LV1/i;->b:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, LV1/i;->isSupportMode(I)Z
...
.method public final k()Z
    ...
    iget-object v1, v0, LV1/Z;->e:LV1/b0;
    ...
    iget-object v2, p0, LV1/i;->g:Ljava/util/ArrayList;
    ...
    invoke-static {v1, v0}, LV1/Y0;->f(Ljava/lang/String;Ljava/lang/String;)I

    move-result v0

    iget-object p0, p0, LV1/i;->g:Ljava/util/ArrayList;

...
.method public constructor <init>(Landroid/content/Context;Landroid/widget/LinearLayout;Lcom/android/camera/data/data/c;)V
    ...
    iput v0, p0, Lg4/h;->e:I

    iput v0, p0, Lg4/h;->f:I

    const/4 v1, 0x1

    iput-boolean v1, p0, Lg4/h;->g:Z

    iput-boolean v0, p0, Lg4/h;->h:Z
    ...
    invoke-direct {v1, p1, p3}, Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/c;)V

    iput-object v1, p0, Lg4/h;->b:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;
    ...
    iput-object v3, p0, Lg4/h;->c:Landroid/widget/FrameLayout;
    ...
    iput-object v2, p0, Lg4/h;->c:Landroid/widget/FrameLayout;
    ...
    iput-object p2, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v0, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, p2}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V

    new-instance p2, Lcom/android/camera/fragment/v;

    invoke-direct {p2}, Lcom/android/camera/fragment/v;-><init>()V

    const-wide/16 v2, 0x96

    invoke-virtual {p2, v2, v3}, Landroidx/recyclerview/widget/RecyclerView$l;->setChangeDuration(J)V

    invoke-virtual {p2, v2, v3}, Landroidx/recyclerview/widget/RecyclerView$l;->setMoveDuration(J)V

    invoke-virtual {p2, v2, v3}, Landroidx/recyclerview/widget/RecyclerView$l;->setAddDuration(J)V

    iget-object v0, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, p2}, Landroidx/recyclerview/widget/RecyclerView;->setItemAnimator(Landroidx/recyclerview/widget/RecyclerView$l;)V

    iget-object p2, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v1, p1}, Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;->getItemPadding(Landroid/content/Context;)Lcom/android/camera/fragment/beauty/g$b;
    ...
    iput-object p1, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :goto_0
    iput-object p3, p0, Lg4/h;->a:Lcom/android/camera/data/data/c;
...
.method public final a(I)V
    ...
    iget v1, p0, Lg4/h;->e:I

    iput v1, p0, Lg4/h;->f:I

    iput p1, p0, Lg4/h;->e:I

    iget-object v1, p0, Lg4/h;->b:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;

    invoke-virtual {v1, p1}, Lcom/android/camera/fragment/beauty/g;->setSelectedIndex(I)V

    invoke-virtual {v1, p1}, Lcom/android/camera/fragment/beauty/g;->scrollIfNeed(I)Z

    iget p1, p0, Lg4/h;->f:I

    iget v2, p0, Lg4/h;->e:I
    ...
    iget-object v6, p0, Lg4/h;->a:Lcom/android/camera/data/data/c;
    ...
    iget-object v8, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v9, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p0, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final c()V
    ...
    iget-object v0, p0, Lg4/h;->c:Landroid/widget/FrameLayout;
...
.method public final j(Landroid/content/Context;)V
    ...
    iget-object p1, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {p1, v1}, Landroidx/recyclerview/widget/RecyclerView;->setLayoutManager(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V

    iget-object p1, p0, Lg4/h;->d:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v0, p0, Lg4/h;->b:Lcom/android/camera2/compat/theme/custom/cv/cvlens/CvLensAdapter;

    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView;->setAdapter(Landroidx/recyclerview/widget/RecyclerView$g;)V

    if-eqz v0, :cond_1

    iget p0, p0, Lg4/h;->e:I
...
.method public final k(Landroid/content/Context;)V
    ...
    iput-boolean p1, p0, Lg4/h;->g:Z

    iget-object p1, p0, Lg4/h;->c:Landroid/widget/FrameLayout;
    ...
    iget-object p1, p0, Lg4/h;->a:Lcom/android/camera/data/data/c;
    ...
    invoke-direct {p1, p0, v1}, LEh/e;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v2, p1, v1}, LCi/d;->e(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {v0, p0, v1}, LC5/l0;-><init>(Ljava/lang/Object;I)V

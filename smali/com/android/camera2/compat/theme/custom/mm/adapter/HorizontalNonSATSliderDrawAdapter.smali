...
.method public initAngleUnit()V
    ...
    iput v1, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/HorizontalManuallyDualLensSliderDrawAdapter;->mEveryStopPointScaleValueAngle:F
    ...
    :cond_0
    invoke-super {p0}, Lcom/android/camera2/compat/theme/custom/mm/adapter/HorizontalManuallyDualLensSliderDrawAdapter;->initAngleUnit()V
...
.method public initValue(Z)V
    ...
    const-string v2, "HorizontalNonSATSliderDrawAdapter"
    ...
    invoke-static {v0, p1, v1}, Lcom/android/camera/data/data/i;->S(ZZ[Ljava/lang/Float;)Ljava/util/ArrayList;
    ...
    new-instance v3, LH2/s0;

    const/4 v4, 0x2

    invoke-direct {v3, p0, v4}, LH2/s0;-><init>(Ljava/lang/Object;I)V

    invoke-interface {p1, v3}, Ljava/util/stream/Stream;->filter(Ljava/util/function/Predicate;)Ljava/util/stream/Stream;

    move-result-object p1

    invoke-static {p1}, LV1/s;->a(Ljava/util/stream/Stream;)Ljava/util/List;
    ...
    invoke-virtual {p0, v4}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->isInOpticalZoom(F)Z

    move-result v4

    if-eqz v4, :cond_e

    invoke-virtual {v3, v0}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->setStopScaleLine(Z)V
    ...
    invoke-virtual {v4, v0}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->setStopScaleLine(Z)V
...
.method public mapValueToAngle(Ljava/lang/String;)F
    ...
    iget v3, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/HorizontalManuallyDualLensSliderDrawAdapter;->mEveryStopPointScaleValueAngle:F
    ...
    invoke-static {p1, v0, v0, v5}, LI/b;->b(FFFF)F

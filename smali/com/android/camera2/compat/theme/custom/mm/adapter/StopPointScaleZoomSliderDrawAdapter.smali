...
# static fields
.field protected static final ALPHA_ANGLE:F = 11.0f

.field protected static final DAMPING_VALUE:I = 0x4

.field protected static final LOG_BASE:I = 0x2

.field protected static final PAINT_MAX_ALPHA:I = 0xff

.field protected static final POWER:F = 4.0f

.field private static final TAG:Ljava/lang/String; = "StopPointScaleZoomSliderDrawAdapter"

.field protected static final TOLERATE_VALUE:F = 5.0E-6f
...
.field protected mOpticalZoomFocusLengthMap:[F

.field protected mOpticalZoomRange:[F
...
.field protected mStopPointSupportScaleZooms:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List<",
            "Ljava/lang/Float;",
...
.method public constructor <init>(Landroid/content/Context;ZILcom/android/camera2/compat/theme/custom/mm/StopPointValueListener;ZZZ)V
    ...
    iput-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mStopPointSupportScaleZooms:Ljava/util/List;
...
.method private getOpticalFocusLength(F)Ljava/lang/String;
    .locals 6

    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mOpticalZoomFocusLengthMap:[F
    ...
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mOpticalZoomFocusLengthMap:[F
    ...
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mOpticalZoomFocusLengthMap:[F
    ...
    invoke-static {p1, v2, p0}, LA1/v;->d(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
...
.method private initOnlyHighLightLine()V
    ...
    invoke-virtual {v0}, LZ1/u0;->m()Ljava/util/ArrayList;
...
.method private initStopPoints()V
    ...
    invoke-static {v4, v5}, LS/l0;->e(ILandroid/util/SparseArray;)Z
    ...
    invoke-virtual {p0, v5}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->isInOpticalZoom(F)Z

    move-result v5

    if-eqz v5, :cond_c

    invoke-virtual {v6, v2}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->setStopScaleLine(Z)V
...
.method private parseFocalLensZooms(IZZ)[Ljava/lang/Float;
    ...
    invoke-virtual {p0}, L捙捕捗挔捗捓挔捞损捌捓捙损挔捙捕捗捗捕捔挔捹捕捗捗捕捔;->t0()Landroid/util/SparseArray;
    ...
    invoke-static {p1, p0}, LS/l0;->e(ILandroid/util/SparseArray;)Z
...
.method private parseScaleZooms(IZ)[Ljava/lang/Float;
    .locals 0
...
.method public getCurrentZoomRange()Landroid/util/Range;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mCurrentZoomRange:Landroid/util/Range;
...
.method public getNearbyRotateAngleAlpha(I)I
    ...
    invoke-static {v1}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->a(Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;)Z
...
.method public getScaleTextValue(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->isStopPoint(I)Z
    ...
    check-cast p1, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;
    ...
    :goto_0
    iget-object v2, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mStopPointSupportScaleZooms:Ljava/util/List;
    ...
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mStopPointSupportScaleZooms:Ljava/util/List;
...
.method public getSelectedStopPointFocusLength(F)Ljava/lang/String;
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->isInOpticalZoom(F)Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-direct {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->getOpticalFocusLength(F)Ljava/lang/String;
    ...
    check-cast v2, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;

    invoke-virtual {v2}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->getZoomRatio()F
    ...
    invoke-virtual {v2}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->getFocalLens()Ljava/lang/String;
...
.method public getSupportedScaleZoom(I)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I)",
    ...
    :goto_2
    invoke-direct {p0, p1, v1}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->parseScaleZooms(IZ)[Ljava/lang/Float;
...
.method public getSupportedZoomInnerValues()V
    ...
    invoke-virtual {p0}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->initOpticalZoomRange()V
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->getSupportedScaleZoom(I)Ljava/util/List;
...
.method public getZoomRatioByPosition(I)F
    ...
    invoke-static {p1, v3}, LS/l0;->e(ILandroid/util/SparseArray;)Z
...
.method public indexAndZoomRangeFilter()V
    ...
    invoke-static {v4, v0}, LI/b;->g(ILjava/util/List;)Ljava/lang/Object;
...
.method public initOpticalZoomRange()V
    .locals 13
    ...
    invoke-static {v1}, Lj8/d;->B(Lj8/c;)[F

    move-result-object v1

    iput-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mOpticalZoomRange:[F

    :cond_0
    iget-object v1, v0, LZ1/u0;->m:Ljava/util/ArrayList;

    iget-object v2, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mOpticalZoomRange:[F
    ...
    iget-object v6, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mOpticalZoomRange:[F
    ...
    iput-object v4, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mOpticalZoomFocusLengthMap:[F
    ...
    iget-object v6, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mOpticalZoomFocusLengthMap:[F
    ...
    invoke-virtual {v0}, LZ1/u0;->getItems()Ljava/util/List;
    ...
    iget-object v12, v11, Lcom/android/camera/data/data/d;->n:Ljava/lang/String;
    ...
    iget v8, v11, Lcom/android/camera/data/data/d;->i:I
    ...
    const-string v11, "not found target focal by ratio = "

    invoke-static {v8, v11}, LA/e;->e(FLjava/lang/String;)Ljava/lang/String;

    move-result-object v8

    new-array v11, v2, [Ljava/lang/Object;

    invoke-static {v9, v8, v11}, Lcom/android/camera/log/Log;->w(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public initValue(Z)V
    ...
    invoke-static {p1, v0, v1}, LFa/s;->e(Ljava/lang/StringBuilder;FLjava/lang/String;)Ljava/lang/String;
...
.method public isInOpticalZoom(F)Z
    .locals 2
...
.method public isStopPoint(I)Z
    ...
    invoke-virtual {p0}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter$ZoomStopPoint;->isStopScaleLine()Z
...
.method public mapAngleToValue(F)Ljava/lang/String;
    ...
    invoke-static {v6, v0, v7, v1, v8}, LCn/B0;->f(Ljava/lang/String;FLjava/lang/String;FLjava/lang/String;)Ljava/lang/StringBuilder;
...
.method public mapAngleToValueFunction(F)F
    ...
    invoke-static {v4, v3}, LI/b;->g(ILjava/util/List;)Ljava/lang/Object;
...
.method public mapValueToAngle(Ljava/lang/String;)F
    ...
    invoke-static {p1, v4, v4, v3}, LI/b;->b(FFFF)F
...
.method public mapValueToAngleFunction(F)F
    ...
    invoke-static {v0, v3}, LI/b;->g(ILjava/util/List;)Ljava/lang/Object;
...
.method public onPositionSelect(FII)V
    ...
    invoke-virtual {p0, p1, v6, v7}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->updateSelectedValue(Ljava/lang/String;ZZ)V
    ...
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView$BaseScaleZoomDrawAdapter;->mSelectedValue:Ljava/lang/String;
    ...
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mCurrentValue:Ljava/lang/String;
    ...
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mStopPointValueListener:Lcom/android/camera2/compat/theme/custom/mm/StopPointValueListener;
    ...
    invoke-interface {p1, v0}, Lcom/android/camera2/compat/theme/custom/mm/StopPointValueListener;->onZoomItemSlideOn(Z)V

    :cond_2
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->mStopPointValueListener:Lcom/android/camera2/compat/theme/custom/mm/StopPointValueListener;

    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView$BaseScaleZoomDrawAdapter;->mSelectedValue:Ljava/lang/String;
...
.method public setStopPointEquivalentFocalLengthValue(Landroid/util/Pair;)V
    ...
    invoke-direct {v3, v5}, LH5/d0;-><init>(I)V
    ...
    :cond_3
    invoke-static {v7, v10}, LA/e;->g(ILjava/lang/String;)Ljava/lang/String;
...
.method public startInit()V
    ...
    invoke-static {v0}, Lcom/android/camera/data/data/i;->Z0(I)Z
...
.method public updateSelect(F)V
    .locals 5
    ...
    .line 2
    invoke-virtual {p0, v1, p1, v4}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->isSupportedZoomItemSlideOn(FFLjava/util/List;)Z

    move-result v1

    .line 3
    invoke-virtual {p0, v0, v2, v1}, Lcom/android/camera2/compat/theme/custom/mm/adapter/StopPointScaleZoomSliderDrawAdapter;->updateSelectedValue(Ljava/lang/String;ZZ)V
...
.method public updateSelect(FF)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView$BaseScaleZoomDrawAdapter;->mSelectedValue:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView$BaseScaleZoomDrawAdapter;->mSelectedSimpleValue:Ljava/lang/String;
    ...
    const-string/jumbo v0, "updateAngleSelect zoomRatio: "

    invoke-direct {p1, v0}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(F)Ljava/lang/StringBuilder;

    const-string p2, " ,mRotateAngle: "
...
.method public updateSelectedValue(Ljava/lang/String;ZZ)V
    .locals 6
    ...
    :cond_0
    iput-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView$BaseScaleZoomDrawAdapter;->mSelectedValue:Ljava/lang/String;
    ...
    iput-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/zoom/BaseScaleZoomView$BaseScaleZoomDrawAdapter;->mSelectedSimpleValue:Ljava/lang/String;

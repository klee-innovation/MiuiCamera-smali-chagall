...
# instance fields
.field public mObservable:Lio/reactivex/q;

.field public mRxDataState:Lcom/android/camera/data/observeable/b;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private loadAllOfficialItemForAperture(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0}, LZ1/j;->getItems()Ljava/util/List;

    move-result-object v0

    sget-object v1, LR1/a;->b:Ljava/lang/String;
    ...
    iget-object v1, v6, Lcom/xiaomi/microfilm/vlog/vv/s;->mItemList:Ljava/util/List;
...
.method public getComponentsChangeList(Lcom/android/camera2/compat/theme/custom/mm/manually/BaseWorkspaceItem;Ljava/util/List;ILjava/util/List;Z)V
    ...
    instance-of v0, v2, LV1/g0;

    if-nez v0, :cond_4

    instance-of v0, v2, LV1/B0;

    if-nez v0, :cond_4

    instance-of v0, v2, LV1/S0;

    if-nez v0, :cond_4

    instance-of v0, v2, LV1/x0;

    if-nez v0, :cond_4

    instance-of v0, v2, LV1/D0;
    ...
    invoke-interface {v0, p3, p1}, Lcom/android/camera/data/data/w;->c(ILjava/lang/String;)V
...
.method public needLoadWorkspaceData()Z
    ...
    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/mm/manually/ManualWorkspace;->mRxDataState:Lcom/android/camera/data/observeable/b;
...
.method public prepareManualWorkspaceData(ILandroidx/lifecycle/w;Lio/reactivex/functions/d;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/manually/ManualWorkspace;->mRxDataState:Lcom/android/camera/data/observeable/b;
    ...
    iput-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/manually/ManualWorkspace;->mRxDataState:Lcom/android/camera/data/observeable/b;

    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/manually/ManualWorkspace;->mObservable:Lio/reactivex/q;

    if-nez v0, :cond_0

    invoke-virtual {p0, p1}, Lcom/android/camera2/compat/theme/custom/mm/manually/BaseUserWorkspace;->getObservable(I)Lio/reactivex/q;

    move-result-object p1

    iput-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/manually/ManualWorkspace;->mObservable:Lio/reactivex/q;

    :cond_0
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/mm/manually/ManualWorkspace;->mObservable:Lio/reactivex/q;
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/data/observeable/b;->a(Landroidx/lifecycle/w;)Lcom/android/camera/data/observeable/b$b;

    move-result-object p0

    invoke-virtual {p0, p3}, Lio/reactivex/q;->subscribe(Lio/reactivex/functions/d;)Lio/reactivex/disposables/b;
...
.method public pullNew(I)V
    ...
    invoke-direct {v2, p0, v3}, LC5/r0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v1}, Lgj/x;->c(Ljava/lang/String;)V
...
.method public resetRxDataState()V
    ...
    iput-object v0, p0, Lcom/android/camera2/compat/theme/custom/mm/manually/ManualWorkspace;->mObservable:Lio/reactivex/q;

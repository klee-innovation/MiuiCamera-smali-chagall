...
.field protected mSnapHelper:Lcom/android/camera/ui/h;
...
.method public static synthetic b(Ld6/X0;)Ljava/lang/Boolean;
    .locals 0

    invoke-static {p0}, Lcom/android/camera2/compat/theme/custom/cv/FilterSelectViewCV;->lambda$onScrolled$0(Ld6/X0;)Ljava/lang/Boolean;
...
.method private static synthetic lambda$onScrolled$0(Ld6/X0;)Ljava/lang/Boolean;
    .locals 1

    invoke-interface {p0}, Ld6/X0;->isPrepareRecording()Z
    ...
    invoke-interface {p0}, Ld6/X0;->isRecorderStopping()Z
...
.method private scrollToCurrentPosition()V
    .locals 3
    ...
    check-cast v1, Lcom/android/camera/fragment/m;

    if-eqz v0, :cond_0

    if-eqz v1, :cond_0

    invoke-virtual {v1}, Lcom/android/camera/fragment/m;->getHeaderSize()I

    move-result v2

    invoke-virtual {v1}, Lcom/android/camera/fragment/m;->getItemSize()I
...
.method public getSelectedIndex(I)I
    ...
    iget-object v0, p0, Lcom/android/camera2/compat/theme/custom/cv/FilterSelectViewCV;->mSnapHelper:Lcom/android/camera/ui/h;

    invoke-virtual {p0}, Landroidx/recyclerview/widget/RecyclerView;->getLayoutManager()Landroidx/recyclerview/widget/RecyclerView$LayoutManager;

    move-result-object p0

    invoke-virtual {v0, p0}, Lcom/android/camera/ui/h;->findSnapView(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroid/view/View;
...
.method public getSnapHelper()Lcom/android/camera/ui/h;
    .locals 0

    iget-object p0, p0, Lcom/android/camera2/compat/theme/custom/cv/FilterSelectViewCV;->mSnapHelper:Lcom/android/camera/ui/h;
...
.method public init(Lcom/android/camera/data/data/c;ILcom/android/camera2/compat/theme/custom/cv/FilterSelectViewCV$onFilterChangeListener;)V
    ...
    invoke-direct {p0}, Lcom/android/camera2/compat/theme/custom/cv/FilterSelectViewCV;->scrollToCurrentPosition()V

    goto :goto_0

    :cond_0
    iput-boolean p2, p0, Lcom/android/camera2/compat/theme/custom/cv/FilterSelectViewCV;->mInit:Z
...
.method public setLayoutManager(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)V
    ...
    :goto_0
    iget-object p1, p0, Lcom/android/camera2/compat/theme/custom/cv/FilterSelectViewCV;->mSnapHelper:Lcom/android/camera/ui/h;

    if-nez p1, :cond_2

    new-instance p1, Lcom/android/camera/ui/h;

    invoke-direct {p1, v1}, Lcom/android/camera/ui/h;-><init>(I)V

    iput-object p1, p0, Lcom/android/camera2/compat/theme/custom/cv/FilterSelectViewCV;->mSnapHelper:Lcom/android/camera/ui/h;
    ...
    iput v1, p0, Lcom/android/camera/ui/h;->d:I

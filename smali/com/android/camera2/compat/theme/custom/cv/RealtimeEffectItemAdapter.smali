...
# instance fields
.field protected mEglCore:LTl/c;
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/camera/data/data/c;Z)V
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lcom/android/camera/fragment/m;-><init>(Landroid/content/Context;Lcom/android/camera/data/data/c;)V
...
.method public constructor <init>(Landroid/content/Context;Lcom/android/camera/data/data/c;ZLTl/c;)V
    .locals 0
    ...
    .line 5
    iput-object p4, p0, Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter;->mEglCore:LTl/c;
...
.method public onBindViewNormalHolder(Landroidx/recyclerview/widget/RecyclerView$B;I)V
    ...
    check-cast v1, Lcom/android/camera/fragment/d$b;

    invoke-virtual {v1, p2, v0}, Lcom/android/camera/fragment/d$b;->bindEffectIndex(ILcom/android/camera/data/data/d;)V
    ...
    iget p0, p0, Lcom/android/camera/fragment/d;->mDisplayRotation:I
...
.method public onCustomCreateViewHolder(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$B;
    ...
    iget-object v1, p0, Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter;->mEglCore:LTl/c;

    invoke-direct {v0, p0, p1, v1}, Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter$EffectRealtimeItemHolderCV;-><init>(Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter;Landroid/view/View;LTl/c;)V
...
.method public onHeaderOrFooterHolder(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$B;
    ...
    invoke-direct {p1, p0, v0, v1}, Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter$EffectRealtimeItemHolderCV;-><init>(Lcom/android/camera2/compat/theme/custom/cv/RealtimeEffectItemAdapter;Landroid/view/View;LTl/c;)V

...
# virtual methods
.method public getTypeItem(Ljava/lang/String;Ljava/lang/String;Lj8/c;)Lcom/android/camera/data/data/C;
    .locals 1
    ...
    sget p1, LZf/c;->ic_vector_beauty_hair_n:I

    sget p3, LZf/f;->edit_hairline:I

    invoke-direct {p0, p1, p3, p2}, Lcom/android/camera/data/data/C;-><init>(IILjava/lang/String;)V
    ...
    sget p1, LZf/c;->ic_vector_beauty_makeup:I

    invoke-virtual {p3}, Lj8/c;->m()I
    ...
    sget p3, LZf/f;->beauty_fx_makeup_cv:I

    goto :goto_0

    :cond_0
    sget p3, LZf/f;->beauty_makeups_subeffect_makeup:I
    ...
    sget p1, LZf/c;->ic_vector_beauty_eye_large_n:I

    sget p3, LZf/f;->edit_eye_large:I
    ...
    sget p1, LZf/c;->ic_vector_beauty_nose_n:I

    sget p3, LZf/f;->edit_nose:I
    ...
    sget p1, LZf/c;->ic_vector_beauty_smooth_n:I

    sget-boolean p3, LEd/c;->j:Z

    sget-object p3, LEd/c$b;->a:LEd/c;

    invoke-virtual {p3}, LEd/c;->s0()V

    const-string p3, "female"

    invoke-static {p3}, Lcom/android/camera/data/data/i;->m1(Ljava/lang/String;)Z

    const-string p3, "male"

    invoke-static {p3}, Lcom/android/camera/data/data/i;->m1(Ljava/lang/String;)Z

    sget p3, LZf/f;->edit_skin_smooth:I
    ...
    sget p1, LZf/c;->ic_vector_beauty_face_slender_n:I

    sget p3, LZf/f;->edit_face_slender:I
    ...
    sget p1, LZf/c;->ic_shine_hair_puffy:I

    sget p3, LZf/f;->shine_hair_puffy:I
    ...
    sget p1, LZf/c;->ic_vector_beauty_whiten:I
    ...
    sget p1, LZf/c;->ic_beauty_teeth_whiten:I

    sget p3, LZf/f;->ic_beauty_teeth_whiten:I
    ...
    sget p1, LZf/c;->ic_vector_beauty_head_narrow:I

    sget p3, LZf/f;->edit_head_narrow:I
    ...
    sget p1, LZf/c;->ic_vector_beauty_solid:I

    sget p3, LZf/f;->edit_solid:I

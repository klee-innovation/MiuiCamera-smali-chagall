...
.field mComponentThemeMoreMode:Lcom/android/camera/data/data/compat/common/IComponentThemeMoreMode;

.field mComponentThemePopUp:Lcom/android/camera/data/data/compat/common/IComponentThemePopUp;
...
.method public constructor <init>()V
    ...
    new-instance v0, Lcom/android/camera/data/data/compat/common/ComponentThemeMoreModeBase;

    invoke-direct {v0}, Lcom/android/camera/data/data/compat/common/ComponentThemeMoreModeBase;-><init>()V

    iput-object v0, p0, Lcom/android/camera/data/data/compat/common/ComponentThemeCompatBaseImpl;->mComponentThemeMoreMode:Lcom/android/camera/data/data/compat/common/IComponentThemeMoreMode;

    new-instance v0, Lcom/android/camera/data/data/compat/common/ComponentThemePopUp;

    invoke-direct {v0}, Lcom/android/camera/data/data/compat/common/ComponentThemePopUp;-><init>()V

    iput-object v0, p0, Lcom/android/camera/data/data/compat/common/ComponentThemeCompatBaseImpl;->mComponentThemePopUp:Lcom/android/camera/data/data/compat/common/IComponentThemePopUp;
...
.method public getComponentThemeMoreMode()Lcom/android/camera/data/data/compat/common/IComponentThemeMoreMode;
    .locals 0

    iget-object p0, p0, Lcom/android/camera/data/data/compat/common/ComponentThemeCompatBaseImpl;->mComponentThemeMoreMode:Lcom/android/camera/data/data/compat/common/IComponentThemeMoreMode;

    return-object p0
.end method

.method public getComponentThemePopUp()Lcom/android/camera/data/data/compat/common/IComponentThemePopUp;
    .locals 0

    iget-object p0, p0, Lcom/android/camera/data/data/compat/common/ComponentThemeCompatBaseImpl;->mComponentThemePopUp:Lcom/android/camera/data/data/compat/common/IComponentThemePopUp;

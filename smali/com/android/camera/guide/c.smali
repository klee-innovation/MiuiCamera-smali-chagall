...
.method public static Oi(Lcom/android/camera/guide/c;)Z
    .locals 3
...
.method public final Gg()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/guide/c;->Oe()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/guide/c;->Xf()V
...
.method public final Oe()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/guide/c;->hh()V
    ...
    invoke-direct {v1, v5}, Lj5/h;-><init>(Landroid/content/Context;)V

    new-instance v5, Landroid/animation/ArgbEvaluator;

    invoke-direct {v5}, Landroid/animation/ArgbEvaluator;-><init>()V

    iput-object v5, v1, Lj5/j;->c:Landroid/animation/ArgbEvaluator;

    new-instance v5, Landroid/animation/ValueAnimator;

    invoke-direct {v5}, Landroid/animation/ValueAnimator;-><init>()V

    iput-object v5, v1, Lj5/j;->d:Landroid/animation/ValueAnimator;

    const-wide/16 v6, 0x258

    invoke-virtual {v5, v6, v7}, Landroid/animation/ValueAnimator;->setDuration(J)Landroid/animation/ValueAnimator;

    iget-object v5, v1, Lj5/j;->d:Landroid/animation/ValueAnimator;

    new-instance v6, LP1/f;

    const/4 v7, 0x1

    invoke-direct {v6, v1, v7}, LP1/f;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v6, v1, v7}, LC4/f;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object v6, v1, Lj5/h;->a:Lj5/t;

    iput v5, v6, Lj5/t;->f:I
    ...
    iget-object v8, v1, Lj5/h;->a:Lj5/t;

    const/4 v9, -0x1

    if-eq v5, v9, :cond_0

    iput v5, v8, Lj5/t;->a:I

    :cond_0
    if-eq v6, v9, :cond_1

    iput v6, v8, Lj5/t;->b:I

    :cond_1
    if-eq v7, v9, :cond_2

    iput v7, v8, Lj5/t;->e:I
    ...
    iget-object v1, v1, Lj5/t;->j:Landroid/widget/FrameLayout$LayoutParams;
    ...
    invoke-direct {v5, v0}, Lj5/e;-><init>(Ljava/util/ArrayList;)V

    invoke-virtual {v1, v5}, Lcom/android/camera/guide/Banner;->c(Lj5/g;)V
    ...
    invoke-direct {v0, p0, v5}, LH2/z0;-><init>(Ljava/lang/Object;I)V

    iput-object v0, v1, Lcom/android/camera/guide/Banner;->h:Lcom/android/camera/guide/Banner$c;

    iget-object v0, v1, Lcom/android/camera/guide/Banner;->a:Lj5/f;

    iput-boolean v4, v0, Lj5/f;->a:Z

    iget-object v0, v1, Lcom/android/camera/guide/Banner;->b:Landroidx/viewpager2/widget/ViewPager2;

    new-instance v5, Lj5/c;

    invoke-direct {v5, v1}, Lj5/c;-><init>(Lcom/android/camera/guide/Banner;)V
    ...
    invoke-virtual {v0}, Lcom/android/camera/guide/Banner;->getBannerConfig()Lj5/f;

    move-result-object v0

    iput-boolean v3, v0, Lj5/f;->b:Z
    ...
    invoke-direct {v1, p0, v2}, LJh/h;-><init>(Ljava/lang/Object;I)V
...
.method public final qg()V
    ...
    invoke-super {p0}, Lcom/android/camera/guide/b;->qg()V
    ...
    iget-object p0, p0, Lcom/android/camera/guide/b;->k:Lcom/android/camera/Camera$e;
    ...
    invoke-virtual {p0, v0}, Lcom/android/camera/Camera;->N(Z)V

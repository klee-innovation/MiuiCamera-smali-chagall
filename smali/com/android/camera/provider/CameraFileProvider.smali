...
.method public static e(Landroid/content/Context;Ljava/io/File;)Landroid/net/Uri;
    ...
    invoke-static {p0, v0}, LH/c;->c(Landroid/content/Context;Ljava/lang/String;)LH/c$b;

    move-result-object p0

    invoke-interface {p0, p1}, LH/c$b;->a(Ljava/io/File;)Landroid/net/Uri;
...
.method public final delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    invoke-super {p0, p1, p2, p3}, LH/c;->delete(Landroid/net/Uri;Ljava/lang/String;[Ljava/lang/String;)I
...
.method public final declared-synchronized f()V
    ...
    invoke-super {p0, v0, v1}, LH/c;->attachInfo(Landroid/content/Context;Landroid/content/pm/ProviderInfo;)V
...
.method public final getType(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-super {p0, p1}, LH/c;->getType(Landroid/net/Uri;)Ljava/lang/String;
...
.method public final openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
    ...
    invoke-super {p0, p1, p2}, LH/c;->openFile(Landroid/net/Uri;Ljava/lang/String;)Landroid/os/ParcelFileDescriptor;
...
.method public final query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-super/range {p0 .. p5}, LH/c;->query(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;

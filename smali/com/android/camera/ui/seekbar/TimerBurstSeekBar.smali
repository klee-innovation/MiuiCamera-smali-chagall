...
.field public final F0:Lcom/android/camera/ui/seekbar/TimerBurstSeekBar$a;

.field public final G0:Lcom/android/camera/ui/seekbar/TimerBurstSeekBar$b;
...
.field public o0:Lmiuix/animation/IStateStyle;
...
.field public x0:LE7/d;

.field public y0:LE7/a;

.field public z0:LE7/e;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->f0:I

    iput-boolean v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->p0:Z

    iput-boolean v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->q0:Z

    iput-boolean v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->r0:Z

    iput-boolean v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->s0:Z
    ...
    sget v0, Lbj/g;->CameraSeekBar:I

    iput v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->E0:I
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->F0:Lcom/android/camera/ui/seekbar/TimerBurstSeekBar$a;
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->G0:Lcom/android/camera/ui/seekbar/TimerBurstSeekBar$b;
    ...
    sget v1, Lbj/c;->seek_bar_timer_rl_seek_scale:I
    ...
    sget v2, Lbj/c;->seek_bar_timer_rl_seek_container_height:I
    ...
    sget v1, Lbj/c;->seek_bar_timer_circle_low_cv:I
    ...
    sget v1, Lbj/c;->seek_bar_timer_inner_low_height:I
    ...
    sget v1, Lbj/c;->seek_bar_timer_inner_high_height:I
    ...
    sget v0, Lbj/b;->white_alpha_12:I

    invoke-virtual {p1, v0}, Landroid/content/Context;->getColor(I)I

    move-result v0

    iput v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->C0:I
    ...
    sget v1, Lbj/c;->timer_menu_csb_slide_margin_top:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->A0:I
    ...
    sget v1, Lbj/c;->timer_menu_csb_slide_inner_radius:I

    invoke-virtual {v0, v1}, Landroid/content/res/Resources;->getDimensionPixelSize(I)I

    move-result v0

    iput v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->B0:I
    ...
    sget v1, Lbj/c;->seek_bar_timer_infinity_height:I
    ...
    sget v1, Lbj/c;->seek_bar_timer_infinity_width:I
    ...
    sget v1, Lbj/c;->seek_bar_timer_between_infinity_and_number_height_delta:I
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;

    invoke-virtual {v0, p2}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    iget-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;
    ...
    sget v2, Lbj/c;->camera_seek_bar_default_text_size:I
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->j0:Landroid/text/TextPaint;

    invoke-virtual {v0, p2}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    iget-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->j0:Landroid/text/TextPaint;
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->g0:Landroid/graphics/Paint;

    invoke-virtual {v0, p2}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    iget-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->g0:Landroid/graphics/Paint;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Lbj/c;->slide_switch_button_back_ground:I
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->h0:Landroid/graphics/Paint;

    invoke-virtual {v0, p2}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    iget-object p2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->h0:Landroid/graphics/Paint;
    ...
    iput-boolean p1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->m0:Z
    ...
    iget-object p1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;
...
.method private getInfinityNormalDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->v0:Landroid/graphics/drawable/Drawable;
    ...
    sget v1, Lbj/d;->ic_timerburst_infinity_config_normal:I
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->v0:Landroid/graphics/drawable/Drawable;

    :cond_0
    iget-object p0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->v0:Landroid/graphics/drawable/Drawable;
...
.method private getInfinitySelectedDrawable()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->w0:Landroid/graphics/drawable/Drawable;
    ...
    sget v1, Lbj/d;->ic_timerburst_infinity_config_selected:I
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->w0:Landroid/graphics/drawable/Drawable;

    :cond_0
    iget-object p0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->w0:Landroid/graphics/drawable/Drawable;
...
.method private getPinPointPaint()Landroid/graphics/Paint;
    ...
    iget-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->k0:Landroid/graphics/Paint;
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->k0:Landroid/graphics/Paint;
    ...
    :cond_0
    iget-object p0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->k0:Landroid/graphics/Paint;
...
.method public final a(ILcom/android/camera/ui/seekbar/TimerBurstSeekBar$c;)F
    ...
    iget p1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->e0:I
    ...
    iget v2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->e0:I
...
.method public final b(ILcom/android/camera/ui/seekbar/TimerBurstSeekBar$c;)F
    ...
    invoke-static {p2, v0, p1}, LAb/h;->i(FFF)F
...
.method public final c(FLcom/android/camera/ui/seekbar/TimerBurstSeekBar$c;)I
    ...
    iget-boolean v2, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->r0:Z
    ...
    invoke-static {v2, v1, v0}, LAb/h;->j(III)I
    ...
    :cond_6
    iget-boolean v2, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->m0:Z
    ...
    iget v0, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->e0:I
    ...
    invoke-static {v9, v8, v13, v12}, LA/e;->c(FFFF)F
    ...
    :goto_6
    iget v1, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->e0:I
    ...
    invoke-static {v3, v1, v0}, LAb/h;->j(III)I
    ...
    invoke-static {v10, v8, v13, v12}, LA/e;->c(FFFF)F
    ...
    iget v2, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->e0:I
...
.method public final d(I)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->z0:LE7/e;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, LE7/e;->e(I)Ljava/lang/String;
...
.method public final e()V
    ...
    sget v3, Lbj/a;->normalTextColor:I

    invoke-static {v2, v1, v3}, LD6/a;->f(ILandroid/content/Context;I)I
    ...
    sget v3, Lbj/a;->currentTextColor:I
    ...
    sget v3, Lbj/a;->backgroundColor:I
    ...
    iget-boolean v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->l0:Z
    ...
    sget v3, Lbj/a;->overPinCircleColor:I
    ...
    sget v3, Lbj/a;->pinCircleColor:I
    ...
    sget v3, Lbj/a;->infinityConfigColor:I

    invoke-static {v2, v1, v3}, LD6/a;->f(ILandroid/content/Context;I)I

    move-result v1

    invoke-static {v0, v1}, LK/a$a;->g(Landroid/graphics/drawable/Drawable;I)V
    ...
    iget p0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->E0:I

    sget v2, Lbj/a;->infinityConfigSelectedColor:I

    invoke-static {p0, v1, v2}, LD6/a;->f(ILandroid/content/Context;I)I

    move-result p0

    invoke-static {v0, p0}, LK/a$a;->g(Landroid/graphics/drawable/Drawable;I)V
...
.method public final f()V
    ...
    iget-object v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->G0:Lcom/android/camera/ui/seekbar/TimerBurstSeekBar$b;
...
.method public final g(IZ)V
    ...
    iput p1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->C0:I

    iget-object p0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->h0:Landroid/graphics/Paint;
...
.method public final onDetachedFromWindow()V
    ...
    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->y0:LE7/a;

    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->x0:LE7/d;

    iput-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->z0:LE7/e;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-boolean v1, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->n0:Z
    ...
    iget v3, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->d0:I
    ...
    :cond_0
    iget v2, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->d0:I

    iget-boolean v3, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->r0:Z
    ...
    invoke-static {v5, v6, v3}, LAb/h;->i(FFF)F
    ...
    :cond_7
    iget-boolean v3, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->m0:Z
    ...
    iput-boolean v15, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->n0:Z

    :cond_b
    iget v1, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->A0:I
    ...
    iget v4, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->A0:I
    ...
    iget v2, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->A0:I

    int-to-float v2, v2

    sub-float v6, v1, v2

    iget-object v8, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->g0:Landroid/graphics/Paint;
    ...
    iget v1, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->B0:I

    int-to-float v7, v1

    invoke-virtual/range {p1 .. p1}, Landroid/graphics/Canvas;->save()I

    iget-boolean v1, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->m0:Z
    ...
    iget v3, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->A0:I

    int-to-float v3, v3

    sub-float v6, v1, v3

    iget-object v8, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->h0:Landroid/graphics/Paint;
    ...
    iget v1, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->f0:I
    ...
    :goto_8
    iput-boolean v1, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->l0:Z
    ...
    iget-boolean v4, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->l0:Z

    if-eqz v4, :cond_11

    iget-object v4, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->a:Landroid/content/Context;

    iget v5, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->E0:I

    sget v6, Lbj/a;->overPinCircleColor:I

    invoke-static {v5, v4, v6}, LD6/a;->f(ILandroid/content/Context;I)I
    ...
    sget v6, Lbj/a;->pinCircleColor:I
    ...
    iget-boolean v3, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->q0:Z
    ...
    iget-object v3, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;

    invoke-virtual {v3}, Landroid/graphics/Paint;->getFontMetrics()Landroid/graphics/Paint$FontMetrics;

    move-result-object v3

    iget-object v5, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;
    ...
    iget-boolean v5, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->m0:Z
    ...
    iget-object v7, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;
    ...
    iget-object v6, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;
    ...
    :cond_15
    :goto_c
    iget-boolean v3, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->u0:Z
    ...
    iget-boolean v6, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->r0:Z
    ...
    iget-boolean v7, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->m0:Z
    ...
    :cond_18
    iget-boolean v6, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->m0:Z
    ...
    iget-object v8, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;
    ...
    iget-boolean v2, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->q0:Z
    ...
    iget-object v2, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;
    ...
    :cond_1e
    iget-object v2, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->j0:Landroid/text/TextPaint;

    invoke-virtual {v0, v3}, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->d(I)Ljava/lang/String;

    move-result-object v3

    iget v5, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->d0:I
    ...
    :cond_20
    :goto_12
    iget v1, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->d0:I
    ...
    iget-object v0, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->j0:Landroid/text/TextPaint;
    ...
    iget-object v1, v0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v4, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->F0:Lcom/android/camera/ui/seekbar/TimerBurstSeekBar$a;
    ...
    :cond_1
    iget-boolean v2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->p0:Z

    if-nez v2, :cond_5

    invoke-virtual {p0}, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->f()V

    iput-boolean v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->p0:Z
    ...
    iput-boolean v3, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->p0:Z

    iget-object v2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->y0:LE7/a;

    if-eqz v2, :cond_5

    invoke-interface {v2}, LE7/a;->c()V
    ...
    iput-object v2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->o0:Lmiuix/animation/IStateStyle;
    ...
    invoke-static {p1, v5, v6}, LAb/h;->i(FFF)F
    ...
    iget-boolean v6, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->m0:Z

    if-eqz v6, :cond_8

    iget-boolean v6, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->r0:Z
    ...
    :cond_8
    :goto_1
    iget v6, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->d0:I
    ...
    :goto_2
    iput v5, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->d0:I
    ...
    iget-object v2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->o0:Lmiuix/animation/IStateStyle;
    ...
    iget-object v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->y0:LE7/a;

    if-eqz v1, :cond_c

    iget v2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->f0:I
    ...
    :cond_a
    iget-boolean v2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->r0:Z

    if-eqz v2, :cond_c

    iget-boolean v2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->s0:Z
    ...
    :cond_d
    iput-boolean v3, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->s0:Z

    iget v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->e0:I
    ...
    :cond_e
    iget-object v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->x0:LE7/d;

    iget v2, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->t:I

    invoke-interface {v1, p0, p1, v5, v2}, LE7/d;->w6(Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;FII)V
...
.method public setForceHideEdgeValue(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->q0:Z

    return-void
.end method

.method public setMoveStateListener(LE7/a;)V
    .locals 0

    iput-object p1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->y0:LE7/a;
...
.method public setNeedDrawMax(Z)V
    ...
    iput-boolean p1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->u0:Z
...
.method public setPinValue(I)V
    ...
    :cond_0
    iput p1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->f0:I
...
.method public setSeekBarConfig(LE7/c;)V
    .locals 3

    const/4 v0, 0x1

    iput-boolean v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->n0:Z

    iget v1, p1, LE7/c;->d:F
    ...
    iput-boolean v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->m0:Z

    iget v1, p1, LE7/c;->b:I

    iput v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->d0:I

    iget v1, p1, LE7/c;->c:I

    invoke-virtual {p0, v1}, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->setPinValue(I)V

    iget v1, p1, LE7/c;->e:I

    iput v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->t:I

    iget-object v1, p1, LE7/c;->f:LE7/e;

    iput-object v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->z0:LE7/e;

    iget-boolean v1, p1, LE7/c;->g:Z

    iput-boolean v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->r0:Z

    iput-boolean v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->s0:Z

    iget v0, p1, LE7/c;->h:I

    iput v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->E0:I

    iget v0, p1, LE7/c;->j:I

    iput v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->C0:I

    invoke-virtual {p0}, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->e()V

    iget-object v0, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->h0:Landroid/graphics/Paint;

    iget v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->C0:I

    invoke-virtual {v0, v1}, Landroid/graphics/Paint;->setColor(I)V

    invoke-virtual {p0}, Landroid/view/View;->invalidate()V

    iget-object v0, p1, LE7/c;->i:Landroid/graphics/Typeface;
    ...
    :cond_0
    iget-object v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->i0:Landroid/text/TextPaint;

    invoke-virtual {v1, v0}, Landroid/graphics/Paint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget-object v1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->j0:Landroid/text/TextPaint;

    invoke-virtual {v1, v0}, Landroid/graphics/Paint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    :goto_0
    iget-boolean v0, p1, LE7/c;->l:Z

    invoke-virtual {p0, v0}, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->setForceHideEdgeValue(Z)V

    iget-object v0, p1, LE7/c;->m:LE7/b;

    invoke-virtual {p0, v0}, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->setMoveStateListener(LE7/a;)V

    iget-object p1, p1, LE7/c;->n:LE7/d;

    invoke-virtual {p0, p1}, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->setSeekBarValueListener(LE7/d;)V
...
.method public setSeekBarValueListener(LE7/d;)V
    .locals 0

    iput-object p1, p0, Lcom/android/camera/ui/seekbar/TimerBurstSeekBar;->x0:LE7/d;

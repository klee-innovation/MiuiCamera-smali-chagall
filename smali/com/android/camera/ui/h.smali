...
.method public constructor <init>(I)V
    ...
    iput v0, p0, Lcom/android/camera/ui/h;->c:I

    iput p1, p0, Lcom/android/camera/ui/h;->d:I
...
.method public final calculateDistanceToFinalSnap(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;Landroid/view/View;)[I
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ui/h;->d(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/D;

    move-result-object v1

    iget v3, p0, Lcom/android/camera/ui/h;->c:I

    invoke-static {p2, v1, v3}, Lcom/android/camera/ui/h;->a(Landroid/view/View;Landroidx/recyclerview/widget/D;I)I
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/ui/h;->getVerticalHelper(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/D;

    move-result-object p1

    iget p0, p0, Lcom/android/camera/ui/h;->d:I

    invoke-static {p2, p1, p0}, Lcom/android/camera/ui/h;->a(Landroid/view/View;Landroidx/recyclerview/widget/D;I)I
...
.method public final d(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/D;
    ...
    iget-object v0, p0, Lcom/android/camera/ui/h;->b:Landroidx/recyclerview/widget/B;
    ...
    iput-object v0, p0, Lcom/android/camera/ui/h;->b:Landroidx/recyclerview/widget/B;

    :cond_1
    iget-object p0, p0, Lcom/android/camera/ui/h;->b:Landroidx/recyclerview/widget/B;
...
.method public final findSnapView(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    invoke-static {p1, v0, p0}, Lcom/android/camera/ui/h;->c(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;Landroidx/recyclerview/widget/D;I)Landroid/view/View;
    ...
    iget p0, p0, Lcom/android/camera/ui/h;->c:I
...
.method public final findTargetSnapPosition(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;II)I
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lcom/android/camera/ui/h;->findSnapView(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    invoke-virtual {p0, p1, v5, p2, v7}, Lcom/android/camera/ui/h;->b(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;Landroidx/recyclerview/widget/D;II)I
    ...
    invoke-virtual {p0, p1, v5, v7, p3}, Lcom/android/camera/ui/h;->b(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;Landroidx/recyclerview/widget/D;II)I
...
.method public final getVerticalHelper(Landroidx/recyclerview/widget/RecyclerView$LayoutManager;)Landroidx/recyclerview/widget/D;
    .locals 1

    iget-object v0, p0, Lcom/android/camera/ui/h;->a:Landroidx/recyclerview/widget/C;
    ...
    iput-object v0, p0, Lcom/android/camera/ui/h;->a:Landroidx/recyclerview/widget/C;

    :cond_1
    iget-object p0, p0, Lcom/android/camera/ui/h;->a:Landroidx/recyclerview/widget/C;

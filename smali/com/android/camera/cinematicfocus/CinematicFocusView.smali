...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object v0, p2, LP1/b;->a:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p2, LP1/b;->g:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p2, LP1/b;->h:Ljava/util/HashMap;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p2, LP1/b;->i:F

    const/4 v0, 0x0

    iput v0, p2, LP1/b;->j:F

    iput v0, p2, LP1/b;->k:F

    const/16 v0, 0x18

    iput v0, p2, LP1/b;->l:I

    const/4 v0, 0x0

    iput v0, p2, LP1/b;->m:I

    iput-object p1, p2, LP1/b;->b:Landroid/content/Context;

    new-instance v1, Landroid/graphics/Paint;

    invoke-direct {v1}, Landroid/graphics/Paint;-><init>()V

    iput-object v1, p2, LP1/b;->c:Landroid/graphics/Paint;
    ...
    iput-object v1, p2, LP1/b;->d:Landroid/graphics/Paint;
    ...
    iput-object v1, p2, LP1/b;->e:Landroid/graphics/Paint;
    ...
    iput-object p1, p2, LP1/b;->f:Landroid/graphics/Paint;
    ...
    iput p1, p2, LP1/b;->m:I

    iput-object p2, p0, Lcom/android/camera/cinematicfocus/CinematicFocusView;->a:LP1/b;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/android/camera/cinematicfocus/CinematicFocusView;->a:LP1/b;

    iget-object p0, p0, Lcom/android/camera/cinematicfocus/CinematicFocusView;->b:Ljava/util/ArrayList;

    iput-object p0, v0, LP1/b;->a:Ljava/util/ArrayList;

    invoke-virtual {v0, p1}, LP1/b;->draw(Landroid/graphics/Canvas;)V

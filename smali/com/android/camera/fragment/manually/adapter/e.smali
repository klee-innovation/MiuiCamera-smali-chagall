...
.field public final d:Lcom/android/camera/fragment/s;

.field public final e:LV1/S0;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;LV1/S0;ILl4/r;)V
    .locals 1
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/manually/adapter/e;->a:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/manually/adapter/e;->b:Ljava/util/List;

    sget-object v0, LV1/S0;->i:Ljava/util/HashMap;

    iput-object v0, p0, Lcom/android/camera/fragment/manually/adapter/e;->a:Ljava/util/HashMap;

    iput-object p1, p0, Lcom/android/camera/fragment/manually/adapter/e;->g:Landroid/content/Context;

    iput-object p2, p0, Lcom/android/camera/fragment/manually/adapter/e;->e:LV1/S0;

    iput p3, p0, Lcom/android/camera/fragment/manually/adapter/e;->f:I

    check-cast p4, Lcom/android/camera/fragment/s;

    iput-object p4, p0, Lcom/android/camera/fragment/manually/adapter/e;->d:Lcom/android/camera/fragment/s;

    invoke-virtual {p0, p1}, Lcom/android/camera/ui/g$a;->initStyle(Landroid/content/Context;)V

    iget-object p1, p0, Lcom/android/camera/ui/g$a;->mTextPaint:Landroid/graphics/Paint;
    ...
    invoke-virtual {p1}, L捙捕捗挔捗捓挔捞损捌捓捙损挔捙捕捗捗捕捔挔捹捕捗捗捕捔;->T()I
    ...
    iput-object p2, p1, LH7/i;->a:Ljava/lang/String;

    const/4 p3, 0x0

    iput p3, p1, LH7/i;->b:I

    iput-object p2, p1, LH7/i;->c:Ljava/lang/String;

    const/4 p3, 0x2

    iput p3, p1, LH7/i;->d:I

    iput-object p2, p1, LH7/i;->f:Lcom/android/camera/ui/g$a$b;

    iput p3, p1, LH7/i;->e:I

    invoke-virtual {p0, p1, p2, p2}, Lcom/android/camera/ui/g$a;->initDataList(LH7/i;Ljava/util/List;Ljava/lang/String;)V
...
.method public final draw(ILandroid/graphics/Canvas;ZIFI)V
    ...
    invoke-virtual {p0, p1, p4}, Lcom/android/camera/fragment/manually/adapter/e;->f(IZ)Ljava/lang/String;
...
.method public e(I)V
    ...
    invoke-virtual {p0}, Lcom/android/camera/fragment/manually/adapter/e;->getRealCount()I
...
.method public f(IZ)Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/manually/adapter/e;->a:Ljava/util/HashMap;
...
.method public mapPositionToValue(F)Ljava/lang/String;
    ...
    invoke-static {p1, v2, v0}, LAb/h;->j(III)I
...
.method public onCustomWheelScroll(Z)V
    ...
    :goto_1
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/manually/adapter/e;->e(I)V
...
.method public final onPositionSelect(Landroid/view/View;FII)V
    ...
    iput p2, p0, Lcom/android/camera/fragment/manually/adapter/e;->c:I
    ...
    :cond_0
    invoke-virtual {p0, p2}, Lcom/android/camera/fragment/manually/adapter/e;->mapValueToPosition(Ljava/lang/String;)F

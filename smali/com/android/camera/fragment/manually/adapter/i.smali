...
.method public constructor <init>(Landroid/content/Context;Lcom/android/camera/data/data/c;ILl4/r;)V
    .locals 1
    ...
    iput-object p4, p0, Lcom/android/camera/fragment/manually/adapter/i;->a:Lcom/android/camera/fragment/s;
...
.method public draw(Lcom/android/camera/ui/g$a$a;ILandroid/graphics/Canvas;ZIFI)V
    ...
    iget p6, p0, Lcom/android/camera/ui/g$a;->mLineSelectWidth:F
    ...
    iget p6, p0, Lcom/android/camera/ui/g$a;->mLineStopPointWidth:F

    goto :goto_0

    :cond_1
    iget p6, p0, Lcom/android/camera/ui/g$a;->mLineWidth:F

    :goto_0
    invoke-virtual {p0, p2, p3, p4, p6}, Lcom/android/camera/ui/g$a;->drawLine(ILandroid/graphics/Canvas;ZF)V
    ...
    iget-boolean p4, p0, Lcom/android/camera/ui/g$a;->mIsRSL:Z

    if-eqz p4, :cond_3

    iget p6, p1, Lcom/android/camera/ui/g$a$a;->h:F

    iget p7, p1, Lcom/android/camera/ui/g$a$a;->b:F

    cmpg-float p6, p6, p7

    if-gez p6, :cond_3

    invoke-virtual {p0, p3, p2}, Lcom/android/camera/fragment/manually/adapter/i;->e(Landroid/graphics/Canvas;I)V

    iput-boolean p5, p1, Lcom/android/camera/ui/g$a$a;->g:Z
    ...
    iget p4, p1, Lcom/android/camera/ui/g$a$a;->h:F

    iget p6, p1, Lcom/android/camera/ui/g$a$a;->a:F
    ...
    iput-boolean p5, p1, Lcom/android/camera/ui/g$a$a;->d:Z
    ...
    iget p7, p1, Lcom/android/camera/ui/g$a$a;->a:F
    ...
    iget p6, p1, Lcom/android/camera/ui/g$a$a;->b:F
...
.method public drawEdge(Lcom/android/camera/ui/g$a$a;Landroid/graphics/Canvas;)V
    ...
    iget-boolean v0, p1, Lcom/android/camera/ui/g$a$a;->g:Z
    ...
    iget v0, p1, Lcom/android/camera/ui/g$a$a;->c:F

    iget v3, p1, Lcom/android/camera/ui/g$a$a;->b:F

    invoke-virtual {p2, v0, v3}, Landroid/graphics/Canvas;->translate(FF)V

    invoke-virtual {p0, p2, v2}, Lcom/android/camera/fragment/manually/adapter/i;->e(Landroid/graphics/Canvas;I)V
    ...
    iget v0, p1, Lcom/android/camera/ui/g$a$a;->b:F

    iget v3, p1, Lcom/android/camera/ui/g$a$a;->c:F
    ...
    invoke-virtual {p0, p2, v0}, Lcom/android/camera/fragment/manually/adapter/i;->e(Landroid/graphics/Canvas;I)V

    :goto_0
    invoke-virtual {p2}, Landroid/graphics/Canvas;->restore()V

    :cond_2
    iget-boolean v0, p1, Lcom/android/camera/ui/g$a$a;->d:Z
    ...
    iget p1, p1, Lcom/android/camera/ui/g$a$a;->a:F
    ...
    invoke-virtual {p0, p2, p1}, Lcom/android/camera/fragment/manually/adapter/i;->e(Landroid/graphics/Canvas;I)V
    ...
    iget v0, p1, Lcom/android/camera/ui/g$a$a;->a:F

    iget p1, p1, Lcom/android/camera/ui/g$a$a;->c:F
...
.method public final e(Landroid/graphics/Canvas;I)V
    ...
    iget v1, p0, Lcom/android/camera/ui/g$a;->mSelectLineTextGap:F

    neg-float v1, v1

    iget v4, p0, Lcom/android/camera/ui/g$a;->mLineSelectHalfHeight:F
    ...
    iget v5, p0, Lcom/android/camera/ui/g$a;->mSelectLineTextGap:F
...
.method public final f(I)V
    ...
    iput-object v5, p0, Lcom/android/camera/ui/g$a;->mCurrentValue:Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/manually/adapter/i;->a:Lcom/android/camera/fragment/s;
    ...
    invoke-interface/range {v2 .. v8}, Ll4/r;->onManuallyDataChanged(Lcom/android/camera/data/data/c;Ljava/lang/String;Ljava/lang/String;ZII)V
    ...
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/ui/g$a;->performValueChangedVibrator(II)V
...
.method public mapValueToPosition(Ljava/lang/String;)F
    ...
    invoke-static {p1, v0, p0}, LAb/h;->i(FFF)F
...
.method public onCustomWheelScroll(Z)V
    ...
    invoke-static {p1, v0, v1}, LAb/h;->j(III)I

    move-result p1

    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/manually/adapter/i;->f(I)V

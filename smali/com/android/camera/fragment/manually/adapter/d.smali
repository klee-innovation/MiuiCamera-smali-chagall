...
.method public constructor <init>(Landroid/content/Context;Lcom/android/camera/data/data/c;ILl4/r;)V
    ...
    iput-object v0, p0, Lcom/android/camera/fragment/manually/adapter/d;->d:Ljava/util/ArrayList;

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    iput-object v0, p0, Lcom/android/camera/fragment/manually/adapter/d;->e:Ljava/util/ArrayList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-direct {v1}, Ljava/util/ArrayList;-><init>()V

    iput-object v1, p0, Lcom/android/camera/fragment/manually/adapter/d;->f:Ljava/util/ArrayList;
    ...
    iput-object p4, p0, Lcom/android/camera/fragment/manually/adapter/d;->a:Lcom/android/camera/fragment/s;

    invoke-virtual {p2, p3}, Lcom/android/camera/data/data/c;->getComponentValue(I)Ljava/lang/String;

    move-result-object p3

    iput-object p3, p0, Lcom/android/camera/ui/g$a;->mCurrentValue:Ljava/lang/String;

    invoke-virtual {p0, p1}, Lcom/android/camera/ui/g$a;->initStyle(Landroid/content/Context;)V

    check-cast p2, LV1/g0;

    iget-object p1, p2, LZ1/j;->v0:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/manually/adapter/d;->g:Ljava/util/ArrayList;
    ...
    iget-object p4, p0, Lcom/android/camera/fragment/manually/adapter/d;->g:Ljava/util/ArrayList;
...
.method public final draw(ILandroid/graphics/Canvas;ZIFI)V
    ...
    invoke-super/range {p0 .. p6}, Lcom/android/camera/ui/g$a;->draw(ILandroid/graphics/Canvas;ZIFI)V

    if-eqz p3, :cond_0

    iget-object p4, p0, Lcom/android/camera/ui/g$a;->mCurrentValue:Ljava/lang/String;

    const/4 p5, 0x1

    invoke-virtual {p0, p2, p5, p4}, Lcom/android/camera/ui/g$a;->drawText(Landroid/graphics/Canvas;ZLjava/lang/String;)V

    iget p4, p0, Lcom/android/camera/ui/g$a;->mLineSelectWidth:F
    ...
    :goto_0
    iget-object p6, p0, Lcom/android/camera/fragment/manually/adapter/d;->d:Ljava/util/ArrayList;
    ...
    iget-object p6, p0, Lcom/android/camera/fragment/manually/adapter/d;->f:Ljava/util/ArrayList;
    ...
    :goto_1
    invoke-virtual {p0, p2, p4, p5}, Lcom/android/camera/ui/g$a;->drawText(Landroid/graphics/Canvas;ZLjava/lang/String;)V

    iget p4, p0, Lcom/android/camera/ui/g$a;->mLineStopPointWidth:F

    goto :goto_2

    :cond_3
    iget p4, p0, Lcom/android/camera/ui/g$a;->mLineWidth:F

    :goto_2
    invoke-virtual {p0, p1, p2, p3, p4}, Lcom/android/camera/ui/g$a;->drawLine(ILandroid/graphics/Canvas;ZF)V
...
.method public final e(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/android/camera/fragment/manually/adapter/d;->a:Lcom/android/camera/fragment/s;

    if-eqz v2, :cond_0

    iget-object v4, p0, Lcom/android/camera/ui/g$a;->mCurrentValue:Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, Lcom/android/camera/ui/g$a;->performValueChangedVibrator(II)V
...
.method public final bridge synthetic mapPositionToValue(F)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/manually/adapter/d;->mapPositionToValue(F)Ljava/lang/String;
...
.method public final mapPositionToValue(F)Ljava/lang/String;
    ...
    .line 2
    iget-object v0, p0, Lcom/android/camera/fragment/manually/adapter/d;->f:Ljava/util/ArrayList;
    ...
    .line 3
    :goto_0
    iget-object v4, p0, Lcom/android/camera/fragment/manually/adapter/d;->e:Ljava/util/ArrayList;
...
.method public final mapValueToPosition(Ljava/lang/String;)F
    ...
    .line 4
    :goto_0
    iget-object v3, p0, Lcom/android/camera/fragment/manually/adapter/d;->f:Ljava/util/ArrayList;
    ...
    iget-object v5, p0, Lcom/android/camera/fragment/manually/adapter/d;->e:Ljava/util/ArrayList;
...
.method public final onCustomWheelScroll(Z)V
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/manually/adapter/d;->e(Ljava/lang/String;)V
...
.method public final onPositionSelect(Landroid/view/View;FII)V
    ...
    invoke-virtual {p0, p2}, Lcom/android/camera/fragment/manually/adapter/d;->mapPositionToValue(F)Ljava/lang/String;

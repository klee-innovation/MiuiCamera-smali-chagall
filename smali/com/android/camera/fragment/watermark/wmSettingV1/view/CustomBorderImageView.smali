...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Lt1/F0;->CustomBorderImageView:[I
...
.method public getRoundBackground()Landroid/graphics/Bitmap;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->h:Landroid/graphics/Bitmap;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->h:Landroid/graphics/Bitmap;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->f:Landroid/graphics/BitmapShader;

    if-nez v0, :cond_0

    new-instance v0, Landroid/graphics/BitmapShader;

    iget-object v1, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->h:Landroid/graphics/Bitmap;

    sget-object v2, Landroid/graphics/Shader$TileMode;->CLAMP:Landroid/graphics/Shader$TileMode;

    invoke-direct {v0, v1, v2, v2}, Landroid/graphics/BitmapShader;-><init>(Landroid/graphics/Bitmap;Landroid/graphics/Shader$TileMode;Landroid/graphics/Shader$TileMode;)V

    iput-object v0, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->f:Landroid/graphics/BitmapShader;
    ...
    iget v4, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->d:F
    ...
    iget-object v1, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->f:Landroid/graphics/BitmapShader;
    ...
    iget-object p0, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->a:Landroid/graphics/Paint;
...
.method public setBitmapInfoList(Ljava/util/List;)V
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->g:Ljava/util/List;
...
.method public setRoundBackground(Landroid/graphics/Bitmap;)V
    ...
    iput-object p1, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->h:Landroid/graphics/Bitmap;
    ...
    :cond_2
    :goto_0
    iput-object v0, p0, Lcom/android/camera/fragment/watermark/wmSettingV1/view/CustomBorderImageView;->h:Landroid/graphics/Bitmap;

...
.method static constructor <clinit>()V
    ...
    sput-object v1, Lcom/android/camera/effect/renders/k;->b:[F

    new-array v0, v0, [F

    fill-array-data v0, :array_1

    sput-object v0, Lcom/android/camera/effect/renders/k;->c:[F
...
.method public final draw(LM2/b;)Z
    ...
    :cond_1
    iget-object v6, v1, LM2/e;->c:[F

    iget-object v7, v1, LM2/n;->b:Landroid/graphics/Rect;
    ...
    invoke-virtual {v0, v2, v8}, Lcom/android/camera/effect/renders/j;->bindTexture(LC8/b;I)Z
    ...
    :cond_2
    iget v8, v0, Lcom/android/camera/effect/renders/j;->mAttributePositionH:I

    iget-object v13, v0, Lcom/android/camera/effect/renders/j;->mVertexBuffer:Ljava/nio/FloatBuffer;
    ...
    iget v14, v0, Lcom/android/camera/effect/renders/j;->mAttributeTexCoorH:I

    iget-object v2, v0, Lcom/android/camera/effect/renders/j;->mTexCoorBuffer:Ljava/nio/FloatBuffer;
    ...
    iget-boolean v8, v0, Lcom/android/camera/effect/renders/j;->mBlendEnabled:Z
    ...
    :goto_0
    invoke-virtual {v0, v2}, Lcom/android/camera/effect/renders/j;->setBlendEnabled(Z)V
    ...
    invoke-virtual {v2, v8, v10}, LL2/d;->g(FF)V
    ...
    invoke-virtual {v2, v8, v7}, LL2/d;->f(FF)V

    iget v2, v0, Lcom/android/camera/effect/renders/j;->mUniformMVPMatrixH:I

    iget-object v7, v0, Lcom/android/camera/effect/renders/h;->mGLCanvas:LC8/g;

    invoke-interface {v7}, LC8/g;->getState()LL2/d;

    move-result-object v7

    invoke-virtual {v7}, LL2/d;->a()[F

    move-result-object v7

    invoke-static {v2, v5, v3, v7, v3}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V

    iget v2, v0, Lcom/android/camera/effect/renders/j;->mUniformSTMatrixH:I

    invoke-static {v2, v5, v3, v6, v3}, Landroid/opengl/GLES20;->glUniformMatrix4fv(IIZ[FI)V
    ...
    iget-object v2, v1, LM2/e;->f:LTl/a;

    sget-object v4, LTl/a;->b:LTl/a$c;

    if-ne v2, v4, :cond_6

    iget-object v1, v1, LM2/e;->g:LTl/a;

    sget-object v2, LTl/a;->a:LTl/a$a;

    if-ne v1, v2, :cond_5

    iget v1, v0, Lcom/android/camera/effect/renders/k;->a:I
...
.method public final initShader()V
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/k;->a:I
    ...
    const-class v0, Lcom/android/camera/effect/renders/k;
...
.method public final initVertexData()V
    ...
    sget-object v2, Lcom/android/camera/effect/renders/k;->b:[F
    ...
    sget-object v1, Lcom/android/camera/effect/renders/k;->c:[F

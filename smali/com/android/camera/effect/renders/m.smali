...
.method public constructor <init>(LC8/g;I)V
    ...
    iput p1, p0, Lcom/android/camera/effect/renders/m;->l:F

    const p1, 0x3c23d70a    # 0.01f

    iput p1, p0, Lcom/android/camera/effect/renders/m;->m:F

    const p1, 0xcd5c60

    iput p1, p0, Lcom/android/camera/effect/renders/m;->n:I

    const p1, 0x6db2f4

    iput p1, p0, Lcom/android/camera/effect/renders/m;->o:I

    const/high16 p1, 0x41000000    # 8.0f

    iput p1, p0, Lcom/android/camera/effect/renders/m;->p:F

    const/high16 p1, 0x41200000    # 10.0f

    iput p1, p0, Lcom/android/camera/effect/renders/m;->q:F

    const/high16 p1, 0x40000000    # 2.0f

    iput p1, p0, Lcom/android/camera/effect/renders/m;->r:F
...
.method public final draw(LM2/b;)Z
    ...
    iget v0, p0, Lcom/android/camera/effect/renders/m;->r:F

    const/high16 v1, 0x3f800000    # 1.0f

    add-float/2addr v0, v1

    iput v0, p0, Lcom/android/camera/effect/renders/m;->r:F
...
.method public final initShader()V
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/m;->k:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/m;->g:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/m;->i:I
    ...
    iput v0, p0, Lcom/android/camera/effect/renders/m;->j:I
...
.method public final initShaderValue(Z)V
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/m;->k:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/m;->d:I

    iget v0, p0, Lcom/android/camera/effect/renders/m;->l:F

    invoke-static {p1, v0}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget p1, p0, Lcom/android/camera/effect/renders/m;->e:I

    iget v0, p0, Lcom/android/camera/effect/renders/m;->m:F

    invoke-static {p1, v0}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget p1, p0, Lcom/android/camera/effect/renders/m;->f:I

    iget v0, p0, Lcom/android/camera/effect/renders/m;->n:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/m;->g:I

    iget v0, p0, Lcom/android/camera/effect/renders/m;->o:I
    ...
    iget p1, p0, Lcom/android/camera/effect/renders/m;->i:I

    iget v0, p0, Lcom/android/camera/effect/renders/m;->p:F

    invoke-static {p1, v0}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget p1, p0, Lcom/android/camera/effect/renders/m;->j:I

    iget v0, p0, Lcom/android/camera/effect/renders/m;->q:F

    invoke-static {p1, v0}, Landroid/opengl/GLES20;->glUniform1f(IF)V

    iget p1, p0, Lcom/android/camera/effect/renders/m;->h:I

    iget p0, p0, Lcom/android/camera/effect/renders/m;->r:F

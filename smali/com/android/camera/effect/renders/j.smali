.class public abstract Lcom/android/camera/effect/renders/j;
...
.method public constructor <init>(LC8/g;)V
    ...
    .line 2
    iput p1, p0, Lcom/android/camera/effect/renders/j;->mProgram:I

    const/4 p1, 0x1

    .line 3
    iput-boolean p1, p0, Lcom/android/camera/effect/renders/j;->mBlendEnabled:Z
    ...
    iput-object p1, p0, Lcom/android/camera/effect/renders/j;->mAttriSupportedList:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Lcom/android/camera/effect/renders/j;->mPreviewEffectRect:[F
    ...
    iput-object p1, p0, Lcom/android/camera/effect/renders/j;->mSnapshotEffectRect:[F

    .line 7
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/j;->initShader()V

    .line 8
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/j;->initVertexData()V

    .line 9
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/j;->initSupportAttriList()V
...
.method public constructor <init>(LC8/g;I)V
    ...
    iput-object p2, p0, Lcom/android/camera/effect/renders/j;->mPreviewEffectRect:[F
...
.method public bindTexture(LC8/b;I)Z
    .locals 0
    ...
    invoke-virtual {p1, p0}, LC8/b;->g(LC8/g;)Z
...
.method public destroy()V
    ...
    iget v2, p0, Lcom/android/camera/effect/renders/j;->mProgram:I
    ...
    iget v1, p0, Lcom/android/camera/effect/renders/j;->mProgram:I

    invoke-interface {v0, v1}, LC8/g;->c(I)V

    iput v2, p0, Lcom/android/camera/effect/renders/j;->mProgram:I
...
.method public finalize()V
    ...
    invoke-virtual {p0}, Lcom/android/camera/effect/renders/j;->destroy()V
...
.method public setBlendEnabled(Z)V
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Lcom/android/camera/effect/renders/j;->setBlendEnabled(ZZ)V

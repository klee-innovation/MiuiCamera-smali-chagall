...
.method public static synthetic Hk(Lcom/android/camera/module/video/FilmExposureDelayModule;Ljava/lang/Integer;)V
    .locals 0
...
.method public static synthetic Ik(JLjava/lang/String;Ld6/j1;)V
    .locals 0

    invoke-static {p0, p1, p2, p3}, Lcom/android/camera/module/video/FilmExposureDelayModule;->lambda$updateRecordingTimeUI$0(JLjava/lang/String;Ld6/j1;)V
...
.method private synthetic lambda$onStartRecorderExposureFilmMode$1(Ljava/lang/Integer;)V
    ...
    invoke-interface {p0}, Ld6/d;->Xg()V

    :cond_0
    return-void
.end method

.method private static lambda$updateRecordingTimeUI$0(JLjava/lang/String;Ld6/j1;)V
    .locals 0
    ...
    invoke-interface {p3, p0, p2}, Ld6/j1;->updateFastmotionProRecordingTime(Ljava/lang/String;Ljava/lang/String;)V
...
.method private onStartRecorderExposureFilmMode()V
    ...
    invoke-virtual {v0, v1, v2, v3}, Lio/reactivex/q;->b(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/internal/operators/observable/f;
...
.method public onBackPressed()Z
    ...
    invoke-interface {p0, v1, v3}, Ld6/B;->m1(Lcom/android/camera/fragment/film/FilmItem;Z)V
...
.method public onMediaRecorderReleased(Z)V
    ...
    iget-object v1, v1, Lx6/a;->a:Landroid/net/Uri;
    ...
    invoke-direct {v4, v5, v0, v1}, LY1/n;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-static {v4}, Lgj/I;->d(Lwm/l;)J
    ...
    invoke-direct {v1, v0, v4}, LW2/a;-><init>(Ljava/lang/String;I)V
...
.method public updateFpsRange()V
    ...
    iget-object v1, v0, Lj8/c;->d0:Landroid/util/Range;
    ...
    iput-object v1, v0, Lj8/c;->d0:Landroid/util/Range;

    sget-object v1, LA8/J;->r1:LA8/Q;
    ...
    iput-object v4, v0, Lj8/c;->d0:Landroid/util/Range;

    :cond_1
    iget-object v0, v0, Lj8/c;->d0:Landroid/util/Range;
    ...
    invoke-virtual {v1, v0}, Lj8/P;->g0(Landroid/util/Range;)V
    ...
    iget-byte v1, v0, Lj8/Q;->T2:B

    if-eq v2, v1, :cond_2

    iput-byte v2, v0, Lj8/Q;->T2:B
...
.method public updateRecordStateWhenStopRecording()V
    ...
    :cond_2
    invoke-interface {v0, v2}, Ld6/T0;->Y2(I)V

...
.method public static synthetic Ce(Lg3/h;)V
    .locals 3
...
.method public static synthetic Oe(Lg3/h;)Ljava/lang/String;
    .locals 0
...
.method public static Rd(Lg3/h;Ld6/B;)V
    .locals 5
    ...
    invoke-virtual {v0, v2}, LV1/t;->getComponentValue(I)Ljava/lang/String;

    move-result-object v2

    iget v3, p0, Lcom/android/camera/fragment/h;->mCurrentMode:I

    invoke-virtual {v0, v3}, LV1/t;->o(I)Ljava/lang/String;
    ...
    invoke-static {v4, v3, v3, v3, v3}, LS1/a;->f(IZZZZ)V

    invoke-interface {p1, v2, v0}, Ld6/B;->Xa(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p1, v1}, Leg/b;->t(Ljava/lang/Class;)Ljava/util/Optional;
...
.method public static ne(Lg3/h;LV1/t;)V
    .locals 3

    iget-object v0, p0, Lg3/h;->h:Landroid/widget/ImageView;

    iget v1, p0, Lcom/android/camera/fragment/h;->mCurrentMode:I

    invoke-virtual {p1, v1}, LV1/t;->x(I)I
    ...
    invoke-virtual {p1, v0}, LV1/t;->B(I)Z
    ...
    :goto_0
    iget-object v2, p0, Lg3/h;->h:Landroid/widget/ImageView;
    ...
    invoke-virtual {p1, v1}, LV1/t;->y(I)I
...
.method public static pd(Lg3/h;Landroid/view/View;)V
    .locals 3
...
.method public static td(Lg3/h;LV1/t;)V
    .locals 6
    ...
    iget-object v4, p0, Lg3/h;->i:Landroid/widget/ImageView;

    if-eqz v4, :cond_0

    xor-int/lit8 v5, v0, 0x1

    invoke-static {v1, v5}, LS1/a;->d(IZ)Landroid/graphics/ColorFilter;
    ...
    :cond_0
    iget-object v4, p0, Lg3/h;->g:Landroid/widget/ImageView;
    ...
    iget-object v1, p0, Lg3/h;->g:Landroid/widget/ImageView;

    invoke-static {}, Lg3/h;->Hf()I
    ...
    :cond_1
    iget-object v1, p0, Lg3/h;->h:Landroid/widget/ImageView;

    if-eqz v1, :cond_3

    iget v1, p0, Lcom/android/camera/fragment/h;->mCurrentMode:I

    invoke-virtual {p1, v1}, LV1/t;->B(I)Z
    ...
    invoke-virtual {p1, v2, v3}, LS1/e;->a(IZ)I

    move-result p1

    :goto_0
    iget-object p0, p0, Lg3/h;->h:Landroid/widget/ImageView;
...
# virtual methods
.method public final Di(F)V
    .locals 1

    iget-object v0, p0, Lg3/h;->c:Lcom/android/camera/features/mode/cosmeticmirror/ui/ZoomSeekBarCompat;

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, Lg3/h;->hf(F)I
...
.method public final Xf()V
    ...
    :cond_0
    iget-object v1, p0, Lg3/h;->a:Landroid/view/View;
    ...
    iput-object v1, p0, Lg3/h;->j:Landroid/widget/ImageView;
    ...
    iput-object v1, p0, Lg3/h;->k:Landroid/view/ViewGroup;
    ...
    iput-object v1, p0, Lg3/h;->l:Landroid/view/ViewGroup;
    ...
    invoke-direct {v2, p0, v3}, LO3/e;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v1, v2}, LF1/i;->i(F[Landroid/view/View;)V
    ...
    invoke-static {v1, v0}, Lcom/android/camera/features/mode/capture/s;->g(Landroid/widget/ImageView;Z)V
...
.method public final Zf(I)V
    ...
    iget-object v2, v0, Lg3/h;->a:Landroid/view/View;
    ...
    :cond_1
    iget-object v2, v0, Lg3/h;->b:Landroid/view/ViewGroup;
    ...
    iget-object v3, v0, Lg3/h;->b:Landroid/view/ViewGroup;
    ...
    iget-object v4, v0, Lg3/h;->c:Lcom/android/camera/features/mode/cosmeticmirror/ui/ZoomSeekBarCompat;
    ...
    iget-object v5, v0, Lg3/h;->g:Landroid/widget/ImageView;
    ...
    iget-object v2, v0, Lg3/h;->c:Lcom/android/camera/features/mode/cosmeticmirror/ui/ZoomSeekBarCompat;

    invoke-virtual {v2, v4}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v2, v0, Lg3/h;->g:Landroid/widget/ImageView;

    invoke-virtual {v2, v5}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    invoke-virtual {v0, v1, v10}, Lg3/h;->xg(IZ)V
...
.method public final changeViewAccessibility(Z)V
    ...
    :cond_0
    iget-object p0, p0, Lg3/h;->a:Landroid/view/View;
...
.method public final ec(Z)V
    ...
    iget-object v0, p0, Lg3/h;->g:Landroid/widget/ImageView;
    ...
    :cond_0
    iget-object p0, p0, Lg3/h;->i:Landroid/widget/ImageView;
...
.method public final hf(F)I
    ...
    invoke-direct {v1, p0, p1}, Lg3/f;-><init>(Lg3/h;F)V
...
.method public final initView(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lg3/h;->a:Landroid/view/View;
    ...
    iput-object v2, p0, Lg3/h;->b:Landroid/view/ViewGroup;
    ...
    iput-object v2, p0, Lg3/h;->c:Lcom/android/camera/features/mode/cosmeticmirror/ui/ZoomSeekBarCompat;
    ...
    iput-object p1, p0, Lg3/h;->g:Landroid/widget/ImageView;

    iget-object p1, p0, Lg3/h;->c:Lcom/android/camera/features/mode/cosmeticmirror/ui/ZoomSeekBarCompat;

    invoke-virtual {p0, v1, v0, p1}, Lcom/android/camera/fragment/h;->animateViews(IZLandroid/view/View;)V

    iget-object p1, p0, Lg3/h;->d:Lio/reactivex/disposables/b;
    ...
    invoke-direct {p1, p0, v2}, LH2/y0;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v3, p1, v2}, Lio/reactivex/internal/operators/flowable/m;-><init>(Lio/reactivex/h;Lio/reactivex/functions/d;)V

    invoke-virtual {v3, p0}, Lio/reactivex/h;->subscribe(Lio/reactivex/functions/d;)Lio/reactivex/disposables/b;

    move-result-object p1

    iput-object p1, p0, Lg3/h;->d:Lio/reactivex/disposables/b;
    ...
    invoke-virtual {p0, v2}, Lg3/h;->hf(F)I
    ...
    invoke-static {v2, v3, v4}, LI/h$a;->a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {v2, p0}, Lg3/g;-><init>(Lg3/h;)V
    ...
    iget-object v5, p0, Lg3/h;->g:Landroid/widget/ImageView;

    xor-int/2addr v2, v1

    invoke-static {v3, v2}, LS1/a;->d(IZ)Landroid/graphics/ColorFilter;

    move-result-object v2

    invoke-virtual {v5, v2}, Landroid/widget/ImageView;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v2, p0, Lg3/h;->g:Landroid/widget/ImageView;
    ...
    invoke-direct {v3, p0, v5}, Lcom/android/camera/fragment/top/e;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v2, v3}, LF1/i;->i(F[Landroid/view/View;)V

    iget-object v3, p0, Lg3/h;->g:Landroid/widget/ImageView;
    ...
    invoke-direct {v3, v5}, LH1/a;-><init>(Landroid/view/View;)V
    ...
    :cond_3
    iget-object v3, p0, Lg3/h;->a:Landroid/view/View;
    ...
    iput-object v3, p0, Lg3/h;->h:Landroid/widget/ImageView;
    ...
    invoke-direct {v5, p0, v6}, LH2/A;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v3, v5}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    :goto_1
    iget-object v3, p0, Lg3/h;->h:Landroid/widget/ImageView;

    new-instance v5, Lcom/xiaomi/milive/mode/b;

    const/4 v6, 0x3

    invoke-direct {v5, p0, v6}, Lcom/xiaomi/milive/mode/b;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v2, v5}, LF1/i;->i(F[Landroid/view/View;)V
    ...
    iput-object v3, p0, Lg3/h;->i:Landroid/widget/ImageView;
    ...
    invoke-static {v3, p1}, LS1/a;->d(IZ)Landroid/graphics/ColorFilter;

    move-result-object p1

    invoke-virtual {v4, p1}, Landroid/widget/ImageView;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object p1, p0, Lg3/h;->i:Landroid/widget/ImageView;

    new-instance v3, Lcom/xiaomi/milive/mode/a;

    invoke-direct {v3, p0, v1}, Lcom/xiaomi/milive/mode/a;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v2, p1}, LF1/i;->i(F[Landroid/view/View;)V
...
.method public final notifyAfterFrameAvailable(I)V
    ...
    iget-object p1, p0, Lg3/h;->a:Landroid/view/View;
    ...
    invoke-interface {v1, v0, v3, v4, v5}, Ld6/j1;->alertRecommendTipHint(ILjava/lang/String;J)V
    ...
    invoke-interface {v1, v2}, Ld6/r0;->Da(I)V

    iput-boolean v0, p1, LZ1/x;->a:Z
...
.method public final notifyLayoutChange()V
    ...
    iget-object p0, p0, Lg3/h;->g:Landroid/widget/ImageView;
...
.method public final notifyThemeChanged(II)V
    ...
    invoke-virtual {p1, p2}, Leg/b;->t(Ljava/lang/Class;)Ljava/util/Optional;
    ...
    invoke-direct {p2, p0, v0}, LH5/h;-><init>(Ljava/lang/Object;I)V
...
.method public final onBackEvent(I)Z
    ...
    iget-object p1, p0, Lg3/h;->m:LF4/h;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, LF4/h;->isShowing()Z
    ...
    invoke-virtual {p0, p1, v0}, Lg3/h;->xg(IZ)V
...
.method public final onPause()V
    ...
    invoke-virtual {p0, v0}, Lg3/h;->onBackEvent(I)Z
...
.method public final provideRotateItem(Ljava/util/List;I)V
    ...
    iget-object v0, p0, Lg3/h;->b:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0, p2}, Lg3/h;->Zf(I)V

    invoke-virtual {p0, p2}, Lg3/h;->ug(I)V

    invoke-virtual {p0, p2}, Lg3/h;->qg(I)V

    goto :goto_0

    :cond_0
    iget-object p2, p0, Lg3/h;->g:Landroid/widget/ImageView;
...
.method public final qg(I)V
    ...
    :cond_0
    iget-object v1, p0, Lg3/h;->i:Landroid/widget/ImageView;
    ...
    iget-object v2, p0, Lg3/h;->i:Landroid/widget/ImageView;
...
.method public final unRegister(La6/g;)V
    ...
    iget-object p0, p0, Lg3/h;->m:LF4/h;
...
.method public final updateView(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, Lg3/h;->Zf(I)V

    invoke-virtual {p0}, Lcom/android/camera/fragment/h;->getDegree()I

    move-result p1

    invoke-virtual {p0, p1}, Lg3/h;->ug(I)V

    invoke-virtual {p0}, Lcom/android/camera/fragment/h;->getDegree()I

    move-result p1

    invoke-virtual {p0, p1}, Lg3/h;->qg(I)V
...
.method public final updateView4Simple(Landroid/view/View;Landroid/os/Bundle;Z)V
    ...
    iget-object v1, p0, Lg3/h;->c:Lcom/android/camera/features/mode/cosmeticmirror/ui/ZoomSeekBarCompat;
    ...
    :goto_2
    iget-object p1, p0, Lg3/h;->b:Landroid/view/ViewGroup;
...
.method public final vg()V
    ...
    iget-object v0, p0, Lg3/h;->l:Landroid/view/ViewGroup;
    ...
    :cond_0
    iget-object v0, p0, Lg3/h;->m:LF4/h;
    ...
    invoke-direct {v4}, LF4/h;-><init>()V

    iput-object v4, p0, Lg3/h;->m:LF4/h;
    ...
    iget-object v4, p0, Lg3/h;->m:LF4/h;
    ...
    invoke-direct {v5, p0, v6}, LGk/a;-><init>(Ljava/lang/Object;I)V

    invoke-direct {v4, v5}, Lq4/e;-><init>(Lq4/e$a;)V
    ...
    check-cast v5, LZ1/n0;

    iget-object v5, v5, LZ1/n0;->a:Ljava/util/ArrayList;

    const-string v6, "0"

    const-class v7, Lf6/f;

    invoke-virtual {v4, v5, v6, v7}, Lq4/a;->Rd(Ljava/util/List;Ljava/lang/String;Ljava/lang/Class;)V

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->getActivity()Landroidx/fragment/app/l;

    move-result-object v5

    invoke-virtual {v5}, Landroidx/fragment/app/l;->Jj()Landroidx/fragment/app/y;
    ...
    invoke-virtual {v6, v5, v4, v1}, Landroidx/fragment/app/E;->j(ILandroidx/fragment/app/Fragment;Ljava/lang/String;)V
    ...
    iget-object v1, p0, Lg3/h;->k:Landroid/view/ViewGroup;

    int-to-float v0, v0

    invoke-virtual {v1, v0}, Landroid/view/View;->setTranslationY(F)V

    iget-object v1, p0, Lg3/h;->l:Landroid/view/ViewGroup;
    ...
    invoke-virtual {p0, v0, v3}, Lg3/h;->xg(IZ)V

    return-void

    :cond_1
    invoke-virtual {v0}, LF4/h;->isShowing()Z
    ...
    invoke-virtual {v0, v1, v2}, LF4/h;->dismiss(II)Z
    ...
    invoke-virtual {v0}, LF4/h;->show()V
...
.method public final w7(F)V
    ...
    invoke-static {p0, p1}, Lcom/android/camera/data/data/B;->y0(IZ)V
...
.method public final xg(IZ)V
    ...
    :goto_0
    iget-object p0, p0, Lg3/h;->c:Lcom/android/camera/features/mode/cosmeticmirror/ui/ZoomSeekBarCompat;

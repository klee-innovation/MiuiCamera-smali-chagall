...
.method static constructor <clinit>()V
    ...
    sput-object v0, LO0/f;->f:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/impl/WorkDatabase;Landroidx/work/a;)V
    ...
    invoke-static {p1}, LO0/b;->b(Landroid/content/Context;)Landroid/app/job/JobScheduler;

    move-result-object v0

    new-instance v1, LO0/e;

    iget-object v2, p3, Landroidx/work/a;->d:Llj/d;

    iget-boolean v3, p3, Landroidx/work/a;->m:Z

    invoke-direct {v1, p1, v2, v3}, LO0/e;-><init>(Landroid/content/Context;Llj/d;Z)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LO0/f;->a:Landroid/content/Context;

    iput-object v0, p0, LO0/f;->b:Landroid/app/job/JobScheduler;

    iput-object v1, p0, LO0/f;->c:LO0/e;

    iput-object p2, p0, LO0/f;->d:Landroidx/work/impl/WorkDatabase;

    iput-object p3, p0, LO0/f;->e:Landroidx/work/a;
...
.method public static a(Landroid/app/job/JobScheduler;I)V
    ...
    invoke-virtual {v0, v1, p1, p0}, LK0/q;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {p1}, LO0/b;->a(Landroid/app/job/JobScheduler;)Ljava/util/List;
...
.method public static f(Landroid/app/job/JobInfo;)LT0/m;
    .locals 3
    ...
    invoke-direct {v2, p0, v1}, LT0/m;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final varargs c([LT0/w;)V
    ...
    iget-object v1, p0, LO0/f;->d:Landroidx/work/impl/WorkDatabase;

    invoke-direct {v0, v1}, LU0/d;-><init>(Landroidx/work/impl/WorkDatabase;)V
    ...
    iget-object v6, v4, LT0/w;->a:Ljava/lang/String;

    invoke-interface {v5, v6}, LT0/x;->p(Ljava/lang/String;)LT0/w;
    ...
    sget-object v7, LO0/f;->f:Ljava/lang/String;

    iget-object v8, v4, LT0/w;->a:Ljava/lang/String;
    ...
    invoke-virtual {v4, v7, v5}, LK0/q;->g(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_2
    iget-object v5, v5, LT0/w;->b:LK0/B;

    sget-object v9, LK0/B;->a:LK0/B;
    ...
    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->c()LT0/k;

    move-result-object v6

    invoke-interface {v6, v5}, LT0/k;->c(LT0/m;)LT0/j;

    move-result-object v6

    if-eqz v6, :cond_2

    iget v7, v6, LT0/j;->c:I

    goto :goto_2

    :cond_2
    iget-object v7, p0, LO0/f;->e:Landroidx/work/a;

    iget v8, v7, Landroidx/work/a;->i:I

    iget v7, v7, Landroidx/work/a;->j:I

    new-instance v9, LU0/c;

    invoke-direct {v9, v0, v8, v7}, LU0/c;-><init>(LU0/d;II)V

    iget-object v7, v0, LU0/d;->a:Ljava/lang/Object;

    check-cast v7, Landroidx/work/impl/WorkDatabase;

    invoke-virtual {v7, v9}, Landroidx/room/m;->runInTransaction(Ljava/util/concurrent/Callable;)Ljava/lang/Object;
    ...
    iget-object v8, v5, LT0/m;->a:Ljava/lang/String;

    iget v5, v5, LT0/m;->b:I

    invoke-direct {v6, v8, v5, v7}, LT0/j;-><init>(Ljava/lang/String;II)V

    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->c()LT0/k;

    move-result-object v5

    invoke-interface {v5, v6}, LT0/k;->e(LT0/j;)V

    :cond_3
    invoke-virtual {p0, v4, v7}, LO0/f;->g(LT0/w;I)V
...
.method public final e(Ljava/lang/String;)V
    ...
    iget-object v1, p0, LO0/f;->b:Landroid/app/job/JobScheduler;

    invoke-static {v0, v1}, LO0/f;->b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v3}, LO0/f;->f(Landroid/app/job/JobInfo;)LT0/m;
    ...
    invoke-static {v1, v2}, LO0/f;->a(Landroid/app/job/JobScheduler;I)V

    goto :goto_2

    :cond_3
    iget-object p0, p0, LO0/f;->d:Landroidx/work/impl/WorkDatabase;

    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->c()LT0/k;

    move-result-object p0

    invoke-interface {p0, p1}, LT0/k;->g(Ljava/lang/String;)V

    :cond_4
    return-void
.end method

.method public final g(LT0/w;I)V
    .locals 12
    ...
    iget-object v1, p1, LT0/w;->j:LK0/d;
    ...
    invoke-virtual {v1}, LK0/d;->a()Landroid/net/NetworkRequest;
    ...
    iget-object v9, v1, LK0/d;->a:LK0/r;

    if-lt v6, v3, :cond_1

    sget-object v3, LK0/r;->f:LK0/r;
    ...
    sget-object v9, LO0/e;->d:Ljava/lang/String;

    invoke-virtual {v3, v9, v6}, LK0/q;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_6
    invoke-virtual {p1}, LT0/w;->a()J

    move-result-wide v5

    iget-object v3, v0, LO0/e;->b:Llj/d;
    ...
    :cond_7
    iget-boolean v5, p1, LT0/w;->q:Z

    if-nez v5, :cond_8

    iget-boolean v0, v0, LO0/e;->c:Z
    ...
    :cond_8
    :goto_3
    iget-object v0, v1, LK0/d;->i:Ljava/util/Set;
    ...
    check-cast v5, LK0/d$a;

    iget-boolean v6, v5, LK0/d$a;->b:Z

    new-instance v9, Landroid/app/job/JobInfo$TriggerContentUri;

    iget-object v5, v5, LK0/d$a;->a:Landroid/net/Uri;
    ...
    invoke-static {v2}, LO0/c;->c(Landroid/app/job/JobInfo$Builder;)V
    ...
    iget-object v0, p1, LT0/w;->x:Ljava/lang/String;

    if-eqz v0, :cond_e

    invoke-static {v2, v0}, LO0/d;->a(Landroid/app/job/JobInfo$Builder;Ljava/lang/String;)V
    ...
    invoke-static {p2, v2, v4, v5}, LD0/p;->f(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    sget-object v5, LO0/f;->f:Ljava/lang/String;

    invoke-virtual {v1, v5, v2}, LK0/q;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0, v5, v1}, LK0/q;->g(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v0, p1, LT0/w;->q:Z

    if-eqz v0, :cond_f

    iget-object v0, p1, LT0/w;->r:LK0/z;

    sget-object v1, LK0/z;->a:LK0/z;

    if-ne v0, v1, :cond_f

    iput-boolean v7, p1, LT0/w;->q:Z
    ...
    invoke-virtual {v1, v5, v0}, LK0/q;->a(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, p1, p2}, LO0/f;->g(LT0/w;I)V
    :try_end_0
    ...
    invoke-virtual {p2, v5, p1, p0}, LK0/q;->c(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_9
    sget-object p2, LO0/b;->a:Ljava/lang/String;

    iget-object p2, p0, LO0/f;->a:Landroid/content/Context;

    const-string v0, "context"

    invoke-static {p2, v0}, Lkotlin/jvm/internal/l;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object v0, p0, LO0/f;->d:Landroidx/work/impl/WorkDatabase;

    const-string/jumbo v1, "workDatabase"

    invoke-static {v0, v1}, Lkotlin/jvm/internal/l;->f(Ljava/lang/Object;Ljava/lang/String;)V

    iget-object p0, p0, LO0/f;->e:Landroidx/work/a;
    ...
    invoke-static {p2}, LO0/b;->b(Landroid/content/Context;)Landroid/app/job/JobScheduler;

    move-result-object v1

    invoke-static {v1}, LO0/b;->a(Landroid/app/job/JobScheduler;)Ljava/util/List;

    move-result-object v3

    if-eqz v3, :cond_17

    invoke-static {p2, v1}, LO0/f;->b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v4, v6}, LA/e;->g(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2, v6}, LO0/f;->b(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {v7, p2}, LA/e;->g(ILjava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lim/k;->B([Ljava/lang/Object;)Ljava/util/ArrayList;
    ...
    invoke-static/range {v6 .. v11}, Lim/s;->d0(Ljava/lang/Iterable;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lwm/l;I)Ljava/lang/String;
    ...
    invoke-static {p2, v1, v4, v2, v3}, LD0/q;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {p2, p0, v0}, LDc/b;->c(Ljava/lang/StringBuilder;IC)Ljava/lang/String;
    ...
    invoke-virtual {p2, v5, p0}, LK0/q;->b(Ljava/lang/String;Ljava/lang/String;)V

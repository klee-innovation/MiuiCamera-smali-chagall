...
.field public d:Lcom/android/camera/module/X;
...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-object v0, p0, LM5/j;->a:Ljava/lang/ref/WeakReference;
...
.method public final onError(Ljava/lang/Throwable;)V
    ...
    iget-object p1, p0, LM5/j;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {p1}, LL5/j;->ne()Z
    ...
    invoke-direct {p1, v1, v0}, LM5/k;-><init>(ILng/a$b;)V

    iput-object p1, p0, LM5/j;->c:LM5/k;

    iget-object p0, p0, LM5/j;->b:Lio/reactivex/x;

    if-eqz p0, :cond_1

    check-cast p0, Lio/reactivex/internal/operators/single/a$a;

    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/single/a$a;->c(Ljava/lang/Object;)V
...
.method public final onNext(Ljava/lang/Object;)V
    ...
    iget-object v1, p0, LM5/j;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    invoke-interface {v1}, LL5/j;->ne()Z
...
.method public final subscribe(Lio/reactivex/x;)V
    ...
    iput-object v0, p0, LM5/j;->c:LM5/k;

    iput-object p1, p0, LM5/j;->b:Lio/reactivex/x;
    ...
    iget v3, p1, LY1/J;->s:I

    invoke-virtual {p1, v3}, LY1/J;->B(I)I
    ...
    :try_start_0
    invoke-static {v2, p1, v4}, Lf2/a;->b(IIZ)I
    ...
    invoke-static {v2, v5, v3, v6}, LKb/v1;->f(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, p0, LM5/j;->d:Lcom/android/camera/module/X;

    if-eqz v2, :cond_0

    invoke-interface {v2, v5}, Lcom/android/camera/module/X;->setActualCameraId(I)V
    ...
    iput-object v3, v7, LM5/i;->c:Ljava/util/concurrent/ConcurrentHashMap;

    sget-object v7, LI2/j;->b:LI2/j;
    ...
    invoke-virtual {v9}, Lng/a$b;->b()Ljava/util/Set;
    ...
    check-cast v12, Lng/a$a;

    iget-object v13, v12, Lng/a$a;->i:Ljava/lang/String;
    ...
    iget-object v10, v12, Lng/a$a;->g:Lj8/f0;

    if-eqz v10, :cond_3

    iget-boolean v10, v12, Lng/a$a;->a:Z

    if-nez v10, :cond_3

    iget-boolean v10, v12, Lng/a$a;->c:Z

    if-nez v10, :cond_3

    iget-boolean v10, v12, Lng/a$a;->e:Z
    ...
    iget-object v11, v12, Lng/a$a;->g:Lj8/f0;

    if-eqz v11, :cond_5

    iget-boolean v11, v12, Lng/a$a;->a:Z

    if-nez v11, :cond_5

    iget-boolean v11, v12, Lng/a$a;->c:Z

    if-nez v11, :cond_5

    iget-boolean v11, v12, Lng/a$a;->e:Z
    ...
    invoke-virtual {v0, v5, p1, p0, v3}, LM5/i;->d(IILio/reactivex/u;[Ljava/lang/String;)V

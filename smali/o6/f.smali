...
.method public constructor <init>(Ljava/lang/ref/WeakReference;)V
    ...
    iput-object p1, p0, Lo6/f;->a:Ljava/lang/ref/WeakReference;
...
.method public final a(Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lo6/a;->a(Ljava/lang/String;)V
    ...
    invoke-virtual {v3}, LB8/j$a;->toString()Ljava/lang/String;
    ...
    invoke-static {v4}, Lo6/a;->a(Ljava/lang/String;)V

    iget v4, v3, LB8/j$a;->a:I

    iget v5, v3, LB8/j$a;->b:I
    ...
    :cond_0
    sget-object v6, Lo6/c;->a:Ljava/util/ArrayList;
    ...
    iget v9, v8, Lo6/d;->a:I

    if-ne v9, v4, :cond_1

    int-to-float v4, v5

    iget v6, v8, Lo6/d;->b:F
    ...
    invoke-static {v3}, Lo6/a;->a(Ljava/lang/String;)V

    goto/16 :goto_7

    :cond_4
    filled-new-array {v3}, [LB8/j$a;

    move-result-object v3

    iget-object v4, p0, Lo6/f;->a:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {v6, v8}, Lcom/android/camera/module/q;-><init>(I)V

    invoke-virtual {v3, v6}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    sget-object v3, La6/h$a;->a:La6/h;

    const-class v6, Ld6/f;

    invoke-virtual {v3, v6}, La6/h;->d(Ljava/lang/Class;)Ljava/util/Optional;
    ...
    invoke-interface {v3}, Ld6/f;->isShowing()Z
    ...
    invoke-virtual {v8, v9, v7}, Leg/a;->g(Ljava/lang/String;Z)Z
    ...
    invoke-interface {v6, v9, v7, v8, v3}, Ld6/o;->ac(IZZ[Ljava/lang/Object;)V
    ...
    invoke-virtual {v6, v3}, Lcom/android/camera/module/Camera2Module;->setAsdScenes([LB8/j$a;)V

    filled-new-array {v7}, [I

    move-result-object v3

    invoke-virtual {v6, v3}, Lcom/android/camera/module/s;->updatePreferenceInWorkThread([I)V
    ...
    invoke-virtual {v6, v3}, Lcom/android/camera/module/AmbilightModule;->setAsdScenes([LB8/j$a;)V
    ...
    iget-object v3, v4, Lcom/android/camera/module/VideoBase;->mUserRecordSetting:Lcom/android/camera/module/video/D;

    invoke-virtual {v4}, Lcom/android/camera/module/s;->getActualCameraId()I

    move-result v6

    invoke-virtual {v3, v6}, Lcom/android/camera/module/video/D;->g(I)Z

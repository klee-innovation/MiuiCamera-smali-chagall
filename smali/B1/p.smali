...
.method public final a()LA1/w;
    ...
    sget-object v4, LB1/d;->c:Ljava/lang/Boolean;

    if-nez v4, :cond_0

    const-string v4, "cam.app.use.debug.gps"

    invoke-static {v4, v3}, Lfj/f;->c(Ljava/lang/String;Z)Z
    ...
    sput-object v4, LB1/d;->c:Ljava/lang/Boolean;
    ...
    :goto_0
    invoke-virtual/range {p0 .. p0}, LB1/p;->c()Ljava/util/HashMap;
    ...
    check-cast v10, LA1/q;

    iget-wide v11, v10, LA1/q;->a:D

    iget-wide v13, v10, LA1/q;->b:D
    ...
    :goto_1
    iget-wide v12, v10, LA1/q;->c:D

    iget-wide v14, v10, LA1/q;->d:D
    ...
    invoke-virtual/range {p0 .. p0}, LB1/p;->d()Ljava/util/ArrayList;
    ...
    iget-object v3, v1, LA1/w;->a:Ljava/lang/String;

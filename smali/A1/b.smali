...
.method static constructor <clinit>()V
    ...
    sput-object v0, LA1/b;->b:Ljava/lang/Object;
...
.method public static c(I)Ljava/util/ArrayList;
    ...
    :cond_0
    sget-object v2, LA1/b;->a:Ljava/util/ArrayList;

    if-nez v2, :cond_2

    sget-object v2, LA1/b;->b:Ljava/lang/Object;

    monitor-enter v2

    :try_start_0
    sget-object v4, LA1/b;->a:Ljava/util/ArrayList;

    if-nez v4, :cond_1

    new-instance v4, LD1/b;

    invoke-direct {v4, v3}, LD1/b;-><init>(I)V

    new-instance v5, Ljava/util/ArrayList;

    invoke-direct {v5}, Ljava/util/ArrayList;-><init>()V

    iput-object v5, v4, LD1/b;->b:Ljava/lang/Object;

    const/4 v5, 0x0

    iput-object v5, v4, LD1/b;->c:Ljava/lang/Object;

    new-instance v5, Ljava/util/ArrayList;

    invoke-virtual {v4}, LD1/b;->c()Ljava/util/ArrayList;

    move-result-object v4

    invoke-direct {v5, v4}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    sput-object v5, LA1/b;->a:Ljava/util/ArrayList;
    ...
    sget-object v0, LA1/b;->a:Ljava/util/ArrayList;

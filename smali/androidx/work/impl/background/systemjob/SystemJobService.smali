...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:LL0/x;
...
.method public static c(Landroid/app/job/JobParameters;)LT0/m;
    .locals 3
    ...
    invoke-direct {v1, v0, p0}, LT0/m;-><init>(Ljava/lang/String;I)V
    :try_end_0
...
.method public final a(LT0/m;Z)V
    ...
    iget-object v2, p1, LT0/m;->a:Ljava/lang/String;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:LL0/x;

    invoke-virtual {v1, p1}, LL0/x;->a(LT0/m;)LL0/w;
...
.method public final onCreate()V
    ...
    invoke-static {v0}, LL0/V;->c(Landroid/content/Context;)LL0/V;

    move-result-object v0

    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:LL0/V;

    iget-object v1, v0, LL0/V;->f:LL0/q;

    new-instance v2, LL0/U;

    iget-object v0, v0, LL0/V;->d:LV0/b;

    invoke-direct {v2, v1, v0}, LL0/U;-><init>(LL0/q;LV0/b;)V

    iput-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->d:LL0/U;

    invoke-virtual {v1, p0}, LL0/q;->a(LL0/c;)V
    :try_end_0
    ...
    invoke-virtual {p0, v0, v1}, LK0/q;->g(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final onDestroy()V
    ...
    iget-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:LL0/V;
...
.method public final onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    :cond_0
    invoke-static {p1}, Landroidx/work/impl/background/systemjob/SystemJobService;->c(Landroid/app/job/JobParameters;)LT0/m;
    ...
    invoke-virtual {p0, v3, p1}, LK0/q;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v3, p1}, LK0/q;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, v3, v5}, LK0/q;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->d:LL0/U;

    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:LL0/x;

    invoke-virtual {p0, v0}, LL0/x;->c(LT0/m;)LL0/w;

    move-result-object p0

    invoke-virtual {p1, p0, v2}, LL0/U;->c(LL0/w;Landroidx/work/WorkerParameters$a;)V
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p0, p1, v0}, LK0/q;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->c:LL0/x;

    invoke-virtual {v2, v0}, LL0/x;->a(LT0/m;)LL0/w;
    ...
    :goto_0
    iget-object v3, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->d:LL0/U;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v3, v2, p1}, LL0/U;->b(LL0/w;I)V

    :cond_3
    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->a:LL0/V;

    iget-object p0, p0, LL0/V;->f:LL0/q;

    iget-object p1, v0, LT0/m;->a:Ljava/lang/String;
    ...
    :try_start_0
    iget-object p0, p0, LL0/q;->i:Ljava/util/HashSet;

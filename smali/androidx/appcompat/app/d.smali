...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    invoke-super/range {p0 .. p1}, Li/s;->onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v3, v4}, Li/s;->setContentView(I)V
    ...
    sget v5, Lh/f;->topPanel:I

    invoke-virtual {v3, v5}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v6

    sget v7, Lh/f;->contentPanel:I

    invoke-virtual {v3, v7}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v8

    sget v9, Lh/f;->buttonPanel:I
    ...
    iget-boolean v0, v2, Landroidx/appcompat/app/AlertController;->h:Z
    ...
    invoke-static {v0, v6}, Landroidx/appcompat/app/AlertController;->b(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    sget v10, Lh/a;->alertDialogCenterButtons:I
    ...
    iget-object v9, v2, Landroidx/appcompat/app/AlertController;->o:Landroid/widget/Button;
    ...
    invoke-virtual {v0, v8, v14, v7}, Landroid/view/ViewGroup;->addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    iget-object v9, v2, Landroidx/appcompat/app/AlertController;->t:Landroid/widget/ImageView;
    ...
    sget v7, Lh/f;->textSpacerNoButtons:I
    ...
    :cond_18
    iget-object v7, v2, Landroidx/appcompat/app/AlertController;->e:Ljava/lang/CharSequence;
    ...
    :cond_1a
    :goto_d
    sget v7, Lh/f;->titleDividerNoCustom:I
    ...
    :cond_1b
    sget v0, Lh/f;->textSpacerNoTitle:I
    ...
    :cond_1f
    iget v10, v0, Landroidx/appcompat/app/AlertController$RecycleListView;->b:I
    ...
    :cond_21
    iget-object v0, v2, Landroidx/appcompat/app/AlertController;->r:Landroidx/core/widget/NestedScrollView;
    ...
    sget v3, Lh/f;->scrollIndicatorUp:I

    invoke-virtual {v4, v3}, Landroid/view/Window;->findViewById(I)Landroid/view/View;

    move-result-object v3

    sget v6, Lh/f;->scrollIndicatorDown:I
    ...
    invoke-static {v0, v1, v6}, LS/H$e;->d(Landroid/view/View;II)V
...
.method public final setTitle(Ljava/lang/CharSequence;)V
    ...
    invoke-super {p0, p1}, Li/s;->setTitle(Ljava/lang/CharSequence;)V

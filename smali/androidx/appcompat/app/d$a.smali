...
.method public c([Ljava/lang/CharSequence;[ZLs0/d$a;)V
    .locals 0
    ...
    iput-object p3, p0, Landroidx/appcompat/app/AlertController$b;->t:Ls0/d$a;
...
.method public create()Landroidx/appcompat/app/d;
    ...
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->e:Landroid/view/View;

    iget-object v8, v0, Landroidx/appcompat/app/d;->f:Landroidx/appcompat/app/AlertController;

    const/4 v9, 0x0

    if-eqz p0, :cond_0

    iput-object p0, v8, Landroidx/appcompat/app/AlertController;->w:Landroid/view/View;

    goto :goto_0

    :cond_0
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->d:Ljava/lang/CharSequence;

    if-eqz p0, :cond_1

    iput-object p0, v8, Landroidx/appcompat/app/AlertController;->d:Ljava/lang/CharSequence;
    ...
    :cond_1
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->c:Landroid/graphics/drawable/Drawable;

    if-eqz p0, :cond_2

    iput-object p0, v8, Landroidx/appcompat/app/AlertController;->s:Landroid/graphics/drawable/Drawable;

    iget-object v1, v8, Landroidx/appcompat/app/AlertController;->t:Landroid/widget/ImageView;
    ...
    :cond_2
    :goto_0
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->f:Ljava/lang/CharSequence;

    if-eqz p0, :cond_3

    iput-object p0, v8, Landroidx/appcompat/app/AlertController;->e:Ljava/lang/CharSequence;

    iget-object v1, v8, Landroidx/appcompat/app/AlertController;->v:Landroid/widget/TextView;
    ...
    :cond_3
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->g:Ljava/lang/CharSequence;
    ...
    :cond_4
    iget-object v1, v7, Landroidx/appcompat/app/AlertController$b;->h:Landroid/content/DialogInterface$OnClickListener;

    const/4 v2, -0x1

    invoke-virtual {v8, v2, p0, v1}, Landroidx/appcompat/app/AlertController;->c(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V

    :goto_1
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->i:Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-object v1, v7, Landroidx/appcompat/app/AlertController$b;->j:Landroid/content/DialogInterface$OnClickListener;
    ...
    :goto_2
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->l:[Ljava/lang/CharSequence;
    ...
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->m:Ljava/lang/Object;

    if-eqz p0, :cond_e

    :cond_6
    iget p0, v8, Landroidx/appcompat/app/AlertController;->A:I

    iget-object v1, v7, Landroidx/appcompat/app/AlertController$b;->b:Landroid/view/LayoutInflater;
    ...
    iget-boolean v1, v7, Landroidx/appcompat/app/AlertController$b;->q:Z
    ...
    iget-object v5, v7, Landroidx/appcompat/app/AlertController$b;->l:[Ljava/lang/CharSequence;

    iget v4, v8, Landroidx/appcompat/app/AlertController;->B:I
    ...
    :cond_7
    iget-boolean v1, v7, Landroidx/appcompat/app/AlertController$b;->r:Z

    if-eqz v1, :cond_8

    iget v1, v8, Landroidx/appcompat/app/AlertController;->C:I

    goto :goto_3

    :cond_8
    iget v1, v8, Landroidx/appcompat/app/AlertController;->D:I

    :goto_3
    iget-object v12, v7, Landroidx/appcompat/app/AlertController$b;->m:Ljava/lang/Object;
    ...
    iget-object v2, v7, Landroidx/appcompat/app/AlertController$b;->l:[Ljava/lang/CharSequence;
    ...
    :goto_4
    iput-object v12, v8, Landroidx/appcompat/app/AlertController;->x:Landroid/widget/ListAdapter;

    iget v1, v7, Landroidx/appcompat/app/AlertController$b;->s:I

    iput v1, v8, Landroidx/appcompat/app/AlertController;->y:I

    iget-object v1, v7, Landroidx/appcompat/app/AlertController$b;->n:Landroid/content/DialogInterface$OnClickListener;
    ...
    :cond_a
    iget-object v1, v7, Landroidx/appcompat/app/AlertController$b;->t:Ls0/d$a;

    if-eqz v1, :cond_b

    new-instance v1, Landroidx/appcompat/app/c;

    invoke-direct {v1, v7, p0, v8}, Landroidx/appcompat/app/c;-><init>(Landroidx/appcompat/app/AlertController$b;Landroidx/appcompat/app/AlertController$RecycleListView;Landroidx/appcompat/app/AlertController;)V
    ...
    :cond_d
    :goto_6
    iput-object p0, v8, Landroidx/appcompat/app/AlertController;->f:Landroidx/appcompat/app/AlertController$RecycleListView;

    :cond_e
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->o:Landroid/view/View;

    if-eqz p0, :cond_f

    iput-object p0, v8, Landroidx/appcompat/app/AlertController;->g:Landroid/view/View;

    iput-boolean v9, v8, Landroidx/appcompat/app/AlertController;->h:Z
    ...
    iget-object p0, v7, Landroidx/appcompat/app/AlertController$b;->k:Landroidx/appcompat/view/menu/g;
...
.method public f([Ljava/lang/CharSequence;ILs0/c$a;)V
    .locals 0

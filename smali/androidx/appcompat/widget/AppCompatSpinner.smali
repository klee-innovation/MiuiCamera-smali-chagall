...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p0}, Lp/K;->a(Landroid/content/Context;Landroid/view/View;)V
    ...
    invoke-direct {v1, p0}, Lp/d;-><init>(Landroid/view/View;)V

    iput-object v1, p0, Landroidx/appcompat/widget/AppCompatSpinner;->a:Lp/d;

    sget v1, Lh/j;->Spinner_popupTheme:I

    iget-object v2, v0, Lp/P;->b:Landroid/content/res/TypedArray;
    ...
    invoke-direct {v4, p1, v1}, Ln/c;-><init>(Landroid/content/Context;I)V
    ...
    sget-object v6, Lh/j;->Spinner:[I

    invoke-static {v5, p2, v6, p3}, Lp/P;->e(Landroid/content/Context;Landroid/util/AttributeSet;[II)Lp/P;

    move-result-object v5

    sget v6, Lh/j;->Spinner_android_dropDownWidth:I

    iget-object v7, v5, Lp/P;->b:Landroid/content/res/TypedArray;
    ...
    sget v6, Lh/j;->Spinner_android_popupBackground:I

    invoke-virtual {v5, v6}, Lp/P;->b(I)Landroid/graphics/drawable/Drawable;

    move-result-object v6

    invoke-virtual {v1, v6}, Lp/D;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    sget v6, Lh/j;->Spinner_android_prompt:I

    invoke-virtual {v2, v6}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v1, Landroidx/appcompat/widget/AppCompatSpinner$e;->h0:Ljava/lang/CharSequence;

    invoke-virtual {v5}, Lp/P;->f()V
    ...
    :goto_4
    sget v1, Lh/j;->Spinner_android_entries:I
    ...
    :cond_6
    iget-object p0, p0, Landroidx/appcompat/widget/AppCompatSpinner;->a:Lp/d;

    invoke-virtual {p0, p2, p3}, Lp/d;->d(Landroid/util/AttributeSet;I)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0, p0, p1}, Lp/B;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public final performClick()Z
    ...
    invoke-interface {p0, v0, v1}, Landroidx/appcompat/widget/AppCompatSpinner$f;->b(II)V
...
.method public setAdapter(Landroid/widget/SpinnerAdapter;)V
    ...
    .line 17
    invoke-interface {p1}, Lp/L;->getDropDownViewTheme()Landroid/content/res/Resources$Theme;

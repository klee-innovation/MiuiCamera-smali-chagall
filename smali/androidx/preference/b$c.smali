...
.method public final a(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)Z
    ...
    iget-boolean v0, v0, Ls0/f;->e:Z

    if-eqz v0, :cond_2

    iget-boolean p0, p0, Landroidx/preference/b$c;->c:Z
    ...
    invoke-virtual {p2, p0}, Landroidx/recyclerview/widget/RecyclerView;->getChildViewHolder(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$B;

    move-result-object p0

    instance-of p1, p0, Ls0/f;

    if-eqz p1, :cond_0

    check-cast p0, Ls0/f;

    iget-boolean p0, p0, Ls0/f;->d:Z
...
.method public final getItemOffsets(Landroid/graphics/Rect;Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    invoke-virtual {p0, p2, p3}, Landroidx/preference/b$c;->a(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)Z

    move-result p2

    if-eqz p2, :cond_0

    iget p0, p0, Landroidx/preference/b$c;->b:I
...
.method public final onDrawOver(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$y;)V
    ...
    invoke-virtual {p0, v3, p2}, Landroidx/preference/b$c;->a(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView;)Z

...
.method public final a(Landroidx/recyclerview/widget/RecyclerView$B;Z)V
    ...
    invoke-virtual {v2}, Landroidx/recyclerview/widget/F;->a()LS/a;
    ...
    iget-object v2, v2, Landroidx/recyclerview/widget/F$a;->b:Ljava/util/WeakHashMap;
    ...
    :goto_0
    invoke-static {v0, v2}, LS/H;->j(Landroid/view/View;LS/a;)V
    ...
    iget-object p2, v1, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:Landroidx/recyclerview/widget/M;

    invoke-virtual {p2, p1}, Landroidx/recyclerview/widget/M;->d(Landroidx/recyclerview/widget/RecyclerView$B;)V
...
.method public final b(ILandroid/view/View;)V
    ...
    iget-object v0, v6, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Landroidx/recyclerview/widget/a;

    const/4 v7, 0x0

    invoke-virtual {v0, p1, v7}, Landroidx/recyclerview/widget/a;->f(II)I

    move-result v2

    if-ltz v2, :cond_3

    iget-object v0, v6, Landroidx/recyclerview/widget/RecyclerView;->mAdapter:Landroidx/recyclerview/widget/RecyclerView$g;
    ...
    :cond_0
    invoke-virtual {v6, p0}, Landroidx/recyclerview/widget/RecyclerView;->checkLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Z

    move-result p1

    if-nez p1, :cond_1

    invoke-virtual {v6, p0}, Landroidx/recyclerview/widget/RecyclerView;->generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    iput-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$o;->a:Landroidx/recyclerview/widget/RecyclerView$B;
    ...
    :cond_2
    iput-boolean v7, p0, Landroidx/recyclerview/widget/RecyclerView$o;->d:Z
    ...
    invoke-static {p1, v2, p2, v0, v1}, LB2/m;->h(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-object p2, v6, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/RecyclerView$y;
    ...
    invoke-static {v6, p1}, LB2/l;->e(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final i(Landroid/view/View;)V
    ...
    invoke-virtual {p0, v0}, Landroidx/recyclerview/widget/RecyclerView$l;->endAnimation(Landroidx/recyclerview/widget/RecyclerView$B;)V
...
.method public final j(Landroidx/recyclerview/widget/RecyclerView$B;)V
    ...
    iget-object v6, v3, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/recyclerview/widget/q$b;
    ...
    iget-object v7, v3, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/recyclerview/widget/q$b;
    ...
    :goto_7
    iget-object p0, v3, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:Landroidx/recyclerview/widget/M;
    ...
    invoke-static {v3, p1}, LB2/l;->e(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v3, v0}, LB2/l;->e(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final k(Landroid/view/View;)V
    ...
    invoke-static {v1, p1}, LB2/l;->e(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final l(Landroidx/recyclerview/widget/RecyclerView$B;IIJ)Z
    ...
    sget-object p4, LS/H;->a:Ljava/util/WeakHashMap;
    ...
    :cond_3
    iget-object p4, v1, Landroidx/recyclerview/widget/RecyclerView;->mAccessibilityDelegate:Landroidx/recyclerview/widget/F;
    ...
    :cond_4
    invoke-virtual {p4}, Landroidx/recyclerview/widget/F;->a()LS/a;

    move-result-object p4

    instance-of p5, p4, Landroidx/recyclerview/widget/F$a;

    if-eqz p5, :cond_7

    move-object p5, p4

    check-cast p5, Landroidx/recyclerview/widget/F$a;
    ...
    :cond_5
    instance-of v0, v2, LS/a$a;

    if-eqz v0, :cond_6

    check-cast v2, LS/a$a;

    iget-object v0, v2, LS/a$a;->a:LS/a;
    ...
    invoke-direct {v0, v2}, LS/a;-><init>(Landroid/view/View$AccessibilityDelegate;)V
    ...
    iget-object p5, p5, Landroidx/recyclerview/widget/F$a;->b:Ljava/util/WeakHashMap;

    invoke-virtual {p5, p0, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_7
    invoke-static {p0, p4}, LS/H;->j(Landroid/view/View;LS/a;)V
...
.method public final m(IJ)Landroidx/recyclerview/widget/RecyclerView$B;
    ...
    invoke-static {v6, v1}, LB2/l;->e(Landroidx/recyclerview/widget/RecyclerView;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView$B;->isAttachedToTransitionOverlay()Z
    ...
    invoke-virtual {v9, v12}, Landroidx/recyclerview/widget/RecyclerView$t;->a(I)Landroidx/recyclerview/widget/RecyclerView$t$a;
    ...
    iput-object v13, v9, Landroidx/recyclerview/widget/RecyclerView$B;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    invoke-virtual {v2, v12}, Landroidx/recyclerview/widget/RecyclerView$t;->a(I)Landroidx/recyclerview/widget/RecyclerView$t$a;
    ...
    invoke-static {v3, v11, v1, v2, v4}, LB2/m;->h(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-virtual {v10, v1}, Landroidx/recyclerview/widget/RecyclerView$B;->hasAnyOfTheFlags(I)Z

    move-result v2

    if-eqz v2, :cond_2f

    invoke-virtual {v10, v7, v1}, Landroidx/recyclerview/widget/RecyclerView$B;->setFlags(II)V

    iget-object v1, v6, Landroidx/recyclerview/widget/RecyclerView;->mState:Landroidx/recyclerview/widget/RecyclerView$y;

    iget-boolean v1, v1, Landroidx/recyclerview/widget/RecyclerView$y;->j:Z

    if-eqz v1, :cond_2f

    invoke-static {v10}, Landroidx/recyclerview/widget/RecyclerView$l;->buildAdapterChangeFlagsForAnimations(Landroidx/recyclerview/widget/RecyclerView$B;)I
    ...
    invoke-virtual {v10}, Landroidx/recyclerview/widget/RecyclerView$B;->getUnmodifiedPayloads()Ljava/util/List;

    move-result-object v5

    invoke-virtual {v2, v4, v10, v1, v5}, Landroidx/recyclerview/widget/RecyclerView$l;->recordPreLayoutInformation(Landroidx/recyclerview/widget/RecyclerView$y;Landroidx/recyclerview/widget/RecyclerView$B;ILjava/util/List;)Landroidx/recyclerview/widget/RecyclerView$l$c;

    move-result-object v1

    invoke-virtual {v6, v10, v1}, Landroidx/recyclerview/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Landroidx/recyclerview/widget/RecyclerView$B;Landroidx/recyclerview/widget/RecyclerView$l$c;)V
    ...
    invoke-virtual {v10}, Landroidx/recyclerview/widget/RecyclerView$B;->isBound()Z

    move-result v1

    if-eqz v1, :cond_30

    iput v3, v10, Landroidx/recyclerview/widget/RecyclerView$B;->mPreLayoutPosition:I
    ...
    invoke-virtual {v10}, Landroidx/recyclerview/widget/RecyclerView$B;->needsUpdate()Z
    ...
    :cond_32
    :goto_19
    iget-object v1, v6, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Landroidx/recyclerview/widget/a;

    invoke-virtual {v1, v3, v7}, Landroidx/recyclerview/widget/a;->f(II)I
    ...
    :goto_1a
    iget-object v1, v10, Landroidx/recyclerview/widget/RecyclerView$B;->itemView:Landroid/view/View;
    ...
    iget-object v2, v10, Landroidx/recyclerview/widget/RecyclerView$B;->itemView:Landroid/view/View;
    ...
    :goto_1b
    iput-object v10, v1, Landroidx/recyclerview/widget/RecyclerView$o;->a:Landroidx/recyclerview/widget/RecyclerView$B;
    ...
    invoke-static {v3, v3, v1, v2, v4}, LB2/m;->h(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

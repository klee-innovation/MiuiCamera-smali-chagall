...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/h;->c:Ljava/util/ArrayList;
...
.method public final a(Ljava/util/ArrayList;Landroidx/recyclerview/widget/RecyclerView$B;)V
    ...
    invoke-virtual {p0, v1, p2}, Landroidx/recyclerview/widget/h;->b(Landroidx/recyclerview/widget/h$d;Landroidx/recyclerview/widget/RecyclerView$B;)Z
...
.method public final animateAdd(Landroidx/recyclerview/widget/RecyclerView$B;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/h;->resetAnimation(Landroidx/recyclerview/widget/RecyclerView$B;)V
...
.method public final animateChange(Landroidx/recyclerview/widget/RecyclerView$B;Landroidx/recyclerview/widget/RecyclerView$B;IIII)Z
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/recyclerview/widget/h;->animateMove(Landroidx/recyclerview/widget/RecyclerView$B;IIII)Z
    ...
    invoke-virtual {p0, p2}, Landroidx/recyclerview/widget/h;->resetAnimation(Landroidx/recyclerview/widget/RecyclerView$B;)V
    ...
    :cond_1
    iget-object p0, p0, Landroidx/recyclerview/widget/h;->d:Ljava/util/ArrayList;

    new-instance v0, Landroidx/recyclerview/widget/h$d;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    iput-object p1, v0, Landroidx/recyclerview/widget/h$d;->a:Landroidx/recyclerview/widget/RecyclerView$B;

    iput-object p2, v0, Landroidx/recyclerview/widget/h$d;->b:Landroidx/recyclerview/widget/RecyclerView$B;

    iput p3, v0, Landroidx/recyclerview/widget/h$d;->c:I

    iput p4, v0, Landroidx/recyclerview/widget/h$d;->d:I

    iput p5, v0, Landroidx/recyclerview/widget/h$d;->e:I

    iput p6, v0, Landroidx/recyclerview/widget/h$d;->f:I
...
.method public final animateMove(Landroidx/recyclerview/widget/RecyclerView$B;IIII)Z
    ...
    :cond_2
    iget-object p0, p0, Landroidx/recyclerview/widget/h;->c:Ljava/util/ArrayList;
...
.method public final animateRemove(Landroidx/recyclerview/widget/RecyclerView$B;)Z
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/h;->a:Ljava/util/ArrayList;
...
.method public final b(Landroidx/recyclerview/widget/h$d;Landroidx/recyclerview/widget/RecyclerView$B;)Z
    .locals 4
    ...
    iput-object v2, p1, Landroidx/recyclerview/widget/h$d;->b:Landroidx/recyclerview/widget/RecyclerView$B;
    ...
    iput-object v2, p1, Landroidx/recyclerview/widget/h$d;->a:Landroidx/recyclerview/widget/RecyclerView$B;
...
.method public final endAnimation(Landroidx/recyclerview/widget/RecyclerView$B;)V
    ...
    invoke-virtual {p0, v1, p1}, Landroidx/recyclerview/widget/h;->a(Ljava/util/ArrayList;Landroidx/recyclerview/widget/RecyclerView$B;)V
    ...
    :cond_2
    iget-object v1, p0, Landroidx/recyclerview/widget/h;->b:Ljava/util/ArrayList;
    ...
    :cond_3
    iget-object v1, p0, Landroidx/recyclerview/widget/h;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, v5, p1}, Landroidx/recyclerview/widget/h;->a(Ljava/util/ArrayList;Landroidx/recyclerview/widget/RecyclerView$B;)V
...
.method public final endAnimations()V
    ...
    invoke-virtual {p0, v4, v5}, Landroidx/recyclerview/widget/h;->b(Landroidx/recyclerview/widget/h$d;Landroidx/recyclerview/widget/RecyclerView$B;)Z
...
.method public final isRunning()Z
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/h;->g:Ljava/util/ArrayList;
...
.method public final resetAnimation(Landroidx/recyclerview/widget/RecyclerView$B;)V
    .locals 2

    sget-object v0, Landroidx/recyclerview/widget/h;->l:Landroid/animation/TimeInterpolator;
    ...
    sput-object v0, Landroidx/recyclerview/widget/h;->l:Landroid/animation/TimeInterpolator;
    ...
    sget-object v1, Landroidx/recyclerview/widget/h;->l:Landroid/animation/TimeInterpolator;

    invoke-virtual {v0, v1}, Landroid/view/ViewPropertyAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)Landroid/view/ViewPropertyAnimator;

    invoke-virtual {p0, p1}, Landroidx/recyclerview/widget/h;->endAnimation(Landroidx/recyclerview/widget/RecyclerView$B;)V
...
.method public final runPendingAnimations()V
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/h;->c:Ljava/util/ArrayList;

    invoke-virtual {v2}, Ljava/util/ArrayList;->isEmpty()Z

    move-result v3

    iget-object v4, p0, Landroidx/recyclerview/widget/h;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p0, Landroidx/recyclerview/widget/h;->j:Ljava/util/ArrayList;
    ...
    iget-object v8, p0, Landroidx/recyclerview/widget/h;->g:Ljava/util/ArrayList;

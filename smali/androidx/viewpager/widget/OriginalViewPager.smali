...
.field public static final F0:Landroidx/viewpager/widget/OriginalViewPager$a;


# instance fields
.field public A0:Ljava/util/ArrayList;

.field public B0:Landroidx/viewpager/widget/OriginalViewPager$g;

.field public final C0:Landroidx/viewpager/widget/OriginalViewPager$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/viewpager/widget/OriginalViewPager;->E0:[I

    new-instance v0, Landroidx/viewpager/widget/OriginalViewPager$a;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroidx/viewpager/widget/OriginalViewPager;->F0:Landroidx/viewpager/widget/OriginalViewPager$a;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->f0:I

    iput p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->p0:I

    const/4 p1, 0x1

    iput-boolean p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->x0:Z
    ...
    iput-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->C0:Landroidx/viewpager/widget/OriginalViewPager$b;

    iput v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->D0:I
    ...
    iput-boolean p1, v1, Lto/h;->l:Z

    iput-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->j:Lto/h;
    ...
    iput v3, p0, Landroidx/viewpager/widget/OriginalViewPager;->k0:I
    ...
    iput v3, p0, Landroidx/viewpager/widget/OriginalViewPager;->r0:I

    invoke-virtual {v1}, Landroid/view/ViewConfiguration;->getScaledMaximumFlingVelocity()I

    move-result v1

    iput v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->s0:I

    new-instance v1, Landroid/widget/EdgeEffect;

    invoke-direct {v1, v0}, Landroid/widget/EdgeEffect;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->v0:Landroid/widget/EdgeEffect;

    new-instance v1, Landroid/widget/EdgeEffect;

    invoke-direct {v1, v0}, Landroid/widget/EdgeEffect;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->w0:Landroid/widget/EdgeEffect;
    ...
    iput v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->t0:I
    ...
    iput v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->u0:I
    ...
    iput v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->i0:I
    ...
    invoke-direct {p1, p0}, LH0/a;-><init>(Landroidx/viewpager/widget/OriginalViewPager;)V

    invoke-static {p0, p1}, LS/H$d;->u(Landroid/view/View;LS/u;)V
...
.method private setScrollingCacheEnabled(Z)V
    ...
    iget-boolean v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->d0:Z

    if-eq v0, p1, :cond_0

    iput-boolean p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->d0:Z
...
.method public final a(II)Landroidx/viewpager/widget/OriginalViewPager$d;
    ...
    iget-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    invoke-virtual {v1, p0, p1}, LH0/b;->f(Landroid/view/ViewGroup;I)Landroidx/fragment/app/Fragment;

    move-result-object v1

    iput-object v1, v0, Landroidx/viewpager/widget/OriginalViewPager$d;->a:Ljava/lang/Object;

    iget-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    invoke-virtual {v1, p1}, LH0/b;->e(I)F
...
.method public final b(I)Z
    ...
    iput-boolean v3, p0, Landroidx/viewpager/widget/OriginalViewPager;->e0:Z
...
.method public final canScrollHorizontally(I)Z
    ...
    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;
...
.method public final computeScroll()V
    ...
    iget-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->j:Lto/h;

    iget-boolean v2, v1, Lto/h;->l:Z

    if-nez v2, :cond_2

    invoke-virtual {v1}, Lto/h;->a()Z
    ...
    iget-wide v4, v1, Lto/h;->c:D

    double-to-int v4, v4

    iget-wide v5, v1, Lto/h;->d:D
...
.method public final d(Z)V
    ...
    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->j:Lto/h;

    iget v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->D0:I
    ...
    iget-boolean v2, v0, Lto/h;->l:Z

    if-nez v2, :cond_2

    iput-boolean v3, v0, Lto/h;->l:Z
    ...
    iget-wide v6, v0, Lto/h;->c:D

    double-to-int v6, v6

    iget-wide v7, v0, Lto/h;->d:D
    ...
    :cond_2
    iput-boolean v4, p0, Landroidx/viewpager/widget/OriginalViewPager;->e0:Z
    ...
    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->C0:Landroidx/viewpager/widget/OriginalViewPager$b;
...
.method public final dispatchKeyEvent(Landroid/view/KeyEvent;)Z
    ...
    iput-boolean v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->e0:Z
...
.method public final draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->w0:Landroid/widget/EdgeEffect;

    iget-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->v0:Landroid/widget/EdgeEffect;
    ...
    iget-object v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    if-eqz v2, :cond_0

    invoke-virtual {v2}, LH0/b;->c()I
...
.method public final e()V
    ...
    iget v3, p0, Landroidx/viewpager/widget/OriginalViewPager;->f0:I
    ...
    iget-object v9, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    iget-object v10, v8, Landroidx/viewpager/widget/OriginalViewPager$d;->a:Ljava/lang/Object;

    invoke-virtual {v9, v10}, LH0/b;->d(Ljava/lang/Object;)I
    ...
    invoke-virtual {v2, p0}, LH0/b;->k(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v2, v9}, LH0/b;->a(Ljava/lang/Object;)V
    ...
    :cond_8
    sget-object v0, Landroidx/viewpager/widget/OriginalViewPager;->F0:Landroidx/viewpager/widget/OriginalViewPager$a;
...
.method public final f(I)V
    ...
    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->B0:Landroidx/viewpager/widget/OriginalViewPager$g;

    if-eqz v0, :cond_0

    invoke-interface {v0, p1}, Landroidx/viewpager/widget/OriginalViewPager$g;->onPageSelected(I)V

    :cond_0
    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->A0:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->A0:Ljava/util/ArrayList;
    ...
    invoke-interface {v2, p1}, Landroidx/viewpager/widget/OriginalViewPager$g;->onPageSelected(I)V
...
.method public final generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 5
    sget-object v1, Landroidx/viewpager/widget/OriginalViewPager;->E0:[I
...
.method public getAdapter()LH0/b;
    .locals 0

    iget-object p0, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;
...
.method public getOffscreenPageLimit()I
    ...
    iget p0, p0, Landroidx/viewpager/widget/OriginalViewPager;->f0:I
...
.method public final h(Landroid/view/View;)Landroidx/viewpager/widget/OriginalViewPager$d;
    ...
    invoke-virtual {v2, p1, v3}, LH0/b;->g(Landroid/view/View;Ljava/lang/Object;)Z
...
.method public final i()Landroidx/viewpager/widget/OriginalViewPager$d;
    ...
    invoke-virtual {v1, v6}, LH0/b;->e(I)F
...
.method public final l(IFI)V
    ...
    iget p3, p0, Landroidx/viewpager/widget/OriginalViewPager;->z0:I
    ...
    :cond_5
    iget-object p3, p0, Landroidx/viewpager/widget/OriginalViewPager;->B0:Landroidx/viewpager/widget/OriginalViewPager$g;

    if-eqz p3, :cond_6

    invoke-interface {p3, p2, p1}, Landroidx/viewpager/widget/OriginalViewPager$g;->a(FI)V

    :cond_6
    iget-object p3, p0, Landroidx/viewpager/widget/OriginalViewPager;->A0:Ljava/util/ArrayList;
    ...
    invoke-interface {v2, p2, p1}, Landroidx/viewpager/widget/OriginalViewPager$g;->a(FI)V
    ...
    :cond_8
    iput-boolean v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->y0:Z
...
.method public final m(Landroid/view/MotionEvent;)V
    ...
    iget v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->p0:I
    ...
    iput v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->l0:F
    ...
    iget-object p0, p0, Landroidx/viewpager/widget/OriginalViewPager;->q0:Landroid/view/VelocityTracker;
...
.method public final n()Z
    ...
    iput-boolean v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->e0:Z
...
.method public final o(I)Z
    ...
    iget-boolean p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->x0:Z
    ...
    :cond_0
    iput-boolean v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->y0:Z

    const/4 p1, 0x0

    invoke-virtual {p0, v2, p1, v2}, Landroidx/viewpager/widget/OriginalViewPager;->l(IFI)V

    iget-boolean p0, p0, Landroidx/viewpager/widget/OriginalViewPager;->y0:Z
...
.method public final onAttachedToWindow()V
    ...
    iput-boolean v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->x0:Z
...
.method public final onDetachedFromWindow()V
    ...
    iget-boolean v1, v0, Lto/h;->l:Z

    if-nez v1, :cond_0

    const/4 v1, 0x1

    iput-boolean v1, v0, Lto/h;->l:Z
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v2, v0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;
    ...
    :cond_1
    iget-object v12, v0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    invoke-virtual {v12, v10}, LH0/b;->e(I)F
    ...
    :goto_2
    iget v13, v0, Landroidx/viewpager/widget/OriginalViewPager;->m:I
    ...
    iget-object v13, v0, Landroidx/viewpager/widget/OriginalViewPager;->n:Landroid/graphics/drawable/Drawable;
    ...
    iget v4, v0, Landroidx/viewpager/widget/OriginalViewPager;->p:I

    invoke-virtual {v13, v14, v15, v1, v4}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->k0:I
    ...
    iget-boolean v5, p0, Landroidx/viewpager/widget/OriginalViewPager;->g0:Z
    ...
    :cond_1
    iget-boolean v5, p0, Landroidx/viewpager/widget/OriginalViewPager;->h0:Z
    ...
    :cond_4
    iget v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->p0:I
    ...
    iget v5, p0, Landroidx/viewpager/widget/OriginalViewPager;->l0:F
    ...
    iget v7, p0, Landroidx/viewpager/widget/OriginalViewPager;->o0:F
    ...
    iget v10, p0, Landroidx/viewpager/widget/OriginalViewPager;->l0:F

    iget v11, p0, Landroidx/viewpager/widget/OriginalViewPager;->j0:I
    ...
    iget v12, p0, Landroidx/viewpager/widget/OriginalViewPager;->j0:I
    ...
    iput v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->l0:F

    iput v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->m0:F

    iput-boolean v3, p0, Landroidx/viewpager/widget/OriginalViewPager;->h0:Z
    ...
    iput-boolean v3, p0, Landroidx/viewpager/widget/OriginalViewPager;->g0:Z
    ...
    iget v4, p0, Landroidx/viewpager/widget/OriginalViewPager;->n0:F
    ...
    :goto_1
    iput v4, p0, Landroidx/viewpager/widget/OriginalViewPager;->l0:F
    ...
    :cond_d
    :goto_2
    iget-boolean v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->g0:Z
    ...
    iput v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->n0:F
    ...
    iput v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->o0:F

    iput v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->m0:F

    invoke-virtual {p1, v4}, Landroid/view/MotionEvent;->getPointerId(I)I

    move-result v1

    iput v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->p0:I

    iput-boolean v4, p0, Landroidx/viewpager/widget/OriginalViewPager;->h0:Z

    iput-boolean v3, p0, Landroidx/viewpager/widget/OriginalViewPager;->k:Z

    invoke-virtual {v0}, Lto/h;->a()Z

    iget v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->D0:I

    if-ne v1, v5, :cond_10

    iget-wide v1, v0, Lto/h;->f:D

    double-to-int v1, v1

    iget-wide v5, v0, Lto/h;->c:D
    ...
    iget v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->u0:I
    ...
    iput-boolean v4, p0, Landroidx/viewpager/widget/OriginalViewPager;->g0:Z

    :cond_11
    :goto_3
    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->q0:Landroid/view/VelocityTracker;
    ...
    iput-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->q0:Landroid/view/VelocityTracker;
...
.method public final onLayout(ZIIII)V
    ...
    iput v11, v0, Landroidx/viewpager/widget/OriginalViewPager;->z0:I

    iget-boolean v1, v0, Landroidx/viewpager/widget/OriginalViewPager;->x0:Z
    ...
    invoke-virtual {v0, v1, v2, v2, v2}, Landroidx/viewpager/widget/OriginalViewPager;->u(IIZZ)V
    ...
    :goto_6
    iput-boolean v2, v0, Landroidx/viewpager/widget/OriginalViewPager;->x0:Z
...
.method public final onMeasure(II)V
    ...
    iget v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->i0:I

    invoke-static {p2, v1}, Ljava/lang/Math;->min(II)I

    move-result p2

    iput p2, p0, Landroidx/viewpager/widget/OriginalViewPager;->j0:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_1
    iget-object v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->q0:Landroid/view/VelocityTracker;
    ...
    iput-object v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->q0:Landroid/view/VelocityTracker;
    ...
    iget v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->p0:I
    ...
    iput p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->l0:F
    ...
    :cond_5
    iget-boolean p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->g0:Z
    ...
    :cond_6
    iget-boolean v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->g0:Z
    ...
    iget v6, p0, Landroidx/viewpager/widget/OriginalViewPager;->m0:F
    ...
    iput-boolean v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->g0:Z
    ...
    :cond_8
    iget v5, p0, Landroidx/viewpager/widget/OriginalViewPager;->n0:F
    ...
    :goto_0
    iput v5, p0, Landroidx/viewpager/widget/OriginalViewPager;->l0:F

    iput v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->m0:F
    ...
    :cond_a
    iget-boolean v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->g0:Z
    ...
    iget-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->q0:Landroid/view/VelocityTracker;

    iget v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->s0:I
    ...
    iput-boolean v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->e0:Z
    ...
    iget v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->n0:F
    ...
    iget v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->t0:I
    ...
    iget v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->r0:I
...
.method public final p(F)Z
    ...
    iget v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->l0:F
    ...
    invoke-static {v6, v3}, LGc/q;->e(ILjava/util/ArrayList;)Ljava/lang/Object;
    ...
    iget-object v8, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;
    ...
    iget-object v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->v0:Landroid/widget/EdgeEffect;
    ...
    iget-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->w0:Landroid/widget/EdgeEffect;
...
.method public final r(I)V
    ...
    :goto_0
    iget-object v1, v0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;
    ...
    :cond_1
    iget-boolean v1, v0, Landroidx/viewpager/widget/OriginalViewPager;->e0:Z
    ...
    invoke-virtual {v1, v0}, LH0/b;->k(Landroid/view/ViewGroup;)V

    iget v1, v0, Landroidx/viewpager/widget/OriginalViewPager;->f0:I
    ...
    iget-object v6, v0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    invoke-virtual {v6}, LH0/b;->c()I
    ...
    iget-object v10, v0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    iget-object v12, v12, Landroidx/viewpager/widget/OriginalViewPager$d;->a:Ljava/lang/Object;

    invoke-virtual {v10, v12}, LH0/b;->a(Ljava/lang/Object;)V
    ...
    iget-object v13, v0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    iget-object v5, v5, Landroidx/viewpager/widget/OriginalViewPager$d;->a:Ljava/lang/Object;

    invoke-virtual {v13, v5}, LH0/b;->a(Ljava/lang/Object;)V
    ...
    iget v3, v2, Landroidx/viewpager/widget/OriginalViewPager$d;->b:I

    iget v6, v9, Landroidx/viewpager/widget/OriginalViewPager$d;->b:I

    if-ge v3, v6, :cond_1a

    iget v6, v2, Landroidx/viewpager/widget/OriginalViewPager$d;->e:F
    ...
    iget-object v11, v0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    invoke-virtual {v11, v3}, LH0/b;->e(I)F
    ...
    iput v2, v10, Landroidx/viewpager/widget/OriginalViewPager$d;->e:F
    ...
    iget v3, v9, Landroidx/viewpager/widget/OriginalViewPager$d;->e:F
    ...
    :goto_15
    iput v11, v0, Landroidx/viewpager/widget/OriginalViewPager;->q:F
    ...
    iget v6, v9, Landroidx/viewpager/widget/OriginalViewPager$d;->d:F
    ...
    :goto_16
    iput v6, v0, Landroidx/viewpager/widget/OriginalViewPager;->r:F
    ...
    check-cast v6, Landroidx/viewpager/widget/OriginalViewPager$d;

    :goto_18
    iget v12, v6, Landroidx/viewpager/widget/OriginalViewPager$d;->b:I
    ...
    :cond_20
    iget v13, v6, Landroidx/viewpager/widget/OriginalViewPager$d;->d:F

    add-float/2addr v13, v5

    sub-float/2addr v3, v13

    iput v3, v6, Landroidx/viewpager/widget/OriginalViewPager$d;->e:F

    if-nez v12, :cond_21

    iput v3, v0, Landroidx/viewpager/widget/OriginalViewPager;->q:F
    ...
    invoke-virtual {v10, v6}, LH0/b;->e(I)F
    ...
    iget v10, v7, Landroidx/viewpager/widget/OriginalViewPager$d;->d:F
    ...
    :cond_24
    iput v3, v7, Landroidx/viewpager/widget/OriginalViewPager$d;->e:F

    iget v7, v7, Landroidx/viewpager/widget/OriginalViewPager$d;->d:F
    ...
    invoke-virtual {v1, v2}, LH0/b;->i(Ljava/lang/Object;)V

    :cond_26
    iget-object v1, v0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    invoke-virtual {v1}, LH0/b;->b()V
    ...
    invoke-static {v3, v4, v5, v6, v7}, LA1/v;->i(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)V
    ...
    iget-object v0, v0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;
...
.method public setAdapter(LH0/b;)V
    .locals 6
    ...
    invoke-virtual {v0, v1}, LH0/b;->j(Landroid/database/DataSetObserver;)V

    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    invoke-virtual {v0, p0}, LH0/b;->k(Landroid/view/ViewGroup;)V
    ...
    iget-object v4, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    iget v5, v1, Landroidx/viewpager/widget/OriginalViewPager$d;->b:I

    iget-object v1, v1, Landroidx/viewpager/widget/OriginalViewPager$d;->a:Ljava/lang/Object;

    invoke-virtual {v4, v1}, LH0/b;->a(Ljava/lang/Object;)V
    ...
    iget-boolean v1, v1, Landroidx/viewpager/widget/OriginalViewPager$e;->a:Z
    ...
    :cond_3
    iput-object p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;
    ...
    :cond_4
    iget-object p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->e:LH0/b;

    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->l:Landroidx/viewpager/widget/OriginalViewPager$h;

    invoke-virtual {p1, v0}, LH0/b;->j(Landroid/database/DataSetObserver;)V

    iput-boolean v3, p0, Landroidx/viewpager/widget/OriginalViewPager;->e0:Z

    iget-boolean p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->x0:Z

    iput-boolean v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->x0:Z
    ...
    invoke-virtual {p1}, LH0/b;->c()I

    move-result p1

    iget v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->g:I

    iget-boolean v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->h:Z
...
.method public setCurrentItem(I)V
    ...
    iget-boolean v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->x0:Z
...
.method public setOffscreenPageLimit(I)V
    ...
    :cond_0
    iget v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->f0:I

    if-eq p1, v0, :cond_1

    iput p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->f0:I
...
.method public setOnPageChangeListener(Landroidx/viewpager/widget/OriginalViewPager$g;)V
    ...
    iput-object p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->B0:Landroidx/viewpager/widget/OriginalViewPager$g;
...
.method public setScrollState(I)V
    ...
    iget v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->D0:I
    ...
    :cond_0
    iput p1, p0, Landroidx/viewpager/widget/OriginalViewPager;->D0:I

    iget-object v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->B0:Landroidx/viewpager/widget/OriginalViewPager$g;

    if-eqz v0, :cond_1

    invoke-interface {v0, p1}, Landroidx/viewpager/widget/OriginalViewPager$g;->onPageScrollStateChanged(I)V
    ...
    invoke-interface {v2, p1}, Landroidx/viewpager/widget/OriginalViewPager$g;->onPageScrollStateChanged(I)V
...
.method public final t()Z
    ...
    iput v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->p0:I

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->g0:Z

    iput-boolean v0, p0, Landroidx/viewpager/widget/OriginalViewPager;->h0:Z
    ...
    iput-object v1, p0, Landroidx/viewpager/widget/OriginalViewPager;->q0:Landroid/view/VelocityTracker;
    ...
    iget-object p0, p0, Landroidx/viewpager/widget/OriginalViewPager;->w0:Landroid/widget/EdgeEffect;
...
.method public final u(IIZZ)V
    ...
    :cond_2
    iget-wide v3, v0, Lto/h;->g:D

    goto :goto_1

    :goto_2
    iput-boolean p3, v0, Lto/h;->l:Z
    ...
    iput-boolean v2, v0, Lto/h;->l:Z

    iput-boolean v2, v0, Lto/h;->m:Z

    float-to-double v7, v3

    iput-wide v7, v0, Lto/h;->g:D

    float-to-double v7, v1

    iput-wide v7, v0, Lto/h;->f:D

    float-to-double v7, v4

    iput-wide v7, v0, Lto/h;->i:D

    double-to-int v2, v7

    int-to-double v7, v2

    iput-wide v7, v0, Lto/h;->d:D

    float-to-double v7, v6

    iput-wide v7, v0, Lto/h;->h:D

    float-to-double v7, p2

    iput-wide v7, v0, Lto/h;->j:D
    ...
    invoke-direct {p2}, Lto/g;-><init>()V

    iput-object p2, v0, Lto/h;->e:Lto/g;
    ...
    :cond_6
    iput p3, v0, Lto/h;->k:I

    invoke-static {}, Landroid/view/animation/AnimationUtils;->currentAnimationTimeMillis()J

    move-result-wide p2

    iput-wide p2, v0, Lto/h;->a:J
...
.method public final v(IIZZ)V
    ...
    :cond_3
    :goto_0
    iget v2, p0, Landroidx/viewpager/widget/OriginalViewPager;->f0:I
    ...
    :cond_6
    iget-boolean p4, p0, Landroidx/viewpager/widget/OriginalViewPager;->x0:Z

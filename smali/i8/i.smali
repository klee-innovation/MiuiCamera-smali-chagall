...
.field public c:LC8/k;

.field public d:LC8/k;
...
.field public final s:Lj8/c;

.field public t:Li8/c;

.field public final u:Landroid/os/Handler;

.field public final v:Li8/b;
...
# direct methods
.method public constructor <init>(Lcom/android/camera/module/Y;ZLjava/util/List;Lj8/c;)V
    .locals 17
    ...
    iput-object v0, v1, Li8/i;->j:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, v1, Li8/i;->k:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, v1, Li8/i;->l:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v0, v1, Li8/i;->m:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v1, Li8/i;->o:Landroid/graphics/Rect;

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, v1, Li8/i;->p:F

    new-instance v14, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v14, v13}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object v14, v1, Li8/i;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v14, v1, Li8/i;->r:Ljava/lang/ref/WeakReference;

    move-object/from16 v14, p4

    iput-object v14, v1, Li8/i;->s:Lj8/c;
    ...
    iput-object v15, v1, Li8/i;->q:Lcom/android/camera/ui/GLTextureView;

    new-instance v5, Li8/e;

    invoke-direct {v5, v1}, Li8/e;-><init>(Li8/i;)V
    ...
    iput-object v5, v1, Li8/i;->u:Landroid/os/Handler;
    ...
    :goto_4
    invoke-static {v15, v2}, Li8/i;->b(FLjava/util/List;)Landroid/util/Size;

    move-result-object v0

    iput-object v0, v1, Li8/i;->f:Landroid/util/Size;

    invoke-static {v9, v2}, Li8/i;->b(FLjava/util/List;)Landroid/util/Size;
    ...
    invoke-static {v0, v2}, Li8/i;->b(FLjava/util/List;)Landroid/util/Size;
    ...
    invoke-static {v7, v2}, Li8/i;->b(FLjava/util/List;)Landroid/util/Size;
    ...
    invoke-static/range {p4 .. p4}, Lj8/d;->H3(Lj8/c;)Z
    ...
    iput-object v7, v1, Li8/i;->f:Landroid/util/Size;
    ...
    iput-object v2, v1, Li8/i;->g:Landroid/util/Size;

    :cond_c
    iget-object v0, v1, Li8/i;->f:Landroid/util/Size;

    if-eqz v0, :cond_d

    iget-object v0, v1, Li8/i;->g:Landroid/util/Size;
    ...
    iput-object v3, v1, Li8/i;->f:Landroid/util/Size;

    new-instance v3, Landroid/util/Size;

    invoke-direct {v3, v2, v0}, Landroid/util/Size;-><init>(II)V

    iput-object v3, v1, Li8/i;->g:Landroid/util/Size;
    ...
    iput-object v0, v1, Li8/i;->g:Landroid/util/Size;

    :cond_12
    :goto_9
    new-instance v0, Li8/b;

    iget-object v2, v1, Li8/i;->q:Lcom/android/camera/ui/GLTextureView;

    iget-object v3, v1, Li8/i;->g:Landroid/util/Size;

    move/from16 v4, p2

    invoke-direct {v0, v2, v3, v4}, Li8/b;-><init>(Landroid/view/View;Landroid/util/Size;Z)V

    iput-object v0, v1, Li8/i;->v:Li8/b;

    sget v0, Lfh/b;->ic_zoom_map_eis_cv:I

    iput v0, v1, Li8/i;->h:I
    ...
    :goto_a
    iput v0, v1, Li8/i;->i:I

    invoke-virtual/range {p0 .. p0}, Li8/i;->c()V
...
.method public final a()Landroid/view/Surface;
    ...
    iget-object v1, p0, Li8/i;->f:Landroid/util/Size;
    ...
    iput-object v0, p0, Li8/i;->a:Landroid/graphics/SurfaceTexture;

    iget-object v2, p0, Li8/i;->f:Landroid/util/Size;

    invoke-virtual {v2}, Landroid/util/Size;->getWidth()I

    move-result v2

    iget-object v3, p0, Li8/i;->f:Landroid/util/Size;
    ...
    iput-object v0, p0, Li8/i;->e:Landroid/view/Surface;

    iget-object v0, p0, Li8/i;->a:Landroid/graphics/SurfaceTexture;

    new-instance v2, Li8/d;

    invoke-direct {v2, p0}, Li8/d;-><init>(Li8/i;)V

    invoke-virtual {v0, v2}, Landroid/graphics/SurfaceTexture;->setOnFrameAvailableListener(Landroid/graphics/SurfaceTexture$OnFrameAvailableListener;)V

    iget-object v0, p0, Li8/i;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    iget-object v2, p0, Li8/i;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    :cond_0
    iget-object p0, p0, Li8/i;->e:Landroid/view/Surface;
...
.method public final c()V
    ...
    iget-object v1, p0, Li8/i;->v:Li8/b;
    ...
    :cond_0
    invoke-virtual {v1}, Li8/b;->c()V

    invoke-virtual {v1}, Li8/b;->a()V
    ...
    iput v0, v1, Li8/b;->a:I

    iput v0, v1, Li8/b;->d:I

    iget-object v0, v1, Li8/b;->i:Landroid/view/View;
    ...
    invoke-virtual {v1}, Li8/b;->b()Landroid/graphics/Rect;

    move-result-object v0

    iget-object v1, p0, Li8/i;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    invoke-direct {v2, v3, p0, v0}, LWf/c;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v1, v2}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-virtual {p0}, Li8/i;->f()V
...
.method public final d()V
    ...
    :cond_0
    :goto_0
    iget-object v0, p0, Li8/i;->u:Landroid/os/Handler;
...
.method public final e(F)V
    ...
    invoke-virtual {v0}, L捙捕捗挔捗捓挔捞损捌捓捙损挔捙捕捗捗捕捔挔捹捕捗捗捕捔;->F0()F
    ...
    iget-object p1, p0, Li8/i;->v:Li8/b;

    if-eqz p1, :cond_0

    iget-object p0, p0, Li8/i;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput v1, p1, Li8/b;->a:I

    iput v1, p1, Li8/b;->d:I

    iget-object p0, p1, Li8/b;->i:Landroid/view/View;
...
.method public final g(LK5/a;Z)V
    .locals 7

    iget-object v0, p1, LK5/a;->a:Ljava/lang/Boolean;
    ...
    iget-object v1, p0, Li8/i;->m:Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-virtual {v1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;->set(Z)V

    :cond_0
    iget-object v0, p1, LK5/a;->b:Landroid/graphics/Rect;
    ...
    iget p1, p1, LK5/a;->c:F

    iget-object p2, p0, Li8/i;->g:Landroid/util/Size;
    ...
    :cond_3
    :goto_0
    iget-object p1, p0, Li8/i;->w:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_4
    iget-object p1, p0, Li8/i;->k:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_5
    iget-object p1, p0, Li8/i;->o:Landroid/graphics/Rect;
    ...
    :goto_1
    iget-object p2, p0, Li8/i;->j:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-object p2, p0, Li8/i;->u:Landroid/os/Handler;

    new-instance v4, Lcom/android/camera/ui/Q;

    const/4 v5, 0x1

    invoke-direct {v4, p0, p1, v5}, Lcom/android/camera/ui/Q;-><init>(Ljava/lang/Object;ZI)V
    ...
    iget-object p1, p0, Li8/i;->q:Lcom/android/camera/ui/GLTextureView;
    ...
    iget-object p1, p0, Li8/i;->u:Landroid/os/Handler;
    ...
    :cond_8
    :goto_2
    iget-object p1, p0, Li8/i;->n:Li8/j;

    if-eqz p1, :cond_9

    iget-object p0, p0, Li8/i;->o:Landroid/graphics/Rect;

    iput-object p0, p1, Li8/j;->e:Landroid/graphics/Rect;

...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lv5/b;->i:Ljava/lang/String;
...
.method public constructor <init>(Lcom/android/camera/ui/TextureVideoView;)V
    ...
    iput-object p1, p0, Lv5/b;->a:Lcom/android/camera/ui/TextureVideoView;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lv5/b;->b:Landroid/graphics/Matrix;

    new-instance v0, Landroid/graphics/Matrix;

    invoke-direct {v0}, Landroid/graphics/Matrix;-><init>()V

    iput-object v0, p0, Lv5/b;->c:Landroid/graphics/Matrix;
    ...
    invoke-direct {v0, p0}, Lv5/d;-><init>(Lv5/b;)V

    new-instance v1, Lv5/c;

    invoke-direct {v1, p0}, Lv5/c;-><init>(Lv5/b;)V
    ...
    iput-object v2, p0, Lv5/b;->e:Landroid/view/ScaleGestureDetector;
    ...
    iput-object v0, p0, Lv5/b;->f:Landroid/view/GestureDetector;
...
.method public final a(Landroid/graphics/Matrix;)V
    ...
    :cond_0
    iput v1, p0, Lv5/b;->d:F

    iget-object p1, p0, Lv5/b;->c:Landroid/graphics/Matrix;

    iget-object v3, p0, Lv5/b;->b:Landroid/graphics/Matrix;
    ...
    invoke-virtual {p0, p1, v0}, Lv5/b;->d(Landroid/graphics/Matrix;Z)V
...
.method public final b(Z)V
    ...
    sget-object v2, Lv5/b;->i:Ljava/lang/String;

    invoke-static {v2, v0, v1}, Lcom/android/camera/log/Log;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, p0, Lv5/b;->c:Landroid/graphics/Matrix;

    iget-object v1, p0, Lv5/b;->b:Landroid/graphics/Matrix;

    invoke-virtual {v0, v1}, Landroid/graphics/Matrix;->set(Landroid/graphics/Matrix;)V

    invoke-virtual {p0, v0, p1}, Lv5/b;->d(Landroid/graphics/Matrix;Z)V
...
.method public final c(Landroid/graphics/Matrix;)V
    ...
    iget-object p0, p0, Lv5/b;->b:Landroid/graphics/Matrix;

    new-instance p1, Ljava/lang/StringBuilder;

    const-string v0, "setBaseMatrix: "
    ...
    sget-object v0, Lv5/b;->i:Ljava/lang/String;
...
.method public final d(Landroid/graphics/Matrix;Z)V
    ...
    iget-object p0, p0, Lv5/b;->a:Lcom/android/camera/ui/TextureVideoView;
...
.method public final onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_3
    :goto_1
    iget-object p1, p0, Lv5/b;->e:Landroid/view/ScaleGestureDetector;
    ...
    iget-object p0, p0, Lv5/b;->f:Landroid/view/GestureDetector;

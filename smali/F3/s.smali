...
.field public y:LF3/q;

.field public z:I


# direct methods
.method public static a(LF3/s;Landroid/view/View;FF)V
    .locals 0
...
.method public static b(LF3/s;)V
    .locals 2

    iget-object v0, p0, LF3/s;->r:Landroid/view/ViewGroup;

    const/16 v1, 0x8

    invoke-virtual {v0, v1}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, LF3/s;->p:Lcom/android/camera/features/mode/polaroid/ui/CenterGradientView;

    invoke-virtual {v0, v1}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, LF3/s;->x:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    invoke-direct {v1, p0}, LF3/r;-><init>(LF3/s;)V
...
.method public static c(LF3/s;I)V
    .locals 11
    ...
    :pswitch_0
    :try_start_1
    iget-object v3, p0, LF3/s;->a:Landroid/widget/TextView;
    ...
    iget-object v6, p0, LF3/s;->s:Lcom/airbnb/lottie/LottieAnimationView;

    iget-object v7, p0, LF3/s;->t:Lcom/airbnb/lottie/LottieAnimationView;

    iget-object v8, p0, LF3/s;->u:Lcom/airbnb/lottie/LottieAnimationView;

    iget-object v9, p0, LF3/s;->v:Lcom/airbnb/lottie/LottieAnimationView;

    iget-object v10, p0, LF3/s;->w:Lcom/airbnb/lottie/LottieAnimationView;

    move-object v5, p0

    invoke-virtual/range {v5 .. v10}, LF3/s;->f(Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/view/View;)V
    ...
    iget-object v3, p0, LF3/s;->w:Lcom/airbnb/lottie/LottieAnimationView;

    invoke-virtual {v3}, Lcom/airbnb/lottie/LottieAnimationView;->playAnimation()V

    iget-object v3, p0, LF3/s;->g:Landroid/widget/ImageView;

    invoke-virtual {v3, v1}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v3, p0, LF3/s;->h:Landroid/widget/ImageView;

    invoke-virtual {v3, v1}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v3, p0, LF3/s;->f:Landroid/widget/ImageView;

    invoke-virtual {v3, v1}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v3, p0, LF3/s;->e:Landroid/widget/ImageView;

    invoke-virtual {v3, v2}, Landroid/widget/ImageView;->setVisibility(I)V

    iget-object v3, p0, LF3/s;->p:Lcom/android/camera/features/mode/polaroid/ui/CenterGradientView;
    ...
    iget-object v3, p0, LF3/s;->v:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v3, p0, LF3/s;->i:Landroid/widget/ImageView;
    ...
    iget-object v3, p0, LF3/s;->u:Lcom/airbnb/lottie/LottieAnimationView;

    invoke-virtual {v3}, Lcom/airbnb/lottie/LottieAnimationView;->playAnimation()V

    iget-object v3, p0, LF3/s;->t:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v3, p0, LF3/s;->s:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    :goto_2
    iput-object v0, p0, LF3/s;->j:Landroid/graphics/drawable/ClipDrawable;

    iget-object v0, p0, LF3/s;->a:Landroid/widget/TextView;

    invoke-virtual {v0, v2}, Landroid/view/View;->setVisibility(I)V

    invoke-virtual {p0, v3}, LF3/s;->g(Landroid/widget/ImageView;)V

    :cond_3
    iput p1, p0, LF3/s;->z:I
    :try_end_1
...
.method public final d(I)V
    ...
    iget-object p0, p0, LF3/s;->y:LF3/q;
...
.method public final e()V
    ...
    iget-object v0, p0, LF3/s;->j:Landroid/graphics/drawable/ClipDrawable;

    if-eqz v0, :cond_2

    iget-object v0, p0, LF3/s;->o:Landroid/animation/ObjectAnimator;
    ...
    :cond_0
    iget-object v0, p0, LF3/s;->c:Landroid/animation/ObjectAnimator;
...
.method public final f(Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct/range {v0 .. v16}, LF3/s$a;-><init>(LF3/s;Landroid/view/View;FFLandroid/view/View;FFLandroid/view/View;FFLandroid/view/View;FFLandroid/view/View;FF)V
...
.method public final g(Landroid/widget/ImageView;)V
    ...
    iput-object p1, p0, LF3/s;->o:Landroid/animation/ObjectAnimator;

    iget-object p1, p0, LF3/s;->j:Landroid/graphics/drawable/ClipDrawable;
    ...
    iput-object p1, p0, LF3/s;->c:Landroid/animation/ObjectAnimator;
    ...
    iget-object v1, p0, LF3/s;->o:Landroid/animation/ObjectAnimator;

    invoke-virtual {p1, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object v1, p0, LF3/s;->c:Landroid/animation/ObjectAnimator;
    ...
    invoke-direct {v2, p0}, LF3/t;-><init>(LF3/s;)V
...
.method public final h()V
    ...
    iget-object v0, p0, LF3/s;->s:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v0, p0, LF3/s;->t:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v0, p0, LF3/s;->u:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v0, p0, LF3/s;->v:Lcom/airbnb/lottie/LottieAnimationView;
    ...
    iget-object v0, p0, LF3/s;->w:Lcom/airbnb/lottie/LottieAnimationView;

    invoke-virtual {v0}, Lcom/airbnb/lottie/LottieAnimationView;->cancelAnimation()V

    iget-object p0, p0, LF3/s;->w:Lcom/airbnb/lottie/LottieAnimationView;
...
.method public final i(Z)V
    ...
    iget-object v0, p0, LF3/s;->d:Landroid/view/View;
    ...
    iget-object p0, p0, LF3/s;->q:Landroid/view/View;

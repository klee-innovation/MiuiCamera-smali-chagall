...
.field public final f:Lt1/m0$a;

.field public final g:LC4/J;

.field public final h:LC4/K;
...
.method public constructor <init>(Lcom/android/camera/Camera;)V
    ...
    iput-boolean v0, p0, Lt1/m0;->c:Z

    new-instance v0, Lt1/m0$a;

    invoke-direct {v0, p0}, Lt1/m0$a;-><init>(Lt1/m0;)V

    iput-object v0, p0, Lt1/m0;->f:Lt1/m0$a;
    ...
    iput-object v0, p0, Lt1/m0;->g:LC4/J;
    ...
    iput-object v0, p0, Lt1/m0;->h:LC4/K;

    new-instance v0, Ljava/lang/ref/WeakReference;

    invoke-direct {v0, p1}, Ljava/lang/ref/WeakReference;-><init>(Ljava/lang/Object;)V

    iput-object v0, p0, Lt1/m0;->a:Ljava/lang/ref/WeakReference;

    return-void
.end method

.method public static a(Lcom/android/camera/Camera;Lt1/T0;Landroid/net/Uri;Landroid/graphics/Rect;F)Landroid/content/Intent;
    .locals 7
    ...
    :goto_1
    invoke-virtual {v0}, LEd/c;->a()Z

    move-result p2

    if-eqz p2, :cond_4

    sget-object p2, Lt1/Z$a;->a:Lt1/Z;

    iget p2, p2, Lt1/Z;->g:F
    ...
    invoke-static {v1, v2}, Lgj/f;->v(Landroid/content/Intent;Z)V
    ...
    invoke-static {p2}, LZh/c;->a(Landroid/content/Context;)Z
    ...
    iget-boolean p2, p1, Lt1/T0;->e:Z

    if-eqz p2, :cond_d

    iget p2, p1, Lt1/T0;->i:I
    ...
    invoke-static {p3, p2}, LD1/a;->b(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object p0, p2, LEd/c;->e:L捙捕捗挔捗捓挔捞损捌捓捙损挔捙捕捗捗捕捔挔捹捕捗捗捕捔;
...
.method public static b(Lcom/android/camera/Camera;Landroid/net/Uri;)V
    ...
    invoke-static {v2}, Lk2/a;->F(Ljava/lang/Long;)Li2/b;
    ...
    invoke-static {p1, p0, v0}, Lt6/A;->x(Landroid/net/Uri;Landroid/content/Context;Z)Z
    ...
    invoke-static {p0, p1}, Lgj/I;->f(Landroid/content/ContentResolver;Landroid/net/Uri;)Z
    ...
    invoke-static {p1, v2, v0, p0}, LCn/B0;->d(Ljava/lang/String;Ljava/lang/String;ZZ)Ljava/lang/String;
...
# virtual methods
.method public final c(Lt1/T0;Lcom/android/camera/Camera;)V
    .locals 9
    ...
    iget-object v4, p2, Lcom/android/camera/a;->R0:LD7/i;

    if-eqz v4, :cond_2

    invoke-virtual {p2}, Lcom/android/camera/a;->lk()Z
    ...
    sget-object p2, LQl/a;->a:LQl/a;

    invoke-virtual {v4, p2}, LD7/i;->q0(LQl/a;)V
    ...
    sget-object v5, LQl/a;->h:LQl/a;

    invoke-virtual {v4, v5, p2}, LD7/i;->e(LQl/a;Z)V

    goto :goto_0

    :cond_1
    sget-object p2, LQl/a;->h:LQl/a;

    invoke-virtual {v4, p2}, LD7/i;->q0(LQl/a;)V

    :cond_2
    :goto_0
    iget-object p2, p0, Lt1/m0;->b:Landroid/os/Messenger;
    ...
    sget-object p2, Lg9/f;->f:Lg9/f$a;

    invoke-virtual {p2}, Lg9/g;->b()Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v5, p1, Lt1/T0;->a:Landroid/net/Uri;

    iget-object v6, p1, Lt1/T0;->b:Landroid/graphics/Bitmap;

    invoke-virtual {p2, v5, v6}, Lg9/f;->d(Landroid/net/Uri;Landroid/graphics/Bitmap;)Z
    ...
    :cond_4
    :try_start_1
    invoke-virtual {p2}, Lg9/f;->c()Landroid/os/ParcelFileDescriptor;
    ...
    iget-object v3, p0, Lt1/m0;->b:Landroid/os/Messenger;
    ...
    :try_start_3
    iget-object v8, p2, Lg9/f;->e:Landroid/net/Uri;
    :try_end_3
    ...
    iget-object p1, p0, Lt1/m0;->b:Landroid/os/Messenger;
    ...
    iget-object p0, p0, Lt1/m0;->b:Landroid/os/Messenger;

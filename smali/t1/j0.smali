...
.method public synthetic constructor <init>(Landroid/view/View;Ljava/lang/String;Landroidx/fragment/app/l;II)V
    ...
    iput-object p1, p0, Lt1/j0;->a:Landroid/view/View;

    iput-object p2, p0, Lt1/j0;->b:Ljava/lang/String;

    iput-object p3, p0, Lt1/j0;->c:Landroidx/fragment/app/l;

    iput p4, p0, Lt1/j0;->d:I

    iput p5, p0, Lt1/j0;->e:I
...
.method public final subscribe(Lio/reactivex/x;)V
    ...
    iget-object v2, p0, Lt1/j0;->a:Landroid/view/View;
    ...
    iget-object v4, p0, Lt1/j0;->b:Ljava/lang/String;
    ...
    iget-object v8, p0, Lt1/j0;->c:Landroidx/fragment/app/l;

    iget v9, p0, Lt1/j0;->d:I

    const v10, 0x7f0715fc
    ...
    iget p0, p0, Lt1/j0;->e:I

    if-eqz v11, :cond_2

    new-instance v9, LH5/Z;

    invoke-direct {v9, v2, v4, p0}, LH5/Z;-><init>(Landroid/view/View;II)V
    ...
    invoke-static {v4}, Lcom/android/camera/module/Z;->b(I)Z
    ...
    invoke-direct {v9, v2, v4, p0}, Lt1/k0;-><init>(Landroid/view/View;II)V

    invoke-virtual {v7, v9}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    invoke-static {p0}, Lcom/android/camera/fragment/top/t;->isLeftBothLandScape(I)Z
    ...
    invoke-static {p0, v4}, Lcom/android/camera/fragment/top/t;->initPortraitTopTipLayout(Landroid/view/View;I)V
    ...
    invoke-virtual {p1, v3}, Lio/reactivex/internal/operators/single/a$a;->c(Ljava/lang/Object;)V

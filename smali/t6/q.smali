...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lt6/q;->a:Ljava/io/File;

    new-instance v0, Ljava/util/concurrent/locks/ReentrantLock;

    invoke-direct {v0}, Ljava/util/concurrent/locks/ReentrantLock;-><init>()V

    sput-object v0, Lt6/q;->b:Ljava/util/concurrent/locks/ReentrantLock;
...
.method public static final a(Lcom/android/camera/storage/MigrateWorker;)Z
    ...
    sget-object v2, Lt6/q;->a:Ljava/io/File;
    ...
    invoke-direct {v4, v5}, LN3/l;-><init>(I)V

    new-instance v5, LEf/b;

    invoke-direct {v5, v4, v0}, LEf/b;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-direct {v5, p0, v1}, LEf/c;-><init>(Ljava/lang/Object;I)V

    new-instance v1, LEf/d;

    const/4 v6, 0x5

    invoke-direct {v1, v5, v6}, LEf/d;-><init>(Ljava/lang/Object;I)V

    invoke-static {v4, v1}, Lt6/p;->a(Ljava/util/stream/Stream;LEf/d;)Ljava/util/stream/Stream;

    move-result-object v1

    new-instance v4, LMh/a;

    invoke-direct {v4, v0, v3, p0}, LMh/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    new-instance p0, LE3/g;

    const/16 v0, 0x17

    invoke-direct {p0, v4, v0}, LE3/g;-><init>(Ljava/lang/Object;I)V
    ...
    invoke-static {v2, p0}, LPn/H;->a(Ljava/lang/AutoCloseable;Ljava/lang/Throwable;)V
...
.method public static final b(Ljava/io/File;Lcom/android/camera/storage/MigrateWorker;)Z
    ...
    invoke-direct {v5, v4, v6}, Lt6/m;-><init>(Landroid/net/Uri;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    invoke-static {v3, v9}, Ljd/b;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    :cond_3
    iget-object v5, v9, Lt6/m;->a:Landroid/net/Uri;

    iget-object v6, v9, Lt6/m;->b:Ljava/lang/String;

    sget-object v7, Lt6/q;->b:Ljava/util/concurrent/locks/ReentrantLock;

    invoke-virtual {v7}, Ljava/util/concurrent/locks/ReentrantLock;->lock()V

    :try_start_3
    invoke-static {v6}, LYf/f;->o(Ljava/lang/String;)Z
    ...
    :cond_5
    invoke-static {p0, v5}, Lt6/q;->c(Ljava/io/File;Landroid/net/Uri;)V
    ...
    :goto_2
    :try_start_5
    invoke-static {v6}, LYf/f;->p(Ljava/lang/String;)V
    :try_end_5
...
.method public static final c(Ljava/io/File;Landroid/net/Uri;)V
    ...
    invoke-static {v0, p1, v1}, LBo/c;->a(Ljava/io/InputStream;Ljava/io/OutputStream;I)J
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_1
    ...
    invoke-static {p1, v1}, Ljd/b;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V

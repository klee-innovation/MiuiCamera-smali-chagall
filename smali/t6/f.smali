...
# instance fields
.field public q:Landroid/hardware/camera2/TotalCaptureResult;

.field public r:Landroid/media/ImageWriter;
...
.method public static a(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    sget-object v4, Lzf/e;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v4}, LA1/v;->f([ILjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v12, v13, v14}, LKk/a;->g(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v7, v4, v5}, Lt6/h;->a(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
    ...
    invoke-static {v2, v4, v5}, Lt6/h;->a(Landroid/media/Image$Plane;II)Ljava/nio/ByteBuffer;
...
.method public final b(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    invoke-static {v3, v15}, LB/c;->b(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v3, v1, Lt6/b;->a:Landroid/app/Application;

    const-string v4, ".HEIC"

    invoke-static {v15, v4}, LI/b;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, v13, Lt6/b;->m:Landroid/os/Handler;
    ...
    :try_start_3
    invoke-direct/range {v12 .. v17}, Llh/f$a;-><init>(Ljava/lang/String;Ljava/io/FileDescriptor;III)V
    ...
    invoke-direct/range {v10 .. v15}, Llh/f$a;-><init>(Ljava/lang/String;Ljava/io/FileDescriptor;III)V

    move-object/from16 v11, v16

    :goto_4
    iget-object v10, v3, Lt6/b;->d:Lag/m;

    iget-object v10, v10, Lag/m;->a:Lag/t;

    iget v10, v10, Lag/t;->d:I

    iput-object v1, v11, Llh/f$a;->j:Landroid/os/Handler;

    move/from16 v1, p12

    invoke-virtual {v11, v1}, Llh/f$a;->b(I)V

    invoke-virtual {v11, v10}, Llh/f$a;->c(I)V

    invoke-virtual {v11}, Llh/f$a;->a()Llh/f;

    move-result-object v1

    const/4 v10, 0x0

    invoke-virtual {v1, v10}, Llh/h;->d(Z)V

    iget v10, v1, Llh/h;->a:I

    const/4 v11, 0x1

    if-ne v10, v11, :cond_5

    iget-object v10, v1, Llh/h;->h:Llh/e;

    iget v12, v10, Llh/c;->j:I

    if-ne v12, v11, :cond_4

    iget-object v10, v10, Llh/c;->k0:Landroid/view/Surface;

    invoke-virtual/range {p1 .. p1}, Landroid/media/Image;->getFormat()I

    move-result v11

    invoke-static {v10, v9, v11}, Landroid/media/ImageWriter;->newInstance(Landroid/view/Surface;II)Landroid/media/ImageWriter;

    move-result-object v9

    iput-object v9, v3, Lt6/f;->r:Landroid/media/ImageWriter;

    invoke-virtual {v1}, Llh/h;->j()V
    ...
    iget-object v7, v3, Lt6/f;->r:Landroid/media/ImageWriter;
    ...
    invoke-virtual {v1, v0, v2}, Llh/h;->a(I[B)V
    ...
    invoke-virtual {v1}, Llh/h;->close()V
    ...
    :goto_7
    iget-object v0, v3, Lt6/f;->r:Landroid/media/ImageWriter;
    ...
    iput-object v12, v3, Lt6/f;->r:Landroid/media/ImageWriter;
    ...
    iget-object v12, v3, Lt6/b;->d:Lag/m;

    invoke-virtual {v12}, Lag/m;->i()Landroid/util/Size;

    move-result-object v12

    iget-object v9, v3, Lt6/b;->m:Landroid/os/Handler;
    ...
    :goto_a
    iget-object v3, v3, Lt6/b;->d:Lag/m;

    iget-object v3, v3, Lag/m;->a:Lag/t;

    iget v3, v3, Lag/t;->d:I

    iput-object v9, v11, Llh/f$a;->j:Landroid/os/Handler;

    invoke-virtual {v11, v1}, Llh/f$a;->b(I)V

    invoke-virtual {v11, v3}, Llh/f$a;->c(I)V
    ...
    invoke-static {v0, v4}, Lt6/f;->a(Landroid/media/Image;Landroid/util/Size;)[B
    ...
    invoke-virtual {v1, v9}, Llh/h;->d(Z)V
    ...
    iget v12, v10, Llh/c;->k:I

    iget v13, v10, Llh/c;->l:I
    ...
    invoke-virtual {v10, v0}, Llh/c;->d([B)V
    ...
    :goto_f
    invoke-static/range {p3 .. p3}, LPo/e;->a(Ljava/io/Closeable;)V
...
.method public final run()V
    ...
    iget-object v0, v14, Lt6/b;->d:Lag/m;

    iget-object v0, v0, Lag/m;->k:Lag/u;

    iget-object v10, v0, Lag/u;->g:Ljava/lang/String;
    ...
    iget-wide v6, v1, Lag/t;->g:J

    iget-object v2, v0, Lag/m;->d:Lag/d;

    iget v8, v2, Lag/d;->g:I

    iget v5, v1, Lag/t;->d:I
    ...
    iget-object v0, v14, Lt6/f;->q:Landroid/hardware/camera2/TotalCaptureResult;

    iget v15, v14, Lt6/b;->i:I

    iget v12, v14, Lt6/b;->j:I

    sget-object v13, Lme/a;->a:Ljava/nio/charset/Charset;

    new-instance v13, Lme/b;

    invoke-direct {v13}, Lme/b;-><init>()V

    move/from16 v18, v3

    const/16 v3, 0xc

    iput v3, v13, Lme/b;->d:I

    if-eqz v0, :cond_0

    invoke-static {v13}, Lt6/d;->g(Lme/b;)Lt6/d$a;

    move-result-object v3

    invoke-virtual {v3, v5, v15, v12}, Lt6/d$a;->b(III)V

    iput-wide v6, v3, Lt6/d$a;->c:J
    ...
    invoke-virtual {v3, v0}, Lt6/d$a;->a(Landroid/hardware/camera2/CaptureResult;)V

    sget-object v0, Ljava/lang/Boolean;->FALSE:Ljava/lang/Boolean;

    sget-object v12, Ljava/lang/Boolean;->TRUE:Ljava/lang/Boolean;

    iput-object v0, v3, Lt6/d$a;->o:Ljava/lang/Boolean;

    iput-object v12, v3, Lt6/d$a;->p:Ljava/lang/Boolean;
    ...
    iget-object v0, v13, Lme/b;->m:Ljava/nio/ByteOrder;

    invoke-direct {v12, v3, v0}, Lme/b$c;-><init>(Ljava/io/OutputStream;Ljava/nio/ByteOrder;)V
    :try_end_1
    ...
    iput-object v0, v12, Lme/b$c;->b:Ljava/nio/ByteOrder;

    sget-object v0, Lme/b;->l0:[B

    invoke-virtual {v12, v0}, Lme/b$c;->write([B)V

    const/16 v0, -0x1f

    invoke-virtual {v12, v0}, Lme/b$c;->g(S)V

    invoke-virtual {v13, v12}, Lme/b;->a0(Lme/b$c;)V
    ...
    const-string/jumbo v12, "writeExifSegment error "

    invoke-static {v3, v12, v0}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    const-string v12, "prepare exif cost "
    ...
    invoke-static {v10}, Lk2/a;->G(Ljava/lang/String;)Li2/b;
    ...
    :cond_2
    invoke-static {v9}, Lt6/A;->n(Ljava/lang/String;)Z
    ...
    invoke-static {v9}, Lt6/A;->o(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v2, v9, v1}, LI/b;->l(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v1, v13, Li2/b;->c:Ljava/lang/Long;

    invoke-virtual {v1}, Ljava/lang/Long;->longValue()J

    move-result-wide v1

    iget-object v6, v14, Lt6/b;->a:Landroid/app/Application;

    invoke-static {v6, v10, v15}, Lt6/A;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;
    ...
    invoke-static {v10}, Lt6/A;->E(Ljava/lang/String;)Z

    move-result v7

    iget-object v2, v14, Lt6/b;->g:Landroid/media/Image;

    iget v1, v14, Lt6/b;->i:I

    iget v15, v14, Lt6/b;->j:I
    ...
    invoke-virtual/range {v1 .. v13}, Lt6/f;->b(Landroid/media/Image;[BZLjava/lang/String;JILjava/lang/String;IILandroid/location/Location;I)Landroid/net/Uri;
    ...
    :try_start_9
    invoke-static {v0, v14}, LC6/a;->c(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_9
    ...
    invoke-static {v13, v0, v2}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V

    move-object/from16 v12, p0

    :goto_8
    iget-object v0, v12, Lt6/b;->a:Landroid/app/Application;

    iget v2, v12, Lt6/b;->i:I

    iget v3, v12, Lt6/b;->j:I
    ...
    invoke-virtual {v10, v12, v11, v13, v13}, Landroid/content/ContentResolver;->query(Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-virtual {v9, v4, v13}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Long;)V
    ...
    invoke-static {v14}, Lt6/A;->E(Ljava/lang/String;)Z
    ...
    invoke-virtual {v1, v10, v13}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Integer;)V
    ...
    invoke-virtual {v1, v13, v10}, Landroid/content/ContentValues;->put(Ljava/lang/String;Ljava/lang/Long;)V
    ...
    invoke-virtual {v2, v12, v3, v4, v4}, Landroid/content/ContentResolver;->query(Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    invoke-virtual {v3, v12, v1, v4, v4}, Landroid/content/ContentResolver;->update(Landroid/net/Uri;Landroid/content/ContentValues;Ljava/lang/String;[Ljava/lang/String;)I
    ...
    :cond_a
    invoke-virtual {v9, v1}, Landroid/content/ContentValues;->putAll(Landroid/content/ContentValues;)V
    ...
    invoke-static {v0, v14, v3}, Lt6/A;->i(Landroid/content/Context;Ljava/lang/String;Z)Landroid/net/Uri;

    move-result-object v4

    invoke-virtual {v1, v4, v9}, Landroid/content/ContentResolver;->insert(Landroid/net/Uri;Landroid/content/ContentValues;)Landroid/net/Uri;
    ...
    :goto_10
    iget-object v0, v11, Lt6/b;->a:Landroid/app/Application;

    move-object/from16 v10, v35

    invoke-static {v0, v10}, Lm2/a;->c(Landroid/content/Context;Li2/b;)V
    ...
    iget-object v2, v11, Lt6/b;->g:Landroid/media/Image;

    iget v0, v11, Lt6/b;->i:I

    iget v9, v11, Lt6/b;->j:I
    ...
    iget-object v1, v14, Lt6/b;->d:Lag/m;

    iget-object v1, v1, Lag/m;->b:Lag/a;

    iget-boolean v1, v1, Lag/a;->i:Z

    if-eqz v1, :cond_10

    iget-object v1, v14, Lt6/b;->a:Landroid/app/Application;
    ...
    iget-object v2, v14, Lt6/b;->b:Lt6/i;

    const/4 v3, 0x1

    invoke-virtual {v2, v1, v3}, Lt6/i;->c(Lt1/T0;Z)V

    goto :goto_12

    :cond_f
    iget-object v1, v14, Lt6/b;->b:Lt6/i;

    invoke-virtual {v1}, Lt6/i;->h()V
    ...
    invoke-virtual/range {v1 .. v6}, Lt6/i;->n(Landroid/net/Uri;ZLjava/lang/String;IZ)V
    ...
    iput-object v1, v3, Li2/b;->c:Ljava/lang/Long;

    iget-object v1, v14, Lt6/b;->a:Landroid/app/Application;

    invoke-static {v1, v3}, Lm2/a;->c(Landroid/content/Context;Li2/b;)V
    ...
    :goto_14
    iget-object v0, v14, Lt6/b;->p:LAb/i;

    iget-object v1, v14, Lt6/b;->g:Landroid/media/Image;

    iget-object v3, v14, Lt6/b;->d:Lag/m;
    ...
    iget-object v4, v0, LTh/k;->B:LTh/k$c;

    invoke-virtual {v4, v1}, LTh/k$c;->b(Landroid/media/Image;)V
    ...
    iget-object v1, v1, Lag/n;->i:Landroid/media/Image;

    invoke-static {v0, v1}, LTh/k;->b(LTh/k;Landroid/media/Image;)V

    invoke-virtual {v3}, Lag/m;->s()V

    invoke-static {v0, v3}, LTh/k;->d(LTh/k;Lag/m;)Z

    move-result v1

    if-eqz v1, :cond_13

    iget-object v1, v0, LTh/k;->h:LTh/g$a;

    if-eqz v1, :cond_13

    invoke-virtual {v1, v3}, LTh/g$a;->a(Lag/m;)V

    :cond_13
    iget-object v1, v3, Lag/m;->a:Lag/t;

    iget-wide v3, v1, Lag/t;->f:J

    invoke-virtual {v0, v3, v4}, LTh/k;->y(J)Lag/m;
    ...
    iget-object v4, v14, Lt6/b;->d:Lag/m;

    iget-object v4, v4, Lag/m;->a:Lag/t;

    iget-wide v4, v4, Lag/t;->h:J
    ...
    invoke-virtual {v2, v0}, LT5/n;->g(Ljava/lang/String;)J
    ...
    iget-wide v5, v1, Lag/t;->h:J

    sub-long/2addr v3, v5

    invoke-virtual {v2, v3, v4, v0}, LT5/n;->f(JLjava/lang/String;)J
    ...
    invoke-virtual {v2, v3, v4, v0}, LT5/n;->q(JLjava/lang/String;)V

    :cond_14
    const/4 v1, 0x0

    iput-object v1, v14, Lt6/b;->g:Landroid/media/Image;

    iput-object v1, v14, Lt6/b;->d:Lag/m;

    iput-object v1, v14, Lt6/b;->p:LAb/i;

    iput-object v1, v14, Lt6/f;->q:Landroid/hardware/camera2/TotalCaptureResult;

    iput-object v1, v14, Lt6/b;->m:Landroid/os/Handler;

    iget-object v0, v14, Lt6/b;->b:Lt6/i;

    iget v1, v14, Lt6/b;->h:I

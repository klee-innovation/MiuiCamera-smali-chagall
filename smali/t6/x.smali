...
.method public synthetic constructor <init>(IJJJLandroid/content/Context;Landroid/location/Location;Ljava/lang/String;ZZ)V
    ...
    iput p1, p0, Lt6/x;->a:I

    iput-object p8, p0, Lt6/x;->b:Landroid/content/Context;

    iput-object p10, p0, Lt6/x;->c:Ljava/lang/String;

    iput-wide p2, p0, Lt6/x;->d:J

    iput-boolean p11, p0, Lt6/x;->e:Z

    iput-wide p4, p0, Lt6/x;->f:J

    iput-object p9, p0, Lt6/x;->g:Landroid/location/Location;

    iput-boolean p12, p0, Lt6/x;->h:Z

    iput-wide p6, p0, Lt6/x;->i:J
...
.method public final run()V
    ...
    iget v1, v0, Lt6/x;->a:I

    iget-object v11, v0, Lt6/x;->b:Landroid/content/Context;

    iget-object v12, v0, Lt6/x;->c:Ljava/lang/String;

    iget-wide v13, v0, Lt6/x;->d:J

    iget-boolean v15, v0, Lt6/x;->e:Z

    iget-wide v9, v0, Lt6/x;->f:J

    iget-object v7, v0, Lt6/x;->g:Landroid/location/Location;

    iget-boolean v8, v0, Lt6/x;->h:Z
    ...
    invoke-static/range {v2 .. v10}, Lt6/A;->k(Landroid/content/Context;Ljava/lang/String;JZJLandroid/location/Location;Z)Landroid/content/Intent;
    ...
    invoke-static/range {v2 .. v9}, Lt6/A;->w(Landroid/content/Context;Ljava/lang/String;ZJZJ)V
    ...
    :goto_1
    sget-object v1, Lt6/A;->p:[Ljava/lang/String;

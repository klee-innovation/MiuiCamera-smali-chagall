...
.method public static final a(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-direct {v5, v6, v7, v8, v9}, Lw0/c$c;-><init>(IILjava/lang/String;Ljava/lang/String;)V

    invoke-virtual {v4, v5}, Ljm/b;->add(Ljava/lang/Object;)Z

    goto :goto_0

    :cond_0
    invoke-static {v4}, LDd/e;->g(Ljm/b;)Ljm/b;

    move-result-object p0

    invoke-static {p0}, Lim/s;->p0(Ljava/util/AbstractList;)Ljava/util/List;
...
.method public static final b(Ly0/b;Ljava/lang/String;Z)Lw0/c$d;
    .locals 13
    ...
    invoke-interface {p0, v0}, Ly0/b;->h0(Ljava/lang/String;)Landroid/database/Cursor;
    ...
    new-instance v2, Lw0/c$d;

    invoke-direct {v2, p1, p2, v0, v1}, Lw0/c$d;-><init>(Ljava/lang/String;ZLjava/util/List;Ljava/util/List;)V
    :try_end_0

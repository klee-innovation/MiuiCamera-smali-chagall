...
.field public final e:Lcom/android/camera/fragment/s;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lcom/android/camera/data/data/c;ILl4/t;)V
    .locals 1
    ...
    iput-object v0, p0, LP3/x;->g:Ljava/util/ArrayList;

    iput-object p1, p0, LP3/x;->a:Landroid/content/Context;

    iput p3, p0, LP3/x;->c:I

    check-cast p4, Lcom/android/camera/fragment/s;

    iput-object p4, p0, LP3/x;->e:Lcom/android/camera/fragment/s;

    iput-object p2, p0, LP3/x;->d:Lcom/android/camera/data/data/c;
    ...
    invoke-direct {p3, p0, p4}, LA3/c;-><init>(Ljava/lang/Object;I)V
...
.method public draw(Lcom/android/camera/ui/g$a$a;ILandroid/graphics/Canvas;ZIFI)V
    ...
    iget-object p1, p0, LP3/x;->f:Landroid/util/Range;

    iget-object p5, p0, LP3/x;->g:Ljava/util/ArrayList;
    ...
    invoke-virtual {p0, p3, p1, p5}, Lcom/android/camera/ui/g$a;->drawText(Landroid/graphics/Canvas;ZLjava/lang/String;)V

    iget p1, p0, Lcom/android/camera/ui/g$a;->mLineSelectWidth:F
    ...
    invoke-static {p1, p5}, Lj/a;->a(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget p6, p0, Lcom/android/camera/ui/g$a;->mLineTextGap:F

    neg-float p6, p6

    iget p7, p0, Lcom/android/camera/ui/g$a;->mCurrentLineHalfHeight:F
    ...
    iget v0, p0, Lcom/android/camera/ui/g$a;->mLineTextGap:F

    neg-float v0, v0

    iget v1, p0, Lcom/android/camera/ui/g$a;->mCurrentLineHalfHeight:F
    ...
    invoke-virtual {p0, p3, p5, p1}, Lcom/android/camera/ui/g$a;->drawText(Landroid/graphics/Canvas;ZLjava/lang/String;)V

    :goto_1
    iget p1, p0, Lcom/android/camera/ui/g$a;->mLineStopPointWidth:F

    goto :goto_2

    :cond_4
    iget p1, p0, Lcom/android/camera/ui/g$a;->mLineWidth:F

    :goto_2
    invoke-virtual {p0, p2, p3, p4, p1}, Lcom/android/camera/ui/g$a;->drawLine(ILandroid/graphics/Canvas;ZF)V

    return-void
.end method

.method public final drawBefore(Lcom/android/camera/ui/g$a$a;Landroid/graphics/Canvas;)V
    .locals 6

    iget p1, p1, Lcom/android/camera/ui/g$a$a;->f:I

    if-ltz p1, :cond_2

    iget-object p2, p0, LP3/x;->g:Ljava/util/ArrayList;
    ...
    invoke-static {v0}, LV1/T;->g(F)Landroid/util/Range;
    ...
    invoke-static {v3, v2, v1}, LAb/h;->i(FFF)F
    ...
    iget-object v4, p0, LP3/x;->g:Ljava/util/ArrayList;
    ...
    invoke-static {p1, v2, v1}, LAb/h;->i(FFF)F
    ...
    iput-object p1, p0, LP3/x;->f:Landroid/util/Range;
...
.method public final isStopPoint(I)Z
    ...
    sget-object v0, LV1/T;->f:Ljava/util/ArrayList;
...
.method public final bridge synthetic mapPositionToValue(F)Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0, p1}, LP3/x;->mapPositionToValue(F)Ljava/lang/String;
...
.method public final mapPositionToValue(F)Ljava/lang/String;
    ...
    .line 3
    invoke-virtual {p0}, Lcom/android/camera/ui/g$a;->getRealCount()I
...
.method public onCustomWheelScroll(Z)V
    ...
    iget-object v0, p0, LP3/x;->d:Lcom/android/camera/data/data/c;
    ...
    iget-object v1, p0, LP3/x;->e:Lcom/android/camera/fragment/s;
    ...
    invoke-interface {v1, v0, v2, v3}, Ll4/t;->onZoomItemSlideOn(IZI)V

    const/4 v0, 0x3

    invoke-interface {v1, p1, v0}, Ll4/t;->onManuallyDataChanged(Ljava/lang/String;I)V
...
.method public final onPositionSelect(Landroid/view/View;FII)V
    ...
    iget-object p2, p0, LP3/x;->e:Lcom/android/camera/fragment/s;
    ...
    invoke-virtual {p0, p2}, LP3/x;->mapValueToPosition(Ljava/lang/String;)F
    ...
    invoke-virtual {p0, p2, p3}, Lcom/android/camera/ui/g$a;->performValueChangedVibrator(II)V

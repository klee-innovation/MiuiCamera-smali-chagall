...
.method public final a()V
    ...
    iget-object v0, p0, LJ5/h;->h:Landroid/graphics/Rect;

    if-eqz v0, :cond_a

    iget-object v0, p0, LJ5/h;->g:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, LJ5/h;->h:Landroid/graphics/Rect;
    ...
    iget-object v1, p0, LJ5/h;->i:[Landroid/hardware/camera2/params/Face;
    ...
    iget-object v9, p0, LJ5/h;->i:[Landroid/hardware/camera2/params/Face;
    ...
    iget-object v8, p0, LJ5/h;->j:Ljava/lang/Byte;
    ...
    :cond_2
    iget v0, p0, LJ5/h;->l:I

    const/16 v1, 0x23

    if-eq v0, v7, :cond_3

    iput v7, p0, LJ5/h;->l:I

    iput v2, p0, LJ5/h;->m:I

    goto :goto_2

    :cond_3
    iget v5, p0, LJ5/h;->m:I
    ...
    iput v5, p0, LJ5/h;->m:I

    if-ne v6, v5, :cond_8

    if-eqz v0, :cond_8

    iput v2, p0, LJ5/h;->l:I

    if-eq v7, v4, :cond_5

    iget v0, p0, LJ5/h;->k:I
...
.method public final b()V
    ...
    invoke-virtual {p0}, LJ5/h;->p()Z

    move-result v1

    if-nez v1, :cond_0

    iget-boolean v1, p0, LJ5/h;->q:Z

    if-eq v1, v0, :cond_1

    :cond_0
    iput-boolean v0, p0, LJ5/h;->q:Z
    ...
    iget p0, p0, LJ5/h;->p:I

    invoke-virtual {v0, p0, v1}, LC5/c;->b(IZ)V
...
.method public final d()Z
    ...
    iget-boolean v0, v0, LC5/c;->c:Z

    const/4 v1, 0x0

    if-nez v0, :cond_0

    iput v1, p0, LJ5/h;->l:I

    iput v1, p0, LJ5/h;->n:I

    iput v1, p0, LJ5/h;->p:I
...
.method public final h()Z
    ...
    iput-object v0, p0, LJ5/h;->g:Landroid/graphics/Rect;
...
.method public final p()Z
    ...
    iput v0, p0, LJ5/h;->p:I

    invoke-static {}, Ljava/lang/System;->currentTimeMillis()J

    move-result-wide v0

    iput-wide v0, p0, LJ5/h;->o:J
...
.method public final t()V
    ...
    iput-object v2, p0, LJ5/h;->h:Landroid/graphics/Rect;
    ...
    iput-object v2, p0, LJ5/h;->i:[Landroid/hardware/camera2/params/Face;
    ...
    iput-object v1, p0, LJ5/h;->j:Ljava/lang/Byte;

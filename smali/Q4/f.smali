...
# virtual methods
.method public final Bb(Landroid/graphics/Bitmap;)V
    .locals 8
    ...
    invoke-static {}, LQ4/p;->b()Landroid/graphics/Bitmap$CompressFormat;
    ...
    invoke-static {v4, v5}, LI/b;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v0, v4, v2, v5}, LNn/o;->U(Ljava/lang/String;CII)I
    ...
    invoke-virtual {v5, v0, v2}, Lcom/xiaomi/cam/watermark/b;->S(Ljava/lang/String;Z)V
    ...
    iget-object v2, v0, LQ4/o;->a:LQ4/o$a;

    if-eqz v2, :cond_7

    invoke-interface {v2, p1}, LQ4/o$a;->a(Landroid/net/Uri;)V
...
.method public final Vg(Landroid/view/View;)V
    ...
    iget-object v1, p0, Lmiuix/appcompat/app/x;->a:Lmiuix/appcompat/app/y;

    invoke-virtual {v1}, Lmiuix/appcompat/app/e;->getActionBar()Lmiuix/appcompat/app/b;

    move-result-object v1

    iput-object v1, p0, LQ4/f;->e:Lmiuix/appcompat/app/b;
    ...
    :cond_0
    invoke-virtual {v1}, Lmiuix/appcompat/app/b;->v()V

    iget-object v1, p0, LQ4/f;->e:Lmiuix/appcompat/app/b;

    if-eqz v1, :cond_1

    invoke-virtual {v1, v0}, Lmiuix/appcompat/app/b;->x(Z)V
    ...
    iget-object v2, p0, LQ4/f;->e:Lmiuix/appcompat/app/b;

    if-eqz v2, :cond_3

    invoke-virtual {v2, v1}, Lmiuix/appcompat/app/b;->u(Landroid/widget/ImageView;)V
    ...
    invoke-direct {v2, p0, v0}, LQ4/a;-><init>(Ljava/lang/Object;I)V
    ...
    iput-object v1, p0, LQ4/f;->f:Lcom/android/camera/fragment/watermark/wmSettingV2/imageCrop/WmIconCropView;
    ...
    iput-object v1, p0, LQ4/f;->k:Landroid/view/View;
    ...
    iput-object p1, p0, LQ4/f;->j:Lcom/miui/support/cardview/CardView;

    iget-object p1, p0, LQ4/f;->g:Landroid/net/Uri;

    if-eqz p1, :cond_5

    iget-object p0, p0, LQ4/f;->f:Lcom/android/camera/fragment/watermark/wmSettingV2/imageCrop/WmIconCropView;
    ...
    invoke-static {v2, p1}, LQ4/o;->a(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    invoke-virtual {p0, p1}, Lcom/android/camera/fragment/watermark/wmSettingV2/imageCrop/WmIconCropView;->e(Landroid/net/Uri;)I
    ...
    :try_start_3
    invoke-static {v1, v3}, Ljd/b;->e(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    :try_end_3
...
.method public final Yb()V
    ...
    iget-object v0, p0, LQ4/f;->i:Lio/reactivex/disposables/b;
    ...
    :cond_0
    iget-object v0, p0, LQ4/f;->m:LQ4/e;

    if-eqz v0, :cond_2

    iget-object v1, p0, LQ4/f;->l:Landroid/os/Handler;
    ...
    iput-object v0, p0, LQ4/f;->m:LQ4/e;
...
.method public final onCreate(Landroid/os/Bundle;)V
    ...
    :goto_2
    iput-object v0, p0, LQ4/f;->g:Landroid/net/Uri;
    ...
    invoke-direct {v0, p0}, LQ4/f$a;-><init>(LQ4/f;)V

...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object p0, p0, Ld8/c;->a:Ld8/d;

    iget-boolean v0, p0, Ld8/d;->s:Z
    ...
    :cond_1
    iget v0, p0, Ld8/d;->b:I

    const/16 v4, 0x5a

    if-ne v0, v4, :cond_3

    iget v0, p0, Ld8/d;->c:I
    ...
    :goto_1
    iget-object v5, p0, Ld8/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-boolean p1, p0, Ld8/d;->t:Z

    if-nez p1, :cond_7

    iput-boolean v1, p0, Ld8/d;->t:Z

    goto/16 :goto_2

    :cond_5
    iget-object p1, p0, Ld8/d;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Ld8/d;->r:Ljava/lang/ref/WeakReference;

    invoke-virtual {v0}, Ljava/lang/ref/Reference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Ld8/d$d;

    if-eqz v0, :cond_6

    invoke-interface {v0}, Ld8/d$d;->onWideSelfCompleted()V

    :cond_6
    iput v1, p0, Ld8/d;->d:I

...
.method public constructor <init>(Ld/i;)V
    ...
    iput-object p1, p0, Ld/i$e;->h:Ld/i;
...
.method public final b(ILg/a;Ljava/lang/Object;)V
    ...
    iget-object v1, p0, Ld/i$e;->h:Ld/i;
    ...
    new-instance p3, Lcom/xiaomi/idm/api/d;

    const/4 v1, 0x1

    invoke-direct {p3, p1, v1, p0, v0}, Lcom/xiaomi/idm/api/d;-><init>(IILjava/lang/Object;Ljava/lang/Object;)V
    ...
    :cond_a
    instance-of p2, v1, LG/a$d;

    if-eqz p2, :cond_b

    move-object p2, v1

    check-cast p2, LG/a$d;

    :cond_b
    invoke-static {v1, p0, p1}, LG/a$a;->b(Landroid/app/Activity;[Ljava/lang/String;I)V
    ...
    invoke-virtual/range {v1 .. v8}, Ld/i;->startIntentSenderForResult(Landroid/content/IntentSender;ILandroid/content/Intent;IIILandroid/os/Bundle;)V
    :try_end_0
    ...
    invoke-direct {v0, p0, p1, p2}, Ld/j;-><init>(Ld/i$e;ILandroid/content/IntentSender$SendIntentException;)V
    ...
    :cond_d
    invoke-virtual {v1, p2, p1, v8}, Ld/i;->startActivityForResult(Landroid/content/Intent;ILandroid/os/Bundle;)V

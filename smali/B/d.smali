...
.method public final h(Landroid/util/AttributeSet;)V
    ...
    sget-object v1, LC/d;->MotionHelper:[I
    ...
    sget v3, LC/d;->MotionHelper_onShow:I

    if-ne v2, v3, :cond_0

    iget-boolean v3, p0, LB/d;->i:Z

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, LB/d;->i:Z

    goto :goto_1

    :cond_0
    sget v3, LC/d;->MotionHelper_onHide:I

    if-ne v2, v3, :cond_1

    iget-boolean v3, p0, LB/d;->j:Z

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, LB/d;->j:Z
...
.method public setProgress(F)V
    ...
    iput-object p1, p0, LB/d;->l:[Landroid/view/View;
    ...
    iget-object p1, p0, LB/d;->l:[Landroid/view/View;

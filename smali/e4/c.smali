...
.method public final Uh(Lcom/android/camera/data/data/c;ILe4/b;)V
    .locals 0

    iput-object p1, p0, Le4/c;->a:Lcom/android/camera/data/data/c;

    iput p2, p0, Lcom/android/camera/fragment/h;->mCurrentMode:I

    iput-object p3, p0, Le4/c;->b:Le4/b;
...
.method public final getSeekbarView()Landroid/view/View;
    ...
    iget-object p0, p0, Le4/c;->c:Lcom/android/camera/ui/CombineSlideView;

    return-object p0
.end method

.method public final hh(Ljava/lang/String;)Ljava/lang/String;
    .locals 2
...
.method public final initView(Landroid/view/View;)V
    ...
    iput-object p1, p0, Le4/c;->c:Lcom/android/camera/ui/CombineSlideView;
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Le4/c;->a:Lcom/android/camera/data/data/c;
    ...
    iget-object v0, p0, Le4/c;->c:Lcom/android/camera/ui/CombineSlideView;
    ...
    iget-object v2, p0, Le4/c;->c:Lcom/android/camera/ui/CombineSlideView;
    ...
    :cond_1
    iget-object p1, p0, Le4/c;->c:Lcom/android/camera/ui/CombineSlideView;
    ...
    :goto_1
    iget-object p1, p0, Le4/c;->a:Lcom/android/camera/data/data/c;

    iget v0, p0, Lcom/android/camera/fragment/h;->mCurrentMode:I

    invoke-virtual {p1, v0, v5}, Lcom/android/camera/data/data/c;->setComponentValue(ILjava/lang/String;)V

    iget-object v3, p0, Le4/c;->a:Lcom/android/camera/data/data/c;
    ...
    invoke-virtual/range {v2 .. v8}, Le4/c;->onManuallyDataChanged(Lcom/android/camera/data/data/c;Ljava/lang/String;Ljava/lang/String;ZII)V
...
.method public final onManuallyDataChanged(Lcom/android/camera/data/data/c;Ljava/lang/String;Ljava/lang/String;ZII)V
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/android/camera/fragment/b;->isEnableClick()Z
    ...
    invoke-virtual {v0, v2}, Le4/c;->hh(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iget-object v7, v0, Le4/c;->b:Le4/b;
    ...
    new-instance v15, Lcom/android/camera2/compat/theme/custom/mm/top/x;

    invoke-direct {v15, v3}, Lcom/android/camera2/compat/theme/custom/mm/top/x;-><init>(I)V

    invoke-virtual {v8, v15}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iget-object v3, v7, Le4/b;->b:Landroid/view/View;

    invoke-virtual {v3, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v3, v7, Le4/b;->m:Le4/b$a;
    ...
    invoke-virtual {v7}, Le4/b;->Oi()V

    new-instance v8, Ljava/lang/StringBuilder;

    invoke-direct {v8}, Ljava/lang/StringBuilder;-><init>()V

    invoke-static {v8, v1, v4, v6}, LI/b;->l(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v8

    iput-object v8, v7, Le4/b;->a:Ljava/lang/String;
    ...
    iput-object v1, v7, Le4/b;->a:Ljava/lang/String;

    iget-object v1, v7, Le4/b;->d:Lcom/android/camera/ui/FastmotionIndicatorView;

    invoke-virtual {v1, v10}, Landroid/view/View;->setVisibility(I)V

    iget-object v1, v7, Le4/b;->e:Landroid/widget/TextView;

    invoke-virtual {v1, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v1, v7, Le4/b;->f:Landroid/widget/TextView;
    ...
    invoke-virtual/range {p0 .. p0}, Le4/c;->Mh()Ljava/lang/String;

    move-result-object v7

    iget-object v8, v0, Le4/c;->b:Le4/b;
    ...
    new-instance v9, Lcom/android/camera2/compat/theme/custom/mm/top/x;

    invoke-direct {v9, v3}, Lcom/android/camera2/compat/theme/custom/mm/top/x;-><init>(I)V

    invoke-virtual {v15, v9}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iget-object v3, v8, Le4/b;->b:Landroid/view/View;

    invoke-virtual {v3, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v3, v8, Le4/b;->m:Le4/b$a;

    invoke-virtual {v3, v14}, Landroid/os/Handler;->removeMessages(I)V

    invoke-virtual {v3, v14, v11, v12}, Landroid/os/Handler;->sendEmptyMessageDelayed(IJ)Z

    invoke-virtual {v8}, Le4/b;->Oi()V

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    invoke-static {v9, v1, v6, v7}, LI/b;->l(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v9

    iput-object v9, v8, Le4/b;->a:Ljava/lang/String;

    if-eqz v4, :cond_7

    iget-object v1, v8, Le4/b;->d:Lcom/android/camera/ui/FastmotionIndicatorView;

    invoke-virtual {v1, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v15, v8, Le4/b;->d:Lcom/android/camera/ui/FastmotionIndicatorView;
    ...
    iget-object v1, v8, Le4/b;->e:Landroid/widget/TextView;

    invoke-virtual {v1, v10}, Landroid/view/View;->setVisibility(I)V

    iget-object v1, v8, Le4/b;->f:Landroid/widget/TextView;
    ...
    invoke-static {v1, v6}, LI/b;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v8, Le4/b;->a:Ljava/lang/String;
    ...
    invoke-virtual {v1, v3}, LV1/x0;->reset(I)V
    ...
    iget-object v9, v0, Le4/c;->c:Lcom/android/camera/ui/CombineSlideView;
    ...
    iget-object v0, v0, Le4/c;->b:Le4/b;
    ...
    new-instance v5, Lcom/android/camera2/compat/theme/custom/mm/top/x;

    invoke-direct {v5, v3}, Lcom/android/camera2/compat/theme/custom/mm/top/x;-><init>(I)V

    invoke-virtual {v4, v5}, Ljava/util/Optional;->ifPresent(Ljava/util/function/Consumer;)V

    iget-object v3, v0, Le4/b;->b:Landroid/view/View;

    invoke-virtual {v3, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v3, v0, Le4/b;->m:Le4/b$a;

    invoke-virtual {v3, v14}, Landroid/os/Handler;->removeMessages(I)V

    invoke-virtual {v3, v14, v11, v12}, Landroid/os/Handler;->sendEmptyMessageDelayed(IJ)Z

    invoke-virtual {v0}, Le4/b;->Oi()V

    new-instance v4, Ljava/lang/StringBuilder;

    invoke-direct {v4}, Ljava/lang/StringBuilder;-><init>()V

    invoke-static {v4, v2, v1, v6}, LI/b;->l(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v4

    iput-object v4, v0, Le4/b;->a:Ljava/lang/String;
    ...
    iget-object v2, v0, Le4/b;->d:Lcom/android/camera/ui/FastmotionIndicatorView;

    const/16 v4, 0x8

    invoke-virtual {v2, v4}, Landroid/view/View;->setVisibility(I)V

    iget-object v2, v0, Le4/b;->e:Landroid/widget/TextView;

    invoke-virtual {v2, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v2, v0, Le4/b;->f:Landroid/widget/TextView;

    invoke-virtual {v2, v4}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, v0, Le4/b;->e:Landroid/widget/TextView;
    ...
    iget-object v0, v0, Le4/b;->f:Landroid/widget/TextView;
    ...
    iget-object v2, v0, Le4/b;->b:Landroid/view/View;

    invoke-virtual {v2, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v2, v0, Le4/b;->m:Le4/b$a;
    ...
    invoke-static {v3, v1, v4}, LGe/b;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    iput-object v3, v0, Le4/b;->a:Ljava/lang/String;
    ...
    invoke-static {v1, v5}, LI/b;->i(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v1

    iput-object v1, v0, Le4/b;->a:Ljava/lang/String;

    iget-object v1, v0, Le4/b;->d:Lcom/android/camera/ui/FastmotionIndicatorView;

    const/16 v3, 0x8

    invoke-virtual {v1, v3}, Landroid/view/View;->setVisibility(I)V

    iget-object v1, v0, Le4/b;->e:Landroid/widget/TextView;

    invoke-virtual {v1, v13}, Landroid/view/View;->setVisibility(I)V

    iget-object v1, v0, Le4/b;->f:Landroid/widget/TextView;
    ...
    :goto_e
    invoke-virtual {v0, v5}, Le4/c;->hh(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v7, Lcom/android/camera2/compat/theme/custom/mm/top/x;

    invoke-direct {v7, v3}, Lcom/android/camera2/compat/theme/custom/mm/top/x;-><init>(I)V
    ...
    invoke-static {v6, v1, v2, v5}, LI/b;->l(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    iput-object v6, v0, Le4/b;->a:Ljava/lang/String;
    ...
    iget-object v15, v0, Le4/b;->d:Lcom/android/camera/ui/FastmotionIndicatorView;
...
.method public final updateView(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-interface {p2}, Lo8/b;->getOperationSeekbar()Lp8/C;
    ...
    iget-object p2, p0, Le4/c;->c:Lcom/android/camera/ui/CombineSlideView;
    ...
    invoke-virtual {v0, p0}, Lcom/android/camera/fragment/manually/adapter/l;->mapValueToPosition(Ljava/lang/String;)F

    move-result p0

    new-array p1, v3, [LH7/a;

    invoke-virtual {p2, v0, p0, p1}, Lcom/android/camera/ui/CombineSlideView;->b(Lcom/android/camera/ui/M;F[LH7/a;)V
    ...
    invoke-interface {v0, v1, v2, v2}, Lcom/android/camera/ui/M;->initDataList(LH7/i;Ljava/util/List;Ljava/lang/String;)V
    ...
    :cond_1
    iget-object v1, p0, Le4/c;->c:Lcom/android/camera/ui/CombineSlideView;
    ...
    invoke-virtual {v0, p1}, Lcom/android/camera/fragment/manually/adapter/l;->mapValueToPosition(Ljava/lang/String;)F
    ...
    invoke-direct {v2, v5}, LH7/a$a;-><init>(I)V

    iput-boolean v3, v2, LH7/a$a;->f:Z

    iput-boolean v4, v2, LH7/a$a;->e:Z

    invoke-static {}, Lcom/android/camera/features/mode/capture/s;->a()I

    move-result v3

    iput v3, v2, LH7/a$a;->l:I

    iput-boolean v4, v2, LH7/a$a;->g:Z
    ...
    iput v3, v2, LH7/a$a;->o:I

    iput v4, v2, LH7/a$a;->j:I
    ...
    invoke-virtual {p2, v5}, Lp8/B;->c(I)I

    move-result p2

    iput p2, v2, LH7/a$a;->k:I

    iput-boolean v4, v2, LH7/a$a;->i:Z

    const p2, 0x7f140d16

    iput p2, v2, LH7/a$a;->c:I

    invoke-virtual {p0}, Lcom/android/camera/fragment/h;->getDegree()I

    move-result p2

    iput p2, v2, LH7/a$a;->h:I

    iput-object p0, v2, LH7/a$a;->a:Landroid/view/View$OnClickListener;

    new-instance p0, LV1/Y;

    const/4 p2, 0x7

    invoke-direct {p0, p2}, LV1/Y;-><init>(I)V

    iput-object p0, v2, LH7/a$a;->n:LH7/a$b;

    new-instance p0, LH7/a;

    invoke-direct {p0, v2}, LH7/a;-><init>(LH7/a$a;)V

    filled-new-array {p0}, [LH7/a;

    move-result-object p0

    invoke-virtual {v1, v0, p1, p0}, Lcom/android/camera/ui/CombineSlideView;->b(Lcom/android/camera/ui/M;F[LH7/a;)V

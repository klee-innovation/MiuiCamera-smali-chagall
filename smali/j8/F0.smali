...
.method public constructor <init>(Lj8/f0;Landroid/hardware/camera2/CaptureResult;LFf/a;)V
    ...
    invoke-direct {p0, p1, p3}, Lj8/y0;-><init>(Lj8/f0;LFf/a;)V

    const/16 p3, 0xb

    iput p3, p0, Lj8/F0;->I:I

    const/4 p3, -0x1

    iput p3, p0, Lj8/F0;->N:I

    iput-object p2, p0, Lj8/y0;->w:Landroid/hardware/camera2/CaptureResult;

    iget-object p1, p1, Lj8/f0;->m0:Lj8/d1;

    iput-object p1, p0, Lj8/F0;->B:Lj8/d1;
...
.method public final j()V
    ...
    iget-boolean v1, p0, Lj8/F0;->H:Z

    if-nez v1, :cond_0

    invoke-virtual {p0}, Lj8/F0;->w()V

    :cond_0
    iput-boolean v0, p0, Lj8/y0;->y:Z

    iget-object v1, p0, Lj8/F0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

    invoke-virtual {v1}, Lcom/xiaomi/camera/imagecodec/FeatureSetting;->getFrameCount()I

    move-result v1

    iput v1, p0, Lj8/F0;->D:I
    ...
    iget-boolean v6, p0, Lj8/F0;->C:Z

    if-eqz v6, :cond_4

    const/16 v2, 0x9

    invoke-static {v0, v2, v3}, Lj8/d;->C0(IILj8/c;)Z
...
.method public final l()V
    ...
    invoke-direct {v3, p0}, Lj8/E0;-><init>(Lj8/F0;)V

    invoke-virtual {p0}, Lj8/F0;->v()Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v4

    iget-object v5, p0, Lj8/F0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    invoke-virtual {v8, v4, v9, v10}, Ln8/b;->L(Landroid/hardware/camera2/CaptureRequest$Builder;J)V
    ...
    invoke-virtual {v8, v7, v4}, Ln8/b;->G(ILandroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    iget-object v9, p0, Lj8/F0;->M:Landroid/util/Size;

    invoke-virtual {v9}, Landroid/util/Size;->getWidth()I

    move-result v9

    iget-object v10, p0, Lj8/F0;->M:Landroid/util/Size;
    ...
    invoke-virtual {p0, v4, v8, v5}, Lj8/y0;->q(Landroid/hardware/camera2/CaptureRequest;Lcom/xiaomi/engine/BufferFormat;I)Lcom/xiaomi/engine/PreProcessData;
    ...
    invoke-static {v5, v4}, LK2/b;->a(Landroid/hardware/camera2/CaptureRequest;Ljava/lang/String;)V

    invoke-virtual {v1}, Lj8/f0;->r()Landroid/hardware/camera2/CameraCaptureSession;

    move-result-object v4

    iget-object v5, p0, Lj8/q0;->c:Landroid/os/Handler;
...
.method public final v()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget-object v8, v2, Lj8/c;->z4:Ljava/lang/Boolean;

    if-nez v8, :cond_2

    sget-object v8, LA8/J;->f3:LA8/Q;

    invoke-virtual {v8}, LA8/Q;->b()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v2, v9}, Lj8/c;->G0(Ljava/lang/String;)Z
    ...
    invoke-static {v9, v8, v4}, LA8/S;->k(Landroid/hardware/camera2/CameraCharacteristics;LA8/Q;I)Ljava/lang/Object;
    ...
    iput-object v8, v2, Lj8/c;->z4:Ljava/lang/Boolean;
    ...
    iget-object v8, v3, Lj8/Q0;->n:Landroid/view/Surface;

    invoke-virtual {v1, v8}, Landroid/hardware/camera2/CaptureRequest$Builder;->addTarget(Landroid/view/Surface;)V

    :goto_2
    iget-object v8, p0, Lj8/F0;->K:Landroid/view/Surface;

    invoke-virtual {v1, v8}, Landroid/hardware/camera2/CaptureRequest$Builder;->addTarget(Landroid/view/Surface;)V

    iget v8, v0, Lj8/a;->a:I

    invoke-static {v8}, Lzf/b;->a(I)I
    ...
    invoke-virtual {v8}, L捙捕捗挔捗捓挔捞损捌捓捙损挔捙捕捗捗捕捔挔捹捕捗捗捕捔;->a4()Z
    ...
    iput v8, p0, Lj8/q0;->t:I

    sget-object v8, Ln8/a$a;->a:Ln8/b;

    invoke-virtual {v8, v1}, Ln8/b;->Y(Landroid/hardware/camera2/CaptureRequest$Builder;)V

    iget-object v8, p0, Lj8/F0;->J:Landroid/view/Surface;

    invoke-virtual {v3, v7}, Lj8/Q0;->i(I)Landroid/view/Surface;
    ...
    invoke-static {v9, v8}, LV1/Y;->a(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v13, p0, Lj8/F0;->L:Landroid/util/Size;

    invoke-virtual {p0, v8, v13, v10, v9}, Lj8/y0;->n(ILandroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;

    move-result-object v8

    iput-object v8, p0, Lj8/y0;->A:Lcom/xiaomi/engine/BufferFormat;

    goto :goto_5

    :cond_8
    iget-object v8, p0, Lj8/F0;->L:Landroid/util/Size;

    invoke-virtual {p0, v8, v10, v9}, Lj8/y0;->p(Landroid/util/Size;II)Lcom/xiaomi/engine/BufferFormat;
    ...
    :cond_9
    iget-boolean v10, p0, Lj8/q0;->n:Z
    ...
    iget-boolean v10, v10, Lj8/Q;->Z:Z
    ...
    invoke-static {v1, v12, v3}, Lj8/T;->l(Landroid/hardware/camera2/CaptureRequest$Builder;ILj8/Q;)V

    invoke-virtual {v0, v12, v1}, Lj8/f0;->D1(ILandroid/hardware/camera2/CaptureRequest$Builder;)V

    sget-object v3, Ln8/a$a;->a:Ln8/b;

    invoke-virtual {v3, v1, v6}, Ln8/b;->H(Landroid/hardware/camera2/CaptureRequest$Builder;B)V

    iget v9, p0, Lj8/F0;->D:I

    invoke-virtual {v3, v9, v1}, Ln8/b;->F(ILandroid/hardware/camera2/CaptureRequest$Builder;)V

    invoke-virtual {v3, v1}, Ln8/b;->J(Landroid/hardware/camera2/CaptureRequest$Builder;)V

    invoke-virtual {v3, v1}, Ln8/b;->I(Landroid/hardware/camera2/CaptureRequest$Builder;)V

    iget-object v9, v0, Lj8/f0;->F:Lj8/P;

    iget-object v9, v9, Lj8/P;->a:Lj8/Q;

    iget v9, v9, Lj8/Q;->X2:I

    if-eq v9, v12, :cond_d

    if-eq v9, v11, :cond_c

    iget-boolean v10, p0, Lj8/F0;->C:Z
    ...
    invoke-static {v9, v10, v11, v13}, LKb/v1;->f(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v10, v1}, Ln8/b;->K(ILandroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    invoke-virtual {v3, v10, v1}, Ln8/b;->D0(Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CaptureRequest$Builder;)V

    :cond_e
    if-eqz v2, :cond_12

    iget-object v10, v2, Lj8/c;->s4:Ljava/lang/Boolean;

    if-nez v10, :cond_11

    sget-object v10, LA8/J;->c3:LA8/Q;

    invoke-virtual {v10}, LA8/Q;->b()Ljava/lang/String;

    move-result-object v11

    invoke-virtual {v2, v11}, Lj8/c;->G0(Ljava/lang/String;)Z

    move-result v11

    if-eqz v11, :cond_10

    iget-object v11, v2, Lj8/c;->d:Landroid/hardware/camera2/CameraCharacteristics;

    invoke-static {v11, v10, v4}, LA8/S;->k(Landroid/hardware/camera2/CameraCharacteristics;LA8/Q;I)Ljava/lang/Object;
    ...
    iput-object v4, v2, Lj8/c;->s4:Ljava/lang/Boolean;
    ...
    :cond_11
    :goto_8
    iget-object v4, v2, Lj8/c;->s4:Ljava/lang/Boolean;
    ...
    invoke-virtual {v3, v1}, Ln8/b;->m(Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    :goto_9
    iget-object v4, v8, LEd/c;->e:L捙捕捗挔捗捓挔捞损捌捓捙损挔捙捕捗捗捕捔挔捹捕捗捗捕捔;

    invoke-virtual {v4}, L捙捕捗挔捗捓挔捞损捌捓捙损挔捙捕捗捗捕捔挔捹捕捗捗捕捔;->f()Z
    ...
    :cond_14
    iget-object v4, p0, Lj8/F0;->B:Lj8/d1;

    if-eqz v4, :cond_16

    iget-object v4, v4, Lj8/d1;->g:Lj8/d1$a;

    iget-boolean v4, v4, Lj8/d1$a;->a:Z

    if-nez v4, :cond_16

    :cond_15
    invoke-static {v1, v7}, Ln8/b;->v(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    iget-boolean v4, v4, Lj8/Q;->S0:Z

    if-eqz v4, :cond_17

    if-ne v12, v9, :cond_17

    invoke-static {v1, v7}, Ln8/b;->u0(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    iget v4, v4, Lj8/Q;->b0:F

    iget-object v6, p0, Lj8/y0;->v:Landroid/graphics/Rect;

    invoke-static {v4, v6}, LE7/b;->v(FLandroid/graphics/Rect;)Landroid/graphics/Rect;

    move-result-object v4

    const-string/jumbo v6, "sr set mtkCrop = "

    invoke-static {v4, v6}, LD1/a;->b(Landroid/graphics/Rect;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v1, v4}, Ln8/b;->d0(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/graphics/Rect;)V
    ...
    iput-object v3, p0, Lj8/q0;->m:Ljava/lang/String;

    sget-object v3, LA8/N;->o3:LA8/Q;
    ...
    invoke-static {v1, v3, v0}, LA8/S;->g(Landroid/hardware/camera2/CaptureRequest$Builder;LA8/Q;Ljava/lang/Object;)V
    ...
    invoke-static {v1, v2, p0}, Lj8/T;->A0(Landroid/hardware/camera2/CaptureRequest$Builder;Lj8/c;Ljava/lang/String;)V
...
.method public final w()V
    ...
    iput-object v3, v0, Lj8/F0;->K:Landroid/view/Surface;
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0

    :catch_0
    iget-object v3, v0, Lj8/F0;->K:Landroid/view/Surface;

    const/4 v4, 0x1

    if-nez v3, :cond_0

    iput-boolean v4, v0, Lj8/F0;->H:Z
    ...
    invoke-virtual {v9, v7, v8}, Lj8/Q0;->f(IZ)Landroid/view/Surface;

    move-result-object v8

    iput-object v8, v0, Lj8/F0;->J:Landroid/view/Surface;
    ...
    iget-object v8, v6, Lj8/Q;->M:Landroid/util/Size;

    goto :goto_3

    :cond_6
    iget-object v8, v6, Lj8/Q;->O:Landroid/util/Size;

    goto :goto_3

    :cond_7
    iget-object v8, v6, Lj8/Q;->N:Landroid/util/Size;
    ...
    :cond_9
    iget-object v8, v6, Lj8/Q;->L:Landroid/util/Size;
    ...
    invoke-static {v13, v8}, LD2/i;->e(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    :goto_4
    iput-object v8, v0, Lj8/F0;->M:Landroid/util/Size;

    iget-object v8, v0, Lj8/F0;->J:Landroid/view/Surface;

    invoke-static {v8}, Lgj/L;->d(Landroid/view/Surface;)Landroid/util/Size;

    move-result-object v8

    iput-object v8, v0, Lj8/F0;->L:Landroid/util/Size;
    ...
    iget-object v12, v0, Lj8/F0;->M:Landroid/util/Size;
    ...
    iget-object v12, v0, Lj8/F0;->L:Landroid/util/Size;
    ...
    iget-object v8, v6, Lj8/Q;->j:Landroid/util/Size;
    ...
    iget-object v13, v0, Lj8/F0;->L:Landroid/util/Size;
    ...
    :goto_6
    iget-object v14, v0, Lj8/F0;->L:Landroid/util/Size;
    ...
    invoke-static {v14, v8}, LD2/i;->e(Ljava/lang/String;Landroid/util/Size;)Ljava/lang/String;
    ...
    iget v14, v6, Lj8/Q;->V:I

    invoke-direct {v8, v12, v13, v14}, Lcom/xiaomi/camera/imagecodec/OutputConfiguration;-><init>(III)V

    iget-object v12, v0, Lj8/y0;->w:Landroid/hardware/camera2/CaptureResult;

    sget-object v13, LTh/g$c;->a:LTh/g;

    invoke-virtual {v13}, LTh/g;->a()LTh/g$b;
    ...
    iget v13, v6, Lj8/Q;->X2:I

    if-eq v13, v10, :cond_13

    if-eq v13, v9, :cond_12

    invoke-static {v12}, Lj8/V;->m(Landroid/hardware/camera2/CaptureResult;)Ljava/lang/Integer;

    move-result-object v3

    iget v14, v6, Lj8/Q;->h0:I
    ...
    :cond_f
    iget-boolean v14, v6, Lj8/Q;->e3:Z
    ...
    :goto_7
    iput-boolean v14, v0, Lj8/F0;->C:Z
    ...
    invoke-static {v13, v11, v14, v15, v4}, LB2/m;->h(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v12}, Lzf/a;->b(Landroid/hardware/camera2/CaptureResult;)Landroid/os/Parcelable;
    ...
    invoke-static {v14, v15, v4}, LF9/d;->d(JLjava/lang/String;)Ljava/lang/String;
    ...
    sget-object v9, LA8/P;->s1:LA8/Q;

    const v10, 0xbabe

    invoke-static {v4, v9, v10}, LA8/S;->n(Landroid/hardware/camera2/CaptureResult;LA8/Q;I)Ljava/lang/Object;
    ...
    :goto_a
    iget-object v13, v0, Lj8/y0;->w:Landroid/hardware/camera2/CaptureResult;

    sget-object v2, LA8/P;->r1:LA8/Q;

    invoke-static {v13, v2, v10}, LA8/S;->n(Landroid/hardware/camera2/CaptureResult;LA8/Q;I)Ljava/lang/Object;
    ...
    invoke-static {v14, v15, v2}, LF9/d;->d(JLjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v2, v0, Lj8/F0;->L:Landroid/util/Size;

    iget-object v4, v0, Lj8/F0;->M:Landroid/util/Size;
    ...
    iput-object v1, v0, Lj8/F0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
    ...
    iget-object v2, v0, Lj8/F0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;
...
.method public final x()Z
    ...
    invoke-static {v0}, Lj8/V;->l(Landroid/hardware/camera2/CaptureResult;)Z
    ...
    :cond_1
    iget-object p0, p0, Lj8/F0;->G:Lcom/xiaomi/camera/imagecodec/FeatureSetting;

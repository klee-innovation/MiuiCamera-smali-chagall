...
# direct methods
.method public constructor <init>(Lj8/f0;IZ)V
    .locals 1
    ...
    iput-boolean v0, p0, Lj8/s0;->y:Z

    iput p1, p0, Lj8/s0;->B:I

    iput-boolean p1, p0, Lj8/s0;->C:Z

    iput p2, p0, Lj8/s0;->z:I

    iput-boolean p3, p0, Lj8/s0;->x:Z
...
.method public final i(Landroid/media/Image;I)V
    ...
    :cond_0
    iget-object v0, p0, Lj8/s0;->w:Landroid/hardware/camera2/TotalCaptureResult;

    invoke-interface {p2, p1, v0}, Lj8/a$i;->onPictureTakenImageConsumed(Landroid/media/Image;Landroid/hardware/camera2/TotalCaptureResult;)Z
    ...
    :cond_1
    iget p2, p0, Lj8/s0;->B:I

    const/4 v0, 0x1

    add-int/2addr p2, v0

    iput p2, p0, Lj8/s0;->B:I
    ...
    iget-object p1, p0, Lj8/s0;->w:Landroid/hardware/camera2/TotalCaptureResult;

    iget-object v1, p0, Lj8/q0;->h:Lj8/a$i;
    ...
    invoke-interface {v1, p2, p1}, Lj8/a$i;->onPictureTaken([BLandroid/hardware/camera2/CaptureResult;)V
    ...
    :goto_0
    iget-boolean p1, p0, Lj8/s0;->C:Z

    if-eqz p1, :cond_3

    iget p1, p0, Lj8/s0;->B:I

    iget p2, p0, Lj8/s0;->A:I

    if-ne p1, p2, :cond_3

    iget p1, p0, Lj8/s0;->v:I

    invoke-virtual {p0, p1, v0}, Lj8/s0;->o(IZ)V
...
.method public final l()V
    ...
    invoke-virtual {v3}, LEd/c;->Y0()Z

    move-result v4

    iget v5, p0, Lj8/s0;->z:I

    if-eqz v4, :cond_0

    if-lez v5, :cond_0

    iget v4, p0, Lj8/s0;->A:I
    ...
    :try_start_0
    new-instance v6, Lj8/r0;

    invoke-direct {v6, p0}, Lj8/r0;-><init>(Lj8/s0;)V

    invoke-virtual {p0}, Lj8/s0;->n()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    iget v11, p0, Lj8/s0;->A:I

    add-int/2addr v11, v0

    iput v11, p0, Lj8/s0;->A:I

    iput v10, p0, Lj8/s0;->u:I

    if-ne v11, v5, :cond_3

    iput v10, p0, Lj8/s0;->v:I
    ...
    iput v0, p0, Lj8/s0;->v:I

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0, v2}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget p0, p0, Lj8/s0;->v:I
...
.method public final n()Landroid/hardware/camera2/CaptureRequest$Builder;
    ...
    invoke-virtual {v1, v3, v7}, LHf/c;->a(LHf/d;Lj8/c1;)Landroid/hardware/camera2/CaptureRequest$Builder;

    move-result-object v1

    sget-object v3, Ln8/a$a;->a:Ln8/b;

    invoke-virtual {v3, v1}, Ln8/b;->g(Landroid/hardware/camera2/CaptureRequest$Builder;)V

    invoke-virtual {v3, v1}, Ln8/b;->Y(Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    invoke-static {v1, v3, v7, v4}, LA8/S;->f(Landroid/hardware/camera2/CaptureRequest$Builder;Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;Z)V
    ...
    invoke-virtual {v3, v1}, Ln8/b;->Z(Landroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    iget-object v7, v3, Lj8/Q0;->a:Landroid/media/ImageReader;
    ...
    iget-boolean p0, p0, Lj8/s0;->x:Z

    if-nez p0, :cond_4

    iget-object p0, v3, Lj8/Q0;->n:Landroid/view/Surface;
    ...
    invoke-virtual {v0, p0, v1}, Lj8/f0;->D1(ILandroid/hardware/camera2/CaptureRequest$Builder;)V
    ...
    invoke-static {v1, v4}, Ln8/b;->B0(Landroid/hardware/camera2/CaptureRequest$Builder;Z)V
    ...
    invoke-static {v1, v0, v2, v4}, LA8/S;->e(Landroid/hardware/camera2/CaptureRequest$Builder;LA8/Q;Ljava/lang/Object;Z)V
    ...
    invoke-virtual {v0}, L捙捕捗挔捗捓挔捞损捌捓捙损挔捙捕捗捗捕捔挔捹捕捗捗捕捔;->s()I

    move-result v0

    invoke-virtual {p0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static {v0, v1}, Ln8/b;->r0(ILandroid/hardware/camera2/CaptureRequest$Builder;)V
...
.method public final o(IZ)V
    ...
    invoke-virtual {v0, v2}, Lj8/f0;->c(Z)V
    ...
    invoke-interface {p1, p2, v3, v4, v2}, Lj8/a$i;->onPictureTakenFinished(ZJI)V
    ...
    :goto_0
    invoke-virtual {v0, p0, p2}, Lj8/f0;->y2(Lj8/q0;Z)V

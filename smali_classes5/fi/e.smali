...
# direct methods
.method public constructor <init>(Lfi/i;Ljava/lang/String;)V
    .locals 1
    ...
    iput-object p1, p0, Lfi/e;->c:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object p1, p0, Lfi/e;->b:Ljava/util/concurrent/LinkedBlockingQueue;
    ...
    iput-object p1, p0, Lfi/e;->e:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance p1, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {p1, v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>(Z)V

    iput-object p1, p0, Lfi/e;->f:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    new-instance p2, Lfi/e$a;

    invoke-direct {p2, p0, p1}, Lfi/e$a;-><init>(Lfi/e;Ljava/net/InetAddress;)V

    iput-object p2, p0, Lfi/e;->d:Lfi/e$a;
    ...
    invoke-virtual {p0, p1}, Lfi/e;->d(Ljava/lang/String;)V
...
.method public final e(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V
    ...
    iget-object v3, p0, Lfi/e;->d:Lfi/e$a;
    ...
    invoke-virtual/range {v3 .. v8}, Lfi/e$a;->d(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V
    :try_end_0
...
.method public final f(Landroid/content/Context;Landroid/net/Uri;ILjava/lang/String;)V
    .locals 8
    ...
    invoke-virtual/range {v2 .. v7}, Lfi/e;->e(Ljava/io/FileInputStream;Ljava/lang/String;IJ)V

...
.method public static a(Lio/reactivex/functions/a;)Lio/reactivex/internal/operators/completable/f;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lio/reactivex/internal/operators/completable/f;-><init>(Lio/reactivex/functions/a;)V

    return-object v0
.end method

.method public static e(JLjava/util/concurrent/TimeUnit;Lio/reactivex/v;)Lio/reactivex/internal/operators/completable/n;
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lio/reactivex/internal/operators/completable/n;-><init>(JLjava/util/concurrent/TimeUnit;Lio/reactivex/v;)V
...
# virtual methods
.method public final b(Lio/reactivex/v;)Lio/reactivex/internal/operators/completable/j;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/completable/j;-><init>(Lio/reactivex/b;Lio/reactivex/v;)V
...
.method public final d(Lio/reactivex/v;)Lio/reactivex/internal/operators/completable/l;
    .locals 1
    ...
    invoke-direct {v0, p0, p1}, Lio/reactivex/internal/operators/completable/l;-><init>(Lio/reactivex/b;Lio/reactivex/v;)V
...
.method public final subscribe(Lio/reactivex/functions/a;)Lio/reactivex/disposables/b;
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/observers/e;-><init>(Lio/reactivex/functions/a;)V
...
.method public final subscribe(Lio/reactivex/functions/a;Lio/reactivex/functions/d;)Lio/reactivex/disposables/b;
    ...
    invoke-direct {v0, p1, p2}, Lio/reactivex/internal/observers/e;-><init>(Lio/reactivex/functions/a;Lio/reactivex/functions/d;)V
...
.method public final subscribe(Lio/reactivex/d;)V
    ...
    .line 4
    :try_start_0
    sget-object v0, Lio/reactivex/plugins/a;->e:Lcom/uber/rxdogtag/f;
    :try_end_0
    ...
    .line 5
    :try_start_1
    invoke-virtual {v0, p0, p1}, Lcom/uber/rxdogtag/f;->apply(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

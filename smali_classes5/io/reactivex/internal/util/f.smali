...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lio/reactivex/internal/util/f$c;,
        Lio/reactivex/internal/util/f$b;
    }
.end annotation
...
.method public static a(Lio/reactivex/u;Ljava/lang/Object;)Z
    ...
    :cond_0
    instance-of v0, p1, Lio/reactivex/internal/util/f$b;

    if-eqz v0, :cond_1

    check-cast p1, Lio/reactivex/internal/util/f$b;

    iget-object p1, p1, Lio/reactivex/internal/util/f$b;->a:Ljava/lang/Throwable;
    ...
    :cond_1
    instance-of v0, p1, Lio/reactivex/internal/util/f$a;

    const/4 v1, 0x0

    if-eqz v0, :cond_2

    check-cast p1, Lio/reactivex/internal/util/f$a;

    iget-object p1, p1, Lio/reactivex/internal/util/f$a;->a:Lio/reactivex/disposables/b;

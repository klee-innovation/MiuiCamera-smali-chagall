...
# virtual methods
.method public final a(Lio/reactivex/v;I)Lio/reactivex/internal/operators/flowable/l;
    .locals 1
    ...
    invoke-static {p2, v0}, LDa/E;->o(ILjava/lang/String;)V

    new-instance v0, Lio/reactivex/internal/operators/flowable/l;

    invoke-direct {v0, p0, p1, p2}, Lio/reactivex/internal/operators/flowable/l;-><init>(Lio/reactivex/h;Lio/reactivex/v;I)V

    return-object v0
.end method

.method public abstract b(LRq/b;)V
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
            "LRq/b<",
...
.method public final subscribe()Lio/reactivex/disposables/b;
    ...
    sget-object v3, Lio/reactivex/internal/operators/flowable/i;->a:Lio/reactivex/internal/operators/flowable/i;
...
.method public final subscribe(Lio/reactivex/functions/d;)Lio/reactivex/disposables/b;
    ...
    sget-object v2, Lio/reactivex/internal/operators/flowable/i;->a:Lio/reactivex/internal/operators/flowable/i;
...
.method public final subscribe(Lio/reactivex/functions/d;Lio/reactivex/functions/d;)Lio/reactivex/disposables/b;
    ...
    sget-object v1, Lio/reactivex/internal/operators/flowable/i;->a:Lio/reactivex/internal/operators/flowable/i;
...
.method public final subscribe(Lio/reactivex/functions/d;Lio/reactivex/functions/d;Lio/reactivex/functions/a;)Lio/reactivex/disposables/b;
    ...
    .line 4
    sget-object v0, Lio/reactivex/internal/operators/flowable/i;->a:Lio/reactivex/internal/operators/flowable/i;
...
.method public final subscribe(LRq/b;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v0, p1}, Lio/reactivex/internal/subscribers/d;-><init>(LRq/b;)V
...
.method public final subscribe(Lio/reactivex/k;)V
    ...
    .line 16
    :try_start_0
    sget-object v0, Lio/reactivex/plugins/a;->a:Lcom/uber/rxdogtag/F;
    :try_end_0
    ...
    .line 21
    invoke-virtual {p0, p1}, Lio/reactivex/h;->b(LRq/b;)V
    :try_end_2

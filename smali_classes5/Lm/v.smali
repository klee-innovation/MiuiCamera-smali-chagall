...
.method static constructor <clinit>()V
    ...
    invoke-static {v1, v0}, Len/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    const-string v2, "java/lang/annotation/Annotation.annotationType()Ljava/lang/Class;"

    invoke-static {v0, v2}, Lim/F;->v(Ljava/util/Set;Ljava/lang/Object;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, LLm/v;->a:Ljava/util/LinkedHashSet;

    sget-object v0, Ltn/c;->e:Ltn/c;

    sget-object v2, Ltn/c;->f:Ltn/c;

    filled-new-array {v0, v2}, [Ltn/c;
    ...
    invoke-virtual {v5}, Lln/c;->f()Lln/f;

    move-result-object v5

    invoke-virtual {v5}, Lln/f;->e()Ljava/lang/String;
    ...
    iget-object v6, v3, Ltn/c;->b:Ljava/lang/String;
    ...
    invoke-virtual {v3}, Ltn/c;->g()Ljava/lang/String;
    ...
    invoke-static {v5, v3}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v3}, Len/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v3

    invoke-static {v2, v3}, Lim/F;->u(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v6, v3}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v8}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v8

    invoke-static {v2, v8}, Lim/F;->u(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v7, v3}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, LLm/v;->b:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v2}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v8, v3}, Len/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v3}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1, v3}, Len/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v8}, Len/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v8}, Len/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v2, LLm/v;->c:Ljava/util/LinkedHashSet;

    filled-new-array {v11}, [Ljava/lang/String;

    move-result-object v2

    invoke-static {v1, v2}, Len/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v5, v0}, Len/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    invoke-static {v1, v0}, Lim/F;->u(Ljava/util/Set;Ljava/lang/Iterable;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v10, v1}, Len/x;->d(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, LLm/v;->d:Ljava/util/LinkedHashSet;

    sget-object v10, Ltn/c;->e:Ltn/c;

    sget-object v14, Ltn/c;->g:Ltn/c;

    sget-object v12, Ltn/c;->l:Ltn/c;

    sget-object v13, Ltn/c;->j:Ltn/c;

    sget-object v15, Ltn/c;->i:Ltn/c;

    sget-object v16, Ltn/c;->k:Ltn/c;

    sget-object v17, Ltn/c;->h:Ltn/c;

    move-object v11, v14

    filled-new-array/range {v10 .. v17}, [Ltn/c;
    ...
    invoke-virtual {v2}, Ltn/c;->i()Lln/c;
    ...
    invoke-static {v3}, Len/x;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v0}, Len/x;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v7, v0}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    invoke-static {v1}, Len/x;->a([Ljava/lang/String;)[Ljava/lang/String;
    ...
    invoke-static {v6, v1}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;
    ...
    sput-object v0, LLm/v;->e:Ljava/util/LinkedHashSet;
    ...
    invoke-static {v9, v0}, Len/x;->c(Ljava/lang/String;[Ljava/lang/String;)Ljava/util/LinkedHashSet;

    move-result-object v0

    sput-object v0, LLm/v;->f:Ljava/util/LinkedHashSet;

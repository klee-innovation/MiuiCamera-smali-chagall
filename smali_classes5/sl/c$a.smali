...
# virtual methods
.method public final a(ILOk/d;)V
    .locals 2

    iget-object p0, p0, Lsl/c$a;->a:Lsl/c;

    iget-object v0, p0, Lsl/c;->r:LOk/d;

    if-eqz v0, :cond_0

    iget-object v1, p2, LOk/d;->a:Ljava/lang/String;
    ...
    :cond_0
    iget-object v0, p0, Lsl/c;->d:Lcom/xiaomi/mimoji/mimojifu2/faceunity/editor/widget/CustomCategoryLinearLayout;

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Lcom/xiaomi/mimoji/mimojifu2/faceunity/editor/widget/CustomCategoryLinearLayout;->setNeedShake(Z)V

    iput-object p2, p0, Lsl/c;->r:LOk/d;

    iget-object v0, p0, Lsl/c;->j:Ljava/util/HashMap;
    ...
    invoke-virtual {p0, p2}, Lpl/j;->b(LOk/d;)V

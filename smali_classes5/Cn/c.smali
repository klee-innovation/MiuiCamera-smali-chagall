...
# direct methods
.method public static a(LCn/g0;LFn/h;LCn/g0$b;)Z
    .locals 9
    ...
    invoke-interface {v0, p1}, LFn/m;->q(LFn/h;)Z
    ...
    :cond_0
    invoke-interface {v0, p1}, LFn/m;->c0(LFn/g;)Z
    ...
    iget-object v1, p0, LCn/g0;->g:Ljava/util/ArrayDeque;
    ...
    invoke-interface {v0, v4}, LFn/m;->q(LFn/h;)Z
    ...
    invoke-interface {v0, v6}, LFn/m;->e(LFn/h;)Z

    move-result v7

    if-eqz v7, :cond_6

    invoke-interface {v0, v6}, LFn/m;->q(LFn/h;)Z
    ...
    :cond_6
    invoke-interface {v0, v6}, LFn/m;->c0(LFn/g;)Z
...
.method public static b(LCn/g0;LFn/h;LFn/k;)Z
    .locals 3

    iget-object v0, p0, LCn/g0;->c:LDn/b;

    invoke-interface {v0, p1}, LFn/m;->d(LFn/h;)Z
    ...
    :cond_1
    iget-boolean p0, p0, LCn/g0;->b:Z

    if-eqz p0, :cond_2

    invoke-interface {v0, p1}, LFn/m;->i0(LFn/h;)Z

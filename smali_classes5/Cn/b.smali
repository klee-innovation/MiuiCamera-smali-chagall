...
.method public constructor <init>(LBn/o;)V
    ...
    invoke-direct {p0, p1}, LCn/i;-><init>(LBn/o;)V
...
.method public final c(LMm/h;)Z
    ...
    invoke-virtual {p0}, LCn/b;->p()LMm/e;
    ...
    instance-of v0, p0, LMm/C;

    if-eqz v0, :cond_2

    instance-of p0, p1, LMm/C;

    goto :goto_3

    :cond_2
    instance-of v0, p1, LMm/C;
...
.method public final e()LCn/F;
    ...
    sget-object v2, LJm/j;->e:Lln/f;

    sget-object v2, LJm/n$a;->a:Lln/d;

    invoke-static {v0, v2}, LJm/j;->b(LMm/e;Lln/d;)Z

    move-result v2

    if-nez v2, :cond_1

    sget-object v2, LJm/n$a;->b:Lln/d;
    ...
    :cond_0
    invoke-virtual {p0}, LCn/b;->k()LJm/j;
...
.method public bridge synthetic m()LMm/h;
    .locals 0
...
.method public abstract p()LMm/e;
.end method

...
.method public constructor <init>(LTl/b;)V
    ...
    iput-object v0, p0, LTl/b$b;->a:Ljava/lang/ref/WeakReference;
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object p0, p0, LTl/b$b;->a:Ljava/lang/ref/WeakReference;
    ...
    iget-object p1, p0, LTl/b;->d:LTl/b$a;
    ...
    check-cast p1, LXl/e$a;

    iget-object p1, p1, LXl/e$a;->a:Lcom/android/camera/module/video/g;
    ...
    :try_start_0
    iget-object v2, p1, Lcom/android/camera/module/video/g;->b:LTl/f;
    ...
    iput-object v0, p1, Lcom/android/camera/module/video/g;->b:LTl/f;
    ...
    :cond_3
    :goto_2
    iput-object v0, p0, LTl/b;->d:LTl/b$a;

    :cond_4
    iget p1, p0, LTl/b;->e:I
    ...
    :cond_8
    iget p1, p0, LTl/b;->s:I

    const-string v2, "ComputeRenderThread"

    invoke-static {p1, v2}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v1, p0, LTl/b;->s:I

    iget p1, p0, LTl/b;->t:I

    const-string v2, "ComputeRenderThread"

    invoke-static {p1, v2}, Lcom/xiaomi/gl/MIGL;->glDeleteProgram(ILjava/lang/String;)V

    iput v1, p0, LTl/b;->t:I

    iget-object p1, p0, LTl/b;->b:Landroid/graphics/SurfaceTexture;
    ...
    iput-object v0, p0, LTl/b;->b:Landroid/graphics/SurfaceTexture;

    :cond_9
    iget-object p1, p0, LTl/b;->l:LTl/d;
    ...
    invoke-virtual {p1}, LTl/e;->d()Z

    iget-object p1, p0, LTl/b;->m:LTl/c;

    iget-object p1, p1, LTl/c;->a:Landroid/opengl/EGLDisplay;

    iget-object v2, p0, LTl/b;->l:LTl/d;

    iget-object v2, v2, LTl/e;->b:Landroid/opengl/EGLSurface;

    invoke-static {p1, v2}, Landroid/opengl/EGL14;->eglDestroySurface(Landroid/opengl/EGLDisplay;Landroid/opengl/EGLSurface;)Z

    iput-object v0, p0, LTl/b;->l:LTl/d;
    ...
    invoke-virtual {p1}, LTl/c;->a()V

    iput-object v0, p0, LTl/b;->m:LTl/c;

    :cond_b
    iget-object p1, p0, LTl/b;->a:LTl/b$b;

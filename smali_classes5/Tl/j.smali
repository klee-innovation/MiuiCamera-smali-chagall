...
.method public constructor <init>(Ljava/lang/String;Landroid/opengl/EGLContext;[I)V
    ...
    iput-object v0, p0, LTl/j;->a:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    new-instance p1, Landroid/os/Handler;

    iget-object v0, p0, LTl/j;->a:Landroid/os/HandlerThread;
    ...
    iput-object p1, p0, LTl/j;->b:Landroid/os/Handler;
    ...
    iget-object p1, p0, LTl/j;->b:Landroid/os/Handler;

    new-instance v0, LK0/H;

    const/4 v1, 0x1

    invoke-direct {v0, v1, p3, p0, p2}, LK0/H;-><init>(ILjava/io/Serializable;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final a()LTl/c;
    ...
    iget-object v1, p0, LTl/j;->b:Landroid/os/Handler;

    if-eqz v1, :cond_0

    const-wide/16 v2, 0x0

    invoke-virtual {v0, v1, v2, v3}, Lzj/a;->a(Landroid/os/Handler;J)Z
...
.method public final b()V
    ...
    iget-object v1, p0, LTl/j;->a:Landroid/os/HandlerThread;
    ...
    iget-object v0, p0, LTl/j;->b:Landroid/os/Handler;

    new-instance v2, LBk/k;

    const/4 v3, 0x3

    invoke-direct {v2, p0, v3}, LBk/k;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {v0, v2}, Landroid/os/Handler;->post(Ljava/lang/Runnable;)Z

    const/4 v0, 0x0

    iput-object v0, p0, LTl/j;->b:Landroid/os/Handler;

    iget-object v2, p0, LTl/j;->a:Landroid/os/HandlerThread;

...
.field private transient reflected:LDm/c;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/d;->getReflected()LDm/c;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, LDm/c;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()LDm/c;
    .locals 1

    iget-object v0, p0, Lkotlin/jvm/internal/d;->reflected:LDm/c;

    if-nez v0, :cond_0

    invoke-virtual {p0}, Lkotlin/jvm/internal/d;->computeReflected()LDm/c;

    move-result-object v0

    iput-object v0, p0, Lkotlin/jvm/internal/d;->reflected:LDm/c;

    :cond_0
    return-object v0
.end method

.method public abstract computeReflected()LDm/c;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {p0}, LDm/b;->getAnnotations()Ljava/util/List;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, LDm/c;->getParameters()Ljava/util/List;
...
.method public getReflected()LDm/c;
    .locals 1
...
.method public getReturnType()LDm/n;
    .locals 0
    ...
    invoke-interface {p0}, LDm/c;->getReturnType()LDm/n;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, LDm/c;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()LDm/r;
    .locals 0
    ...
    invoke-interface {p0}, LDm/c;->getVisibility()LDm/r;
...
.method public isAbstract()Z
    ...
    invoke-interface {p0}, LDm/c;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {p0}, LDm/c;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {p0}, LDm/c;->isOpen()Z

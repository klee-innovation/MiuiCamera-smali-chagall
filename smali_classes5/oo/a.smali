...
.method public final getMovementFlags(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$B;)I
    ...
    instance-of p0, p2, Lko/c$a;

    const/4 p1, 0x0

    if-eqz p0, :cond_3

    check-cast p2, Lko/c$a;

    iget-object p0, p2, Lko/c$a;->a:Ljava/lang/Object;

    if-eqz p0, :cond_2

    instance-of p2, p0, Lmo/c;
    ...
    :goto_0
    instance-of v0, p0, Lmo/g;

    if-eqz v0, :cond_1

    check-cast p0, Lmo/g;

    invoke-interface {p0}, Lmo/g;->a()I
    ...
    :goto_1
    invoke-static {p1, p0}, Landroidx/recyclerview/widget/r$d;->makeMovementFlags(II)I
...
.method public final getSwipeThreshold(Landroidx/recyclerview/widget/RecyclerView$B;)F
    .locals 0
...
.method public final onChildDraw(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$B;FFIZ)V
    ...
    :cond_0
    invoke-super/range {p0 .. p7}, Landroidx/recyclerview/widget/r$d;->onChildDraw(Landroid/graphics/Canvas;Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$B;FFIZ)V
...
.method public final onSwiped(Landroidx/recyclerview/widget/RecyclerView$B;I)V
    ...
    iget-object p2, p0, Lko/c;->i:Ljava/util/ArrayList;
    ...
    invoke-static {p2}, Lkotlin/jvm/internal/F;->a(Ljava/lang/Object;)Ljava/util/List;

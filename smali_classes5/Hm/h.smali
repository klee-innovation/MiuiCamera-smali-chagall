...
.field public final c:LHm/h$a;


# direct methods
.method public constructor <init>(LHm/f;LMm/u;Z)V
    .locals 8
    ...
    iput-object p1, p0, LHm/h;->a:LHm/f;

    iput-boolean p3, p0, LHm/h;->b:Z
    ...
    invoke-static {p3}, LL0/X;->l(LCn/F;)Ljava/lang/Class;
    ...
    invoke-static {p3, p2}, LL0/X;->j(Ljava/lang/Class;LMm/b;)Ljava/lang/reflect/Method;
    ...
    :goto_0
    invoke-static {p2}, Lon/j;->a(LMm/b;)Z
    ...
    new-instance p1, LHm/h$a;

    sget-object p2, LCm/c;->d:LCm/c;

    new-array p3, v2, [Ljava/lang/reflect/Method;

    invoke-direct {p1, p2, p3, v1}, LHm/h$a;-><init>(LCm/c;[Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V

    goto/16 :goto_9

    :cond_1
    instance-of p3, p1, LHm/g$g$c;
    ...
    :cond_2
    instance-of p3, p2, LMm/j;

    if-eqz p3, :cond_4

    instance-of p1, p1, LHm/e;
    ...
    :cond_4
    invoke-interface {p2}, LMm/a;->a0()LMm/Q;
    ...
    invoke-static {p1}, Lon/j;->b(LMm/k;)Z
    ...
    invoke-interface {p2}, LMm/a;->c0()LMm/Q;
    ...
    invoke-interface {p3}, LMm/j;->G()LMm/e;
    ...
    :goto_6
    invoke-interface {p2}, LMm/u;->isSuspend()Z
    ...
    invoke-static {v3, v4}, LCm/d;->y(II)LCm/c;
    ...
    iget v6, v3, LCm/a;->a:I

    iget v7, v3, LCm/a;->b:I
    ...
    invoke-static {v6}, LL0/X;->l(LCn/F;)Ljava/lang/Class;

    move-result-object v6

    if-eqz v6, :cond_c

    invoke-static {v6, p2}, LL0/X;->j(Ljava/lang/Class;LMm/b;)Ljava/lang/reflect/Method;
    ...
    invoke-direct {p1, v3, v4, v1}, LHm/h$a;-><init>(LCm/c;[Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;)V

    :goto_9
    iput-object p1, p0, LHm/h;->c:LHm/h$a;
    ...
    iget-object p2, p0, LHm/h;->a:LHm/f;

    invoke-interface {p2}, LHm/f;->getParameterTypes()Ljava/util/List;
...
.method public final a()Ljava/lang/reflect/Member;
    ...
    iget-object p0, p0, LHm/h;->a:LHm/f;
...
.method public final call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v0, p0, LHm/h;->c:LHm/h$a;

    iget-object v1, v0, LHm/h$a;->a:LCm/c;
    ...
    iget v3, v1, LCm/a;->a:I

    const/4 v4, 0x0

    iget v1, v1, LCm/a;->b:I

    if-gt v3, v1, :cond_2

    :goto_0
    iget-object v5, v0, LHm/h$a;->b:[Ljava/lang/reflect/Method;
    ...
    invoke-static {v5}, LGm/d0;->e(Ljava/lang/reflect/Type;)Ljava/lang/Object;
    ...
    invoke-interface {p0, v2}, LHm/f;->call([Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    iget-object p1, v0, LHm/h$a;->c:Ljava/lang/reflect/Method;

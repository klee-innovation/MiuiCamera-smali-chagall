...
# direct methods
.method public constructor <init>(LCh/d;LDh/a;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LGh/a;->a:LCh/d;

    iput-object p2, p0, LGh/a;->b:LDh/a;
...
# virtual methods
.method public final a(Lsi/d;)Lsi/d;
    .locals 11
    ...
    iget-object v1, p1, Lsi/d;->a:Ljava/lang/Object;

    check-cast v1, [B

    iget-object v4, p1, Lsi/d;->b:Lsi/b;

    iget-object v2, v4, Lsi/b;->h:Lag/m;
    ...
    invoke-virtual {v2, v1}, Lag/m;->d([B)Lme/b;

    move-result-object v5

    invoke-virtual {v5}, Lme/b;->r()I

    move-result v5

    const/4 v6, 0x0

    invoke-virtual {v3, v6}, Lme/b;->U([B)V
    ...
    invoke-virtual {v3, v6, v7}, Lme/b;->R(Ljava/lang/String;Ljava/lang/String;)V

    iget-boolean v6, v4, Lsi/b;->e:Z

    if-nez v6, :cond_0

    iget-object v6, v4, Lsi/b;->g:LFf/f;

    invoke-static {v3, v1}, Lt6/d;->h(Lme/b;[B)Lt6/d$a;

    move-result-object v7

    iget-wide v9, v4, Lsi/b;->c:J

    iput-wide v9, v7, Lt6/d$a;->c:J

    iget-object v9, v4, Lsi/b;->f:Ljava/lang/String;

    iput-object v9, v7, Lt6/d$a;->n:Ljava/lang/String;

    iput-object v6, v7, Lt6/d$a;->f:LFf/f;

    iget v6, v4, Lsi/b;->a:I

    iget v9, v4, Lsi/b;->b:I

    invoke-virtual {v7, v5, v6, v9}, Lt6/d$a;->b(III)V

    iget-object v6, v4, Lsi/b;->d:Landroid/location/Location;

    iput-object v6, v7, Lt6/d$a;->j:Landroid/location/Location;

    iget-object v6, v2, Lag/m;->b:Lag/a;

    iget v6, v6, Lag/a;->a:I

    iput v6, v7, Lt6/d$a;->m:I

    invoke-virtual {v7}, Lt6/d$a;->c()Lme/b;

    iget-object v6, v2, Lag/m;->e:Lcom/xiaomi/camera/core/ExifData;
    ...
    invoke-static {v3, v6}, Lt6/d;->c(Lme/b;[B)V

    iget-object v2, v2, Lag/m;->d:Lag/d;

    iget v2, v2, Lag/d;->f:I

    invoke-virtual {p0, v1, v2, v5, v3}, LGh/a;->b([BIILme/b;)[B
    ...
    invoke-direct/range {v2 .. v7}, Lsi/d;-><init>(Ljava/lang/Object;Lsi/b;ZZZ)V
...
.method public final b([BIILme/b;)[B
    .locals 23
    ...
    iget-object v3, v0, LGh/a;->b:LDh/a;

    iget-object v4, v3, LDh/a;->a:Lmg/h;

    iget v13, v4, Lmg/h;->b:I

    iget v14, v4, Lmg/h;->c:I

    iget-object v11, v4, Lmg/h;->a:[B

    iget-object v15, v3, LDh/a;->b:[F

    iget-object v6, v3, LDh/a;->c:Ljava/lang/String;

    iget-object v5, v3, LDh/a;->d:Ljava/lang/String;
    ...
    invoke-static {v13, v14, v4, v9, v10}, LB2/m;->h(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v3, v0, LGh/a;->a:LCh/d;

    iget-object v3, v3, LCh/d;->a:Ltg/a;

    iget-object v3, v3, Ltg/a;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    invoke-static {v2, v7, v9, v10}, LKb/v1;->f(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_3
    sget-object v2, Lul/a$c;->a:Lul/a$c;

    goto :goto_3

    :cond_4
    :goto_0
    sget-object v2, Lul/a$c;->c:Lul/a$c;

    goto :goto_3

    :cond_5
    :goto_1
    sget-object v2, Lul/a$c;->b:Lul/a$c;

    goto :goto_3

    :cond_6
    :goto_2
    sget-object v2, Lul/a$c;->d:Lul/a$c;

    :goto_3
    new-array v12, v4, [F

    iget-object v9, v3, Lul/a;->b:Ljava/lang/Object;
    ...
    invoke-static {v9, v3}, LD2/i;->h([FLjava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v2, v0, LGh/a;->a:LCh/d;

    iget-object v2, v2, LCh/d;->a:Ltg/a;

    iget-object v2, v2, Ltg/a;->a:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :cond_7
    invoke-static {v6}, Ltg/a;->a(Ljava/lang/String;)Lul/a$a;

    move-result-object v3

    iget-object v11, v2, Lul/a;->b:Ljava/lang/Object;

    monitor-enter v11

    :try_start_2
    iget-wide v12, v2, Lul/a;->a:J
    ...
    iget-object v3, v2, LCh/d;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-boolean v3, v2, LCh/d;->f:Z

    if-eqz v3, :cond_9

    invoke-virtual {v2}, LCh/d;->a()V
    ...
    iget-object v2, v0, LGh/a;->c:LLh/c;
    ...
    iput-object v2, v0, LGh/a;->c:LLh/c;
    ...
    invoke-virtual/range {v2 .. v7}, LLh/c;->a(Landroid/graphics/Canvas;Ljava/lang/String;III)V
    ...
    invoke-static {v2, v11}, Lgj/e;->f(ILandroid/graphics/Bitmap;)[B
    ...
    invoke-virtual {v0, v3, v2, v7}, La1/m;->n(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {v5, v4, v0}, Lh9/b;->e(Ljava/io/ByteArrayInputStream;Ljava/io/ByteArrayOutputStream;LZ0/d;)V
    ...
    invoke-static {v2, v2, v10, v0, v3}, Lag/v;->f(II[B[BI)V

    array-length v3, v10

    array-length v4, v1

    invoke-static {v3, v2, v1, v0, v4}, Lag/v;->f(II[B[BI)V

...
# static fields
.field public static final K0:Lmiuix/animation/property/IntValueProperty;
...
.field public final J0:Lmiuix/androidbasewidget/widget/SeekBar$a;
...
.field public final f0:Lmiuix/androidbasewidget/widget/SeekBar$c;

.field public g:Z

.field public final g0:Lmiuix/androidbasewidget/widget/SeekBar$c;
...
.field public final r0:Lmiuix/animation/physics/SpringAnimation;

.field public final s:I

.field public final s0:Lmiuix/animation/physics/SpringAnimation;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lmiuix/androidbasewidget/widget/SeekBar;->K0:Lmiuix/animation/property/IntValueProperty;
    ...
    sput-object v0, Lmiuix/androidbasewidget/widget/SeekBar;->L0:Lmiuix/animation/property/IntValueProperty;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput v6, v0, Lmiuix/androidbasewidget/widget/SeekBar;->p0:F

    iput-boolean v3, v0, Lmiuix/androidbasewidget/widget/SeekBar;->E0:Z
    ...
    iput-object v7, v0, Lmiuix/androidbasewidget/widget/SeekBar;->J0:Lmiuix/androidbasewidget/widget/SeekBar$a;
    ...
    iput v8, v0, Lmiuix/androidbasewidget/widget/SeekBar;->j0:I

    sget-object v8, Lro/g;->SeekBar:[I

    sget v9, Lro/f;->Widget_SeekBar_Thumb_DayNight:I
    ...
    sget v5, Lro/g;->SeekBar_useCustomDrawables:I
    ...
    iput-object v5, v0, Lmiuix/androidbasewidget/widget/SeekBar;->t0:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v5, v0, Lmiuix/androidbasewidget/widget/SeekBar;->t0:Landroid/graphics/drawable/Drawable;
    ...
    iput-boolean v4, v0, Lmiuix/androidbasewidget/widget/SeekBar;->H0:Z
    ...
    iput-object v5, v0, Lmiuix/androidbasewidget/widget/SeekBar;->y0:Landroid/graphics/drawable/GradientDrawable;

    invoke-virtual {v5}, Landroid/graphics/drawable/Drawable;->getIntrinsicWidth()I

    move-result v8

    iput v8, v0, Lmiuix/androidbasewidget/widget/SeekBar;->w0:I

    invoke-virtual {v5}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I

    move-result v5

    iput v5, v0, Lmiuix/androidbasewidget/widget/SeekBar;->x0:I
    ...
    iput v5, v0, Lmiuix/androidbasewidget/widget/SeekBar;->u0:I
    ...
    iput v5, v0, Lmiuix/androidbasewidget/widget/SeekBar;->v0:I
    ...
    sget v8, Lro/b;->miuix_appcompat_progress_primary_colors_light:I
    ...
    sget v11, Lro/b;->miuix_appcompat_progress_disable_color_light:I
    ...
    sget v13, Lro/b;->miuix_appcompat_seekbar_background_normal_color:I

    invoke-virtual {v12, v13}, Landroid/content/res/Resources;->getColor(I)I

    move-result v12

    iput v12, v0, Lmiuix/androidbasewidget/widget/SeekBar;->d0:I

    invoke-virtual/range {p1 .. p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v13

    sget v14, Lro/b;->miuix_appcompat_seekbar_background_disabled_color:I

    invoke-virtual {v13, v14}, Landroid/content/res/Resources;->getColor(I)I

    move-result v13

    iput v13, v0, Lmiuix/androidbasewidget/widget/SeekBar;->e0:I

    invoke-virtual/range {p1 .. p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v14

    sget v15, Lro/b;->miuix_appcompat_seekbar_scale_primary_color:I
    ...
    sget v15, Lro/b;->miuix_appcompat_seekbar_scale_secondary_color:I
    ...
    sget v15, Lro/b;->miuix_appcompat_progress_background_icon_light:I

    invoke-virtual {v14, v15}, Landroid/content/res/Resources;->getColor(I)I

    move-result v14

    sget v15, Lro/g;->SeekBar_middleEnabled:I
    ...
    sget v15, Lro/g;->SeekBar_scaleEnable:I

    invoke-virtual {v2, v15, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v15

    iput-boolean v15, v0, Lmiuix/androidbasewidget/widget/SeekBar;->m0:Z

    sget v15, Lro/g;->SeekBar_balanceEnable:I

    invoke-virtual {v2, v15, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v15

    iput-boolean v15, v0, Lmiuix/androidbasewidget/widget/SeekBar;->n0:Z

    sget v15, Lro/g;->SeekBar_foregroundPrimaryColor:I
    ...
    sget v5, Lro/g;->SeekBar_foregroundPrimaryDisableColor:I
    ...
    sget v5, Lro/g;->SeekBar_progressPrimaryColor:I

    invoke-virtual {v2, v5, v8}, Landroid/content/res/TypedArray;->getColor(II)I

    sget v5, Lro/g;->SeekBar_progressPrimaryDisableColor:I

    invoke-virtual {v2, v5, v11}, Landroid/content/res/TypedArray;->getColor(II)I

    sget v5, Lro/g;->SeekBar_backgroundPrimaryColor:I
    ...
    sget v5, Lro/g;->SeekBar_backgroundPrimaryDisableColor:I
    ...
    sget v5, Lro/g;->SeekBar_iconPrimaryColor:I
    ...
    sget v5, Lro/g;->SeekBar_disabledProgressAlpha:I
    ...
    sget v5, Lro/g;->SeekBar_minMiddle:I
    ...
    sget v11, Lro/g;->SeekBar_maxMiddle:I
    ...
    sget v13, Lro/g;->SeekBar_draggableMinPercentProgress:I
    ...
    sget v9, Lro/g;->SeekBar_draggableMaxPercentProgress:I
    ...
    :goto_3
    iput v9, v0, Lmiuix/androidbasewidget/widget/SeekBar;->i:F

    sget v9, Lro/g;->SeekBar_dragAnimationEnable:I

    invoke-virtual {v2, v9, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v9

    iput-boolean v9, v0, Lmiuix/androidbasewidget/widget/SeekBar;->F0:Z

    sget v9, Lro/g;->SeekBar_touchAnimationEnable:I

    invoke-virtual {v2, v9, v4}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v9

    iput-boolean v9, v0, Lmiuix/androidbasewidget/widget/SeekBar;->G0:Z

    sget v9, Lro/g;->SeekBar_balanceProgress:I

    invoke-virtual {v2, v9, v3}, Landroid/content/res/TypedArray;->getInteger(II)I

    move-result v9

    iput v9, v0, Lmiuix/androidbasewidget/widget/SeekBar;->o0:I
    ...
    iput-object v9, v0, Lmiuix/androidbasewidget/widget/SeekBar;->z0:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v13, v0, Lmiuix/androidbasewidget/widget/SeekBar;->A0:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v9, v0, Lmiuix/androidbasewidget/widget/SeekBar;->B0:Landroid/graphics/drawable/Drawable;
    ...
    iget v9, v0, Lmiuix/androidbasewidget/widget/SeekBar;->i:F
    ...
    sget v2, Lro/b;->miuix_appcompat_transparent:I
    ...
    iput v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->D0:F

    new-instance v1, Lmiuix/androidbasewidget/widget/SeekBar$c;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->f0:Lmiuix/androidbasewidget/widget/SeekBar$c;

    new-instance v2, Lmiuix/androidbasewidget/widget/SeekBar$c;

    invoke-direct {v2}, Ljava/lang/Object;-><init>()V

    iput-object v2, v0, Lmiuix/androidbasewidget/widget/SeekBar;->g0:Lmiuix/androidbasewidget/widget/SeekBar$c;
    ...
    sget-object v5, Lmiuix/androidbasewidget/widget/SeekBar;->K0:Lmiuix/animation/property/IntValueProperty;

    iget v9, v0, Lmiuix/androidbasewidget/widget/SeekBar;->D0:F
    ...
    sget-object v2, Lmiuix/androidbasewidget/widget/SeekBar;->L0:Lmiuix/animation/property/IntValueProperty;
    ...
    iget-object v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->t0:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->I0:Landroid/graphics/Paint;

    invoke-virtual {v1, v4}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    iget-boolean v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->H0:Z

    if-eqz v1, :cond_c

    iget v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->w0:I

    int-to-float v1, v1

    iget v2, v0, Lmiuix/androidbasewidget/widget/SeekBar;->p0:F

    mul-float/2addr v1, v2

    float-to-int v1, v1

    iput v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->w0:I

    iget v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->x0:I
    ...
    iput v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->x0:I
    ...
    sget v2, Lro/c;->miuix_appcompat_seekbar_icon_size:I
    ...
    iput v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->q0:F
    ...
    iput-object v2, v0, Lmiuix/androidbasewidget/widget/SeekBar;->r0:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v2, v0, Lmiuix/androidbasewidget/widget/SeekBar;->r0:Lmiuix/animation/physics/SpringAnimation;
    ...
    new-instance v7, Lto/d;

    invoke-direct {v7, v0}, Lto/d;-><init>(Lmiuix/androidbasewidget/widget/SeekBar;)V
    ...
    iput-object v2, v0, Lmiuix/androidbasewidget/widget/SeekBar;->s0:Lmiuix/animation/physics/SpringAnimation;
    ...
    iget-object v1, v0, Lmiuix/androidbasewidget/widget/SeekBar;->s0:Lmiuix/animation/physics/SpringAnimation;
    ...
    invoke-direct {v2, v0}, Lto/e;-><init>(Lmiuix/androidbasewidget/widget/SeekBar;)V
...
.method public final c()V
    ...
    iget v5, p0, Lmiuix/androidbasewidget/widget/SeekBar;->j:I
    ...
    iget-object v11, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;

    if-nez v11, :cond_0

    if-eqz v10, :cond_0

    iput-object v10, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;

    :cond_0
    iget-object v10, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;
    ...
    iput-object v12, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;
    ...
    iput-object v9, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;

    :cond_3
    iget-object v9, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;
    ...
    iput-object v5, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;
    ...
    iget-object v3, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;

    if-nez v3, :cond_6

    if-eqz v1, :cond_6

    iput-object v1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;

    :cond_6
    iget-object v1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;
    ...
    iget v4, p0, Lmiuix/androidbasewidget/widget/SeekBar;->e0:I
    ...
    iget v6, p0, Lmiuix/androidbasewidget/widget/SeekBar;->d0:I
    ...
    iput-object v4, p0, Lmiuix/androidbasewidget/widget/SeekBar;->i0:Landroid/content/res/ColorStateList;
...
.method public getThumbScale()F
    ...
    iget p0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->p0:F
...
.method public final declared-synchronized onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v3, v1, Lmiuix/androidbasewidget/widget/SeekBar;->y0:Landroid/graphics/drawable/GradientDrawable;
    ...
    sget v9, Lro/c;->miuix_appcompat_seekbar_progress_custom_bg_radius:I
    ...
    iget v14, v1, Lmiuix/androidbasewidget/widget/SeekBar;->D0:F
    ...
    :cond_3
    iget v13, v1, Lmiuix/androidbasewidget/widget/SeekBar;->D0:F
    ...
    :goto_3
    iget-boolean v13, v1, Lmiuix/androidbasewidget/widget/SeekBar;->n0:Z
    ...
    iget v15, v1, Lmiuix/androidbasewidget/widget/SeekBar;->o0:I
    ...
    :cond_4
    iget v12, v1, Lmiuix/androidbasewidget/widget/SeekBar;->o0:I
    ...
    iget v4, v1, Lmiuix/androidbasewidget/widget/SeekBar;->v0:I
    ...
    iget-object v2, v1, Lmiuix/androidbasewidget/widget/SeekBar;->A0:Landroid/graphics/drawable/Drawable;

    if-nez v2, :cond_8

    move/from16 v17, v4

    iget-object v4, v1, Lmiuix/androidbasewidget/widget/SeekBar;->B0:Landroid/graphics/drawable/Drawable;
    ...
    :cond_6
    iget-object v2, v1, Lmiuix/androidbasewidget/widget/SeekBar;->z0:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v2, v4, v13, v6, v7}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V
    ...
    iget-boolean v3, v1, Lmiuix/androidbasewidget/widget/SeekBar;->n0:Z
    ...
    iget-boolean v2, v1, Lmiuix/androidbasewidget/widget/SeekBar;->n0:Z
    ...
    iget-object v2, v1, Lmiuix/androidbasewidget/widget/SeekBar;->I0:Landroid/graphics/Paint;

    invoke-virtual {v2, v15}, Landroid/graphics/Paint;->setColor(I)V

    div-float v2, v5, v16

    iget v3, v1, Lmiuix/androidbasewidget/widget/SeekBar;->q0:F

    iget-object v4, v1, Lmiuix/androidbasewidget/widget/SeekBar;->I0:Landroid/graphics/Paint;
    ...
    :goto_9
    iget-boolean v2, v1, Lmiuix/androidbasewidget/widget/SeekBar;->m0:Z
    ...
    iget v9, v1, Lmiuix/androidbasewidget/widget/SeekBar;->D0:F

    cmpg-float v10, v8, v9

    if-gez v10, :cond_12

    iget-object v8, v1, Lmiuix/androidbasewidget/widget/SeekBar;->I0:Landroid/graphics/Paint;
    ...
    sget v12, Lro/b;->miuix_appcompat_transparent:I
    ...
    :goto_d
    iget v9, v1, Lmiuix/androidbasewidget/widget/SeekBar;->q0:F

    iget-object v12, v1, Lmiuix/androidbasewidget/widget/SeekBar;->I0:Landroid/graphics/Paint;

    invoke-virtual {v0, v8, v6, v9, v12}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V
    ...
    iget v2, v1, Lmiuix/androidbasewidget/widget/SeekBar;->D0:F

    iget v4, v1, Lmiuix/androidbasewidget/widget/SeekBar;->o0:I
    ...
    sget v4, Lro/b;->miuix_appcompat_transparent:I
    ...
    iget v2, v1, Lmiuix/androidbasewidget/widget/SeekBar;->q0:F

    iget-object v3, v1, Lmiuix/androidbasewidget/widget/SeekBar;->I0:Landroid/graphics/Paint;
    ...
    :cond_1c
    :goto_e
    iget-object v2, v1, Lmiuix/androidbasewidget/widget/SeekBar;->t0:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_1e

    iget v3, v1, Lmiuix/androidbasewidget/widget/SeekBar;->u0:I
    ...
    iget v5, v1, Lmiuix/androidbasewidget/widget/SeekBar;->v0:I
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    iget-boolean v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->H0:Z
    ...
    iget-object v3, p0, Lmiuix/androidbasewidget/widget/SeekBar;->t0:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v3}, Landroid/graphics/drawable/Drawable;->copyBounds()Landroid/graphics/Rect;

    move-result-object v3

    iput-object v3, p0, Lmiuix/androidbasewidget/widget/SeekBar;->C0:Landroid/graphics/Rect;
    ...
    :cond_2
    iget-boolean v1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->l0:Z
    ...
    iget v4, p0, Lmiuix/androidbasewidget/widget/SeekBar;->k0:F
    ...
    iget v6, p0, Lmiuix/androidbasewidget/widget/SeekBar;->j0:I
    ...
    iput-boolean v5, p0, Lmiuix/androidbasewidget/widget/SeekBar;->l0:Z
    ...
    iget-object v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->C0:Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->s0:Lmiuix/animation/physics/SpringAnimation;
    ...
    :cond_4
    iget-object v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->r0:Lmiuix/animation/physics/SpringAnimation;
    ...
    iput-boolean v5, p0, Lmiuix/androidbasewidget/widget/SeekBar;->E0:Z
    ...
    :cond_7
    iget-boolean v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->l0:Z

    if-eqz v0, :cond_a

    iput-boolean v1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->l0:Z
    ...
    iput v1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->k0:F
...
.method public setBalanceProgress(I)V
    ...
    iput p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->o0:I
...
.method public setDraggedAnimationEnable(Z)V
    ...
    iput-boolean p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->F0:Z
...
.method public setOnSeekBarChangeListener(Landroid/widget/SeekBar$OnSeekBarChangeListener;)V
    ...
    iget-object v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->J0:Lmiuix/androidbasewidget/widget/SeekBar$a;
    ...
    :cond_0
    iput-object p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->h0:Landroid/widget/SeekBar$OnSeekBarChangeListener;
...
.method public declared-synchronized setProgress(I)V
    ...
    iget-object v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->f0:Lmiuix/androidbasewidget/widget/SeekBar$c;

    iget-object v0, v0, Lmiuix/androidbasewidget/widget/SeekBar$c;->a:Lmiuix/animation/Folme$ObjectFolmeImpl;

    sget-object v1, Lmiuix/androidbasewidget/widget/SeekBar;->K0:Lmiuix/animation/property/IntValueProperty;
    ...
    iget-object v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->g0:Lmiuix/androidbasewidget/widget/SeekBar$c;

    iget-object v0, v0, Lmiuix/androidbasewidget/widget/SeekBar$c;->a:Lmiuix/animation/Folme$ObjectFolmeImpl;

    sget-object v1, Lmiuix/androidbasewidget/widget/SeekBar;->L0:Lmiuix/animation/property/IntValueProperty;
...
.method public setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->z0:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->A0:Landroid/graphics/drawable/Drawable;
    ...
    iput-object p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->A0:Landroid/graphics/drawable/Drawable;
...
.method public setThumb(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->t0:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p1}, Landroid/graphics/drawable/Drawable;->getIntrinsicWidth()I

    move-result p1

    iput p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->u0:I
    ...
    :cond_0
    iget-object p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->t0:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p1}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I

    move-result p1

    iput p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->v0:I
...
.method public setThumbScale(F)V
    ...
    iput p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->p0:F

    iget v0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->w0:I
    ...
    iget v1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->x0:I
    ...
    iget-object v1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->y0:Landroid/graphics/drawable/GradientDrawable;
...
.method public setTouchAnimationEnable(Z)V
    ...
    iput-boolean p1, p0, Lmiuix/androidbasewidget/widget/SeekBar;->G0:Z

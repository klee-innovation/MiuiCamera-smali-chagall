...
.method public final onProgressChanged(Landroid/widget/SeekBar;IZ)V
    ...
    iget-object v14, v6, Lmiuix/androidbasewidget/widget/SeekBar;->g0:Lmiuix/androidbasewidget/widget/SeekBar$c;
    ...
    sget-object v12, Lmiuix/androidbasewidget/widget/SeekBar;->L0:Lmiuix/animation/property/IntValueProperty;
    ...
    sget-object v13, Lmiuix/androidbasewidget/widget/SeekBar;->L0:Lmiuix/animation/property/IntValueProperty;
    ...
    :cond_6
    iget-boolean v11, v6, Lmiuix/androidbasewidget/widget/SeekBar;->E0:Z

    iget-object v12, v6, Lmiuix/androidbasewidget/widget/SeekBar;->f0:Lmiuix/androidbasewidget/widget/SeekBar$c;

    if-eqz v11, :cond_8

    iput v2, v6, Lmiuix/androidbasewidget/widget/SeekBar;->r:I

    iget-boolean v8, v6, Lmiuix/androidbasewidget/widget/SeekBar;->G0:Z

    if-eqz v8, :cond_7

    iget-object v8, v12, Lmiuix/androidbasewidget/widget/SeekBar$c;->a:Lmiuix/animation/Folme$ObjectFolmeImpl;

    sget-object v9, Lmiuix/androidbasewidget/widget/SeekBar;->K0:Lmiuix/animation/property/IntValueProperty;
    ...
    iput v8, v6, Lmiuix/androidbasewidget/widget/SeekBar;->D0:F

    iget-object v9, v12, Lmiuix/androidbasewidget/widget/SeekBar$c;->a:Lmiuix/animation/Folme$ObjectFolmeImpl;

    sget-object v11, Lmiuix/androidbasewidget/widget/SeekBar;->K0:Lmiuix/animation/property/IntValueProperty;
    ...
    iget-boolean v11, v6, Lmiuix/androidbasewidget/widget/SeekBar;->F0:Z
    ...
    sget-object v12, Lmiuix/androidbasewidget/widget/SeekBar;->K0:Lmiuix/animation/property/IntValueProperty;
    ...
    :goto_5
    iput-boolean v4, v6, Lmiuix/androidbasewidget/widget/SeekBar;->E0:Z
    ...
    iget-boolean v7, v6, Lmiuix/androidbasewidget/widget/SeekBar;->g:Z
    ...
    iget-object v5, v0, Lmiuix/androidbasewidget/widget/SeekBar$a;->a:LZp/a;

    if-nez v5, :cond_f

    new-instance v5, LZp/a;

    invoke-virtual {v6}, Landroid/view/View;->getContext()Landroid/content/Context;

    move-result-object v7

    invoke-direct {v5, v7}, LZp/a;-><init>(Landroid/content/Context;)V

    iput-object v5, v0, Lmiuix/androidbasewidget/widget/SeekBar$a;->a:LZp/a;

    :cond_f
    iget-object v0, v0, Lmiuix/androidbasewidget/widget/SeekBar$a;->a:LZp/a;

    const/16 v5, 0xcb

    invoke-virtual {v0, v5}, LZp/a;->b(I)V
    ...
    :cond_13
    iget-boolean v0, v6, Lmiuix/androidbasewidget/widget/SeekBar;->g:Z
    ...
    :cond_14
    :goto_7
    iput-boolean v4, v6, Lmiuix/androidbasewidget/widget/SeekBar;->g:Z

    iget-object v0, v6, Lmiuix/androidbasewidget/widget/SeekBar;->h0:Landroid/widget/SeekBar$OnSeekBarChangeListener;
...
.method public final onStartTrackingTouch(Landroid/widget/SeekBar;)V
    ...
    iget-object p0, p0, Lmiuix/androidbasewidget/widget/SeekBar;->h0:Landroid/widget/SeekBar$OnSeekBarChangeListener;

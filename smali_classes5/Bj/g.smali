...
.method public static a(Landroid/content/Context;Landroid/graphics/Bitmap;)LBj/e;
    .locals 12
    ...
    invoke-direct {v0, p0}, LBj/f;-><init>(Ljava/util/concurrent/LinkedBlockingQueue;)V

    sget-object v4, LBj/d;->b:Ljava/lang/String;

    sget-object v5, LBj/d;->d:LBj/d;

    if-nez v5, :cond_5

    const-class v5, Ljq/x;

    monitor-enter v5

    :try_start_2
    sget-object v6, LBj/d;->d:LBj/d;

    if-nez v6, :cond_4

    new-instance v6, LBj/d;

    invoke-direct {v6}, LBj/d;-><init>()V

    sput-object v6, LBj/d;->d:LBj/d;
    ...
    sget-object v7, Ljq/v;->e:Ljava/util/regex/Pattern;

    invoke-static {v6}, Ljq/v$a;->b(Ljava/lang/String;)Ljq/v;

    move-result-object v6

    sget-object v7, LBj/d;->e:Lcom/google/gson/Gson;
    ...
    invoke-static {v3, v6}, Ljq/C$a;->a(Ljava/lang/String;Ljq/v;)Ljq/B;
    ...
    invoke-static {v1, v9}, LL2/a;->o(ILjava/lang/String;)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v6, v8, v9}, Ljq/z$a;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_7
    invoke-virtual {v6, v4}, Ljq/z$a;->g(Ljava/lang/String;)V

    const-string p1, "POST"

    invoke-virtual {v6, p1, v3}, Ljq/z$a;->e(Ljava/lang/String;Ljq/C;)V

    invoke-virtual {v6}, Ljq/z$a;->b()Ljq/z;

    move-result-object p1

    sget-object v3, LBj/d;->c:Ljq/x;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v4, Lnq/e;

    invoke-direct {v4, v3, p1, v2}, Lnq/e;-><init>(Ljq/x;Ljq/z;Z)V

    new-instance p1, LBj/b;

    invoke-direct {p1, v5, v0}, LBj/b;-><init>(LBj/d;LBj/f;)V

    invoke-virtual {v4, p1}, Lnq/e;->L(Ljq/f;)V
    ...
    invoke-direct {p0, v0, p1}, LBj/e;-><init>(ILjava/lang/String;)V

...
.method public constructor <init>()V
    ...
    iput v0, p0, Lbk/x;->f:I

    new-instance v0, Ljava/util/TreeMap;

    invoke-direct {v0}, Ljava/util/TreeMap;-><init>()V

    iput-object v0, p0, Lbk/x;->g:Ljava/util/TreeMap;

    const/4 v0, -0x1

    iput v0, p0, Lbk/x;->i:I
...
.method public static a(Ljava/util/TreeMap;Ljava/util/TreeMap;)V
    ...
    iget-object v3, v2, Lbk/x$b;->a:Ljava/lang/String;

    iget-object v2, v2, Lbk/x$b;->b:Ljava/lang/String;

    invoke-virtual {p1, v1}, Ljava/util/TreeMap;->get(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lbk/x$b;

    if-eqz v1, :cond_1

    if-eqz v3, :cond_0

    iget-object v1, v1, Lbk/x$b;->a:Ljava/lang/String;
    ...
    invoke-static {v1}, Lgj/x;->b([Ljava/lang/String;)V
...
.method public final b(I)V
    ...
    invoke-virtual {p0, p1}, Lbk/x;->c(I)Lbk/x$b;
    ...
    iget-object v1, v0, Lbk/x$b;->a:Ljava/lang/String;

    iget-object v2, p0, Lbk/x;->h:Ljava/util/TreeMap;

    if-eqz v2, :cond_1

    if-eqz v1, :cond_1

    iget-object p0, p0, Lbk/x;->g:Ljava/util/TreeMap;
    ...
    check-cast p0, Lbk/x$b;

    if-eqz p0, :cond_1

    iget-object p0, p0, Lbk/x$b;->a:Ljava/lang/String;
    ...
    :cond_1
    iget-object p0, v0, Lbk/x$b;->b:Ljava/lang/String;
...
.method public final c(I)Lbk/x$b;
    .locals 0
...
.method public final d()Ljava/util/TreeMap;
    ...
    iget-object v0, p0, Lbk/x;->h:Ljava/util/TreeMap;

    if-nez v0, :cond_0

    iget-object v0, p0, Lbk/x;->g:Ljava/util/TreeMap;
...
.method public final f()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lbk/x;->g()Ljava/lang/String;
...
.method public final g()Ljava/lang/String;
    ...
    iget-object p0, p0, Lbk/x;->c:Ljava/lang/String;
...
.method public final h()I
    ...
    iget-object v2, p0, Lbk/x;->c:Ljava/lang/String;
    ...
    invoke-static {v0, v2}, LGe/f;->d(Ljava/io/IOException;Ljava/lang/StringBuilder;)Ljava/lang/String;
...
.method public final i()V
    ...
    new-instance v1, Lbk/x$a;

    invoke-direct {v1, p0}, Lbk/x$a;-><init>(Lbk/x;)V

...
.method public final C(LFf/h;)V
    ...
    invoke-static {v0, v1}, LFa/s;->h(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-boolean v1, v1, LFf/b$a;->i:Z
    ...
    iget-object v5, v4, LFf/b$a;->d:Landroid/media/Image;

    invoke-static {v5}, Lag/i;->m(Landroid/media/Image;)Z
    ...
    :cond_2
    iget-object v6, v4, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    if-nez v1, :cond_3

    iget v7, p1, LFf/h;->d:I

    invoke-virtual {p0, v6, v5, v3, v7}, LTh/q;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget-object v8, v4, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v8}, Lcom/xiaomi/protocol/ICustomCaptureResult;->getRequest()Landroid/hardware/camera2/CaptureRequest;

    move-result-object v8

    sget-object v9, LA8/N;->v:LA8/Q;

    const v10, 0xbabe

    invoke-static {v8, v9, v10}, LA8/S;->m(Landroid/hardware/camera2/CaptureRequest;LA8/Q;I)Ljava/lang/Object;
    ...
    :goto_2
    iget v8, p1, LFf/h;->d:I

    invoke-virtual {p0, v6, v5, v7, v8}, LTh/q;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V

    :goto_3
    iget-object v4, v4, LFf/b$a;->e:Landroid/media/Image;

    iget-object v5, p0, Lag/i;->j:LTh/k$e;

    invoke-static {v4, v5}, LTh/b;->E(Landroid/media/Image;LTh/k$e;)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v0, v1, v2, v4}, LFa/q;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    :cond_0
    new-instance p1, LTh/o;

    invoke-direct {p1, p0}, LTh/o;-><init>(LTh/q;)V
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    iget-object v1, p0, LTh/b;->w:Landroid/media/ImageReader;

    new-instance v2, LTh/l;

    invoke-direct {v2, p0, p1}, LTh/l;-><init>(LTh/q;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {v2, p0}, LTh/m;-><init>(LTh/q;)V
    ...
    invoke-direct {v1, p0}, LTh/n;-><init>(LTh/q;)V

...
# virtual methods
.method public final a(LFf/b;Z)V
    .locals 5
    ...
    iget-object v0, p1, LFf/b;->p:LTh/k$c;
    ...
    iget-boolean p0, p1, LFf/b;->m:Z

    if-eqz p0, :cond_1

    iget-object p0, p1, LFf/b;->g:Ljava/util/ArrayList;
    ...
    :cond_1
    iget-object p0, p1, LFf/b;->i:LFf/b$a;

    if-eqz p0, :cond_2

    invoke-virtual {p0}, LFf/b$a;->a()V

    :cond_2
    :goto_1
    iget-object p0, p1, LFf/b;->f:Ljava/util/ArrayList;
    ...
    iget-object p2, p1, LFf/b;->i:LFf/b$a;

    iget-boolean v2, p1, LFf/b;->j:Z

    iget-object p0, p0, LTh/h$a;->a:LTh/h;

    invoke-static {p0, p2, v1, v2}, LTh/h;->a(LTh/h;LFf/b$a;IZ)V

    iget-object v2, p2, LFf/b$a;->h:LFf/d;
    ...
    invoke-static {p0, p2, v4, v2}, LTh/h;->a(LTh/h;LFf/b$a;IZ)V
    ...
    invoke-virtual {v0, p1}, LTh/k$c;->a(LFf/b;)V

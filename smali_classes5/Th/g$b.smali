...
.field public final synthetic f:LTh/g;
...
.method public constructor <init>(LTh/g;)V
    ...
    iput-object p1, p0, LTh/g$b;->f:LTh/g;

    new-instance p1, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {p1}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object p1, p0, LTh/g$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, LTh/g$b;->d:Ljava/lang/Object;
...
.method public static j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    invoke-virtual {v4, v3}, Lv8/e;->equals(Ljava/lang/Object;)Z
...
.method public final a(IILandroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    const-string v1, "checkMiviEngine E"
    ...
    iget-object v0, p0, LTh/g$b;->d:Ljava/lang/Object;

    monitor-enter v0

    :goto_0
    :try_start_0
    iget-boolean v1, p0, LTh/g$b;->e:Z

    if-nez v1, :cond_0

    const-string v1, "LocalParallelService"

    const-string v3, "waiting mivi engine..."
    ...
    :try_start_1
    iget-object v1, p0, LTh/g$b;->d:Ljava/lang/Object;
    ...
    const-string v1, "checkMiviEngine X"
    ...
    const-string v1, "configCaptureOutputBuffer E"
    ...
    :try_start_3
    iget-object v0, p0, LTh/g$b;->c:Landroid/util/SparseArray;

    invoke-static {p3, v0}, LTh/g$b;->j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z
    ...
    iget-object v0, p0, LTh/g$b;->b:LTh/k;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, LTh/k;->k()Z
    ...
    iget-object v3, p0, LTh/g$b;->b:LTh/k;
    ...
    iget-object p3, p0, LTh/g$b;->b:LTh/k;

    iget-object v0, p3, LTh/k;->j:Ljava/lang/Object;
    ...
    :try_start_5
    iget-object p1, p0, LTh/g$b;->b:LTh/k;

    iget-object p3, p1, LTh/k;->j:Ljava/lang/Object;
    ...
    iget-object p2, p1, LTh/k;->j:Ljava/lang/Object;
    ...
    :try_start_8
    iget-object p1, p1, LTh/k;->e:Landroid/util/SparseArray;
    ...
    :try_start_9
    invoke-static {p1}, Lv8/d;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    iget-object v4, p0, LTh/g$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :goto_1
    iget-object v3, p0, LTh/g$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :cond_2
    iget-object v4, v3, LTh/k;->j:Ljava/lang/Object;
    ...
    :try_start_10
    iget-object v5, v3, LTh/k;->e:Landroid/util/SparseArray;
    ...
    :try_start_11
    invoke-static {p3, v5}, LTh/g$b;->j(Landroid/util/SparseArray;Landroid/util/SparseArray;)Z

    move-result v4

    if-eqz v4, :cond_4

    invoke-virtual {v3}, LTh/k;->k()Z
    ...
    iget-object v0, v3, LTh/k;->j:Ljava/lang/Object;
    ...
    :cond_3
    iput-object p3, p0, LTh/g$b;->c:Landroid/util/SparseArray;

    iput-object v3, p0, LTh/g$b;->b:LTh/k;
    ...
    :try_start_16
    iget-object v3, v3, LTh/k;->e:Landroid/util/SparseArray;
    ...
    :try_start_17
    invoke-static {v3}, Lv8/d;->b(Landroid/util/SparseArray;)Landroid/util/SparseArray;
    ...
    invoke-virtual {p0}, LTh/g$b;->f()LTh/k;

    move-result-object v1

    iget-object v3, v1, LTh/k;->j:Ljava/lang/Object;
    ...
    :try_start_21
    iget-object p1, v1, LTh/k;->j:Ljava/lang/Object;
    ...
    :try_start_23
    iget-object p1, p0, LTh/g$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    iput-object v1, p0, LTh/g$b;->b:LTh/k;

    invoke-virtual {v1, p3}, LTh/k;->n(Landroid/util/SparseArray;)Landroid/util/SparseArray;
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-virtual {p0}, LTh/g$b;->c()LTh/k;
    ...
    invoke-virtual {v3, v4, v5}, Lag/b;->f(II)I
    ...
    iget-object v5, p0, LTh/k;->j:Ljava/lang/Object;

    monitor-enter v5

    :try_start_0
    iget-object v6, p0, LTh/k;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v6}, Lag/i;->n()Z

    move-result v7

    if-nez v7, :cond_3

    invoke-virtual {v6}, Lag/i;->x()Z

    move-result v7

    if-eqz v7, :cond_3

    iget-object p1, p0, LTh/k;->b:Lag/i;

    if-eq p1, v6, :cond_2

    if-eqz p1, :cond_1

    invoke-virtual {p1}, Lag/i;->w()V
    ...
    :cond_1
    :goto_0
    iput-object v6, p0, LTh/k;->b:Lag/i;
    ...
    :cond_3
    iget-object v4, p0, LTh/k;->b:Lag/i;

    if-eqz v4, :cond_4

    invoke-virtual {v4}, Lag/i;->w()V
    ...
    iget-object v6, p0, LTh/k;->D:LTh/k$e;

    invoke-direct {v4, v6, p1}, LTh/f;-><init>(LTh/k$e;Lcom/xiaomi/engine/BufferFormat;)V

    goto :goto_1

    :cond_6
    new-instance v4, LTh/q;

    iget-object v6, p0, LTh/k;->D:LTh/k$e;

    invoke-direct {v4, v6, p1}, LTh/b;-><init>(LTh/k$e;Lcom/xiaomi/engine/BufferFormat;)V

    :goto_1
    iget v6, p0, LTh/k;->a:I

    if-lez v6, :cond_7

    iput v6, v4, Lag/i;->a:I

    :cond_7
    iput v6, v4, Lag/i;->e:I

    invoke-virtual {v4}, LTh/b;->J()V

    invoke-virtual {v4, p1}, Lag/i;->b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;

    move-result-object v6

    iget-object v7, p0, LTh/k;->z:LTh/k$a;
    ...
    invoke-virtual {p0, v3}, Lag/b;->i(I)V
...
.method public final e()Ljava/util/Iterator;
    ...
    :try_start_0
    iget-object v0, p0, LTh/g$b;->a:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final f()LTh/k;
    ...
    iget-object p0, p0, LTh/g$b;->f:LTh/g;

    iget-object v1, p0, LTh/g;->d:LTh/g$a;

    invoke-direct {v0, v1}, LTh/k;-><init>(LTh/g$a;)V

    iget v1, p0, LTh/g;->c:I
...
.method public final g()Z
    ...
    iget-object v3, v2, Lag/m;->g:Lag/n;

    iget v3, v3, Lag/n;->g:I
    ...
    iget-object v5, v2, Lag/m;->g:Lag/n;

    iget v5, v5, Lag/n;->g:I
...
.method public final h()Z
    ...
    iget-object v2, v2, Lag/m;->g:Lag/n;

    iget-boolean v2, v2, Lag/n;->e:Z
...
.method public final i()Z
    ...
    invoke-virtual {p0}, LTh/g$b;->e()Ljava/util/Iterator;
...
.method public final k()Z
    ...
    iget-object v2, p0, LTh/k;->b:Lag/i;

    iget-object v3, p0, LTh/k;->m:Ljava/lang/Object;

    monitor-enter v3

    :try_start_0
    iget-object v4, p0, LTh/k;->k:Ljava/util/HashMap;
    ...
    iget-object v7, v6, Lag/m;->g:Lag/n;

    iget-object v8, v7, Lag/n;->k:Ljava/lang/Object;

    if-ne v8, v2, :cond_1

    iget-boolean v7, v7, Lag/n;->f:Z

    if-nez v7, :cond_2

    iget-object v6, v6, Lag/m;->h:Lag/o;

    iget v6, v6, Lag/o;->a:I
    ...
    invoke-virtual {p0, v5}, Lag/i;->o(I)Z
...
.method public final l(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
    ...
    invoke-virtual {p0, p1, p2}, Lag/k;->e(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V
...
.method public final m(IJ)V
    ...
    invoke-direct {v1, p2, p3, p0, v2}, Lag/p;-><init>(JLTh/k$b;Z)V
    ...
    iget-object p0, p1, Lag/k;->a:Landroid/os/HandlerThread;
    ...
    iget-object p0, p1, Lag/k;->b:Lag/k$a;
    ...
    iget-object p2, p1, Lag/k;->b:Lag/k$a;
    ...
    invoke-virtual {p1, v1}, Lag/k;->h(Lag/p;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final n(Lag/m;)V
    .locals 16

    move-object/from16 v0, p1

    invoke-virtual/range {p0 .. p0}, LTh/g$b;->c()LTh/k;
    ...
    iget-object v1, v1, LTh/k;->o:LTh/k$g;

    iget-object v3, v1, LTh/k$g;->a:LTh/k;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    sget-object v4, Landroid/os/Build;->DEVICE:Ljava/lang/String;

    const-string v5, "Flare"
    ...
    invoke-virtual {v4, v2, v6}, Lag/b;->f(II)I
    ...
    iget-object v3, v0, Lag/m;->g:Lag/n;

    iget-object v3, v3, Lag/n;->j:LFf/d;

    iget-object v4, v0, Lag/m;->k:Lag/u;
    ...
    iget-object v4, v1, LTh/k$g;->a:LTh/k;

    invoke-static {v4, v11, v12, v0}, LTh/k;->f(LTh/k;JLag/m;)V

    iget-object v4, v0, Lag/m;->g:Lag/n;

    iget-object v4, v4, Lag/n;->r:Lag/m$a;
    ...
    iget v7, v4, Lag/n;->g:I

    const/4 v8, 0x4

    if-eq v7, v8, :cond_3

    iput-boolean v15, v4, Lag/n;->f:Z

    :cond_3
    iget-object v4, v0, Lag/m;->g:Lag/n;

    iget-object v7, v1, LTh/k$g;->a:LTh/k;

    iget-object v7, v7, LTh/k;->b:Lag/i;

    iput-object v7, v4, Lag/n;->k:Ljava/lang/Object;

    :cond_4
    iget-object v4, v1, LTh/k$g;->a:LTh/k;

    iget-object v4, v4, LTh/k;->b:Lag/i;

    instance-of v7, v4, LTh/f;
    ...
    :goto_2
    iget-object v6, v0, Lag/m;->g:Lag/n;

    iget v10, v6, Lag/n;->a:I

    iget-object v7, v0, Lag/m;->j:Lag/s;

    iget-boolean v14, v7, Lag/s;->q:Z

    new-instance v13, LFf/b;

    iget v8, v6, Lag/n;->g:I

    iget-object v6, v6, Lag/n;->o:Ljava/lang/String;
    ...
    invoke-direct/range {v7 .. v15}, LFf/b;-><init>(IIIJLjava/lang/String;ZLag/i;)V

    iget-object v4, v0, Lag/m;->g:Lag/n;

    iget v7, v4, Lag/n;->q:I

    iput v7, v2, LFf/b;->x:I

    iget-object v7, v1, LTh/k$g;->a:LTh/k;

    iget-object v7, v7, LTh/k;->A:LTh/k$b;

    iput-object v7, v2, LFf/b;->q:LTh/k$b;

    iget-boolean v4, v4, Lag/n;->h:Z

    iput-boolean v4, v2, LFf/b;->l:Z

    iput-object v3, v2, LFf/b;->o:LFf/d;

    iget-object v3, v0, Lag/m;->j:Lag/s;

    iget-object v4, v3, Lag/s;->i:LFf/a;

    iput-object v4, v2, LFf/b;->v:LFf/a;

    iget-boolean v3, v3, Lag/s;->r:Z

    iput-boolean v3, v2, LFf/b;->m:Z
    ...
    invoke-static {v3, v15}, LI/g;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    iput-boolean v15, v2, LFf/b;->s:Z

    :cond_7
    sget-object v3, Lag/k$e;->a:Lag/k;

    iget-object v3, v3, Lag/k;->b:Lag/k$a;
    ...
    invoke-direct {v4, v5, v1, v2, v0}, LO4/i;-><init>(ILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final o()V
    ...
    iget-object v7, v7, Lag/m;->b:Lag/a;

    iget v11, v7, Lag/a;->f:I

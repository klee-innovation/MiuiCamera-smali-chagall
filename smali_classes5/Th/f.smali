...
.method public constructor <init>(LTh/k$e;Lcom/xiaomi/engine/BufferFormat;)V
    ...
    invoke-direct {p0, p1, p2}, LTh/b;-><init>(LTh/k$e;Lcom/xiaomi/engine/BufferFormat;)V
...
# virtual methods
.method public final C(LFf/h;)V
    .locals 10

    iget-object v0, p1, LFf/h;->a:Ljava/util/ArrayList;
    ...
    :cond_0
    iget-boolean v1, p1, LFf/h;->b:Z

    if-eqz v1, :cond_1

    iget-object v1, p0, LTh/b;->r:Ljava/util/concurrent/atomic/AtomicInteger;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicInteger;->getAndIncrement()I

    :cond_1
    iget-object v1, p1, LFf/h;->g:LFf/d;

    invoke-virtual {v1}, LFf/d;->d()I
    ...
    iget-object v4, v1, LFf/b$a;->d:Landroid/media/Image;

    iget-object v6, v1, LFf/b$a;->e:Landroid/media/Image;

    invoke-static {v4}, Lag/i;->m(Landroid/media/Image;)Z

    move-result v7

    invoke-static {v6}, Lag/i;->m(Landroid/media/Image;)Z
    ...
    :cond_4
    iget-object v1, v1, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget v7, p1, LFf/h;->d:I

    invoke-virtual {p0, v1, v4, v2, v7}, LTh/f;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    iget v4, p1, LFf/h;->d:I

    invoke-virtual {p0, v1, v6, v5, v4}, LTh/f;->K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
...
.method public final K(Lcom/xiaomi/protocol/ICustomCaptureResult;Landroid/media/Image;II)V
    ...
    invoke-static {v1, v2, v3, v5}, LFa/q;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-boolean p2, p0, LTh/f;->C:Z

    if-eqz p2, :cond_1

    :try_start_0
    sget-object p2, LA8/P;->o1:LA8/Q;

    invoke-virtual {p2}, LA8/Q;->a()Ljava/lang/Object;
    ...
    invoke-static {p1, p2, v1}, LA8/S;->j(Landroid/os/Parcelable;Landroid/hardware/camera2/CaptureResult$Key;Ljava/lang/Number;)V
    ...
    invoke-static {p2, v0}, LKb/v1;->g(Ljava/lang/Exception;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-direct {p1, p0}, LTh/f$a;-><init>(LTh/f;)V
    ...
    iget-object p1, p0, LTh/b;->A:Ljava/lang/Object;
...
.method public final b(Lcom/xiaomi/engine/BufferFormat;)Ljava/util/ArrayList;
    ...
    invoke-direct {v2, p0}, LTh/c;-><init>(LTh/f;)V

    iget-object v3, p0, LTh/b;->t:Landroid/os/Handler;

    invoke-virtual {v1, v2, v3}, Landroid/media/ImageReader;->setOnImageAvailableListener(Landroid/media/ImageReader$OnImageAvailableListener;Landroid/os/Handler;)V

    new-instance v1, Landroid/hardware/camera2/params/OutputConfiguration;

    iget-object v2, p0, LTh/b;->w:Landroid/media/ImageReader;
    ...
    invoke-direct {v2, p0}, LTh/d;-><init>(LTh/f;)V

    iget-object v4, p0, LTh/b;->t:Landroid/os/Handler;
    ...
    iget-object v2, p0, LTh/b;->x:Landroid/media/ImageReader;
    ...
    invoke-static {v2, p1, v1, v5, v6}, LB2/m;->h(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iput-object p1, p0, LTh/b;->y:Landroid/media/ImageReader;

    new-instance v1, LTh/e;

    invoke-direct {v1, p0}, LTh/e;-><init>(LTh/f;)V
    ...
    iget-object p0, p0, LTh/b;->y:Landroid/media/ImageReader;
...
.method public final l()Z
    ...
    iget-object v0, p0, Lag/i;->b:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object v0, p0, Lag/i;->c:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iget-object p0, p0, Lag/i;->d:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    invoke-virtual {v1, p0}, LTh/k$e;->a(LTh/b;)Z

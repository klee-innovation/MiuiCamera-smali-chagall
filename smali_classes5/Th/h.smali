...
.field public final e:LTh/h$d;

.field public final f:LTh/h$a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LTh/h;->c:Ljava/lang/Object;

    new-instance v0, LTh/h$a;

    invoke-direct {v0, p0}, LTh/h$a;-><init>(LTh/h;)V

    iput-object v0, p0, LTh/h;->f:LTh/h$a;
    ...
    iput-object v0, p0, LTh/h;->d:Landroid/os/HandlerThread;

    invoke-virtual {v0}, Ljava/lang/Thread;->start()V

    new-instance v1, LTh/h$d;

    invoke-virtual {v0}, Landroid/os/HandlerThread;->getLooper()Landroid/os/Looper;

    move-result-object v0

    invoke-direct {v1, p0, v0}, LTh/h$d;-><init>(LTh/h;Landroid/os/Looper;)V

    iput-object v1, p0, LTh/h;->e:LTh/h$d;

    return-void
.end method

.method public static a(LTh/h;LFf/b$a;IZ)V
    .locals 17
    ...
    new-instance v12, LTh/i;

    invoke-direct {v12, v1, v0, v2}, LTh/i;-><init>(LTh/h;LFf/b$a;I)V

    const/4 v13, 0x1

    if-nez v2, :cond_0

    iget-object v3, v0, LFf/b$a;->d:Landroid/media/Image;
    ...
    iget-object v3, v0, LFf/b$a;->e:Landroid/media/Image;
    ...
    iget-object v5, v0, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v4, v5, v2}, LD0/s;->h(Ljava/lang/StringBuilder;Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-static {v4, v3, v6, v13}, Lzf/e;->l(Lcom/xiaomi/camera/imagecodec/ImagePool;Landroid/media/Image;IZ)Landroid/media/Image;
    ...
    iget-object v3, v1, LTh/h;->c:Ljava/lang/Object;
    ...
    iput-wide v6, v1, LTh/h;->a:J

    iput-boolean v13, v1, LTh/h;->b:Z
    ...
    iget-object v7, v0, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v4, v1, LTh/h;->c:Ljava/lang/Object;
    ...
    :try_start_2
    iget-boolean v0, v1, LTh/h;->b:Z

    if-eqz v0, :cond_1

    iget-object v0, v1, LTh/h;->c:Ljava/lang/Object;
    ...
    invoke-static {v1, v2, v3}, LI/b;->h(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/String;
...
# virtual methods
.method public final b(LFf/b;Lcom/xiaomi/engine/TaskSession;)V
    .locals 33
    ...
    sget-boolean v0, Lg9/b;->y:Z

    move-object/from16 v4, p0

    iget-object v4, v4, LTh/h;->f:LTh/h$a;

    iget-object v6, v1, LFf/b;->f:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;

    invoke-virtual {v0, v2, v7}, LFf/b$a;->d(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    iget-object v2, v1, LFf/b;->p:LTh/k$c;
    ...
    iget-object v8, v5, LFf/b$a;->d:Landroid/media/Image;

    iget-object v9, v5, LFf/b$a;->e:Landroid/media/Image;

    iget-object v5, v5, LFf/b$a;->g:Landroid/media/Image;

    if-eqz v8, :cond_0

    invoke-virtual {v8}, Landroid/media/Image;->close()V

    invoke-virtual {v2, v8}, LTh/k$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v2, v9}, LTh/k$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v2, v5}, LTh/k$c;->b(Landroid/media/Image;)V
    ...
    invoke-virtual {v0}, LFf/b$a;->c()Z

    move-result v2

    if-eqz v2, :cond_4

    iput-object v0, v1, LFf/b;->i:LFf/b$a;

    invoke-virtual {v4, v1, v3}, LTh/h$a;->a(LFf/b;Z)V

    :cond_4
    return-void

    :cond_5
    iget v0, v1, LFf/b;->a:I
    ...
    iget-boolean v5, v1, LFf/b;->l:Z

    iget-object v12, v1, LFf/b;->o:LFf/d;

    iget-boolean v14, v1, LFf/b;->m:Z
    ...
    invoke-direct/range {v14 .. v19}, LFf/b$a;-><init>(IZLFf/d;ZZ)V

    new-instance v5, Ljava/lang/StringBuilder;

    invoke-direct {v5, v11}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v6, v5}, LFa/s;->h(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    invoke-static {v2, v5, v11, v12}, LFa/q;->d(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;Ljava/lang/String;)Ljava/lang/StringBuilder;
    ...
    iget-object v7, v14, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v7, v14, LFf/b$a;->d:Landroid/media/Image;
    ...
    iget-object v7, v7, LFf/b$a;->d:Landroid/media/Image;
    ...
    :cond_8
    invoke-static {v14, v10}, LV1/Y;->a(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v9, v5, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    :goto_3
    invoke-virtual {v0, v7, v3, v3}, LFf/b$a;->e(Landroid/media/Image;IZ)V
    ...
    iget-object v7, v1, LFf/b;->p:LTh/k$c;
    ...
    check-cast v11, LFf/b$a;

    if-eq v11, v5, :cond_b

    iget-object v12, v11, LFf/b$a;->d:Landroid/media/Image;

    invoke-virtual {v12}, Landroid/media/Image;->close()V

    invoke-virtual {v7, v12}, LTh/k$c;->b(Landroid/media/Image;)V

    iget-object v12, v11, LFf/b$a;->e:Landroid/media/Image;
    ...
    :cond_c
    iget-object v11, v11, LFf/b$a;->g:Landroid/media/Image;

    if-eqz v11, :cond_b

    invoke-virtual {v11}, Landroid/media/Image;->close()V

    invoke-virtual {v7, v11}, LTh/k$c;->b(Landroid/media/Image;)V
    ...
    iget-object v6, v5, LFf/b$a;->d:Landroid/media/Image;

    invoke-virtual {v6}, Landroid/media/Image;->close()V

    invoke-virtual {v7, v6}, LTh/k$c;->b(Landroid/media/Image;)V

    const/4 v6, 0x1

    invoke-virtual {v0, v9, v6}, LFf/b$a;->d(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    iget-boolean v6, v1, LFf/b;->l:Z

    if-eqz v6, :cond_e

    iget-object v6, v5, LFf/b$a;->g:Landroid/media/Image;

    iget-boolean v7, v5, LFf/b$a;->l:Z

    invoke-virtual {v0, v6, v13, v7}, LFf/b$a;->e(Landroid/media/Image;IZ)V

    :cond_e
    iget-object v5, v5, LFf/b$a;->e:Landroid/media/Image;

    const/4 v6, 0x1

    if-eqz v5, :cond_f

    invoke-virtual {v0, v5, v6, v3}, LFf/b$a;->e(Landroid/media/Image;IZ)V
    ...
    invoke-virtual {v4, v1, v6}, LTh/h$a;->a(LFf/b;Z)V
    ...
    iget-object v0, v1, LFf/b;->n:Landroid/util/Size;
    ...
    invoke-static {v9, v0, v14, v15}, LKb/v1;->f(IILjava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v5, LFf/b$a;

    iget v0, v1, LFf/b;->b:I

    iget-boolean v12, v1, LFf/b;->l:Z

    iget-object v15, v1, LFf/b;->o:LFf/d;

    iget-boolean v13, v1, LFf/b;->m:Z
    ...
    invoke-direct/range {v17 .. v22}, LFf/b$a;-><init>(IZLFf/d;ZZ)V

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0, v11}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    invoke-static {v6, v0}, LFa/s;->h(Ljava/util/ArrayList;Ljava/lang/StringBuilder;)Ljava/lang/String;
    ...
    iget-object v0, v3, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v8, v0, v4}, LA8/S;->j(Landroid/os/Parcelable;Landroid/hardware/camera2/CaptureResult$Key;Ljava/lang/Number;)V
    ...
    const-string v5, "doProcess: Exception\uff1a "
    ...
    iget-object v4, v3, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v3, LFf/b$a;->d:Landroid/media/Image;
    ...
    invoke-virtual {v2, v12, v4, v5}, Lcom/xiaomi/engine/TaskSession;->processFrameWithSync(Ljava/util/List;Landroid/media/Image;I)I
    ...
    invoke-static {v0, v8}, LV1/Y;->a(ILjava/lang/String;)Ljava/lang/String;
    ...
    iget-object v0, v1, LFf/b;->o:LFf/d;
    ...
    iget-object v0, v12, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    invoke-static {v13, v0, v3}, LA8/S;->j(Landroid/os/Parcelable;Landroid/hardware/camera2/CaptureResult$Key;Ljava/lang/Number;)V
    ...
    iget-object v3, v12, LFf/b$a;->c:Lcom/xiaomi/protocol/ICustomCaptureResult;
    ...
    iget-object v3, v12, LFf/b$a;->e:Landroid/media/Image;
    ...
    iget-object v0, v0, LFf/b$a;->e:Landroid/media/Image;
    ...
    :cond_20
    invoke-static {v2, v8}, LV1/Y;->a(ILjava/lang/String;)Ljava/lang/String;
    ...
    :goto_16
    invoke-virtual {v10, v0, v8, v4}, LFf/b$a;->e(Landroid/media/Image;IZ)V
    ...
    :goto_17
    invoke-virtual {v10, v9, v8}, LFf/b$a;->d(Lcom/xiaomi/protocol/ICustomCaptureResult;Z)V

    iget-boolean v0, v1, LFf/b;->l:Z

    if-eqz v0, :cond_23

    iget-object v0, v5, LFf/b$a;->g:Landroid/media/Image;

    iget-boolean v4, v5, LFf/b$a;->l:Z
    ...
    :goto_19
    invoke-virtual {v10, v0, v2, v2}, LFf/b$a;->e(Landroid/media/Image;IZ)V
    ...
    iget-object v0, v1, LFf/b;->p:LTh/k$c;
    ...
    :cond_26
    iget-object v8, v4, LFf/b$a;->d:Landroid/media/Image;

    invoke-virtual {v8}, Landroid/media/Image;->close()V

    invoke-virtual {v0, v8}, LTh/k$c;->b(Landroid/media/Image;)V

    iget-object v8, v4, LFf/b$a;->e:Landroid/media/Image;
    ...
    :cond_27
    iget-object v4, v4, LFf/b$a;->g:Landroid/media/Image;

    if-eqz v4, :cond_25

    invoke-virtual {v4}, Landroid/media/Image;->close()V

    invoke-virtual {v0, v4}, LTh/k$c;->b(Landroid/media/Image;)V
    ...
    iget-object v2, v5, LFf/b$a;->d:Landroid/media/Image;

    invoke-virtual {v2}, Landroid/media/Image;->close()V

    invoke-virtual {v0, v2}, LTh/k$c;->b(Landroid/media/Image;)V

    iget-object v2, v5, LFf/b$a;->e:Landroid/media/Image;

    if-eqz v2, :cond_29

    iget-object v4, v1, LFf/b;->o:LFf/d;
    ...
    invoke-virtual {v10, v2, v5, v4}, LFf/b$a;->e(Landroid/media/Image;IZ)V

    :goto_1b
    invoke-virtual {v10}, LFf/b$a;->c()Z
    ...
    invoke-interface {v3, v4, v10}, Ljava/util/List;->add(ILjava/lang/Object;)V
    ...
    iput-boolean v4, v2, LFf/b$a;->i:Z
    ...
    iput-object v3, v1, LFf/b;->g:Ljava/util/ArrayList;

    iget-boolean v0, v1, LFf/b;->k:Z
    ...
    invoke-virtual {v3, v1, v0}, LTh/h$a;->a(LFf/b;Z)V
    ...
    iput-object v10, v1, LFf/b;->i:LFf/b$a;

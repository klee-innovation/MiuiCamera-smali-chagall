...
.method public constructor <init>(LTh/k;)V
    ...
    iput-object p1, p0, LTh/k$a;->a:LTh/k;
...
.method public final onSessionCallback(ILjava/lang/String;Ljava/lang/Object;)V
    ...
    iget-object v0, v0, LTh/k$a;->a:LTh/k;

    iget-object v0, v0, LTh/k;->h:LTh/g$a;
    ...
    invoke-virtual {v0}, LTh/g$b;->e()Ljava/util/Iterator;
    ...
    :try_start_0
    iget-object v5, v3, LTh/k;->b:Lag/i;

    if-eqz v5, :cond_1

    invoke-virtual {v5, v1, v2}, Lag/i;->q(J)Z
    ...
    :cond_1
    iget-object v3, v3, LTh/k;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v6, v1, v2}, Lag/i;->q(J)Z
    ...
    iget-object v0, v0, LTh/k;->v:Ljava/lang/ref/WeakReference;
    ...
    invoke-interface {v0, v1, v2}, Lag/g;->a(ILjava/lang/Object;)V
    ...
    iget-object v1, v0, LTh/k$a;->a:LTh/k;

    iget-object v1, v1, LTh/k;->h:LTh/g$a;
    ...
    iget-object v4, v1, LTh/k;->j:Ljava/lang/Object;

    monitor-enter v4

    :try_start_2
    iget-object v5, v1, LTh/k;->b:Lag/i;

    iget-object v6, v1, LTh/k;->c:Ljava/util/HashMap;
    ...
    invoke-virtual {v8}, Lag/i;->p()Ljava/util/ArrayList;
    ...
    invoke-virtual {v5}, Lag/i;->p()Ljava/util/ArrayList;
    ...
    :cond_8
    iget-object v5, v1, LTh/k;->c:Ljava/util/HashMap;
    ...
    iget-object v4, v1, LTh/k;->g:Landroid/os/Handler;

    new-instance v5, LBj/a;

    invoke-direct {v5, v3, v1, v2}, LBj/a;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v0, v0, LTh/k;->D:LTh/k$e;

    if-eqz v0, :cond_18

    const-string v8, ","

    iget-object v9, v0, LTh/k$e;->a:LTh/k;
    ...
    invoke-virtual {v9, v2, v3}, LTh/k;->u(J)Lag/m;
    ...
    invoke-static {v2, v3, v1}, LF9/d;->d(JLjava/lang/String;)Ljava/lang/String;
    ...
    :cond_c
    iget-object v2, v4, Lag/m;->e:Lcom/xiaomi/camera/core/ExifData;
    ...
    iput-object v1, v2, LFf/f;->F:Ljava/lang/String;
    ...
    iget-object v0, v4, Lag/m;->g:Lag/n;

    iput-byte v6, v0, Lag/n;->v:B

    iput-byte v6, v2, LFf/f;->L:B
    ...
    invoke-virtual {v9, v11, v12}, LTh/k;->u(J)Lag/m;
    ...
    invoke-static {v13, v14, v4, v8, v8}, LB2/m;->h(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v4

    const-string v13, "]"

    invoke-static {v4, v15, v8, v5, v13}, LKb/v1;->i(Ljava/lang/StringBuilder;ILjava/lang/String;ILjava/lang/String;)Ljava/lang/String;
    ...
    :goto_a
    iget-object v4, v9, LTh/k;->s:Ljava/util/HashMap;
    ...
    iput-object v4, v9, LTh/k;->s:Ljava/util/HashMap;
    ...
    iget-object v4, v9, LTh/k;->t:Ljava/util/HashMap;
    ...
    iput-object v4, v9, LTh/k;->t:Ljava/util/HashMap;

    :cond_15
    iget-object v3, v9, LTh/k;->t:Ljava/util/HashMap;
    ...
    iget-object v0, v9, LTh/k;->s:Ljava/util/HashMap;
    ...
    iget-object v4, v1, Lag/m;->h:Lag/o;

    iget v5, v4, Lag/o;->b:I

    iget v4, v4, Lag/o;->c:I

    iget-object v1, v1, Lag/m;->g:Lag/n;

    iget-object v6, v1, Lag/n;->l:Landroid/graphics/Rect;

    iget v1, v1, Lag/n;->m:F

    invoke-static {v0, v5, v4, v6, v1}, LTh/k;->i(Landroid/graphics/Rect;IILandroid/graphics/Rect;F)V
    ...
    :try_start_4
    invoke-virtual {v9, v11, v12, v3}, LTh/k;->z(JLcom/xiaomi/camera/imagecodec/ReprocessData;)V
    :try_end_4
    .catch Ljava/lang/Exception; {:try_start_4 .. :try_end_4} :catch_0
    .catchall {:try_start_4 .. :try_end_4} :catchall_2

    iget-object v0, v9, LTh/k;->t:Ljava/util/HashMap;
    ...
    :try_start_5
    iget-object v0, v9, LTh/k;->E:LTh/k$f;
    ...
    invoke-virtual {v0, v1, v2}, LTh/k$f;->onError(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_5
    ...
    iget-object v1, v9, LTh/k;->t:Ljava/util/HashMap;
    ...
    iget-object v1, v9, LTh/k;->s:Ljava/util/HashMap;
    ...
    invoke-static {v11, v12, v1}, LF9/d;->d(JLjava/lang/String;)Ljava/lang/String;

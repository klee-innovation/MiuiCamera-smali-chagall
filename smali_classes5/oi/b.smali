...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Loi/b;->j:Ljava/lang/Object;

    new-instance v1, Landroid/media/AudioTimestamp;

    invoke-direct {v1}, Landroid/media/AudioTimestamp;-><init>()V

    iput-object v1, p0, Loi/b;->k:Landroid/media/AudioTimestamp;

    iput-boolean v0, p0, Loi/b;->l:Z

    iput v0, p0, Loi/b;->n:I

    const-wide/16 v0, 0x0

    iput-wide v0, p0, Loi/b;->q:J

    return-void
.end method

.method public static a(Loi/b;Ljava/lang/String;I)V
    .locals 4
    ...
    iput-wide p1, p0, Loi/b;->q:J

    :cond_0
    return-void
.end method

.method public static b(Loi/b;)V
    .locals 5
    ...
    iget-object v3, p0, Loi/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object v1, p0, Loi/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v2, p0, Loi/b;->a:Landroid/media/AudioRecord;
...
.method public final c()V
    ...
    iget-object v0, p0, Loi/b;->b:Ljava/lang/Thread;

    if-nez v0, :cond_2

    iget-boolean v0, p0, Loi/b;->l:Z
    ...
    iget-object v5, p0, Loi/b;->a:Landroid/media/AudioRecord;
    ...
    :goto_0
    const-string v5, "setAudioRecordParameters err = "
    ...
    :goto_4
    iget-object v0, p0, Loi/b;->a:Landroid/media/AudioRecord;
    ...
    invoke-direct {v0, p0}, Loi/d;-><init>(Loi/b;)V

    iput-object v0, p0, Loi/b;->b:Ljava/lang/Thread;
    ...
    invoke-direct {v0, p0}, Loi/c;-><init>(Loi/b;)V
...
.method public final d(Landroid/media/AudioFormat;IIIII)V
    .locals 2
    ...
    iput-object p1, p0, Loi/b;->e:Landroid/media/AudioFormat;

    iput p2, p0, Loi/b;->g:I

    iput p3, p0, Loi/b;->f:I

    iput p4, p0, Loi/b;->h:I

    iput p5, p0, Loi/b;->n:I
    ...
    invoke-direct {p4, p6}, Ljava/util/concurrent/ArrayBlockingQueue;-><init>(I)V

    iput-object p4, p3, Loi/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;

    iput-object p3, p0, Loi/b;->i:Loi/a;

    iget-object p3, p0, Loi/b;->e:Landroid/media/AudioFormat;
    ...
    iput-object p4, p3, Lni/a;->c:Ljava/nio/ByteBuffer;

    const-wide/16 v0, -0x1

    iput-wide v0, p3, Lni/a;->d:J

    const-wide/16 v0, 0x0

    iput-wide v0, p3, Lni/a;->e:J

    iput-boolean p5, p3, Lni/a;->f:Z

    iput p1, p3, Lni/a;->a:I

    iput-object p4, p3, Lni/a;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object p1, p3, Lni/a;->c:Ljava/nio/ByteBuffer;

    iput-object p3, p0, Loi/b;->m:Lni/a;

    new-instance p1, Loi/b$a;

    invoke-direct {p1, p0}, Loi/b$a;-><init>(Loi/b;)V

    iput-object p1, p3, Lni/a;->g:Loi/b$a;

    goto :goto_0

    :cond_0
    iput-boolean p5, p0, Loi/b;->l:Z
    ...
    invoke-static {p2, p1, p3}, LKk/a;->g(ILjava/lang/String;Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object p1

    iget-boolean p2, p0, Loi/b;->l:Z
    ...
    iget-object p2, p0, Loi/b;->e:Landroid/media/AudioFormat;
    ...
    iput-object p1, p0, Loi/b;->a:Landroid/media/AudioRecord;
    :try_end_0
...
.method public final e()V
    ...
    iput-boolean v2, p0, Loi/b;->c:Z

    iget-object v0, p0, Loi/b;->j:Ljava/lang/Object;

    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Loi/b;->a:Landroid/media/AudioRecord;
    ...
    iput-object v1, p0, Loi/b;->a:Landroid/media/AudioRecord;

    iget-object v3, p0, Loi/b;->i:Loi/a;

    if-eqz v3, :cond_3

    iget-object v3, v3, Loi/a;->a:Ljava/util/concurrent/ArrayBlockingQueue;
    ...
    invoke-direct {v4, v5}, Lg4/g;-><init>(I)V

    invoke-virtual {v3, v4}, Ljava/util/concurrent/ArrayBlockingQueue;->forEach(Ljava/util/function/Consumer;)V
    ...
    iget-object v0, p0, Loi/b;->m:Lni/a;

    if-eqz v0, :cond_4

    iput-object v1, v0, Lni/a;->b:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Lni/a;->c:Ljava/nio/ByteBuffer;

    iput-object v1, v0, Lni/a;->g:Loi/b$a;

    const-wide/16 v3, -0x1

    iput-wide v3, v0, Lni/a;->d:J

    const-wide/16 v3, 0x0

    iput-wide v3, v0, Lni/a;->e:J

    :cond_4
    iput-object v1, p0, Loi/b;->m:Lni/a;

    iput-object v1, p0, Loi/b;->b:Ljava/lang/Thread;

    iput-boolean v2, p0, Loi/b;->l:Z
...
.method public final f()V
    ...
    iget-object v1, p0, Loi/b;->i:Loi/a;
    ...
    invoke-direct {v2, v4}, Lg4/g;-><init>(I)V

    invoke-virtual {v1, v2}, Ljava/util/concurrent/ArrayBlockingQueue;->forEach(Ljava/util/function/Consumer;)V

    invoke-virtual {v1}, Ljava/util/concurrent/ArrayBlockingQueue;->clear()V

    :cond_0
    iget-object v1, p0, Loi/b;->b:Ljava/lang/Thread;
    ...
    :cond_1
    iget-object p0, p0, Loi/b;->b:Ljava/lang/Thread;
...
.method public final g()V
    ...
    const-string v2, "stopRecorder E mIsPause: "

    invoke-direct {v1, v2}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    iget-boolean v2, p0, Loi/b;->d:Z
    ...
    :try_start_1
    iget-object v3, p0, Loi/b;->m:Lni/a;

    iget-object v4, v3, Lni/a;->b:Ljava/nio/ByteBuffer;
    ...
    :cond_1
    iput-object v1, v3, Lni/a;->b:Ljava/nio/ByteBuffer;

    iget-object v4, v3, Lni/a;->c:Ljava/nio/ByteBuffer;

...
.method public constructor <init>(Loi/b;)V
    ...
    iput-object p1, p0, Loi/d;->c:Loi/b;
    ...
    iput-wide v0, p0, Loi/d;->a:J

    const-wide/16 v0, -0x1

    iput-wide v0, p0, Loi/d;->b:J
...
.method public final a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    iget-wide v7, v1, Loi/d;->a:J

    cmp-long v5, v10, v7

    if-lez v5, :cond_2

    iget-object v5, v1, Loi/d;->c:Loi/b;
    ...
    iget-object v8, v5, Loi/b;->e:Landroid/media/AudioFormat;
    ...
    iget-object v5, v5, Loi/b;->e:Landroid/media/AudioFormat;
    ...
    iget-wide v13, v1, Loi/d;->a:J

    sub-long/2addr v10, v13

    iget-object v5, v1, Loi/d;->c:Loi/b;

    iget-object v5, v5, Loi/b;->a:Landroid/media/AudioRecord;
    ...
    iget-object v5, v5, Loi/b;->m:Lni/a;

    iget-wide v7, v1, Loi/d;->b:J

    iput-wide v7, v5, Lni/a;->d:J
    ...
    :cond_5
    :try_start_0
    iget-object v7, v5, Lni/a;->c:Ljava/nio/ByteBuffer;

    invoke-virtual {v7}, Ljava/nio/ByteBuffer;->clear()Ljava/nio/Buffer;

    iget-object v7, v5, Lni/a;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v8, v5, Lni/a;->b:Ljava/nio/ByteBuffer;
    ...
    iput-object v8, v5, Lni/a;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v8, v5, Lni/a;->c:Ljava/nio/ByteBuffer;

    invoke-virtual {v8, v3}, Ljava/nio/ByteBuffer;->put(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;

    add-int/2addr v7, v4

    iget-object v4, v5, Lni/a;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v10, v5, Lni/a;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v11, v5, Lni/a;->c:Ljava/nio/ByteBuffer;
    ...
    :cond_8
    iget-wide v10, v5, Lni/a;->e:J

    const-wide/16 v12, 0x400

    add-long/2addr v10, v12

    iput-wide v10, v5, Lni/a;->e:J

    iget-wide v12, v5, Lni/a;->d:J

    const-wide/32 v16, 0xf4240

    mul-long v10, v10, v16

    iget v3, v5, Lni/a;->a:I
    ...
    iget-object v0, v5, Lni/a;->g:Loi/b$a;
    ...
    iget-object v1, v0, Loi/b$a;->a:Loi/b;

    iget-boolean v1, v1, Loi/b;->d:Z
    ...
    invoke-direct/range {v10 .. v15}, Lpi/f;-><init>(Ljava/nio/ByteBuffer;IJLandroid/media/MediaCodec$BufferInfo;)V

    iget-object v0, v0, Loi/b$a;->a:Loi/b;

    iget-object v3, v0, Loi/b;->p:LH4/a;

    if-eqz v3, :cond_9

    iget-object v0, v3, LH4/a;->b:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v8, v1}, Lrh/c;->a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    invoke-virtual {v0, v1}, Loi/a;->b(Lpi/f;)V
    ...
    :cond_d
    iget-object v0, v5, Lni/a;->b:Ljava/nio/ByteBuffer;

    if-nez v0, :cond_e

    iget-object v0, v5, Lni/a;->c:Ljava/nio/ByteBuffer;
    ...
    iput-object v0, v5, Lni/a;->b:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, v5, Lni/a;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v4, v5, Lni/a;->b:Ljava/nio/ByteBuffer;

    invoke-virtual {v1, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object v3, v5, Lni/a;->c:Ljava/nio/ByteBuffer;
...
.method public final run()V
    ...
    iget-object v0, p0, Loi/d;->c:Loi/b;

    iget v0, v0, Loi/b;->g:I

    invoke-static {v0}, Ljava/nio/ByteBuffer;->allocateDirect(I)Ljava/nio/ByteBuffer;

    move-result-object v0

    iget-object v1, p0, Loi/d;->c:Loi/b;

    invoke-static {v1}, Loi/b;->b(Loi/b;)V

    const-wide/16 v3, -0x1

    iput-wide v3, p0, Loi/d;->b:J

    :goto_0
    iget-object v1, p0, Loi/d;->c:Loi/b;

    iget-boolean v1, v1, Loi/b;->c:Z

    if-eqz v1, :cond_2

    iget-object v1, p0, Loi/d;->c:Loi/b;

    iget-object v1, v1, Loi/b;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    iget-object v3, p0, Loi/d;->c:Loi/b;

    iget-object v4, v3, Loi/b;->a:Landroid/media/AudioRecord;

    if-eqz v4, :cond_1

    iget v3, v3, Loi/b;->g:I

    invoke-virtual {v4, v0, v3}, Landroid/media/AudioRecord;->read(Ljava/nio/ByteBuffer;I)I

    move-result v3

    iget-object v4, p0, Loi/d;->c:Loi/b;

    iget-object v5, v4, Loi/b;->a:Landroid/media/AudioRecord;

    iget-object v6, v4, Loi/b;->k:Landroid/media/AudioTimestamp;

    iget v4, v4, Loi/b;->n:I
    ...
    iget-object v5, p0, Loi/d;->c:Loi/b;

    iget-object v5, v5, Loi/b;->k:Landroid/media/AudioTimestamp;

    invoke-virtual {p0, v4, v5, v0, v3}, Loi/d;->a(ILandroid/media/AudioTimestamp;Ljava/nio/ByteBuffer;I)V
    ...
    invoke-static {v4, v5, v3}, Loi/b;->a(Loi/b;Ljava/lang/String;I)V
    ...
    :cond_2
    :try_start_1
    iget-object p0, p0, Loi/d;->c:Loi/b;

...
.method public final onActionItemClicked(Landroid/view/ActionMode;Landroid/view/MenuItem;)Z
    ...
    sget p1, Lcom/xiaomi/microfilm/vlog/vv/VVWorkspaceActivity;->v0:I

    invoke-virtual {p0, v0}, Lcom/xiaomi/microfilm/vlog/vv/VVWorkspaceActivity;->Qj(Z)V
    ...
    iget-object p2, p0, Lcom/xiaomi/microfilm/vlog/vv/VVWorkspaceActivity;->p0:Lcom/xiaomi/microfilm/vlog/vv/A;
    ...
    :cond_1
    iget-boolean p2, p2, Lcom/xiaomi/microfilm/vlog/vv/A;->b:Z
    ...
    iput-object v3, p2, Lzi/g;->a:Ljava/util/LinkedHashMap;

    new-instance v3, Ljava/util/LinkedHashMap;

    invoke-direct {v3}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v3, p2, Lzi/g;->b:Ljava/util/LinkedHashMap;

    new-instance v3, Ljava/util/LinkedHashMap;

    invoke-direct {v3}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v3, p2, Lzi/g;->e:Ljava/util/LinkedHashMap;

    iput-object p2, p1, Lzi/i;->b:Lzi/g;

    const-string p2, "value_vv_click_workspace_select_all"

    invoke-virtual {p1, p2, v1}, Lzi/i;->c(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    iget-object p1, p1, Lcom/xiaomi/microfilm/vlog/vv/A;->a:Ljava/util/List;
    ...
    check-cast p2, Lcom/xiaomi/microfilm/vlog/vv/C;

    iget-boolean p2, p2, Lcom/xiaomi/microfilm/vlog/vv/C;->j:Z
    ...
    iget-object v0, p1, Lcom/xiaomi/microfilm/vlog/vv/A;->a:Ljava/util/List;
    ...
    iput-boolean p2, v1, Lcom/xiaomi/microfilm/vlog/vv/C;->j:Z
    ...
    invoke-virtual {p2}, Lcom/xiaomi/microfilm/vlog/vv/A;->i()I
    ...
    invoke-direct {v7, p0, p1}, LE3/e;-><init>(Ljava/lang/Object;I)V
    ...
    new-instance v11, Lcom/android/camera/features/mode/cinematic/j;

    const/4 p1, 0x2

    invoke-direct {v11, p1}, Lcom/android/camera/features/mode/cinematic/j;-><init>(I)V
    ...
    iput-object p1, p0, Lcom/xiaomi/microfilm/vlog/vv/VVWorkspaceActivity;->s0:Lmiuix/appcompat/app/m;

    new-instance p2, Lcom/xiaomi/microfilm/vlog/vv/z;

    invoke-direct {p2, p0}, Lcom/xiaomi/microfilm/vlog/vv/z;-><init>(Lcom/xiaomi/microfilm/vlog/vv/VVWorkspaceActivity;)V
...
.method public final onCreateActionMode(Landroid/view/ActionMode;Landroid/view/Menu;)Z
    ...
    iput-object p2, p0, Lcom/xiaomi/microfilm/vlog/vv/VVWorkspaceActivity;->l0:Landroid/view/MenuItem;

    const/4 v1, 0x1

    invoke-interface {p2, v1}, Landroid/view/MenuItem;->setShowAsAction(I)V

    iget-object p0, p0, Lcom/xiaomi/microfilm/vlog/vv/VVWorkspaceActivity;->l0:Landroid/view/MenuItem;
    ...
    invoke-interface {p1, p0, p2}, Lmiuix/view/e;->e(II)V

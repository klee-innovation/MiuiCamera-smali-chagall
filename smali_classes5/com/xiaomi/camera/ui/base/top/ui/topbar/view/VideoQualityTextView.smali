...
.method public final initChildView()V
    ...
    sget v2, LLi/b;->top_bar_video_quality_view_text_size_mm:I
    ...
    iget-boolean v7, v6, LS1/a;->b:Z

    if-eqz v7, :cond_0

    sget v7, LLi/f;->ShadowStyle_light:I

    goto :goto_0

    :cond_0
    sget v7, LLi/f;->ShadowStyle:I
    ...
    iput-object v4, p0, Lcom/android/camera/ui/H0;->mStartView:Landroid/view/View;
    ...
    invoke-direct {v4, v9}, Lcom/android/camera/ui/m;-><init>(Landroid/content/Context;)V
    ...
    iget-boolean v1, v6, LS1/a;->b:Z

    if-eqz v1, :cond_1

    sget v1, LLi/f;->ShadowStyle_light:I

    goto :goto_1

    :cond_1
    sget v1, LLi/f;->ShadowStyle:I

    :goto_1
    invoke-static {v4, v1}, LS1/e;->e(Landroid/widget/TextView;I)V
    ...
    iput-object v4, p0, Lcom/android/camera/ui/H0;->mEndView:Landroid/view/View;
...
.method public setTextColor(I)V
    ...
    instance-of v1, v1, Lcom/android/camera/ui/m;
    ...
    check-cast v1, Lcom/android/camera/ui/m;

    invoke-virtual {v1, p1}, Lcom/android/camera/ui/m;->setColor(I)V
...
.method public setTexts([Ljava/lang/String;)V
    ...
    invoke-direct {v0, p1, v1}, LG3/o;-><init>(Ljava/lang/Object;I)V

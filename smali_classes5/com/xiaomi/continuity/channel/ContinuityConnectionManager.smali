...
.field private mService:Lrj/f;


# direct methods
.method private constructor <init>(Lrj/f;Landroid/content/Context;)V
    .locals 1
    ...
    iput-object p1, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lrj/f;
    ...
    invoke-virtual {p0, p1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lrj/b;)V

    return-void
.end method

.method public static synthetic access$002(Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;Lrj/f;)Lrj/f;
    .locals 0
...
.method private checkApiFeatureStatusChanged()Z
    ...
    invoke-static {p0, v0}, Lrj/i;->b(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static declared-synchronized getInstance(Landroid/content/Context;)Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;
    ...
    invoke-static {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Lrj/f;
    ...
    invoke-direct {v2, v1, p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;-><init>(Lrj/f;Landroid/content/Context;)V
...
.method private getRuntimeException(Landroid/os/RemoteException;)Ljava/lang/RuntimeException;
    ...
    invoke-static {p1}, LB2/t;->b(Landroid/os/RemoteException;)Ljava/lang/RuntimeException;
...
.method private declared-synchronized getService()Lrj/f;
    .locals 4

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lrj/f;
    ...
    invoke-static {v0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getSystemService(Landroid/content/Context;)Lrj/f;

    move-result-object v0

    iput-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mService:Lrj/f;
    ...
    invoke-static {v1, v3, v2, v0}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static getSystemService(Landroid/content/Context;)Lrj/f;
    .locals 9

    invoke-static {p0}, Lrj/d;->a(Landroid/content/Context;)Lrj/d;
    ...
    :try_start_0
    iget-object v5, p0, Lrj/d;->b:Lrj/e;

    new-instance v6, Lrj/c;

    invoke-direct {v6}, Ljava/lang/Object;-><init>()V

    invoke-virtual {v5, v6}, Lsj/d;->j(Lrj/c;)Lsj/d$a;
    ...
    iget-object v5, p0, Lrj/d;->d:Ljava/util/ArrayList;

    monitor-enter v5

    :try_start_1
    iget-object v3, p0, Lrj/d;->d:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Lrj/d;->d:Ljava/util/ArrayList;
    ...
    :cond_3
    new-instance p0, Lrj/f$a$a;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object v4, p0, Lrj/f$a$a;->a:Landroid/os/IBinder;
    ...
    invoke-static {v0, v2, v1, p0}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
# virtual methods
.method public addServiceListener(Lrj/b;)V
    .locals 0
    ...
    iget-object p0, p0, Lrj/d;->c:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public confirmChannel(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)I
    ...
    invoke-direct {p0}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->getService()Lrj/f;
    ...
    invoke-interface {v0, p1, p2, p3}, Lrj/f;->r0(IILcom/xiaomi/continuity/channel/ChannelConfirmOptions;)V
    ...
    invoke-interface {v0, p1, p2, p0}, Lrj/f;->e0(IILjava/lang/String;)V

    goto :goto_0

    :cond_1
    invoke-interface {v0, p1, p2}, Lrj/f;->Z(II)V
    ...
    invoke-static {v1, p2, p0, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    ...
    invoke-static {v1, p0, p2, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public createChannel(Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    .line 1
    :try_start_0
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lrj/b;)V
    ...
    invoke-interface/range {v1 .. v6}, Lrj/f;->F(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    invoke-interface/range {v1 .. v6}, Lrj/f;->J(Ljava/lang/String;Lcom/xiaomi/continuity/netbus/LinkAddress;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$c;)I
    ...
    invoke-static {p3, p1, p4, p2}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 3
    invoke-virtual {p0, p5}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lrj/b;)V
...
.method public createChannel(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface/range {v1 .. v6}, Lrj/f;->b(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptionsV2;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
    ...
    invoke-interface/range {v1 .. v6}, Lrj/f;->S(Ljava/lang/String;Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ClientChannelOptions;Lcom/xiaomi/continuity/channel/ContinuityConnectionManager$b;)I
...
.method public destroyChannel(I)I
    ...
    :try_start_0
    invoke-interface {p0, p1}, Lrj/f;->P(I)V
    ...
    invoke-static {v1, v3, p0, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v1, p0, v2, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public getApiFeature()Ljava/lang/String;
    ...
    :try_start_0
    invoke-interface {v0}, Lrj/f;->l()Ljava/lang/String;
...
.method public getChannelInfoExt(II)Landroid/os/Bundle;
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Lrj/f;->o0(II)Landroid/os/Bundle;
    ...
    invoke-static {p2, p0, v0, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerConnected(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {p0, v3}, Lrj/i;->b(Ljava/lang/String;Ljava/lang/String;)Z

    move-result p0

    if-eqz p0, :cond_1

    invoke-interface {v0, p1, p2}, Lrj/f;->t(Lcom/xiaomi/continuity/ServiceName;I)V
    ...
    invoke-static {v2, p2, p0, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, p0, p2, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreateFailed(I)V
    ...
    :try_start_0
    invoke-interface {p0, p1, v1}, Lrj/f;->k0(II)V
    ...
    invoke-static {v0, v2, p0, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v0, p0, v1, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public notifyChannelServerCreated(II)V
    ...
    :try_start_0
    invoke-interface {p0, p1, p2}, Lrj/f;->k0(II)V
    ...
    invoke-static {v2, v0, p0, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, v0, p2, v1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public registerChannelListener(Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/ChannelInnerListener;Ljava/util/concurrent/Executor;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->addServiceListener(Lrj/b;)V
    ...
    invoke-interface {v0, p3, p1, p2, v1}, Lrj/f;->Y(Ljava/lang/String;Lcom/xiaomi/continuity/ServiceName;Lcom/xiaomi/continuity/channel/ServerChannelOptions;Lcom/xiaomi/continuity/channel/a;)I
    ...
    invoke-virtual {p0, v1}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lrj/b;)V
    ...
    invoke-static {p2, p0, p3, p1}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public removeServiceListener(Lrj/b;)V
    .locals 0
...
.method public send(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/SendResultCallback;Ljava/util/concurrent/Executor;)I
    ...
    invoke-interface {p0, p1, p2, p3, v3}, Lrj/f;->H(I[BLandroid/os/Bundle;Lcom/xiaomi/continuity/channel/f;)I
...
.method public unbindService()V
    ...
    invoke-static {v1, v2, v0}, Luj/a;->c(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    iget-object v0, p0, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->mContext:Landroid/content/Context;

    invoke-static {v0}, Lrj/d;->a(Landroid/content/Context;)Lrj/d;

    move-result-object v0

    const-string v1, "continuity_connection"

    iget-object v2, v0, Lrj/d;->d:Ljava/util/ArrayList;

    monitor-enter v2

    :try_start_0
    iget-object v3, v0, Lrj/d;->d:Ljava/util/ArrayList;
    ...
    :cond_0
    :goto_0
    iget-object v1, v0, Lrj/d;->d:Ljava/util/ArrayList;
    ...
    iget-object v0, v0, Lrj/d;->b:Lrj/e;

    iput-boolean v3, v0, Lsj/d;->m:Z

    iget-object v1, v0, Lsj/d;->h:Landroid/os/Handler;

    new-instance v3, LEo/c;

    const/16 v4, 0x16

    invoke-direct {v3, v0, v4}, LEo/c;-><init>(Ljava/lang/Object;I)V
...
.method public unregisterChannelListener(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-virtual {p0, v3}, Lcom/xiaomi/continuity/channel/ContinuityConnectionManager;->removeServiceListener(Lrj/b;)V
    ...
    invoke-interface {p0, p1}, Lrj/f;->A0(Lcom/xiaomi/continuity/ServiceName;)I
    ...
    invoke-static {p0, v4, p1, v3}, Luj/a;->b(Ljava/lang/String;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V

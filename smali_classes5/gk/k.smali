...
.field public g:Lgk/m;

.field public h:Lgk/l;

.field public i:Landroid/widget/ImageView;

.field public j:Ldk/a;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lgk/k;->k:Lio/reactivex/disposables/a;

    return-void
.end method

.method public static synthetic Gg(Lgk/k;Ljava/lang/Throwable;)V
    .locals 2
...
.method public static synthetic Mh(Lgk/k;)Ljava/lang/String;
    .locals 0
...
.method public static synthetic Uh(Lgk/k;)Ljava/lang/String;
    .locals 0
...
.method public static synthetic hh(Lgk/k;Ljava/lang/Throwable;)V
    .locals 2

    invoke-virtual {p0}, Lgk/k;->oj()V
...
.method public final Aj(I)V
    ...
    iget-object v0, p0, Lgk/k;->j:Ldk/a;
    ...
    iput-object v0, p0, Lgk/k;->p:Lcom/xiaomi/milive/data/EffectItem;

    iget v1, p0, Lgk/k;->f:I

    iget-object v5, p0, Lgk/k;->i:Landroid/widget/ImageView;

    const/16 v6, 0x8

    invoke-virtual {v5, v6}, Landroid/widget/ImageView;->setVisibility(I)V

    iput p1, p0, Lgk/k;->f:I

    iget-object v5, p0, Lgk/k;->g:Lgk/m;

    invoke-virtual {v5, p1}, Lcom/android/camera/fragment/beauty/g;->setSelectedIndex(I)V
    ...
    :cond_0
    iget-object v4, p0, Lgk/k;->h:Lgk/l;
    ...
    iget-object v1, p0, Lgk/k;->h:Lgk/l;

    invoke-virtual {v1, v4}, Landroidx/recyclerview/widget/LinearLayoutManager;->scrollToPosition(I)V

    :cond_4
    iget-object v1, p0, Lgk/k;->n:Lcom/xiaomi/milive/data/LiveMasterProcessing;
    ...
    invoke-virtual {v1, v4}, LZ1/W;->h(Ljava/lang/String;)V

    iget-object v1, p0, Lgk/k;->n:Lcom/xiaomi/milive/data/LiveMasterProcessing;

    invoke-virtual {v1, v0}, Lcom/xiaomi/milive/data/LiveMasterProcessing;->setCurrentEffect(Lcom/xiaomi/milive/data/EffectItem;)V

    iget-object p0, p0, Lgk/k;->g:Lgk/m;

    invoke-virtual {p0, p1}, Lgk/m;->getItemViewType(I)I
    ...
    iget-object p1, p0, Lgk/k;->o:Lcom/android/camera/data/observeable/VMResource;
    ...
    iput-object p1, p0, Lgk/k;->o:Lcom/android/camera/data/observeable/VMResource;

    new-instance v1, LIh/a;

    const/4 v3, 0x7

    invoke-direct {v1, p0, v3}, LIh/a;-><init>(Ljava/lang/Object;I)V

    invoke-virtual {p1, p0, v1}, Lcom/android/camera/data/observeable/VMResource;->startObservable(Landroidx/lifecycle/w;Lio/reactivex/functions/d;)V
    ...
    iget-object p0, p0, Lgk/k;->o:Lcom/android/camera/data/observeable/VMResource;
...
.method public final Oi(Landroid/view/View;)V
    ...
    invoke-static {v2}, Lg9/b;->d(Ljava/lang/String;)Z
    ...
    invoke-static {v1, p1}, LF1/i;->i(F[Landroid/view/View;)V
    ...
    iget-object p0, p0, Lgk/k;->i:Landroid/widget/ImageView;
...
.method public final Q7(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, Lgk/k;->n:Lcom/xiaomi/milive/data/LiveMasterProcessing;
    ...
    iget v1, v0, Ldk/a;->e:I

    iget v0, v0, Ldk/a;->d:I

    iget-object p0, p0, Lgk/k;->e:Lmiuix/recyclerview/widget/RecyclerView;
...
.method public final Ui()V
    ...
    iput v2, p0, Lgk/k;->f:I

    iget-object v3, p0, Lgk/k;->j:Ldk/a;

    iget-object v3, v3, Lk6/f;->b:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v4, p0, Lgk/k;->j:Ldk/a;
    ...
    invoke-virtual {v4, v3}, Lk6/f;->b(I)Lcom/android/camera/resource/BaseResourceItem;
    ...
    :cond_1
    :goto_1
    iget-object v0, p0, Lgk/k;->m:Landroid/view/View;

    const/16 v3, 0x8

    invoke-virtual {v0, v3}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, Lgk/k;->l:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroid/view/View;->setVisibility(I)V

    iget-object v0, p0, Lgk/k;->i:Landroid/widget/ImageView;

    iget v4, p0, Lgk/k;->f:I
    ...
    invoke-direct {v5, p0, v6}, LGe/c;-><init>(Ljava/lang/Object;I)V

    iget-object v3, v3, Lk6/f;->b:Ljava/util/ArrayList;

    invoke-direct {v0, v2, v4, v3, v5}, Lcom/android/camera/fragment/beauty/g;-><init>(Landroid/content/Context;ILjava/util/List;Lcom/android/camera/fragment/beauty/g$c;)V

    iput-object v0, p0, Lgk/k;->g:Lgk/m;

    iput-object p0, v0, Lgk/m;->a:Lgk/k;
    ...
    invoke-direct {v0, v2, v3}, Lgk/n;-><init>(Landroid/content/Context;Ldk/a;)V

    iput-object v0, p0, Lgk/k;->q:Lgk/n;
    ...
    iput-object v0, p0, Lgk/k;->h:Lgk/l;

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->getContext()Landroid/content/Context;

    iget-object v0, p0, Lgk/k;->a:Landroid/widget/LinearLayout;
    ...
    iget-object v2, p0, Lgk/k;->e:Lmiuix/recyclerview/widget/RecyclerView;

    iget-object v3, p0, Lgk/k;->q:Lgk/n;
    ...
    iget-object v2, p0, Lgk/k;->h:Lgk/l;
    ...
    :goto_2
    iget-object v2, p0, Lgk/k;->a:Landroid/widget/LinearLayout;

    invoke-virtual {v2, v0}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    iget-object v0, p0, Lgk/k;->e:Lmiuix/recyclerview/widget/RecyclerView;
    ...
    new-instance v1, Lgk/k$a;

    invoke-direct {v1, p0}, Lgk/k$a;-><init>(Lgk/k;)V

    invoke-virtual {v0, v1}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    iget-object v0, p0, Lgk/k;->e:Lmiuix/recyclerview/widget/RecyclerView;

    new-instance v1, Lgk/k$b;

    invoke-direct {v1, p0}, Lgk/k$b;-><init>(Lgk/k;)V
    ...
    invoke-virtual {p0, v0}, Lgk/k;->Q7(Ljava/lang/String;)V
...
.method public final initView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lgk/k;->a:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lgk/k;->n:Lcom/xiaomi/milive/data/LiveMasterProcessing;
    ...
    iput-object v0, p0, Lgk/k;->m:Landroid/view/View;
    ...
    iput-object v0, p0, Lgk/k;->e:Lmiuix/recyclerview/widget/RecyclerView;
    ...
    iput-object v0, p0, Lgk/k;->l:Landroid/view/View;
    ...
    iput-object p1, p0, Lgk/k;->i:Landroid/widget/ImageView;
    ...
    iget-object v0, p1, Ldk/c;->a:Ldk/a;
    ...
    :goto_0
    iput-object v0, p0, Lgk/k;->j:Ldk/a;
    ...
    sget-object v4, Lck/a;->l:Ljava/lang/String;

    invoke-static {v2, v4, v3}, LGe/b;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    sget-object v4, Ldk/b;->a:Ljava/lang/String;
    ...
    sget-object v5, Ldk/b;->a:Ljava/lang/String;

    invoke-static {v4, v5, v3}, LGe/b;->f(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-boolean p0, p1, Ldk/c;->b:Z

    goto :goto_1

    :cond_3
    iput-boolean v1, p1, Ldk/c;->b:Z

    new-instance p1, Lk6/s;

    invoke-direct {p1, v3, v2}, Lk6/s;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p1, v2}, Lk6/b;->h(Ljava/lang/Object;)Lio/reactivex/internal/operators/observable/g;

    move-result-object p1

    new-instance v0, Lgk/j;

    invoke-direct {v0, p0, v2, v4}, Lgk/j;-><init>(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    new-instance v1, LY3/e;

    const/4 v2, 0x6

    invoke-direct {v1, p0, v2}, LY3/e;-><init>(Ljava/lang/Object;I)V
    ...
    iget-object p0, p0, Lgk/k;->k:Lio/reactivex/disposables/a;
...
.method public final mapItemsToStringList()Ljava/util/List;
    ...
    iget-object v2, v1, Ldk/c;->a:Ldk/a;
    ...
    :goto_0
    iput-object v2, p0, Lgk/k;->j:Ldk/a;

    if-eqz v2, :cond_5

    iget-boolean p0, v2, Lk6/f;->c:Z

    if-nez p0, :cond_5

    iget-boolean p0, v1, Ldk/c;->b:Z
    ...
    :cond_1
    iget-object p0, v2, Lk6/f;->b:Ljava/util/ArrayList;
    ...
    sget-object v2, Lck/a;->o:Ljava/util/HashMap;
...
.method public final notifyThemeChanged(II)V
    ...
    iget-object p2, p0, Lgk/k;->i:Landroid/widget/ImageView;

    invoke-virtual {p2, p1}, Landroid/widget/ImageView;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V

    iget-object p1, p0, Lgk/k;->g:Lgk/m;

    if-eqz p1, :cond_1

    iget p0, p0, Lgk/k;->f:I
...
.method public final oj()V
    ...
    sget-object v1, Lck/a;->k:Ljava/lang/String;
    ...
    invoke-direct {v2, v0, v3}, LC5/o;-><init>(Ljava/lang/Object;I)V
...
.method public final onClick(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v0}, Lgk/m;->getItemViewType(I)I
    ...
    :goto_0
    iget-object p1, p0, Lgk/k;->n:Lcom/xiaomi/milive/data/LiveMasterProcessing;
    ...
    invoke-virtual {p1, v0}, LZ1/W;->h(Ljava/lang/String;)V

    iget-object p1, p0, Lgk/k;->g:Lgk/m;

    const/4 v0, -0x1

    invoke-virtual {p1, v0}, Lcom/android/camera/fragment/beauty/g;->setSelectedIndex(I)V
    ...
    iget-object p1, p0, Lgk/k;->i:Landroid/widget/ImageView;

    const/4 v1, 0x0

    invoke-virtual {p1, v1}, Landroid/widget/ImageView;->setVisibility(I)V

    iput v0, p0, Lgk/k;->f:I
...
.method public final provideAnimateElement(ILjava/util/List;I)V
    ...
    invoke-virtual {p0, p3}, Lgk/k;->onBackEvent(I)Z
...
.method public final updateView4Normal(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    :cond_0
    iget-object p1, p0, Lgk/k;->l:Landroid/view/View;

    invoke-virtual {p0, p1}, Lgk/k;->Oi(Landroid/view/View;)V
...
.method public final updateView4Pad(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    :goto_0
    iput p2, p0, Lgk/k;->d:I

    iget-object p2, p0, Lgk/k;->l:Landroid/view/View;

    invoke-virtual {p0, p2}, Lgk/k;->Oi(Landroid/view/View;)V

...
.method public constructor <init>()V
    ...
    iput-object v0, p0, LSk/b;->d:[F

    new-instance v0, LBk/f;

    const/4 v1, 0x1

    invoke-direct {v0, p0, v1}, LBk/f;-><init>(Ljava/lang/Object;I)V

    invoke-static {v0}, Lag/v;->t(Lwm/a;)Lhm/m;

    new-instance v0, LSk/a;

    invoke-direct {v0, p0}, LSk/a;-><init>(LSk/b;)V

    invoke-static {v0}, Lag/v;->t(Lwm/a;)Lhm/m;

    move-result-object v0

    iput-object v0, p0, LSk/b;->j:Lhm/m;

    new-instance v0, LSk/b$a;

    invoke-direct {v0, p0}, LSk/b$a;-><init>(LSk/b;)V

    iput-object v0, p0, LSk/b;->k:LSk/b$a;

    return-void
.end method

.method public static a(LSk/b;II)V
    .locals 2
    ...
    iget-object v0, p0, LSk/b;->j:Lhm/m;
...
.method public final buildFURenderInputData()Lcom/faceunity/core/entity/FURenderInputData;
    ...
    iget-object p0, p0, LSk/b;->j:Lhm/m;
...
.method public final drawRenderFrame()V
    ...
    iget-boolean v0, p0, LSk/b;->h:Z

    const/4 v1, 0x0

    if-nez v0, :cond_1

    iget-object v0, p0, LSk/b;->f:Landroid/graphics/Bitmap;
    ...
    iget-object v1, p0, LSk/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;

    if-eqz v1, :cond_4

    iget p0, p0, LSk/b;->g:I
    ...
    :cond_2
    iput v1, p0, LSk/b;->i:I

    if-lez v1, :cond_3

    iget-object v0, p0, LSk/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
...
.method public final isRenderEnvironmentPrepare()Z
    ...
    iget-object p0, p0, LSk/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
...
.method public final pauseRender()V
    ...
    invoke-direct {v3, v4, p0, v0}, LM0/d;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V
...
.method public final release()V
    ...
    iput-object v0, p0, LSk/b;->f:Landroid/graphics/Bitmap;
...
.method public final releaseGLResource()V
    ...
    iput-object v0, p0, LSk/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;
...
.method public final surfaceCreated(Landroid/opengl/EGLConfig;)V
    ...
    iput-object p1, p0, LSk/b;->a:Lcom/faceunity/toolbox/program/FUProgramTexture2d;

    const/4 p1, 0x0

    iput-boolean p1, p0, LSk/b;->h:Z

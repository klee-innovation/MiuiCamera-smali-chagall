...
.method public constructor <init>(Lmi/k;)V
    ...
    iput-object p1, p0, Lmi/m;->a:Lmi/k;
...
.method public final a(Landroid/media/MediaFormat;Lpi/c;)V
    ...
    iget-object v0, p0, Lmi/m;->a:Lmi/k;

    iget-object v1, v0, Lmi/k;->i:Lpi/h;
    ...
    iget-boolean v5, v4, Lmi/q;->t:Z

    iget-boolean v0, v0, Lmi/k;->v:Z

    iget-boolean v4, v4, Lmi/q;->u:Z
    ...
    iget-object v1, p0, Lmi/m;->a:Lmi/k;

    iget v1, v1, Lmi/k;->k:I
    ...
    :cond_4
    iget-object v0, v0, Lmi/k;->j:Lpi/h;
    ...
    :cond_5
    :goto_1
    iget-object p0, p0, Lmi/m;->a:Lmi/k;
    ...
    :try_start_0
    invoke-virtual {p0}, Lmi/k;->c()Z

    move-result p2

    if-eqz p2, :cond_7

    iget-boolean p2, p0, Lmi/k;->h:Z
    ...
    invoke-virtual {p0, p2}, Lmi/b;->a(I)V

    :goto_2
    iget-object p0, p0, Lmi/k;->x:Ljava/lang/Object;
    ...
    iget-object p2, p0, Lmi/k;->x:Ljava/lang/Object;
...
.method public final b(Ljava/nio/ByteBuffer;Lpi/e;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object v0, p0, Lmi/k;->i:Lpi/h;
    ...
    iget-object p2, p0, Lmi/k;->g:Landroid/media/MediaMuxer;

    iget v0, p0, Lmi/k;->k:I

    invoke-virtual {p0, p2, v0, p1, p3}, Lmi/k;->f(Landroid/media/MediaMuxer;ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    iget-object p3, p0, Lmi/k;->g:Landroid/media/MediaMuxer;

    iget v0, p0, Lmi/k;->m:I

    invoke-virtual {p0, p3, v0, p1, p2}, Lmi/k;->f(Landroid/media/MediaMuxer;ILjava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    goto :goto_0

    :cond_0
    iget-object v0, p0, Lmi/k;->j:Lpi/h;

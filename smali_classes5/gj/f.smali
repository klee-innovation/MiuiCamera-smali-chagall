...
.method public static l(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lgj/f;->p(Landroid/content/Intent;)Z
...
.method public static p(Landroid/content/Intent;)Z
    ...
    invoke-static {p0}, Lgj/f;->n(Landroid/content/Intent;)Z
...
.method public final a(Landroidx/fragment/app/l;)Z
    ...
    :cond_3
    iget-object v1, p0, Lgj/f;->a:Landroid/content/Intent;
    ...
    iget-object p1, p0, Lgj/f;->a:Landroid/content/Intent;

    invoke-static {p1}, Lgj/f;->i(Landroid/content/Intent;)Z
    ...
    invoke-static {p0, v4}, LI/g;->e(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-static {p0, v0, p1, v2}, LD0/p;->f(ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final b()V
    ...
    iget-object v0, p0, Lgj/f;->a:Landroid/content/Intent;
...
.method public final c()Z
    ...
    iget-object v1, p0, Lgj/f;->c:Ljava/lang/Boolean;

    if-nez v1, :cond_9

    invoke-virtual {p0}, Lgj/f;->d()Ljava/lang/String;
    ...
    :cond_9
    :goto_1
    iget-object p0, p0, Lgj/f;->c:Ljava/lang/Boolean;
...
.method public final d()Ljava/lang/String;
    ...
    iget-object v0, p0, Lgj/f;->b:Landroid/net/Uri;

    if-nez v0, :cond_0

    iget-object v0, p0, Lgj/f;->a:Landroid/content/Intent;

    invoke-static {v0}, Lgj/f;->t(Landroid/content/Intent;)Landroid/net/Uri;

    move-result-object v0

    iput-object v0, p0, Lgj/f;->b:Landroid/net/Uri;

    :cond_0
    iget-object p0, p0, Lgj/f;->b:Landroid/net/Uri;
...
.method public final m()Z
    ...
    iget-object v3, p0, Lgj/f;->a:Landroid/content/Intent;
    ...
    :cond_6
    iget-object v6, p0, Lgj/f;->a:Landroid/content/Intent;
    ...
    :cond_8
    sget-object v8, Lt1/p0$a;->a:Lt1/p0;

    iget v8, v8, Lt1/p0;->a:I
    ...
    invoke-static {v6}, Lgj/f;->n(Landroid/content/Intent;)Z
...
.method public final u(Lcom/android/camera/a;)V
    .locals 1
    ...
    iput-object p1, p0, Lgj/f;->b:Landroid/net/Uri;
    ...
    invoke-static {p0}, Lgj/f$a;->a(Landroid/content/Intent;)V

...
# direct methods
.method public static a(LKm/b;Z)LKm/e;
    .locals 20
    ...
    sget-object v2, LMm/b$a;->a:LMm/b$a;

    const/4 v3, 0x0

    move/from16 v4, p1

    invoke-direct {v1, v0, v3, v2, v4}, LKm/e;-><init>(LMm/k;LKm/e;LMm/b$a;Z)V

    invoke-virtual/range {p0 .. p0}, LPm/b;->T()LMm/Q;

    move-result-object v14

    sget-object v15, Lim/u;->a:Lim/u;

    iget-object v0, v0, LKm/b;->k:Ljava/util/List;
    ...
    invoke-interface {v5}, LMm/a0;->t()I
    ...
    :cond_0
    invoke-static {v3}, Lim/s;->A0(Ljava/lang/Iterable;)Lim/y;
    ...
    invoke-interface {v2}, LMm/h;->n()LCn/O;
    ...
    invoke-direct/range {v2 .. v13}, LPm/X;-><init>(LMm/a;LMm/e0;ILNm/f;Lln/f;LCn/F;ZZZLCn/F;LMm/V;)V
    ...
    sget-object v9, LMm/A;->d:LMm/A;

    sget-object v10, LMm/q;->e:LMm/q$h;
    ...
    invoke-virtual/range {v2 .. v10}, LPm/P;->S0(LPm/O;LMm/Q;Ljava/util/List;Ljava/util/List;Ljava/util/List;LCn/F;LMm/A;LMm/r;)LPm/P;

    const/4 v0, 0x1

    iput-boolean v0, v1, LPm/x;->e0:Z

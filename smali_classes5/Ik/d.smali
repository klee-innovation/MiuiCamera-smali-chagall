...
# direct methods
.method public static a(Lvk/e$a;)V
    .locals 10
    ...
    sget-object v3, LXk/b;->a:Ljava/lang/String;

    invoke-virtual {v2, v3}, LVk/b;->j(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v7, v1, v0}, LAc/c;->x(ILjava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    invoke-static {v4}, Lgj/x;->j(Ljava/lang/String;)Z
    ...
    invoke-static {v7, v6, v0}, LAc/c;->x(ILjava/lang/String;Ljava/lang/String;)V

    iget-object p0, p0, Lvk/e$a;->a:Lvk/e;

    const/4 v0, 0x0

    iput-object v0, p0, Lvk/e;->B0:Lvk/e$a;
    ...
    invoke-static {v3, v1, v4}, LAc/c;->x(ILjava/lang/String;Ljava/lang/String;)V

    new-instance v4, Ljava/io/File;

    sget-object v5, LJk/a;->a:Ljava/lang/String;
    ...
    sget-object v8, LJk/a;->b:Ljava/lang/String;
    ...
    invoke-static {v0, v6, v1}, LAc/c;->x(ILjava/lang/String;Ljava/lang/String;)V
    ...
    iget-object v0, p0, Lvk/e$a;->a:Lvk/e;

    iget-object v1, v0, Lvk/e;->g0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-virtual {v0}, Lvk/e;->v()V

    goto :goto_1

    :cond_4
    iget-object v1, v0, Lvk/e;->f0:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iput-object v1, v0, Lvk/e;->r:LBk/m;

    iget-object v1, v1, LBk/m;->a:LBk/l;

    iput-object v1, v0, Lvk/e;->n0:LBk/l;
    ...
    iget-object v0, v0, Lvk/e;->q:Lcom/faceunity/core/faceunity/FUAIKit;
    ...
    invoke-virtual {v2, v0}, LD7/i;->r0(Ljava/lang/Runnable;)V
    ...
    invoke-static {v7, v6, p0}, LAc/c;->x(ILjava/lang/String;Ljava/lang/String;)V
...
.method public static b(Ljava/lang/String;Lvk/e$a;)V
    .locals 13
    ...
    iput-object v4, v0, Lnl/c;->a:[B

    iput-object v5, v0, Lnl/c;->b:[B
    ...
    sget-object v12, Lcom/xiaomi/camera/rx/CameraSchedulers;->sCameraWorkScheduler:Lio/reactivex/v;
    ...
    invoke-direct/range {v6 .. v11}, LIk/a;-><init>(Ljava/lang/String;Ljava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicInteger;Lvk/e$a;Ljava/util/concurrent/atomic/AtomicBoolean;)V

    invoke-static {v12, v3}, LJb/A;->h(Lio/reactivex/v;Ljava/lang/Runnable;)Lio/reactivex/disposables/b;
    ...
    invoke-direct/range {v3 .. v9}, LIk/b;-><init>([B[BLjava/util/concurrent/locks/ReentrantLock;Ljava/util/concurrent/atomic/AtomicBoolean;Lvk/e$a;Ljava/util/concurrent/atomic/AtomicInteger;)V

    invoke-static {v12, p0}, LJb/A;->h(Lio/reactivex/v;Ljava/lang/Runnable;)Lio/reactivex/disposables/b;

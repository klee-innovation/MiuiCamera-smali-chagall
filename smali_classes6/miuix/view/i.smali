...
.method public static b(Landroid/content/Context;I[I)[I
    ...
    invoke-static {p0, v0}, Lgp/d;->g(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final a(Z)V
    ...
    invoke-static {v0, p1}, LPo/i;->f(ILandroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_3

    invoke-static {v0, p1}, LPo/i;->g(ILandroid/view/View;)Z

    :cond_3
    invoke-static {p1}, LPo/i;->b(Landroid/view/View;)V
...
.method public final d()V
    ...
    invoke-static {v2, v5}, LPo/i;->f(ILandroid/view/View;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {v2, v5}, LPo/i;->g(ILandroid/view/View;)Z
    ...
    :cond_1
    :goto_0
    invoke-static {v5}, LPo/i;->b(Landroid/view/View;)V
    ...
    invoke-interface {v4, v0}, Lmiuix/view/i$a;->b(Z)LPo/f$b;
    ...
    iget v8, v0, LPo/f$b;->a:I

    iget-object v0, v0, LPo/f$b;->b:LPo/f$c;

    if-eqz v0, :cond_7

    iget-object v9, v0, LPo/f$c;->a:[I
    ...
    invoke-static {v6}, LPo/k;->d(Landroid/graphics/drawable/Drawable;)Ljava/lang/Integer;
    ...
    :goto_4
    invoke-interface {v4, v3}, Lmiuix/view/i$a;->e(Z)V

    iget v3, p0, Lmiuix/view/i;->n:I
    ...
    invoke-static {v0, v5, v3}, LPo/i;->e(ILandroid/view/View;I)Z
    ...
    :cond_a
    invoke-static {v3, v5}, LPo/i;->g(ILandroid/view/View;)Z
    ...
    sput-object v0, LPo/i;->b:Ljava/lang/reflect/Method;
    ...
    invoke-static {v5, v0, p0}, LPo/i;->d(Landroid/view/View;[I[I)V

...
.field public H0:Lmiuix/preference/MultiChoicePreferenceCategory$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, LBp/x;->multiChoicePreferenceStyle:I
    ...
    sget-object v2, LBp/F;->ChoicePreference:[I

    invoke-virtual {p1, p2, v2, v0, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, LBp/F;->ChoicePreference_android_value:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object p2

    iput-object p2, p0, Lmiuix/preference/MultiChoicePreference;->J0:Ljava/lang/String;
...
.method public final D(Ls0/f;)V
    ...
    iput-object p1, p0, Lmiuix/preference/MultiChoicePreference;->I0:Landroid/view/View;
    ...
    iget-boolean v3, p0, Lmiuix/preference/MultiChoicePreference;->G0:Z
    ...
    iput-boolean v2, p0, Lmiuix/preference/MultiChoicePreference;->G0:Z
    ...
    :cond_8
    iget-object p1, p0, Lmiuix/preference/MultiChoicePreference;->I0:Landroid/view/View;

    new-instance v2, LBp/g;

    invoke-direct {v2, p0, v0, v1}, LBp/g;-><init>(Lmiuix/preference/MultiChoicePreference;Landroid/view/View;Landroid/view/View;)V

    invoke-static {p1, v2}, LS/H;->j(Landroid/view/View;LS/a;)V
...
.method public final E()V
    ...
    iput-boolean v0, p0, Lmiuix/preference/MultiChoicePreference;->G0:Z

    invoke-super {p0}, Landroidx/preference/TwoStatePreference;->E()V

    iget-boolean v0, p0, Lmiuix/preference/MultiChoicePreference;->G0:Z

    if-eqz v0, :cond_0

    iget-object p0, p0, Lmiuix/preference/MultiChoicePreference;->I0:Landroid/view/View;
...
.method public final k(Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lmiuix/preference/MultiChoicePreference;->H0:Lmiuix/preference/MultiChoicePreferenceCategory$a;
    ...
    invoke-virtual {v0, p0, v1}, Lmiuix/preference/MultiChoicePreferenceCategory$a;->a(Lmiuix/preference/BaseCheckBoxPreference;Ljava/lang/Boolean;)Z

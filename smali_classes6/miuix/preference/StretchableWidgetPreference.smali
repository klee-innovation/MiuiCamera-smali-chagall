...
.field public C0:Lmiuix/stretchablewidget/WidgetContainer;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    .line 1
    sget v0, LBp/x;->stretchableWidgetPreferenceStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 4
    iput v0, p0, Lmiuix/preference/StretchableWidgetPreference;->I0:I

    .line 5
    sget-object v1, LBp/F;->StretchableWidgetPreference:[I
    ...
    .line 6
    sget p2, LBp/F;->StretchableWidgetPreference_detail_message:I

    invoke-virtual {p1, p2}, Landroid/content/res/TypedArray;->getString(I)Ljava/lang/String;

    move-result-object p2

    iput-object p2, p0, Lmiuix/preference/StretchableWidgetPreference;->H0:Ljava/lang/String;

    .line 7
    sget p2, LBp/F;->StretchableWidgetPreference_expand_state:I

    invoke-virtual {p1, p2, v0}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result p2

    iput-boolean p2, p0, Lmiuix/preference/StretchableWidgetPreference;->G0:Z
...
.method public D(Ls0/f;)V
    ...
    iput-object v0, p0, Lmiuix/preference/StretchableWidgetPreference;->B0:Landroid/widget/RelativeLayout;
    ...
    iput-object v0, p0, Lmiuix/preference/StretchableWidgetPreference;->C0:Lmiuix/stretchablewidget/WidgetContainer;
    ...
    iget-object v0, p0, Lmiuix/preference/StretchableWidgetPreference;->C0:Lmiuix/stretchablewidget/WidgetContainer;
    ...
    sget v0, LBp/B;->detail_msg_text:I
    ...
    iput-object v0, p0, Lmiuix/preference/StretchableWidgetPreference;->D0:Landroid/widget/TextView;

    sget v0, LBp/B;->state_image:I
    ...
    iput-object v0, p0, Lmiuix/preference/StretchableWidgetPreference;->A0:Landroid/widget/ImageView;

    sget v2, LBp/A;->miuix_stretchable_widget_state_collapse:I

    invoke-virtual {v0, v2}, Landroid/view/View;->setBackgroundResource(I)V

    sget v0, LBp/B;->button_line:I

    invoke-virtual {p1, v0}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object v0

    iput-object v0, p0, Lmiuix/preference/StretchableWidgetPreference;->E0:Landroid/view/View;

    sget v0, LBp/B;->top_line:I

    invoke-virtual {p1, v0}, Landroid/view/View;->findViewById(I)Landroid/view/View;

    move-result-object p1

    iput-object p1, p0, Lmiuix/preference/StretchableWidgetPreference;->F0:Landroid/view/View;

    iget-object p1, p0, Lmiuix/preference/StretchableWidgetPreference;->H0:Ljava/lang/String;

    iget-object v0, p0, Lmiuix/preference/StretchableWidgetPreference;->D0:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lmiuix/preference/StretchableWidgetPreference;->A0:Landroid/widget/ImageView;

    sget v2, LBp/A;->miuix_stretchable_widget_state_expand:I
    ...
    iget-object v0, p0, Lmiuix/preference/StretchableWidgetPreference;->F0:Landroid/view/View;
    ...
    iget v3, p0, Lmiuix/preference/StretchableWidgetPreference;->I0:I
    ...
    iget-object p1, p0, Lmiuix/preference/StretchableWidgetPreference;->B0:Landroid/widget/RelativeLayout;

...
# static fields
.field public static volatile a:Lsq/h;
...
.method static constructor <clinit>()V
    ...
    sget-object v0, Ltq/c;->b:Ljava/util/Map;
    ...
    sget-object v5, Ltq/c;->a:Ljava/util/concurrent/CopyOnWriteArraySet;
    ...
    sget-boolean v0, Lsq/b;->e:Z

    if-eqz v0, :cond_5

    new-instance v2, Lsq/b;

    invoke-direct {v2}, Lsq/b;-><init>()V
    ...
    sget-boolean v1, Lsq/d;->d:Z

    if-eqz v1, :cond_7

    new-instance v1, Lsq/d;

    invoke-direct {v1}, Lsq/d;-><init>()V
    ...
    sget-boolean v1, Lsq/c;->d:Z

    if-eqz v1, :cond_9

    new-instance v1, Lsq/c;

    invoke-direct {v1}, Lsq/c;-><init>()V
    ...
    sget-boolean v1, Lsq/g;->d:Z

    if-eqz v1, :cond_b

    new-instance v1, Lsq/g;

    invoke-direct {v1}, Lsq/g;-><init>()V
    ...
    invoke-direct/range {v7 .. v12}, Lsq/e;-><init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/Class;Ljava/lang/Class;)V
    :try_end_1
    ...
    invoke-direct {v0}, Lsq/h;-><init>()V

    :cond_11
    :goto_a
    sput-object v0, Lsq/h;->a:Lsq/h;

    const-class v0, Ljq/x;
    ...
    sput-object v0, Lsq/h;->b:Ljava/util/logging/Logger;
...
.method public static i(Ljava/lang/String;ILjava/lang/Throwable;)V
    ...
    :goto_0
    sget-object v0, Lsq/h;->b:Ljava/util/logging/Logger;
...
.method public static synthetic j(Lsq/h;Ljava/lang/String;II)V
    .locals 0
    ...
    invoke-static {p1, p2, p0}, Lsq/h;->i(Ljava/lang/String;ILjava/lang/Throwable;)V
...
.method public b(Ljavax/net/ssl/X509TrustManager;)Lvq/c;
    .locals 1
...
.method public c(Ljavax/net/ssl/X509TrustManager;)Lvq/e;
    .locals 1
    ...
    invoke-direct {p0, p1}, Lvq/b;-><init>([Ljava/security/cert/X509Certificate;)V
...
.method public g()Ljava/lang/Object;
    ...
    sget-object p0, Lsq/h;->b:Ljava/util/logging/Logger;
...
.method public k(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {p2, p0, p1}, Lsq/h;->i(Ljava/lang/String;ILjava/lang/Throwable;)V
...
.method public m(Ljavax/net/ssl/X509TrustManager;)Ljavax/net/ssl/SSLSocketFactory;
    ...
    :try_start_0
    invoke-virtual {p0}, Lsq/h;->l()Ljavax/net/ssl/SSLContext;

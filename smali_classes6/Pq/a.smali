...
# direct methods
.method public static a(LKq/a;LPq/b;)Ljava/util/LinkedList;
    .locals 10
    ...
    invoke-static {p0}, LMq/g;->b(LKq/a;)Ljava/util/ArrayList;
    ...
    check-cast v1, LMq/g$a;

    iget-object v3, v1, LMq/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;
    ...
    iget-wide v3, v1, LMq/g$a;->a:J

    invoke-virtual {p0, v3, v4}, LKq/a;->a(J)V

    iget-object v0, v1, LMq/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;

    iget-wide v3, v0, Lorg/jcodec/containers/mp4/boxes/b;->b:J

    long-to-int v0, v3

    invoke-static {p0, v0}, LKq/b;->b(Ljava/nio/channels/ByteChannel;I)Ljava/nio/ByteBuffer;
    ...
    sget-object v4, LMq/b;->b:LMq/b;

    invoke-static {v0, v3, v4}, LMq/c;->a(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/b;LMq/b;)Lorg/jcodec/containers/mp4/boxes/Box;
    ...
    check-cast v7, LMq/g$a;

    iget-object v8, v7, LMq/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;
    ...
    check-cast v6, LMq/g$a;

    iget-wide v7, v6, LMq/g$a;->a:J

    invoke-virtual {p0, v7, v8}, LKq/a;->a(J)V

    iget-object v7, v6, LMq/g$a;->b:Lorg/jcodec/containers/mp4/boxes/b;

    iget-wide v7, v7, Lorg/jcodec/containers/mp4/boxes/b;->b:J

    long-to-int v7, v7

    invoke-static {p0, v7}, LKq/b;->b(Ljava/nio/channels/ByteChannel;I)Ljava/nio/ByteBuffer;

    move-result-object v7

    new-instance v8, LJq/e;

    invoke-direct {v8, v6, v7}, LJq/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    sget-object v8, LMq/b;->b:LMq/b;

    invoke-static {v7, v6, v8}, LMq/c;->a(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/b;LMq/b;)Lorg/jcodec/containers/mp4/boxes/Box;
    ...
    invoke-direct {v8, v7, v6}, LJq/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    iget-object v6, v6, LJq/e;->b:Ljava/lang/Object;
    ...
    iget-object v5, p1, LJq/e;->a:Ljava/lang/Object;

    check-cast v5, Ljava/nio/ByteBuffer;

    iget-object p1, p1, LJq/e;->b:Ljava/lang/Object;

    check-cast p1, Lorg/jcodec/containers/mp4/boxes/Box;

    invoke-static {v5, p1}, LPq/a;->b(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/Box;)Z
    ...
    :cond_7
    invoke-interface {p1, v3}, LPq/b;->a(Lorg/jcodec/containers/mp4/boxes/MovieBox;)V

    :cond_8
    invoke-static {v0, v3}, LPq/a;->b(Ljava/nio/ByteBuffer;Lorg/jcodec/containers/mp4/boxes/Box;)Z
    ...
    :cond_9
    new-instance p0, LJq/e;

    invoke-direct {p0, v1, v0}, LJq/e;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

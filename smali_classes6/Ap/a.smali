...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput v2, p0, LAp/a;->e:I

    iput-object p1, p0, LAp/a;->b:Landroid/content/Context;

    const/4 v2, 0x1

    iput-boolean v2, p0, LAp/a;->d:Z

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v3

    sget v4, Lwp/c;->miuix_appcompat_arrow_popup_window_list_max_height:I
    ...
    sget v3, Lwp/f;->miuix_appcompat_arrow_popup_view:I
    ...
    iput-object p1, p0, LAp/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;
    ...
    iget-object p1, p0, LAp/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    invoke-virtual {p1, p0}, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->setArrowPopupWindow(LAp/a;)V
    ...
    invoke-direct {v4, p1}, Lzp/a;-><init>(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)V

    invoke-virtual {v3, v4}, Landroid/view/View;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V

    iget v4, p1, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->r0:I
    ...
    invoke-direct {v4, p1}, Lzp/b;-><init>(Lmiuix/popupwidget/internal/widget/ArrowPopupView;)V

    invoke-virtual {v3, v4}, Landroid/view/View;->setOutlineProvider(Landroid/view/ViewOutlineProvider;)V

    iget p1, p1, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->r0:I
    ...
    iput v3, p1, LAp/c;->g:I

    invoke-virtual {p1, v2}, Landroid/widget/PopupWindow;->setFocusable(Z)V

    iget-object v3, p1, LAp/a;->b:Landroid/content/Context;

    invoke-static {v3}, Landroid/view/LayoutInflater;->from(Landroid/content/Context;)Landroid/view/LayoutInflater;

    move-result-object v3

    sget v4, Lwp/f;->miuix_appcompat_guide_popup_content_view:I
    ...
    iput-object v0, p1, LAp/c;->f:Landroid/widget/LinearLayout;

    invoke-virtual {p1, v0}, LAp/a;->setContentView(Landroid/view/View;)V

    iget-object v0, p1, LAp/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v0, p1, LAp/c;->f:Landroid/widget/LinearLayout;
    ...
    invoke-direct {v1, p1, v2}, LAp/b;-><init>(Ljava/lang/Object;I)V

    invoke-static {v0, v1}, LS/H;->j(Landroid/view/View;LS/a;)V

    invoke-virtual {p0}, Landroid/widget/PopupWindow;->update()V

    iget-object p1, p0, LAp/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    iget p0, p0, LAp/a;->e:I
...
.method public final a()V
    ...
    iget-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k0:Landroid/view/animation/AnimationSet;
    ...
    iput-object v0, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k0:Landroid/view/animation/AnimationSet;
    ...
    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->k0:Landroid/view/animation/AnimationSet;

    invoke-virtual {v1, v11}, Landroid/view/animation/AnimationSet;->addAnimation(Landroid/view/animation/Animation;)V

    iget-boolean v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->A0:Z
    ...
    iget-object v1, p0, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->u0:Lmiuix/popupwidget/internal/widget/ArrowPopupView$b;
...
.method public final c(I)V
    ...
    iget-object v0, p0, LAp/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;

    invoke-virtual {v0}, Lmiuix/popupwidget/internal/widget/ArrowPopupView;->getContentFrameWrapperBottomPadding()I

    move-result v0

    iget-object v1, p0, LAp/a;->a:Lmiuix/popupwidget/internal/widget/ArrowPopupView;
...
.method public final setHeight(I)V
    ...
    invoke-virtual {p0, p1}, LAp/a;->c(I)V
...
.method public final showAsDropDown(Landroid/view/View;II)V
    ...
    .line 1
    invoke-virtual {p0, p2, p1, p3}, LAp/a;->d(ILandroid/view/View;I)V
...
.method public final update(IIIIZ)V
    ...
    invoke-virtual {p0, p4}, LAp/a;->c(I)V
